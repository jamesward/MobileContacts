 ...
 * of this value object you may modify the generated sub-class of this class - PartnerRole.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_PartnerRole extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.PartnerRole") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.PartnerRole", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _PartnerRoleEntityMetadata;
    ...
    private var _internal_ReverseRole : String;
    ...
    public function _Super_PartnerRole()
    {
        _model = new _PartnerRoleEntityMetadata(this);
        ...
        model_internal::_changeWatcherArray.push(mx.binding.utils.ChangeWatcher.watch(this, "ReverseRole", model_internal::setterListenerReverseRole));
    ...
    [Bindable(event="propertyChange")]
    public function get ReverseRole() : String
    {
        return _internal_ReverseRole;
    }
    ...
    public function set ReverseRole(value:String) : void
    {
        var oldValue:String = _internal_ReverseRole;
        if (oldValue !== value)
        {
            _internal_ReverseRole = value;
        }
    }
    ...
    model_internal function setterListenerReverseRole(value:flash.events.Event):void
    {
        _model.invalidateDependentOnReverseRole();
    }
    ...
    model_internal function calculateIsValid():Boolean
    {
        ...
        if (!_model.ReverseRoleIsValid)
        {
            propertyValidity = false;
            com.adobe.fiber.util.FiberUtils.arrayAdd(validationFailureMessages, _model.model_internal::_ReverseRoleValidationFailureMessages);
        }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _PartnerRoleEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _PartnerRoleEntityMetadata) : void
    {
        var oldValue : _PartnerRoleEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
    ...
    model_internal var _doValidationCacheOfReverseRole : Array = null;
    model_internal var _doValidationLastValOfReverseRole : String;

    model_internal function _doValidationForReverseRole(valueIn:Object):Array
    {
        var value : String = valueIn as String;

        if (model_internal::_doValidationCacheOfReverseRole != null && model_internal::_doValidationLastValOfReverseRole == value)
           return model_internal::_doValidationCacheOfReverseRole ;

        _model.model_internal::_ReverseRoleIsValidCacheInitialized = true;
        var validationFailures:Array = new Array();
        var errorMessage:String;
        var failure:Boolean;

        var valRes:ValidationResult;
        if (_model.isReverseRoleAvailable && _internal_ReverseRole == null)
        {
            validationFailures.push(new ValidationResult(true, "", "", "ReverseRole is required"));
        }

        model_internal::_doValidationCacheOfReverseRole = validationFailures;
        model_internal::_doValidationLastValOfReverseRole = value;
