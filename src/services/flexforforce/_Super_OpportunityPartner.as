 ...
 * of this value object you may modify the generated sub-class of this class - OpportunityPartner.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_OpportunityPartner extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.OpportunityPartner") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.OpportunityPartner", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _OpportunityPartnerEntityMetadata;
    ...
    public function _Super_OpportunityPartner()
    {
        _model = new _OpportunityPartnerEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _OpportunityPartnerEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _OpportunityPartnerEntityMetadata) : void
    {
        var oldValue : _OpportunityPartnerEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
