 ...
 * of this value object you may modify the generated sub-class of this class - AdditionalNumber.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_AdditionalNumber extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.AdditionalNumber") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.AdditionalNumber", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _AdditionalNumberEntityMetadata;
    ...
    public function _Super_AdditionalNumber()
    {
        _model = new _AdditionalNumberEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _AdditionalNumberEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _AdditionalNumberEntityMetadata) : void
    {
        var oldValue : _AdditionalNumberEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
