 ...
 * of this value object you may modify the generated sub-class of this class - CampaignMemberStatus.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_CampaignMemberStatus extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.CampaignMemberStatus") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.CampaignMemberStatus", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _CampaignMemberStatusEntityMetadata;
    ...
    public function _Super_CampaignMemberStatus()
    {
        _model = new _CampaignMemberStatusEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _CampaignMemberStatusEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _CampaignMemberStatusEntityMetadata) : void
    {
        var oldValue : _CampaignMemberStatusEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
