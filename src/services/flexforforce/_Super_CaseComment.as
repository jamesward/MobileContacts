 ...
 * of this value object you may modify the generated sub-class of this class - CaseComment.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_CaseComment extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.CaseComment") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.CaseComment", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _CaseCommentEntityMetadata;
    ...
    private var _internal_IsPublished : Boolean;
    ...
    public function _Super_CaseComment()
    {
        _model = new _CaseCommentEntityMetadata(this);
    ...
    {
        var oldValue:Boolean = _internal_IsPublished;
        if (oldValue !== value)
        {
            _internal_IsPublished = value;
        }
    }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _CaseCommentEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _CaseCommentEntityMetadata) : void
    {
        var oldValue : _CaseCommentEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
