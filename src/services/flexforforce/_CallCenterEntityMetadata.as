...
[ExcludeClass]
internal class _CallCenterEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    private static var emptyArray:Array = new Array();

    model_internal static var allProperties:Array = new Array("Id", "CreatedById", "CreatedDate", "InternalName", "LastModifiedById", "LastModifiedDate", "Name", "SystemModstamp", "Version");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("Id", "CreatedById", "CreatedDate", "InternalName", "LastModifiedById", "LastModifiedDate", "Name", "SystemModstamp", "Version");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("Id", "CreatedById", "CreatedDate", "InternalName", "LastModifiedById", "LastModifiedDate", "Name", "SystemModstamp", "Version");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("Id", "CreatedById", "CreatedDate", "InternalName", "LastModifiedById", "LastModifiedDate", "Name", "SystemModstamp", "Version");
    model_internal static var derivedProperties:Array = new Array();
    model_internal static var collectionProperties:Array = new Array();
    model_internal static var collectionBaseMap:Object;
    model_internal static var entityName:String = "CallCenter";
    ...
    model_internal var _InternalNameIsValid:Boolean;
    model_internal var _InternalNameValidator:com.adobe.fiber.styles.StyleValidator;
    model_internal var _InternalNameIsValidCacheInitialized:Boolean = false;
    model_internal var _InternalNameValidationFailureMessages:Array;
    ...
    model_internal var _instance:_Super_CallCenter;
    model_internal static var _nullStyle:com.adobe.fiber.styles.Style = new com.adobe.fiber.styles.Style();

    public function _CallCenterEntityMetadata(value : _Super_CallCenter)
    {
        ...
        if (model_internal::dependentsOnMap == null)
        {
            ...
            model_internal::dependentsOnMap["InternalName"] = new Array();
        ...
        model_internal::_InternalNameValidator = new StyleValidator(model_internal::_instance.model_internal::_doValidationForInternalName);
        model_internal::_InternalNameValidator.required = true;
        model_internal::_InternalNameValidator.requiredFieldError = "InternalName is required";
        //model_internal::_InternalNameValidator.source = model_internal::_instance;
        //model_internal::_InternalNameValidator.property = "InternalName";
    ...
    override public function getDependants(propertyName:String):Array
    {
       if (model_internal::dataProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a data property of entity CallCenter");  
    ...
    override public function getCollectionBase(propertyName:String):String
    {
        if (model_internal::collectionProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a collection property of entity CallCenter");  
    ...
    override public function getValue(propertyName:String):*
    {
        ...
        {
            throw new Error(propertyName + " does not exist for entity CallCenter");
        }
    ...
    [Bindable(event="propertyChange")]
    public function get isInternalNameAvailable():Boolean
    {
        return true;
    }
    ...
    public function invalidateDependentOnInternalName():void
    {
        if (model_internal::_InternalNameIsValidCacheInitialized )
        {
            model_internal::_instance.model_internal::_doValidationCacheOfInternalName = null;
            model_internal::calculateInternalNameIsValid();
        }
    }
    ...
    [Bindable(event="propertyChange")]   
    public function get InternalNameStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }

    public function get InternalNameValidator() : StyleValidator
    {
        return model_internal::_InternalNameValidator;
    }

    model_internal function set _InternalNameIsValid_der(value:Boolean):void 
    {
        var oldValue:Boolean = model_internal::_InternalNameIsValid;         
        if (oldValue !== value)
        {
            model_internal::_InternalNameIsValid = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "InternalNameIsValid", oldValue, value));
        }                             
    }

    [Bindable(event="propertyChange")]
    public function get InternalNameIsValid():Boolean
    {
        if (!model_internal::_InternalNameIsValidCacheInitialized)
        {
            model_internal::calculateInternalNameIsValid();
        ...
        return model_internal::_InternalNameIsValid;
    }

    model_internal function calculateInternalNameIsValid():void
    {
        var valRes:ValidationResultEvent = model_internal::_InternalNameValidator.validate(model_internal::_instance.InternalName)
        model_internal::_InternalNameIsValid_der = (valRes.results == null);
        model_internal::_InternalNameIsValidCacheInitialized = true;
        if (valRes.results == null)
             model_internal::InternalNameValidationFailureMessages_der = emptyArray;
        else
        {
            var _valFailures:Array = new Array();
            for (var a:int = 0 ; a<valRes.results.length ; a++)
            ...
            model_internal::InternalNameValidationFailureMessages_der = _valFailures;
        }
    }

    [Bindable(event="propertyChange")]
    public function get InternalNameValidationFailureMessages():Array
    {
        if (model_internal::_InternalNameValidationFailureMessages == null)
            model_internal::calculateInternalNameIsValid();

        return _InternalNameValidationFailureMessages;
    }

    model_internal function set InternalNameValidationFailureMessages_der(value:Array) : void
    {
        var oldValue:Array = model_internal::_InternalNameValidationFailureMessages;
        ...
        if (needUpdate)
        {
            model_internal::_InternalNameValidationFailureMessages = value;   
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "InternalNameValidationFailureMessages", oldValue, value));
            // Only execute calculateIsValid if it has been called before, to update the validationFailureMessages for
            // the entire entity.
            if (model_internal::_instance.model_internal::_cacheInitialized_isValid)
            {
     ...
     */  
     override public function getPropertyValidationFailureMessages(propertyName:String):Array
     {
         switch(propertyName)
         {
            ...
            case("InternalName"):
            {
                return InternalNameValidationFailureMessages;
            }
