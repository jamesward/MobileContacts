 ...
 * of this value object you may modify the generated sub-class of this class - Pricebook2.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_Pricebook2 extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.Pricebook2") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.Pricebook2", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _Pricebook2EntityMetadata;
    ...
    private var _internal_IsStandard : Boolean;
    ...
    public function _Super_Pricebook2()
    {
        _model = new _Pricebook2EntityMetadata(this);
    ...
    [Bindable(event="propertyChange")]
    public function get IsStandard() : Boolean
    {
    ...
    public function set IsStandard(value:Boolean) : void
    {
        var oldValue:Boolean = _internal_IsStandard;
        if (oldValue !== value)
        {
            _internal_IsStandard = value;
        }
    }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _Pricebook2EntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _Pricebook2EntityMetadata) : void
    {
        var oldValue : _Pricebook2EntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
