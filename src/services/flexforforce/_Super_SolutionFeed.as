 ...
 * of this value object you may modify the generated sub-class of this class - SolutionFeed.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_SolutionFeed extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.SolutionFeed") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.SolutionFeed", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _SolutionFeedEntityMetadata;
    ...
    public function _Super_SolutionFeed()
    {
        _model = new _SolutionFeedEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _SolutionFeedEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _SolutionFeedEntityMetadata) : void
    {
        var oldValue : _SolutionFeedEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
