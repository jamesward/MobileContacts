 ...
 * of this value object you may modify the generated sub-class of this class - AccountContactRole.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_AccountContactRole extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.AccountContactRole") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.AccountContactRole", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _AccountContactRoleEntityMetadata;
    ...
    public function _Super_AccountContactRole()
    {
        _model = new _AccountContactRoleEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _AccountContactRoleEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _AccountContactRoleEntityMetadata) : void
    {
        var oldValue : _AccountContactRoleEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
