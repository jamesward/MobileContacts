...
[ExcludeClass]
internal class _SFDC_Issue__cEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    private static var emptyArray:Array = new Array();

    model_internal static var allProperties:Array = new Array("Id", "ConnectionReceivedId", "ConnectionSentId", "CreatedById", "CreatedDate", "IsDeleted", "LastActivityDate", "LastModifiedById", "LastModifiedDate", "Name", "OwnerId", "SFDC_Issue_Description__c", "SFDC_Issue_Name__c", "SFDC_Issue_Priority__c", "SFDC_Issue_Status__c", "SFDC_Project__c", "SystemModstamp", "User__c");
    ...
    model_internal static var entityName:String = "SFDC_Issue__c";
    ...
    model_internal var _SFDC_Issue_Description__cIsValid:Boolean;
    model_internal var _SFDC_Issue_Description__cValidator:com.adobe.fiber.styles.StyleValidator;
    model_internal var _SFDC_Issue_Description__cIsValidCacheInitialized:Boolean = false;
    model_internal var _SFDC_Issue_Description__cValidationFailureMessages:Array;
    
    model_internal var _SFDC_Issue_Name__cIsValid:Boolean;
    model_internal var _SFDC_Issue_Name__cValidator:com.adobe.fiber.styles.StyleValidator;
    model_internal var _SFDC_Issue_Name__cIsValidCacheInitialized:Boolean = false;
    model_internal var _SFDC_Issue_Name__cValidationFailureMessages:Array;
    
    model_internal var _SFDC_Issue_Priority__cIsValid:Boolean;
    model_internal var _SFDC_Issue_Priority__cValidator:com.adobe.fiber.styles.StyleValidator;
    model_internal var _SFDC_Issue_Priority__cIsValidCacheInitialized:Boolean = false;
    model_internal var _SFDC_Issue_Priority__cValidationFailureMessages:Array;
    
    model_internal var _SFDC_Issue_Status__cIsValid:Boolean;
    model_internal var _SFDC_Issue_Status__cValidator:com.adobe.fiber.styles.StyleValidator;
    model_internal var _SFDC_Issue_Status__cIsValidCacheInitialized:Boolean = false;
    model_internal var _SFDC_Issue_Status__cValidationFailureMessages:Array;
    ...
    model_internal var _User__cIsValid:Boolean;
    model_internal var _User__cValidator:com.adobe.fiber.styles.StyleValidator;
    model_internal var _User__cIsValidCacheInitialized:Boolean = false;
    model_internal var _User__cValidationFailureMessages:Array;

    model_internal var _instance:_Super_SFDC_Issue__c;
    model_internal static var _nullStyle:com.adobe.fiber.styles.Style = new com.adobe.fiber.styles.Style();

    public function _SFDC_Issue__cEntityMetadata(value : _Super_SFDC_Issue__c)
    {
        ...
        if (model_internal::dependentsOnMap == null)
        {
            ...
            model_internal::dependentsOnMap["SFDC_Issue_Description__c"] = new Array();
            model_internal::dependentsOnMap["SFDC_Issue_Name__c"] = new Array();
            model_internal::dependentsOnMap["SFDC_Issue_Priority__c"] = new Array();
            model_internal::dependentsOnMap["SFDC_Issue_Status__c"] = new Array();
            model_internal::dependentsOnMap["SFDC_Project__c"] = new Array();
            model_internal::dependentsOnMap["SystemModstamp"] = new Array();
            model_internal::dependentsOnMap["User__c"] = new Array();
        ...
        model_internal::_SFDC_Issue_Description__cValidator = new StyleValidator(model_internal::_instance.model_internal::_doValidationForSFDC_Issue_Description__c);
        model_internal::_SFDC_Issue_Description__cValidator.required = true;
        model_internal::_SFDC_Issue_Description__cValidator.requiredFieldError = "SFDC_Issue_Description__c is required";
        //model_internal::_SFDC_Issue_Description__cValidator.source = model_internal::_instance;
        //model_internal::_SFDC_Issue_Description__cValidator.property = "SFDC_Issue_Description__c";
        model_internal::_SFDC_Issue_Name__cValidator = new StyleValidator(model_internal::_instance.model_internal::_doValidationForSFDC_Issue_Name__c);
        model_internal::_SFDC_Issue_Name__cValidator.required = true;
        model_internal::_SFDC_Issue_Name__cValidator.requiredFieldError = "SFDC_Issue_Name__c is required";
        //model_internal::_SFDC_Issue_Name__cValidator.source = model_internal::_instance;
        //model_internal::_SFDC_Issue_Name__cValidator.property = "SFDC_Issue_Name__c";
        model_internal::_SFDC_Issue_Priority__cValidator = new StyleValidator(model_internal::_instance.model_internal::_doValidationForSFDC_Issue_Priority__c);
        model_internal::_SFDC_Issue_Priority__cValidator.required = true;
        model_internal::_SFDC_Issue_Priority__cValidator.requiredFieldError = "SFDC_Issue_Priority__c is required";
        //model_internal::_SFDC_Issue_Priority__cValidator.source = model_internal::_instance;
        //model_internal::_SFDC_Issue_Priority__cValidator.property = "SFDC_Issue_Priority__c";
        model_internal::_SFDC_Issue_Status__cValidator = new StyleValidator(model_internal::_instance.model_internal::_doValidationForSFDC_Issue_Status__c);
        model_internal::_SFDC_Issue_Status__cValidator.required = true;
        model_internal::_SFDC_Issue_Status__cValidator.requiredFieldError = "SFDC_Issue_Status__c is required";
        //model_internal::_SFDC_Issue_Status__cValidator.source = model_internal::_instance;
        //model_internal::_SFDC_Issue_Status__cValidator.property = "SFDC_Issue_Status__c";
        ...
        model_internal::_User__cValidator = new StyleValidator(model_internal::_instance.model_internal::_doValidationForUser__c);
        model_internal::_User__cValidator.required = true;
        model_internal::_User__cValidator.requiredFieldError = "User__c is required";
        //model_internal::_User__cValidator.source = model_internal::_instance;
        //model_internal::_User__cValidator.property = "User__c";
    }
    ...
    override public function getDependants(propertyName:String):Array
    {
       if (model_internal::dataProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a data property of entity SFDC_Issue__c");  
    ...
    override public function getCollectionBase(propertyName:String):String
    {
        if (model_internal::collectionProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a collection property of entity SFDC_Issue__c");  
    ...
    override public function getValue(propertyName:String):*
    {
        ...
        {
            throw new Error(propertyName + " does not exist for entity SFDC_Issue__c");
        }
    ...
    [Bindable(event="propertyChange")]
    public function get isSFDC_Issue_Description__cAvailable():Boolean
    {
        return true;
    }

    [Bindable(event="propertyChange")]
    public function get isSFDC_Issue_Name__cAvailable():Boolean
    {
        return true;
    }

    [Bindable(event="propertyChange")]
    public function get isSFDC_Issue_Priority__cAvailable():Boolean
    {
        return true;
    }

    [Bindable(event="propertyChange")]
    public function get isSFDC_Issue_Status__cAvailable():Boolean
    {
        return true;
    }
    ...
    [Bindable(event="propertyChange")]
    public function get isUser__cAvailable():Boolean
    {
        return true;
    }
    ...
    public function invalidateDependentOnSFDC_Issue_Description__c():void
    {
        if (model_internal::_SFDC_Issue_Description__cIsValidCacheInitialized )
        {
            model_internal::_instance.model_internal::_doValidationCacheOfSFDC_Issue_Description__c = null;
            model_internal::calculateSFDC_Issue_Description__cIsValid();
        }
    }
    public function invalidateDependentOnSFDC_Issue_Name__c():void
    {
        if (model_internal::_SFDC_Issue_Name__cIsValidCacheInitialized )
        {
            model_internal::_instance.model_internal::_doValidationCacheOfSFDC_Issue_Name__c = null;
            model_internal::calculateSFDC_Issue_Name__cIsValid();
        }
    }
    public function invalidateDependentOnSFDC_Issue_Priority__c():void
    {
        if (model_internal::_SFDC_Issue_Priority__cIsValidCacheInitialized )
        {
            model_internal::_instance.model_internal::_doValidationCacheOfSFDC_Issue_Priority__c = null;
            model_internal::calculateSFDC_Issue_Priority__cIsValid();
        }
    }
    public function invalidateDependentOnSFDC_Issue_Status__c():void
    {
        if (model_internal::_SFDC_Issue_Status__cIsValidCacheInitialized )
        {
            model_internal::_instance.model_internal::_doValidationCacheOfSFDC_Issue_Status__c = null;
            model_internal::calculateSFDC_Issue_Status__cIsValid();
        }
    }
    ...
    public function invalidateDependentOnUser__c():void
    {
        if (model_internal::_User__cIsValidCacheInitialized )
        {
            model_internal::_instance.model_internal::_doValidationCacheOfUser__c = null;
            model_internal::calculateUser__cIsValid();
        }
    }
    ...
    [Bindable(event="propertyChange")]   
    public function get SFDC_Issue_Description__cStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }

    public function get SFDC_Issue_Description__cValidator() : StyleValidator
    {
        return model_internal::_SFDC_Issue_Description__cValidator;
    }

    model_internal function set _SFDC_Issue_Description__cIsValid_der(value:Boolean):void 
    {
        var oldValue:Boolean = model_internal::_SFDC_Issue_Description__cIsValid;         
        if (oldValue !== value)
        {
            model_internal::_SFDC_Issue_Description__cIsValid = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "SFDC_Issue_Description__cIsValid", oldValue, value));
        }                             
    }

    [Bindable(event="propertyChange")]
    public function get SFDC_Issue_Description__cIsValid():Boolean
    {
        if (!model_internal::_SFDC_Issue_Description__cIsValidCacheInitialized)
        {
            model_internal::calculateSFDC_Issue_Description__cIsValid();
        ...
        return model_internal::_SFDC_Issue_Description__cIsValid;
    }

    model_internal function calculateSFDC_Issue_Description__cIsValid():void
    {
        var valRes:ValidationResultEvent = model_internal::_SFDC_Issue_Description__cValidator.validate(model_internal::_instance.SFDC_Issue_Description__c)
        model_internal::_SFDC_Issue_Description__cIsValid_der = (valRes.results == null);
        model_internal::_SFDC_Issue_Description__cIsValidCacheInitialized = true;
        if (valRes.results == null)
             model_internal::SFDC_Issue_Description__cValidationFailureMessages_der = emptyArray;
        else
        {
            var _valFailures:Array = new Array();
            for (var a:int = 0 ; a<valRes.results.length ; a++)
            ...
            model_internal::SFDC_Issue_Description__cValidationFailureMessages_der = _valFailures;
        }
    }

    [Bindable(event="propertyChange")]
    public function get SFDC_Issue_Description__cValidationFailureMessages():Array
    {
        if (model_internal::_SFDC_Issue_Description__cValidationFailureMessages == null)
            model_internal::calculateSFDC_Issue_Description__cIsValid();

        return _SFDC_Issue_Description__cValidationFailureMessages;
    }

    model_internal function set SFDC_Issue_Description__cValidationFailureMessages_der(value:Array) : void
    {
        var oldValue:Array = model_internal::_SFDC_Issue_Description__cValidationFailureMessages;
        ...
        if (needUpdate)
        {
            model_internal::_SFDC_Issue_Description__cValidationFailureMessages = value;   
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "SFDC_Issue_Description__cValidationFailureMessages", oldValue, value));
            // Only execute calculateIsValid if it has been called before, to update the validationFailureMessages for
            // the entire entity.
            if (model_internal::_instance.model_internal::_cacheInitialized_isValid)
            {
    ...
    [Bindable(event="propertyChange")]   
    public function get SFDC_Issue_Name__cStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }

    public function get SFDC_Issue_Name__cValidator() : StyleValidator
    {
        return model_internal::_SFDC_Issue_Name__cValidator;
    }

    model_internal function set _SFDC_Issue_Name__cIsValid_der(value:Boolean):void 
    {
        var oldValue:Boolean = model_internal::_SFDC_Issue_Name__cIsValid;         
        if (oldValue !== value)
        {
            model_internal::_SFDC_Issue_Name__cIsValid = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "SFDC_Issue_Name__cIsValid", oldValue, value));
        }                             
    }

    [Bindable(event="propertyChange")]
    public function get SFDC_Issue_Name__cIsValid():Boolean
    {
        if (!model_internal::_SFDC_Issue_Name__cIsValidCacheInitialized)
        {
            model_internal::calculateSFDC_Issue_Name__cIsValid();
        ...
        return model_internal::_SFDC_Issue_Name__cIsValid;
    }

    model_internal function calculateSFDC_Issue_Name__cIsValid():void
    {
        var valRes:ValidationResultEvent = model_internal::_SFDC_Issue_Name__cValidator.validate(model_internal::_instance.SFDC_Issue_Name__c)
        model_internal::_SFDC_Issue_Name__cIsValid_der = (valRes.results == null);
        model_internal::_SFDC_Issue_Name__cIsValidCacheInitialized = true;
        if (valRes.results == null)
             model_internal::SFDC_Issue_Name__cValidationFailureMessages_der = emptyArray;
        else
        {
            var _valFailures:Array = new Array();
            for (var a:int = 0 ; a<valRes.results.length ; a++)
            ...
            model_internal::SFDC_Issue_Name__cValidationFailureMessages_der = _valFailures;
        }
    }

    [Bindable(event="propertyChange")]
    public function get SFDC_Issue_Name__cValidationFailureMessages():Array
    {
        if (model_internal::_SFDC_Issue_Name__cValidationFailureMessages == null)
            model_internal::calculateSFDC_Issue_Name__cIsValid();

        return _SFDC_Issue_Name__cValidationFailureMessages;
    }

    model_internal function set SFDC_Issue_Name__cValidationFailureMessages_der(value:Array) : void
    {
        var oldValue:Array = model_internal::_SFDC_Issue_Name__cValidationFailureMessages;
        ...
        if (needUpdate)
        {
            model_internal::_SFDC_Issue_Name__cValidationFailureMessages = value;   
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "SFDC_Issue_Name__cValidationFailureMessages", oldValue, value));
            // Only execute calculateIsValid if it has been called before, to update the validationFailureMessages for
            // the entire entity.
            if (model_internal::_instance.model_internal::_cacheInitialized_isValid)
            {
    ...
    [Bindable(event="propertyChange")]   
    public function get SFDC_Issue_Priority__cStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }

    public function get SFDC_Issue_Priority__cValidator() : StyleValidator
    {
        return model_internal::_SFDC_Issue_Priority__cValidator;
    }

    model_internal function set _SFDC_Issue_Priority__cIsValid_der(value:Boolean):void 
    {
        var oldValue:Boolean = model_internal::_SFDC_Issue_Priority__cIsValid;         
        if (oldValue !== value)
        {
            model_internal::_SFDC_Issue_Priority__cIsValid = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "SFDC_Issue_Priority__cIsValid", oldValue, value));
        }                             
    }

    [Bindable(event="propertyChange")]
    public function get SFDC_Issue_Priority__cIsValid():Boolean
    {
        if (!model_internal::_SFDC_Issue_Priority__cIsValidCacheInitialized)
        {
            model_internal::calculateSFDC_Issue_Priority__cIsValid();
        ...
        return model_internal::_SFDC_Issue_Priority__cIsValid;
    }

    model_internal function calculateSFDC_Issue_Priority__cIsValid():void
    {
        var valRes:ValidationResultEvent = model_internal::_SFDC_Issue_Priority__cValidator.validate(model_internal::_instance.SFDC_Issue_Priority__c)
        model_internal::_SFDC_Issue_Priority__cIsValid_der = (valRes.results == null);
        model_internal::_SFDC_Issue_Priority__cIsValidCacheInitialized = true;
        if (valRes.results == null)
             model_internal::SFDC_Issue_Priority__cValidationFailureMessages_der = emptyArray;
        else
        {
            var _valFailures:Array = new Array();
            for (var a:int = 0 ; a<valRes.results.length ; a++)
            ...
            model_internal::SFDC_Issue_Priority__cValidationFailureMessages_der = _valFailures;
        }
    }

    [Bindable(event="propertyChange")]
    public function get SFDC_Issue_Priority__cValidationFailureMessages():Array
    {
        if (model_internal::_SFDC_Issue_Priority__cValidationFailureMessages == null)
            model_internal::calculateSFDC_Issue_Priority__cIsValid();

        return _SFDC_Issue_Priority__cValidationFailureMessages;
    }

    model_internal function set SFDC_Issue_Priority__cValidationFailureMessages_der(value:Array) : void
    {
        var oldValue:Array = model_internal::_SFDC_Issue_Priority__cValidationFailureMessages;
        ...
        if (needUpdate)
        {
            model_internal::_SFDC_Issue_Priority__cValidationFailureMessages = value;   
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "SFDC_Issue_Priority__cValidationFailureMessages", oldValue, value));
            // Only execute calculateIsValid if it has been called before, to update the validationFailureMessages for
            // the entire entity.
            if (model_internal::_instance.model_internal::_cacheInitialized_isValid)
            {
    ...
    [Bindable(event="propertyChange")]   
    public function get SFDC_Issue_Status__cStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }

    public function get SFDC_Issue_Status__cValidator() : StyleValidator
    {
        return model_internal::_SFDC_Issue_Status__cValidator;
    }

    model_internal function set _SFDC_Issue_Status__cIsValid_der(value:Boolean):void 
    {
        var oldValue:Boolean = model_internal::_SFDC_Issue_Status__cIsValid;         
        if (oldValue !== value)
        {
            model_internal::_SFDC_Issue_Status__cIsValid = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "SFDC_Issue_Status__cIsValid", oldValue, value));
        }                             
    }

    [Bindable(event="propertyChange")]
    public function get SFDC_Issue_Status__cIsValid():Boolean
    {
        if (!model_internal::_SFDC_Issue_Status__cIsValidCacheInitialized)
        {
            model_internal::calculateSFDC_Issue_Status__cIsValid();
        ...
        return model_internal::_SFDC_Issue_Status__cIsValid;
    }

    model_internal function calculateSFDC_Issue_Status__cIsValid():void
    {
        var valRes:ValidationResultEvent = model_internal::_SFDC_Issue_Status__cValidator.validate(model_internal::_instance.SFDC_Issue_Status__c)
        model_internal::_SFDC_Issue_Status__cIsValid_der = (valRes.results == null);
        model_internal::_SFDC_Issue_Status__cIsValidCacheInitialized = true;
        if (valRes.results == null)
             model_internal::SFDC_Issue_Status__cValidationFailureMessages_der = emptyArray;
        else
        {
            var _valFailures:Array = new Array();
            for (var a:int = 0 ; a<valRes.results.length ; a++)
            ...
            model_internal::SFDC_Issue_Status__cValidationFailureMessages_der = _valFailures;
        }
    }

    [Bindable(event="propertyChange")]
    public function get SFDC_Issue_Status__cValidationFailureMessages():Array
    {
        if (model_internal::_SFDC_Issue_Status__cValidationFailureMessages == null)
            model_internal::calculateSFDC_Issue_Status__cIsValid();

        return _SFDC_Issue_Status__cValidationFailureMessages;
    }

    model_internal function set SFDC_Issue_Status__cValidationFailureMessages_der(value:Array) : void
    {
        var oldValue:Array = model_internal::_SFDC_Issue_Status__cValidationFailureMessages;
        ...
        if (needUpdate)
        {
            model_internal::_SFDC_Issue_Status__cValidationFailureMessages = value;   
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "SFDC_Issue_Status__cValidationFailureMessages", oldValue, value));
            // Only execute calculateIsValid if it has been called before, to update the validationFailureMessages for
            // the entire entity.
            if (model_internal::_instance.model_internal::_cacheInitialized_isValid)
            {
    ...
    [Bindable(event="propertyChange")]   
    public function get User__cStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }

    public function get User__cValidator() : StyleValidator
    {
        return model_internal::_User__cValidator;
    }

    model_internal function set _User__cIsValid_der(value:Boolean):void 
    {
        var oldValue:Boolean = model_internal::_User__cIsValid;         
        if (oldValue !== value)
        {
            model_internal::_User__cIsValid = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "User__cIsValid", oldValue, value));
        }                             
    }

    [Bindable(event="propertyChange")]
    public function get User__cIsValid():Boolean
    {
        if (!model_internal::_User__cIsValidCacheInitialized)
        {
            model_internal::calculateUser__cIsValid();
        ...
        return model_internal::_User__cIsValid;
    }

    model_internal function calculateUser__cIsValid():void
    {
        var valRes:ValidationResultEvent = model_internal::_User__cValidator.validate(model_internal::_instance.User__c)
        model_internal::_User__cIsValid_der = (valRes.results == null);
        model_internal::_User__cIsValidCacheInitialized = true;
        if (valRes.results == null)
             model_internal::User__cValidationFailureMessages_der = emptyArray;
        else
        {
            var _valFailures:Array = new Array();
            for (var a:int = 0 ; a<valRes.results.length ; a++)
            ...
            model_internal::User__cValidationFailureMessages_der = _valFailures;
        }
    }

    [Bindable(event="propertyChange")]
    public function get User__cValidationFailureMessages():Array
    {
        if (model_internal::_User__cValidationFailureMessages == null)
            model_internal::calculateUser__cIsValid();

        return _User__cValidationFailureMessages;
    }

    model_internal function set User__cValidationFailureMessages_der(value:Array) : void
    {
        var oldValue:Array = model_internal::_User__cValidationFailureMessages;
        ...
        if (needUpdate)
        {
            model_internal::_User__cValidationFailureMessages = value;   
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "User__cValidationFailureMessages", oldValue, value));
            // Only execute calculateIsValid if it has been called before, to update the validationFailureMessages for
            // the entire entity.
            if (model_internal::_instance.model_internal::_cacheInitialized_isValid)
            {
     ...
     */  
     override public function getPropertyValidationFailureMessages(propertyName:String):Array
     {
         switch(propertyName)
         {
            ...
            case("SFDC_Issue_Description__c"):
            {
                return SFDC_Issue_Description__cValidationFailureMessages;
            }
            case("SFDC_Issue_Name__c"):
            {
                return SFDC_Issue_Name__cValidationFailureMessages;
            }
            case("SFDC_Issue_Priority__c"):
            {
                return SFDC_Issue_Priority__cValidationFailureMessages;
            }
            case("SFDC_Issue_Status__c"):
            {
                return SFDC_Issue_Status__cValidationFailureMessages;
            }
            ...
            case("User__c"):
            {
                return User__cValidationFailureMessages;
            }
            default:
            {
                return emptyArray;
