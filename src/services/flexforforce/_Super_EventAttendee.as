 ...
 * of this value object you may modify the generated sub-class of this class - EventAttendee.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_EventAttendee extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.EventAttendee") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.EventAttendee", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _EventAttendeeEntityMetadata;

    /**
     * properties
     */
    private var _internal_Id : String;
    private var _internal_AttendeeId : String;
    ...
    private var _internal_RespondedDate : Date;
    ...
    public function _Super_EventAttendee()
    {
        _model = new _EventAttendeeEntityMetadata(this);

        // Bind to own data properties for cache invalidation triggering
        model_internal::_changeWatcherArray.push(mx.binding.utils.ChangeWatcher.watch(this, "AttendeeId", model_internal::setterListenerAttendeeId));
        ...
        model_internal::_changeWatcherArray.push(mx.binding.utils.ChangeWatcher.watch(this, "RespondedDate", model_internal::setterListenerRespondedDate));
    ...
    [Bindable(event="propertyChange")]
    public function get AttendeeId() : String
    {
        return _internal_AttendeeId;
    }
    ...
    [Bindable(event="propertyChange")]
    public function get RespondedDate() : Date
    {
        return _internal_RespondedDate;
    }
    ...
    public function set AttendeeId(value:String) : void
    {
        var oldValue:String = _internal_AttendeeId;
        if (oldValue !== value)
        {
            _internal_AttendeeId = value;
        }
    }
    ...
    public function set RespondedDate(value:Date) : void
    {
        var oldValue:Date = _internal_RespondedDate;
        if (oldValue !== value)
        {
            _internal_RespondedDate = value;
        }
    }
    ...
    model_internal function setterListenerAttendeeId(value:flash.events.Event):void
    {
        _model.invalidateDependentOnAttendeeId();
    }
    ...
    model_internal function setterListenerRespondedDate(value:flash.events.Event):void
    {
        _model.invalidateDependentOnRespondedDate();
    }
    ...
    model_internal function calculateIsValid():Boolean
    {
        ...
        if (!_model.AttendeeIdIsValid)
        {
            propertyValidity = false;
            com.adobe.fiber.util.FiberUtils.arrayAdd(validationFailureMessages, _model.model_internal::_AttendeeIdValidationFailureMessages);
        }
        ...
        if (!_model.RespondedDateIsValid)
        {
            propertyValidity = false;
            com.adobe.fiber.util.FiberUtils.arrayAdd(validationFailureMessages, _model.model_internal::_RespondedDateValidationFailureMessages);
        }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _EventAttendeeEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _EventAttendeeEntityMetadata) : void
    {
        var oldValue : _EventAttendeeEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
    ...
    model_internal var _doValidationCacheOfAttendeeId : Array = null;
    model_internal var _doValidationLastValOfAttendeeId : String;

    model_internal function _doValidationForAttendeeId(valueIn:Object):Array
    {
        var value : String = valueIn as String;

        if (model_internal::_doValidationCacheOfAttendeeId != null && model_internal::_doValidationLastValOfAttendeeId == value)
           return model_internal::_doValidationCacheOfAttendeeId ;

        _model.model_internal::_AttendeeIdIsValidCacheInitialized = true;
        var validationFailures:Array = new Array();
        var errorMessage:String;
        var failure:Boolean;

        var valRes:ValidationResult;
        if (_model.isAttendeeIdAvailable && _internal_AttendeeId == null)
        {
            validationFailures.push(new ValidationResult(true, "", "", "AttendeeId is required"));
        }

        model_internal::_doValidationCacheOfAttendeeId = validationFailures;
        model_internal::_doValidationLastValOfAttendeeId = value;
    ...
    model_internal var _doValidationCacheOfRespondedDate : Array = null;
    model_internal var _doValidationLastValOfRespondedDate : Date;

    model_internal function _doValidationForRespondedDate(valueIn:Object):Array
    {
        var value : Date = valueIn as Date;

        if (model_internal::_doValidationCacheOfRespondedDate != null && model_internal::_doValidationLastValOfRespondedDate == value)
           return model_internal::_doValidationCacheOfRespondedDate ;

        _model.model_internal::_RespondedDateIsValidCacheInitialized = true;
        var validationFailures:Array = new Array();
        var errorMessage:String;
        var failure:Boolean;

        var valRes:ValidationResult;
        if (_model.isRespondedDateAvailable && _internal_RespondedDate == null)
        {
            validationFailures.push(new ValidationResult(true, "", "", "RespondedDate is required"));
        }

        model_internal::_doValidationCacheOfRespondedDate = validationFailures;
        model_internal::_doValidationLastValOfRespondedDate = value;

        return validationFailures;
    }
    
    model_internal var _doValidationCacheOfResponse : Array = null;
    model_internal var _doValidationLastValOfResponse : String;
