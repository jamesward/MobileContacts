...
[ExcludeClass]
internal class _Claim__cEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    private static var emptyArray:Array = new Array();

    model_internal static var allProperties:Array = new Array("Id", "Address__c", "City__c", "ConnectionReceivedId", "ConnectionSentId", "Contact__c", "CreatedById", "CreatedDate", "Date__c", "Estimate__c", "IsDeleted", "LastActivityDate", "LastModifiedById", "LastModifiedDate", "Name", "OwnerId", "State__c", "Status__c", "Street__c", "SystemModstamp");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("Id", "Address__c", "City__c", "ConnectionReceivedId", "ConnectionSentId", "Contact__c", "CreatedById", "CreatedDate", "Date__c", "Estimate__c", "IsDeleted", "LastActivityDate", "LastModifiedById", "LastModifiedDate", "Name", "OwnerId", "State__c", "Status__c", "Street__c", "SystemModstamp");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("Id", "Address__c", "City__c", "ConnectionReceivedId", "ConnectionSentId", "Contact__c", "CreatedById", "CreatedDate", "Date__c", "Estimate__c", "IsDeleted", "LastActivityDate", "LastModifiedById", "LastModifiedDate", "Name", "OwnerId", "State__c", "Status__c", "Street__c", "SystemModstamp");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("Id", "Address__c", "City__c", "ConnectionReceivedId", "ConnectionSentId", "Contact__c", "CreatedById", "CreatedDate", "Date__c", "Estimate__c", "IsDeleted", "LastActivityDate", "LastModifiedById", "LastModifiedDate", "Name", "OwnerId", "State__c", "Status__c", "Street__c", "SystemModstamp");
    model_internal static var derivedProperties:Array = new Array();
    model_internal static var collectionProperties:Array = new Array();
    model_internal static var collectionBaseMap:Object;
    model_internal static var entityName:String = "Claim__c";
    model_internal static var dependentsOnMap:Object;
    model_internal static var dependedOnServices:Array = new Array();

    
    model_internal var _Address__cIsValid:Boolean;
    model_internal var _Address__cValidator:com.adobe.fiber.styles.StyleValidator;
    model_internal var _Address__cIsValidCacheInitialized:Boolean = false;
    model_internal var _Address__cValidationFailureMessages:Array;
    ...
    model_internal var _Date__cIsValid:Boolean;
    model_internal var _Date__cValidator:com.adobe.fiber.styles.StyleValidator;
    model_internal var _Date__cIsValidCacheInitialized:Boolean = false;
    model_internal var _Date__cValidationFailureMessages:Array;
    ...
    model_internal var _instance:_Super_Claim__c;
    model_internal static var _nullStyle:com.adobe.fiber.styles.Style = new com.adobe.fiber.styles.Style();

    public function _Claim__cEntityMetadata(value : _Super_Claim__c)
    {
        ...
        if (model_internal::dependentsOnMap == null)
        {
            ...
            model_internal::dependentsOnMap["Address__c"] = new Array();
            ...
            model_internal::dependentsOnMap["Date__c"] = new Array();
            model_internal::dependentsOnMap["Estimate__c"] = new Array();
        ...
        model_internal::_Address__cValidator = new StyleValidator(model_internal::_instance.model_internal::_doValidationForAddress__c);
        model_internal::_Address__cValidator.required = true;
        model_internal::_Address__cValidator.requiredFieldError = "Address__c is required";
        //model_internal::_Address__cValidator.source = model_internal::_instance;
        //model_internal::_Address__cValidator.property = "Address__c";
        ...
        model_internal::_Date__cValidator = new StyleValidator(model_internal::_instance.model_internal::_doValidationForDate__c);
        model_internal::_Date__cValidator.required = true;
        model_internal::_Date__cValidator.requiredFieldError = "Date__c is required";
        //model_internal::_Date__cValidator.source = model_internal::_instance;
        //model_internal::_Date__cValidator.property = "Date__c";
    ...
    override public function getDependants(propertyName:String):Array
    {
       if (model_internal::dataProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a data property of entity Claim__c");  
    ...
    override public function getCollectionBase(propertyName:String):String
    {
        if (model_internal::collectionProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a collection property of entity Claim__c");  
    ...
    override public function getValue(propertyName:String):*
    {
        ...
        {
            throw new Error(propertyName + " does not exist for entity Claim__c");
        }
    ...
    [Bindable(event="propertyChange")]
    public function get isAddress__cAvailable():Boolean
    {
        return true;
    }
    ...
    [Bindable(event="propertyChange")]
    public function get isDate__cAvailable():Boolean
    {
        return true;
    }

    [Bindable(event="propertyChange")]
    public function get isEstimate__cAvailable():Boolean
    {
        return true;
    }
     ...
     */
    public function invalidateDependentOnAddress__c():void
    {
        if (model_internal::_Address__cIsValidCacheInitialized )
        {
            model_internal::_instance.model_internal::_doValidationCacheOfAddress__c = null;
            model_internal::calculateAddress__cIsValid();
        }
    }
    ...
    public function invalidateDependentOnDate__c():void
    {
        if (model_internal::_Date__cIsValidCacheInitialized )
        {
            model_internal::_instance.model_internal::_doValidationCacheOfDate__c = null;
            model_internal::calculateDate__cIsValid();
        }
    }
    ...
    [Bindable(event="propertyChange")]   
    public function get Address__cStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }

    public function get Address__cValidator() : StyleValidator
    {
        return model_internal::_Address__cValidator;
    }

    model_internal function set _Address__cIsValid_der(value:Boolean):void 
    {
        var oldValue:Boolean = model_internal::_Address__cIsValid;         
        if (oldValue !== value)
        {
            model_internal::_Address__cIsValid = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "Address__cIsValid", oldValue, value));
        }                             
    }

    [Bindable(event="propertyChange")]
    public function get Address__cIsValid():Boolean
    {
        if (!model_internal::_Address__cIsValidCacheInitialized)
        {
            model_internal::calculateAddress__cIsValid();
        ...
        return model_internal::_Address__cIsValid;
    }

    model_internal function calculateAddress__cIsValid():void
    {
        var valRes:ValidationResultEvent = model_internal::_Address__cValidator.validate(model_internal::_instance.Address__c)
        model_internal::_Address__cIsValid_der = (valRes.results == null);
        model_internal::_Address__cIsValidCacheInitialized = true;
        if (valRes.results == null)
             model_internal::Address__cValidationFailureMessages_der = emptyArray;
        else
        {
            ...
            model_internal::Address__cValidationFailureMessages_der = _valFailures;
        }
    }

    [Bindable(event="propertyChange")]
    public function get Address__cValidationFailureMessages():Array
    {
        if (model_internal::_Address__cValidationFailureMessages == null)
            model_internal::calculateAddress__cIsValid();

        return _Address__cValidationFailureMessages;
    }

    model_internal function set Address__cValidationFailureMessages_der(value:Array) : void
    {
        var oldValue:Array = model_internal::_Address__cValidationFailureMessages;
        ...
        if (needUpdate)
        {
            model_internal::_Address__cValidationFailureMessages = value;   
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "Address__cValidationFailureMessages", oldValue, value));
    ...
    [Bindable(event="propertyChange")]   
    public function get Date__cStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }

    public function get Date__cValidator() : StyleValidator
    {
        return model_internal::_Date__cValidator;
    }

    model_internal function set _Date__cIsValid_der(value:Boolean):void 
    {
        var oldValue:Boolean = model_internal::_Date__cIsValid;         
        if (oldValue !== value)
        {
            model_internal::_Date__cIsValid = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "Date__cIsValid", oldValue, value));
        }                             
    }

    [Bindable(event="propertyChange")]
    public function get Date__cIsValid():Boolean
    {
        if (!model_internal::_Date__cIsValidCacheInitialized)
        {
            model_internal::calculateDate__cIsValid();
        ...
        return model_internal::_Date__cIsValid;
    }

    model_internal function calculateDate__cIsValid():void
    {
        var valRes:ValidationResultEvent = model_internal::_Date__cValidator.validate(model_internal::_instance.Date__c)
        model_internal::_Date__cIsValid_der = (valRes.results == null);
        model_internal::_Date__cIsValidCacheInitialized = true;
        if (valRes.results == null)
             model_internal::Date__cValidationFailureMessages_der = emptyArray;
        else
        {
            var _valFailures:Array = new Array();
            for (var a:int = 0 ; a<valRes.results.length ; a++)
            ...
            model_internal::Date__cValidationFailureMessages_der = _valFailures;
        }
    }

    [Bindable(event="propertyChange")]
    public function get Date__cValidationFailureMessages():Array
    {
        if (model_internal::_Date__cValidationFailureMessages == null)
            model_internal::calculateDate__cIsValid();

        return _Date__cValidationFailureMessages;
    }

    model_internal function set Date__cValidationFailureMessages_der(value:Array) : void
    {
        var oldValue:Array = model_internal::_Date__cValidationFailureMessages;
        ...
        if (needUpdate)
        {
            model_internal::_Date__cValidationFailureMessages = value;   
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "Date__cValidationFailureMessages", oldValue, value));
            // Only execute calculateIsValid if it has been called before, to update the validationFailureMessages for
            // the entire entity.
            if (model_internal::_instance.model_internal::_cacheInitialized_isValid)
            {
    ...
    [Bindable(event="propertyChange")]   
    public function get Estimate__cStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }
     ...
     */  
     override public function getPropertyValidationFailureMessages(propertyName:String):Array
     {
         switch(propertyName)
         {
            case("Address__c"):
            {
                return Address__cValidationFailureMessages;
            }
            case("City__c"):
            {
            ...
            case("Date__c"):
            {
                return Date__cValidationFailureMessages;
            }
