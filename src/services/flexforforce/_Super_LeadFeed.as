 ...
 * of this value object you may modify the generated sub-class of this class - LeadFeed.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_LeadFeed extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.LeadFeed") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.LeadFeed", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _LeadFeedEntityMetadata;
    ...
    public function _Super_LeadFeed()
    {
        _model = new _LeadFeedEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _LeadFeedEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _LeadFeedEntityMetadata) : void
    {
        var oldValue : _LeadFeedEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
