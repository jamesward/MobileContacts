 ...
 * of this value object you may modify the generated sub-class of this class - ViewerConfig__c.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_ViewerConfig__c extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.ViewerConfig__c") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.ViewerConfig__c", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _ViewerConfig__cEntityMetadata;
    ...
    private var _internal_GridLayoutFillColors2__c : String;
    private var _internal_GridLayoutFillColors__c : String;
    ...
    private var _internal_ListLayoutFillColors2__c : String;
    private var _internal_ListLayoutFillColors__c : String;
    ...
    public function _Super_ViewerConfig__c()
    {
        _model = new _ViewerConfig__cEntityMetadata(this);
        ...
        model_internal::_changeWatcherArray.push(mx.binding.utils.ChangeWatcher.watch(this, "GridLayoutFillColors2__c", model_internal::setterListenerGridLayoutFillColors2__c));
        model_internal::_changeWatcherArray.push(mx.binding.utils.ChangeWatcher.watch(this, "GridLayoutFillColors__c", model_internal::setterListenerGridLayoutFillColors__c));
        ...
        model_internal::_changeWatcherArray.push(mx.binding.utils.ChangeWatcher.watch(this, "ListLayoutFillColors2__c", model_internal::setterListenerListLayoutFillColors2__c));
        model_internal::_changeWatcherArray.push(mx.binding.utils.ChangeWatcher.watch(this, "ListLayoutFillColors__c", model_internal::setterListenerListLayoutFillColors__c));
    ...
    [Bindable(event="propertyChange")]
    public function get GridLayoutFillColors2__c() : String
    {
        return _internal_GridLayoutFillColors2__c;
    }

    [Bindable(event="propertyChange")]
    public function get GridLayoutFillColors__c() : String
    {
        return _internal_GridLayoutFillColors__c;
    }
    ...
    [Bindable(event="propertyChange")]
    public function get ListLayoutFillColors2__c() : String
    {
        return _internal_ListLayoutFillColors2__c;
    }

    [Bindable(event="propertyChange")]
    public function get ListLayoutFillColors__c() : String
    {
        return _internal_ListLayoutFillColors__c;
    }
    ...
    public function set GridLayoutFillColors2__c(value:String) : void
    {
        var oldValue:String = _internal_GridLayoutFillColors2__c;
        if (oldValue !== value)
        {
            _internal_GridLayoutFillColors2__c = value;
        }
    }

    public function set GridLayoutFillColors__c(value:String) : void
    {
        var oldValue:String = _internal_GridLayoutFillColors__c;
        if (oldValue !== value)
        {
            _internal_GridLayoutFillColors__c = value;
        }
    }
    ...
    public function set ListLayoutFillColors2__c(value:String) : void
    {
        var oldValue:String = _internal_ListLayoutFillColors2__c;
        if (oldValue !== value)
        {
            _internal_ListLayoutFillColors2__c = value;
        }
    }

    public function set ListLayoutFillColors__c(value:String) : void
    {
        var oldValue:String = _internal_ListLayoutFillColors__c;
        if (oldValue !== value)
        {
            _internal_ListLayoutFillColors__c = value;
        }
    }
    ...
    model_internal function setterListenerGridLayoutFillColors2__c(value:flash.events.Event):void
    {
        _model.invalidateDependentOnGridLayoutFillColors2__c();
    }

    model_internal function setterListenerGridLayoutFillColors__c(value:flash.events.Event):void
    {
        _model.invalidateDependentOnGridLayoutFillColors__c();
    }
    ...
    model_internal function setterListenerListLayoutFillColors2__c(value:flash.events.Event):void
    {
        _model.invalidateDependentOnListLayoutFillColors2__c();
    }

    model_internal function setterListenerListLayoutFillColors__c(value:flash.events.Event):void
    {
        _model.invalidateDependentOnListLayoutFillColors__c();
    }
    ...
    model_internal function calculateIsValid():Boolean
    {
        ...
        if (!_model.GridLayoutFillColors2__cIsValid)
        {
            propertyValidity = false;
            com.adobe.fiber.util.FiberUtils.arrayAdd(validationFailureMessages, _model.model_internal::_GridLayoutFillColors2__cValidationFailureMessages);
        }
        if (!_model.GridLayoutFillColors__cIsValid)
        {
            propertyValidity = false;
            com.adobe.fiber.util.FiberUtils.arrayAdd(validationFailureMessages, _model.model_internal::_GridLayoutFillColors__cValidationFailureMessages);
        }
        ...
        if (!_model.ListLayoutFillColors2__cIsValid)
        {
            propertyValidity = false;
            com.adobe.fiber.util.FiberUtils.arrayAdd(validationFailureMessages, _model.model_internal::_ListLayoutFillColors2__cValidationFailureMessages);
        }
        if (!_model.ListLayoutFillColors__cIsValid)
        {
            propertyValidity = false;
            com.adobe.fiber.util.FiberUtils.arrayAdd(validationFailureMessages, _model.model_internal::_ListLayoutFillColors__cValidationFailureMessages);
        }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _ViewerConfig__cEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _ViewerConfig__cEntityMetadata) : void
    {
        var oldValue : _ViewerConfig__cEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
    ...
    model_internal var _doValidationCacheOfGridLayoutFillColors2__c : Array = null;
    model_internal var _doValidationLastValOfGridLayoutFillColors2__c : String;

    model_internal function _doValidationForGridLayoutFillColors2__c(valueIn:Object):Array
    {
        var value : String = valueIn as String;

        if (model_internal::_doValidationCacheOfGridLayoutFillColors2__c != null && model_internal::_doValidationLastValOfGridLayoutFillColors2__c == value)
           return model_internal::_doValidationCacheOfGridLayoutFillColors2__c ;

        _model.model_internal::_GridLayoutFillColors2__cIsValidCacheInitialized = true;
        var validationFailures:Array = new Array();
        var errorMessage:String;
        var failure:Boolean;

        var valRes:ValidationResult;
        if (_model.isGridLayoutFillColors2__cAvailable && _internal_GridLayoutFillColors2__c == null)
        {
            validationFailures.push(new ValidationResult(true, "", "", "GridLayoutFillColors2__c is required"));
        }

        model_internal::_doValidationCacheOfGridLayoutFillColors2__c = validationFailures;
        model_internal::_doValidationLastValOfGridLayoutFillColors2__c = value;

        return validationFailures;
    }
    
    model_internal var _doValidationCacheOfGridLayoutFillColors__c : Array = null;
    model_internal var _doValidationLastValOfGridLayoutFillColors__c : String;

    model_internal function _doValidationForGridLayoutFillColors__c(valueIn:Object):Array
    {
        var value : String = valueIn as String;

        if (model_internal::_doValidationCacheOfGridLayoutFillColors__c != null && model_internal::_doValidationLastValOfGridLayoutFillColors__c == value)
           return model_internal::_doValidationCacheOfGridLayoutFillColors__c ;

        _model.model_internal::_GridLayoutFillColors__cIsValidCacheInitialized = true;
        var validationFailures:Array = new Array();
        var errorMessage:String;
        var failure:Boolean;

        var valRes:ValidationResult;
        if (_model.isGridLayoutFillColors__cAvailable && _internal_GridLayoutFillColors__c == null)
        {
            validationFailures.push(new ValidationResult(true, "", "", "GridLayoutFillColors__c is required"));
        }

        model_internal::_doValidationCacheOfGridLayoutFillColors__c = validationFailures;
        model_internal::_doValidationLastValOfGridLayoutFillColors__c = value;
    ...
    model_internal var _doValidationCacheOfListLayoutFillColors2__c : Array = null;
    model_internal var _doValidationLastValOfListLayoutFillColors2__c : String;

    model_internal function _doValidationForListLayoutFillColors2__c(valueIn:Object):Array
    {
        var value : String = valueIn as String;

        if (model_internal::_doValidationCacheOfListLayoutFillColors2__c != null && model_internal::_doValidationLastValOfListLayoutFillColors2__c == value)
           return model_internal::_doValidationCacheOfListLayoutFillColors2__c ;

        _model.model_internal::_ListLayoutFillColors2__cIsValidCacheInitialized = true;
        var validationFailures:Array = new Array();
        var errorMessage:String;
        var failure:Boolean;

        var valRes:ValidationResult;
        if (_model.isListLayoutFillColors2__cAvailable && _internal_ListLayoutFillColors2__c == null)
        {
            validationFailures.push(new ValidationResult(true, "", "", "ListLayoutFillColors2__c is required"));
        }

        model_internal::_doValidationCacheOfListLayoutFillColors2__c = validationFailures;
        model_internal::_doValidationLastValOfListLayoutFillColors2__c = value;

        return validationFailures;
    }
    
    model_internal var _doValidationCacheOfListLayoutFillColors__c : Array = null;
    model_internal var _doValidationLastValOfListLayoutFillColors__c : String;

    model_internal function _doValidationForListLayoutFillColors__c(valueIn:Object):Array
    {
        var value : String = valueIn as String;

        if (model_internal::_doValidationCacheOfListLayoutFillColors__c != null && model_internal::_doValidationLastValOfListLayoutFillColors__c == value)
           return model_internal::_doValidationCacheOfListLayoutFillColors__c ;

        _model.model_internal::_ListLayoutFillColors__cIsValidCacheInitialized = true;
        var validationFailures:Array = new Array();
        var errorMessage:String;
        var failure:Boolean;

        var valRes:ValidationResult;
        if (_model.isListLayoutFillColors__cAvailable && _internal_ListLayoutFillColors__c == null)
        {
            validationFailures.push(new ValidationResult(true, "", "", "ListLayoutFillColors__c is required"));
        }

        model_internal::_doValidationCacheOfListLayoutFillColors__c = validationFailures;
        model_internal::_doValidationLastValOfListLayoutFillColors__c = value;
