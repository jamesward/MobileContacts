 ...
 * of this value object you may modify the generated sub-class of this class - NewsFeed.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_NewsFeed extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.NewsFeed") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.NewsFeed", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _NewsFeedEntityMetadata;
    ...
    public function _Super_NewsFeed()
    {
        _model = new _NewsFeedEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _NewsFeedEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _NewsFeedEntityMetadata) : void
    {
        var oldValue : _NewsFeedEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
