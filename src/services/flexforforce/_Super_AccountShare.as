 ...
 * of this value object you may modify the generated sub-class of this class - AccountShare.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_AccountShare extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.AccountShare") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.AccountShare", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _AccountShareEntityMetadata;

    /**
     * properties
     */
    private var _internal_Id : String;
    private var _internal_AccountAccessLevel : String;
    private var _internal_AccountId : String;
    private var _internal_CaseAccessLevel : String;
    ...
    public function _Super_AccountShare()
    {
        _model = new _AccountShareEntityMetadata(this);

        // Bind to own data properties for cache invalidation triggering
        model_internal::_changeWatcherArray.push(mx.binding.utils.ChangeWatcher.watch(this, "AccountAccessLevel", model_internal::setterListenerAccountAccessLevel));
        ...
        model_internal::_changeWatcherArray.push(mx.binding.utils.ChangeWatcher.watch(this, "CaseAccessLevel", model_internal::setterListenerCaseAccessLevel));
    ...
    [Bindable(event="propertyChange")]
    public function get AccountAccessLevel() : String
    {
        return _internal_AccountAccessLevel;
    }
    ...
    [Bindable(event="propertyChange")]
    public function get CaseAccessLevel() : String
    {
        return _internal_CaseAccessLevel;
    }
    ...
    public function set AccountAccessLevel(value:String) : void
    {
        var oldValue:String = _internal_AccountAccessLevel;
        if (oldValue !== value)
        {
            _internal_AccountAccessLevel = value;
        }
    }
    ...
    public function set CaseAccessLevel(value:String) : void
    {
        var oldValue:String = _internal_CaseAccessLevel;
        if (oldValue !== value)
        {
            _internal_CaseAccessLevel = value;
        }
    }
    ...
    model_internal function setterListenerAccountAccessLevel(value:flash.events.Event):void
    {
        _model.invalidateDependentOnAccountAccessLevel();
    }
    ...
    model_internal function setterListenerCaseAccessLevel(value:flash.events.Event):void
    {
        _model.invalidateDependentOnCaseAccessLevel();
    }
    ...
    model_internal function calculateIsValid():Boolean
    {
        ...
        if (!_model.AccountAccessLevelIsValid)
        {
            propertyValidity = false;
            com.adobe.fiber.util.FiberUtils.arrayAdd(validationFailureMessages, _model.model_internal::_AccountAccessLevelValidationFailureMessages);
        }
        ...
        if (!_model.CaseAccessLevelIsValid)
        {
            propertyValidity = false;
            com.adobe.fiber.util.FiberUtils.arrayAdd(validationFailureMessages, _model.model_internal::_CaseAccessLevelValidationFailureMessages);
        }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _AccountShareEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _AccountShareEntityMetadata) : void
    {
        var oldValue : _AccountShareEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
    ...
    model_internal var _doValidationCacheOfAccountAccessLevel : Array = null;
    model_internal var _doValidationLastValOfAccountAccessLevel : String;

    model_internal function _doValidationForAccountAccessLevel(valueIn:Object):Array
    {
        var value : String = valueIn as String;

        if (model_internal::_doValidationCacheOfAccountAccessLevel != null && model_internal::_doValidationLastValOfAccountAccessLevel == value)
           return model_internal::_doValidationCacheOfAccountAccessLevel ;

        _model.model_internal::_AccountAccessLevelIsValidCacheInitialized = true;
        var validationFailures:Array = new Array();
        var errorMessage:String;
        var failure:Boolean;

        var valRes:ValidationResult;
        if (_model.isAccountAccessLevelAvailable && _internal_AccountAccessLevel == null)
        {
            validationFailures.push(new ValidationResult(true, "", "", "AccountAccessLevel is required"));
        }

        model_internal::_doValidationCacheOfAccountAccessLevel = validationFailures;
        model_internal::_doValidationLastValOfAccountAccessLevel = value;
    ...
    model_internal var _doValidationCacheOfCaseAccessLevel : Array = null;
    model_internal var _doValidationLastValOfCaseAccessLevel : String;

    model_internal function _doValidationForCaseAccessLevel(valueIn:Object):Array
    {
        var value : String = valueIn as String;

        if (model_internal::_doValidationCacheOfCaseAccessLevel != null && model_internal::_doValidationLastValOfCaseAccessLevel == value)
           return model_internal::_doValidationCacheOfCaseAccessLevel ;

        _model.model_internal::_CaseAccessLevelIsValidCacheInitialized = true;
        var validationFailures:Array = new Array();
        var errorMessage:String;
        var failure:Boolean;

        var valRes:ValidationResult;
        if (_model.isCaseAccessLevelAvailable && _internal_CaseAccessLevel == null)
        {
            validationFailures.push(new ValidationResult(true, "", "", "CaseAccessLevel is required"));
        }

        model_internal::_doValidationCacheOfCaseAccessLevel = validationFailures;
        model_internal::_doValidationLastValOfCaseAccessLevel = value;
