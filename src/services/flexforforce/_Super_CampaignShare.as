 ...
 * of this value object you may modify the generated sub-class of this class - CampaignShare.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_CampaignShare extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.CampaignShare") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.CampaignShare", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _CampaignShareEntityMetadata;

    /**
     * properties
     */
    private var _internal_Id : String;
    private var _internal_CampaignAccessLevel : String;
    ...
    public function _Super_CampaignShare()
    {
        _model = new _CampaignShareEntityMetadata(this);

        // Bind to own data properties for cache invalidation triggering
        model_internal::_changeWatcherArray.push(mx.binding.utils.ChangeWatcher.watch(this, "CampaignAccessLevel", model_internal::setterListenerCampaignAccessLevel));
    ...
    [Bindable(event="propertyChange")]
    public function get CampaignAccessLevel() : String
    {
        return _internal_CampaignAccessLevel;
    }
    ...
    public function set CampaignAccessLevel(value:String) : void
    {
        var oldValue:String = _internal_CampaignAccessLevel;
        if (oldValue !== value)
        {
            _internal_CampaignAccessLevel = value;
        }
    }
    ...
    model_internal function setterListenerCampaignAccessLevel(value:flash.events.Event):void
    {
        _model.invalidateDependentOnCampaignAccessLevel();
    }
    ...
    model_internal function calculateIsValid():Boolean
    {
        ...
        if (!_model.CampaignAccessLevelIsValid)
        {
            propertyValidity = false;
            com.adobe.fiber.util.FiberUtils.arrayAdd(validationFailureMessages, _model.model_internal::_CampaignAccessLevelValidationFailureMessages);
        }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _CampaignShareEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _CampaignShareEntityMetadata) : void
    {
        var oldValue : _CampaignShareEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
    ...
    model_internal var _doValidationCacheOfCampaignAccessLevel : Array = null;
    model_internal var _doValidationLastValOfCampaignAccessLevel : String;

    model_internal function _doValidationForCampaignAccessLevel(valueIn:Object):Array
    {
        var value : String = valueIn as String;

        if (model_internal::_doValidationCacheOfCampaignAccessLevel != null && model_internal::_doValidationLastValOfCampaignAccessLevel == value)
           return model_internal::_doValidationCacheOfCampaignAccessLevel ;

        _model.model_internal::_CampaignAccessLevelIsValidCacheInitialized = true;
        var validationFailures:Array = new Array();
        var errorMessage:String;
        var failure:Boolean;

        var valRes:ValidationResult;
        if (_model.isCampaignAccessLevelAvailable && _internal_CampaignAccessLevel == null)
        {
            validationFailures.push(new ValidationResult(true, "", "", "CampaignAccessLevel is required"));
        }

        model_internal::_doValidationCacheOfCampaignAccessLevel = validationFailures;
        model_internal::_doValidationLastValOfCampaignAccessLevel = value;
