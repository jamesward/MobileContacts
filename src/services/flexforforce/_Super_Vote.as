 ...
 * of this value object you may modify the generated sub-class of this class - Vote.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_Vote extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.Vote") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.Vote", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _VoteEntityMetadata;
    ...
    public function _Super_Vote()
    {
        _model = new _VoteEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _VoteEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _VoteEntityMetadata) : void
    {
        var oldValue : _VoteEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
