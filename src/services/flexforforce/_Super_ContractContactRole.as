 ...
 * of this value object you may modify the generated sub-class of this class - ContractContactRole.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_ContractContactRole extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.ContractContactRole") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.ContractContactRole", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _ContractContactRoleEntityMetadata;
    ...
    private var _internal_ContractId : String;
    ...
    public function _Super_ContractContactRole()
    {
        _model = new _ContractContactRoleEntityMetadata(this);
        ...
        model_internal::_changeWatcherArray.push(mx.binding.utils.ChangeWatcher.watch(this, "ContractId", model_internal::setterListenerContractId));
    ...
    [Bindable(event="propertyChange")]
    public function get ContractId() : String
    {
    ...
    public function set ContractId(value:String) : void
    {
        var oldValue:String = _internal_ContractId;
        if (oldValue !== value)
        {
            _internal_ContractId = value;
        }
    }
    ...
    model_internal function setterListenerContractId(value:flash.events.Event):void
    {
        _model.invalidateDependentOnContractId();
    }
    ...
    model_internal function calculateIsValid():Boolean
    {
        ...
        if (!_model.ContractIdIsValid)
        {
            propertyValidity = false;
            com.adobe.fiber.util.FiberUtils.arrayAdd(validationFailureMessages, _model.model_internal::_ContractIdValidationFailureMessages);
        }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _ContractContactRoleEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _ContractContactRoleEntityMetadata) : void
    {
        var oldValue : _ContractContactRoleEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
    ...
    model_internal var _doValidationCacheOfContractId : Array = null;
    model_internal var _doValidationLastValOfContractId : String;

    model_internal function _doValidationForContractId(valueIn:Object):Array
    {
        var value : String = valueIn as String;

        if (model_internal::_doValidationCacheOfContractId != null && model_internal::_doValidationLastValOfContractId == value)
           return model_internal::_doValidationCacheOfContractId ;

        _model.model_internal::_ContractIdIsValidCacheInitialized = true;
        var validationFailures:Array = new Array();
        var errorMessage:String;
        var failure:Boolean;

        var valRes:ValidationResult;
        if (_model.isContractIdAvailable && _internal_ContractId == null)
        {
            validationFailures.push(new ValidationResult(true, "", "", "ContractId is required"));
        }

        model_internal::_doValidationCacheOfContractId = validationFailures;
        model_internal::_doValidationLastValOfContractId = value;
