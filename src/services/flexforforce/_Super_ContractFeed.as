 ...
 * of this value object you may modify the generated sub-class of this class - ContractFeed.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_ContractFeed extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.ContractFeed") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.ContractFeed", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _ContractFeedEntityMetadata;
    ...
    public function _Super_ContractFeed()
    {
        _model = new _ContractFeedEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _ContractFeedEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _ContractFeedEntityMetadata) : void
    {
        var oldValue : _ContractFeedEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
