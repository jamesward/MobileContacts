 ...
 * of this value object you may modify the generated sub-class of this class - FooFoo__c.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_FooFoo__c extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.FooFoo__c") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.FooFoo__c", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _FooFoo__cEntityMetadata;
    ...
    private var _internal_asdf__c : String;
    ...
    public function _Super_FooFoo__c()
    {
        _model = new _FooFoo__cEntityMetadata(this);
        ...
        model_internal::_changeWatcherArray.push(mx.binding.utils.ChangeWatcher.watch(this, "asdf__c", model_internal::setterListenerAsdf__c));
    ...
    [Bindable(event="propertyChange")]
    public function get asdf__c() : String
    {
        return _internal_asdf__c;
    }
    ...
    public function set asdf__c(value:String) : void
    {
        var oldValue:String = _internal_asdf__c;
        if (oldValue !== value)
        {
            _internal_asdf__c = value;
        }
    }
    ...
    model_internal function setterListenerAsdf__c(value:flash.events.Event):void
    {
        _model.invalidateDependentOnAsdf__c();
    }
    ...
    model_internal function calculateIsValid():Boolean
    {
        ...
        if (!_model.asdf__cIsValid)
        {
            propertyValidity = false;
            com.adobe.fiber.util.FiberUtils.arrayAdd(validationFailureMessages, _model.model_internal::_asdf__cValidationFailureMessages);
        }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _FooFoo__cEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _FooFoo__cEntityMetadata) : void
    {
        var oldValue : _FooFoo__cEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
    ...
    model_internal var _doValidationCacheOfAsdf__c : Array = null;
    model_internal var _doValidationLastValOfAsdf__c : String;

    model_internal function _doValidationForAsdf__c(valueIn:Object):Array
    {
        var value : String = valueIn as String;

        if (model_internal::_doValidationCacheOfAsdf__c != null && model_internal::_doValidationLastValOfAsdf__c == value)
           return model_internal::_doValidationCacheOfAsdf__c ;

        _model.model_internal::_asdf__cIsValidCacheInitialized = true;
        var validationFailures:Array = new Array();
        var errorMessage:String;
        var failure:Boolean;

        var valRes:ValidationResult;
        if (_model.isAsdf__cAvailable && _internal_asdf__c == null)
        {
            validationFailures.push(new ValidationResult(true, "", "", "asdf__c is required"));
        }

        model_internal::_doValidationCacheOfAsdf__c = validationFailures;
        model_internal::_doValidationLastValOfAsdf__c = value;
