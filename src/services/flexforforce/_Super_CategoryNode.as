 ...
 * of this value object you may modify the generated sub-class of this class - CategoryNode.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_CategoryNode extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.CategoryNode") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.CategoryNode", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _CategoryNodeEntityMetadata;
    ...
    private var _internal_SortStyle : String;
    ...
    public function _Super_CategoryNode()
    {
        _model = new _CategoryNodeEntityMetadata(this);
        ...
        model_internal::_changeWatcherArray.push(mx.binding.utils.ChangeWatcher.watch(this, "SortStyle", model_internal::setterListenerSortStyle));
    ...
    [Bindable(event="propertyChange")]
    public function get SortStyle() : String
    {
        return _internal_SortStyle;
    }
    ...
    public function set SortStyle(value:String) : void
    {
        var oldValue:String = _internal_SortStyle;
        if (oldValue !== value)
        {
            _internal_SortStyle = value;
        }
    }
    ...
    model_internal function setterListenerSortStyle(value:flash.events.Event):void
    {
        _model.invalidateDependentOnSortStyle();
    }
    ...
    model_internal function calculateIsValid():Boolean
    {
        ...
        if (!_model.SortStyleIsValid)
        {
            propertyValidity = false;
            com.adobe.fiber.util.FiberUtils.arrayAdd(validationFailureMessages, _model.model_internal::_SortStyleValidationFailureMessages);
        }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _CategoryNodeEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _CategoryNodeEntityMetadata) : void
    {
        var oldValue : _CategoryNodeEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
    ...
    model_internal var _doValidationCacheOfSortStyle : Array = null;
    model_internal var _doValidationLastValOfSortStyle : String;

    model_internal function _doValidationForSortStyle(valueIn:Object):Array
    {
        var value : String = valueIn as String;

        if (model_internal::_doValidationCacheOfSortStyle != null && model_internal::_doValidationLastValOfSortStyle == value)
           return model_internal::_doValidationCacheOfSortStyle ;

        _model.model_internal::_SortStyleIsValidCacheInitialized = true;
        var validationFailures:Array = new Array();
        var errorMessage:String;
        var failure:Boolean;

        var valRes:ValidationResult;
        if (_model.isSortStyleAvailable && _internal_SortStyle == null)
        {
            validationFailures.push(new ValidationResult(true, "", "", "SortStyle is required"));
        }

        model_internal::_doValidationCacheOfSortStyle = validationFailures;
        model_internal::_doValidationLastValOfSortStyle = value;
