 ...
 * of this value object you may modify the generated sub-class of this class - Apples__c.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_Apples__c extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.Apples__c") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.Apples__c", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _Apples__cEntityMetadata;
    ...
    public function _Super_Apples__c()
    {
        _model = new _Apples__cEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _Apples__cEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _Apples__cEntityMetadata) : void
    {
        var oldValue : _Apples__cEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
