 ...
 * of this value object you may modify the generated sub-class of this class - OpportunityFeed.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_OpportunityFeed extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.OpportunityFeed") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.OpportunityFeed", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _OpportunityFeedEntityMetadata;
    ...
    public function _Super_OpportunityFeed()
    {
        _model = new _OpportunityFeedEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _OpportunityFeedEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _OpportunityFeedEntityMetadata) : void
    {
        var oldValue : _OpportunityFeedEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
