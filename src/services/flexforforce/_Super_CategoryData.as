 ...
 * of this value object you may modify the generated sub-class of this class - CategoryData.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_CategoryData extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.CategoryData") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.CategoryData", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _CategoryDataEntityMetadata;

    /**
     * properties
     */
    private var _internal_Id : String;
    private var _internal_CategoryNodeId : String;
    ...
    private var _internal_RelatedSobjectId : String;
    ...
    public function _Super_CategoryData()
    {
        _model = new _CategoryDataEntityMetadata(this);

        // Bind to own data properties for cache invalidation triggering
        model_internal::_changeWatcherArray.push(mx.binding.utils.ChangeWatcher.watch(this, "CategoryNodeId", model_internal::setterListenerCategoryNodeId));
        ...
        model_internal::_changeWatcherArray.push(mx.binding.utils.ChangeWatcher.watch(this, "RelatedSobjectId", model_internal::setterListenerRelatedSobjectId));
    ...
    [Bindable(event="propertyChange")]
    public function get CategoryNodeId() : String
    {
        return _internal_CategoryNodeId;
    }
    ...
    [Bindable(event="propertyChange")]
    public function get RelatedSobjectId() : String
    {
        return _internal_RelatedSobjectId;
    }
    ...
    public function set CategoryNodeId(value:String) : void
    {
        var oldValue:String = _internal_CategoryNodeId;
        if (oldValue !== value)
        {
            _internal_CategoryNodeId = value;
        }
    }
    ...
    public function set RelatedSobjectId(value:String) : void
    {
        var oldValue:String = _internal_RelatedSobjectId;
        if (oldValue !== value)
        {
            _internal_RelatedSobjectId = value;
        }
    }
    ...
    model_internal function setterListenerCategoryNodeId(value:flash.events.Event):void
    {
        _model.invalidateDependentOnCategoryNodeId();
    }
    ...
    model_internal function setterListenerRelatedSobjectId(value:flash.events.Event):void
    {
        _model.invalidateDependentOnRelatedSobjectId();
    }
    ...
    model_internal function calculateIsValid():Boolean
    {
        ...
        if (!_model.CategoryNodeIdIsValid)
        {
            propertyValidity = false;
            com.adobe.fiber.util.FiberUtils.arrayAdd(validationFailureMessages, _model.model_internal::_CategoryNodeIdValidationFailureMessages);
        }
        ...
        if (!_model.RelatedSobjectIdIsValid)
        {
            propertyValidity = false;
            com.adobe.fiber.util.FiberUtils.arrayAdd(validationFailureMessages, _model.model_internal::_RelatedSobjectIdValidationFailureMessages);
        }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _CategoryDataEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _CategoryDataEntityMetadata) : void
    {
        var oldValue : _CategoryDataEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
    ...
    model_internal var _doValidationCacheOfCategoryNodeId : Array = null;
    model_internal var _doValidationLastValOfCategoryNodeId : String;

    model_internal function _doValidationForCategoryNodeId(valueIn:Object):Array
    {
        var value : String = valueIn as String;

        if (model_internal::_doValidationCacheOfCategoryNodeId != null && model_internal::_doValidationLastValOfCategoryNodeId == value)
           return model_internal::_doValidationCacheOfCategoryNodeId ;

        _model.model_internal::_CategoryNodeIdIsValidCacheInitialized = true;
        var validationFailures:Array = new Array();
        var errorMessage:String;
        var failure:Boolean;

        var valRes:ValidationResult;
        if (_model.isCategoryNodeIdAvailable && _internal_CategoryNodeId == null)
        {
            validationFailures.push(new ValidationResult(true, "", "", "CategoryNodeId is required"));
        }

        model_internal::_doValidationCacheOfCategoryNodeId = validationFailures;
        model_internal::_doValidationLastValOfCategoryNodeId = value;
    ...
    model_internal var _doValidationCacheOfRelatedSobjectId : Array = null;
    model_internal var _doValidationLastValOfRelatedSobjectId : String;

    model_internal function _doValidationForRelatedSobjectId(valueIn:Object):Array
    {
        var value : String = valueIn as String;

        if (model_internal::_doValidationCacheOfRelatedSobjectId != null && model_internal::_doValidationLastValOfRelatedSobjectId == value)
           return model_internal::_doValidationCacheOfRelatedSobjectId ;

        _model.model_internal::_RelatedSobjectIdIsValidCacheInitialized = true;
        var validationFailures:Array = new Array();
        var errorMessage:String;
        var failure:Boolean;

        var valRes:ValidationResult;
        if (_model.isRelatedSobjectIdAvailable && _internal_RelatedSobjectId == null)
        {
            validationFailures.push(new ValidationResult(true, "", "", "RelatedSobjectId is required"));
        }

        model_internal::_doValidationCacheOfRelatedSobjectId = validationFailures;
        model_internal::_doValidationLastValOfRelatedSobjectId = value;
