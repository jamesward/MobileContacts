 ...
 * of this value object you may modify the generated sub-class of this class - ContactHistory.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_ContactHistory extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.ContactHistory") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.ContactHistory", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _ContactHistoryEntityMetadata;
    ...
    public function _Super_ContactHistory()
    {
        _model = new _ContactHistoryEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _ContactHistoryEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _ContactHistoryEntityMetadata) : void
    {
        var oldValue : _ContactHistoryEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
