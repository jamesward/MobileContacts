 ...
 * of this value object you may modify the generated sub-class of this class - Product2Feed.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_Product2Feed extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.Product2Feed") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.Product2Feed", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _Product2FeedEntityMetadata;
    ...
    public function _Super_Product2Feed()
    {
        _model = new _Product2FeedEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _Product2FeedEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _Product2FeedEntityMetadata) : void
    {
        var oldValue : _Product2FeedEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
