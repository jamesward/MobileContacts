 ...
 * of this value object you may modify the generated sub-class of this class - Attachment.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_Attachment extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.Attachment") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.Attachment", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _AttachmentEntityMetadata;
    ...
    private var _internal_IsPartnerShared : Boolean;
    ...
    public function _Super_Attachment()
    {
        _model = new _AttachmentEntityMetadata(this);
    ...
    [Bindable(event="propertyChange")]
    public function get IsPartnerShared() : Boolean
    {
        return _internal_IsPartnerShared;
    }
    ...
    public function set IsPartnerShared(value:Boolean) : void
    {
        var oldValue:Boolean = _internal_IsPartnerShared;
        if (oldValue !== value)
        {
            _internal_IsPartnerShared = value;
        }
    }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _AttachmentEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _AttachmentEntityMetadata) : void
    {
        var oldValue : _AttachmentEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
