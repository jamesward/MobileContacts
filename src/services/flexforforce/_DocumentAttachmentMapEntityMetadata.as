...
[ExcludeClass]
internal class _DocumentAttachmentMapEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    private static var emptyArray:Array = new Array();

    model_internal static var allProperties:Array = new Array("Id", "CreatedById", "CreatedDate", "DocumentId", "DocumentSequence", "ParentId");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("Id", "CreatedById", "CreatedDate", "DocumentId", "DocumentSequence", "ParentId");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("Id", "CreatedById", "CreatedDate", "DocumentId", "DocumentSequence", "ParentId");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("Id", "CreatedById", "CreatedDate", "DocumentId", "DocumentSequence", "ParentId");
    model_internal static var derivedProperties:Array = new Array();
    model_internal static var collectionProperties:Array = new Array();
    model_internal static var collectionBaseMap:Object;
    model_internal static var entityName:String = "DocumentAttachmentMap";
    ...
    model_internal var _DocumentIdIsValid:Boolean;
    model_internal var _DocumentIdValidator:com.adobe.fiber.styles.StyleValidator;
    model_internal var _DocumentIdIsValidCacheInitialized:Boolean = false;
    model_internal var _DocumentIdValidationFailureMessages:Array;
    ...
    model_internal var _instance:_Super_DocumentAttachmentMap;
    model_internal static var _nullStyle:com.adobe.fiber.styles.Style = new com.adobe.fiber.styles.Style();

    public function _DocumentAttachmentMapEntityMetadata(value : _Super_DocumentAttachmentMap)
    {
        ...
        if (model_internal::dependentsOnMap == null)
        {
            ...
            model_internal::dependentsOnMap["DocumentId"] = new Array();
            model_internal::dependentsOnMap["DocumentSequence"] = new Array();
        ...
        model_internal::_DocumentIdValidator = new StyleValidator(model_internal::_instance.model_internal::_doValidationForDocumentId);
        model_internal::_DocumentIdValidator.required = true;
        model_internal::_DocumentIdValidator.requiredFieldError = "DocumentId is required";
        //model_internal::_DocumentIdValidator.source = model_internal::_instance;
        //model_internal::_DocumentIdValidator.property = "DocumentId";
    ...
    override public function getDependants(propertyName:String):Array
    {
       if (model_internal::dataProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a data property of entity DocumentAttachmentMap");  
    ...
    override public function getCollectionBase(propertyName:String):String
    {
        if (model_internal::collectionProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a collection property of entity DocumentAttachmentMap");  
    ...
    override public function getValue(propertyName:String):*
    {
        ...
        {
            throw new Error(propertyName + " does not exist for entity DocumentAttachmentMap");
        }
    ...
    [Bindable(event="propertyChange")]
    public function get isDocumentIdAvailable():Boolean
    {
        return true;
    }

    [Bindable(event="propertyChange")]
    public function get isDocumentSequenceAvailable():Boolean
    {
        return true;
    }
    ...
    public function invalidateDependentOnDocumentId():void
    {
        if (model_internal::_DocumentIdIsValidCacheInitialized )
        {
            model_internal::_instance.model_internal::_doValidationCacheOfDocumentId = null;
            model_internal::calculateDocumentIdIsValid();
        }
    }
    ...
    [Bindable(event="propertyChange")]   
    public function get DocumentIdStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }

    public function get DocumentIdValidator() : StyleValidator
    {
        return model_internal::_DocumentIdValidator;
    }

    model_internal function set _DocumentIdIsValid_der(value:Boolean):void 
    {
        var oldValue:Boolean = model_internal::_DocumentIdIsValid;         
        if (oldValue !== value)
        {
            model_internal::_DocumentIdIsValid = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "DocumentIdIsValid", oldValue, value));
        }                             
    }

    [Bindable(event="propertyChange")]
    public function get DocumentIdIsValid():Boolean
    {
        if (!model_internal::_DocumentIdIsValidCacheInitialized)
        {
            model_internal::calculateDocumentIdIsValid();
        ...
        return model_internal::_DocumentIdIsValid;
    }

    model_internal function calculateDocumentIdIsValid():void
    {
        var valRes:ValidationResultEvent = model_internal::_DocumentIdValidator.validate(model_internal::_instance.DocumentId)
        model_internal::_DocumentIdIsValid_der = (valRes.results == null);
        model_internal::_DocumentIdIsValidCacheInitialized = true;
        if (valRes.results == null)
             model_internal::DocumentIdValidationFailureMessages_der = emptyArray;
        else
        {
            var _valFailures:Array = new Array();
            for (var a:int = 0 ; a<valRes.results.length ; a++)
            ...
            model_internal::DocumentIdValidationFailureMessages_der = _valFailures;
        }
    }

    [Bindable(event="propertyChange")]
    public function get DocumentIdValidationFailureMessages():Array
    {
        if (model_internal::_DocumentIdValidationFailureMessages == null)
            model_internal::calculateDocumentIdIsValid();

        return _DocumentIdValidationFailureMessages;
    }

    model_internal function set DocumentIdValidationFailureMessages_der(value:Array) : void
    {
        var oldValue:Array = model_internal::_DocumentIdValidationFailureMessages;
        ...
        if (needUpdate)
        {
            model_internal::_DocumentIdValidationFailureMessages = value;   
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "DocumentIdValidationFailureMessages", oldValue, value));
            // Only execute calculateIsValid if it has been called before, to update the validationFailureMessages for
            // the entire entity.
            if (model_internal::_instance.model_internal::_cacheInitialized_isValid)
            {
    ...
    [Bindable(event="propertyChange")]   
    public function get DocumentSequenceStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }
     ...
     */  
     override public function getPropertyValidationFailureMessages(propertyName:String):Array
     {
         switch(propertyName)
         {
            ...
            case("DocumentId"):
            {
                return DocumentIdValidationFailureMessages;
            }
            case("ParentId"):
            {
