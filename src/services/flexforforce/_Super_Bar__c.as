 ...
 * of this value object you may modify the generated sub-class of this class - Bar__c.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_Bar__c extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.Bar__c") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.Bar__c", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _Bar__cEntityMetadata;
    ...
    public function _Super_Bar__c()
    {
        _model = new _Bar__cEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _Bar__cEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _Bar__cEntityMetadata) : void
    {
        var oldValue : _Bar__cEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
