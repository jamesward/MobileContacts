 ...
 * of this value object you may modify the generated sub-class of this class - CaseStatus.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_CaseStatus extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.CaseStatus") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.CaseStatus", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _CaseStatusEntityMetadata;
    ...
    public function _Super_CaseStatus()
    {
        _model = new _CaseStatusEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _CaseStatusEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _CaseStatusEntityMetadata) : void
    {
        var oldValue : _CaseStatusEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
