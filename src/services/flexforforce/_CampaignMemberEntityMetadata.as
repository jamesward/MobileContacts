...
[ExcludeClass]
internal class _CampaignMemberEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    private static var emptyArray:Array = new Array();

    model_internal static var allProperties:Array = new Array("Id", "CampaignId", "ContactId", "CreatedById", "CreatedDate", "FirstRespondedDate", "HasResponded", "IsDeleted", "LastModifiedById", "LastModifiedDate", "LeadId", "Status", "SystemModstamp");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("Id", "CampaignId", "ContactId", "CreatedById", "CreatedDate", "FirstRespondedDate", "HasResponded", "IsDeleted", "LastModifiedById", "LastModifiedDate", "LeadId", "Status", "SystemModstamp");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("Id", "CampaignId", "ContactId", "CreatedById", "CreatedDate", "FirstRespondedDate", "HasResponded", "IsDeleted", "LastModifiedById", "LastModifiedDate", "LeadId", "Status", "SystemModstamp");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("Id", "CampaignId", "ContactId", "CreatedById", "CreatedDate", "FirstRespondedDate", "HasResponded", "IsDeleted", "LastModifiedById", "LastModifiedDate", "LeadId", "Status", "SystemModstamp");
    model_internal static var derivedProperties:Array = new Array();
    model_internal static var collectionProperties:Array = new Array();
    model_internal static var collectionBaseMap:Object;
    model_internal static var entityName:String = "CampaignMember";
    ...
    model_internal var _FirstRespondedDateIsValid:Boolean;
    model_internal var _FirstRespondedDateValidator:com.adobe.fiber.styles.StyleValidator;
    model_internal var _FirstRespondedDateIsValidCacheInitialized:Boolean = false;
    model_internal var _FirstRespondedDateValidationFailureMessages:Array;
    ...
    model_internal var _instance:_Super_CampaignMember;
    model_internal static var _nullStyle:com.adobe.fiber.styles.Style = new com.adobe.fiber.styles.Style();

    public function _CampaignMemberEntityMetadata(value : _Super_CampaignMember)
    {
        ...
        if (model_internal::dependentsOnMap == null)
        {
            ...
            model_internal::dependentsOnMap["FirstRespondedDate"] = new Array();
            model_internal::dependentsOnMap["HasResponded"] = new Array();
        ...
        model_internal::_FirstRespondedDateValidator = new StyleValidator(model_internal::_instance.model_internal::_doValidationForFirstRespondedDate);
        model_internal::_FirstRespondedDateValidator.required = true;
        model_internal::_FirstRespondedDateValidator.requiredFieldError = "FirstRespondedDate is required";
        //model_internal::_FirstRespondedDateValidator.source = model_internal::_instance;
        //model_internal::_FirstRespondedDateValidator.property = "FirstRespondedDate";
    ...
    override public function getDependants(propertyName:String):Array
    {
       if (model_internal::dataProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a data property of entity CampaignMember");  
    ...
    override public function getCollectionBase(propertyName:String):String
    {
        if (model_internal::collectionProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a collection property of entity CampaignMember");  
    ...
    override public function getValue(propertyName:String):*
    {
        ...
        {
            throw new Error(propertyName + " does not exist for entity CampaignMember");
        }
    ...
    [Bindable(event="propertyChange")]
    public function get isFirstRespondedDateAvailable():Boolean
    {
        return true;
    }

    [Bindable(event="propertyChange")]
    public function get isHasRespondedAvailable():Boolean
    {
        return true;
    }
    ...
    public function invalidateDependentOnFirstRespondedDate():void
    {
        if (model_internal::_FirstRespondedDateIsValidCacheInitialized )
        {
            model_internal::_instance.model_internal::_doValidationCacheOfFirstRespondedDate = null;
            model_internal::calculateFirstRespondedDateIsValid();
        }
    }
    ...
    [Bindable(event="propertyChange")]   
    public function get FirstRespondedDateStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }

    public function get FirstRespondedDateValidator() : StyleValidator
    {
        return model_internal::_FirstRespondedDateValidator;
    }

    model_internal function set _FirstRespondedDateIsValid_der(value:Boolean):void 
    {
        var oldValue:Boolean = model_internal::_FirstRespondedDateIsValid;         
        if (oldValue !== value)
        {
            model_internal::_FirstRespondedDateIsValid = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "FirstRespondedDateIsValid", oldValue, value));
        }                             
    }

    [Bindable(event="propertyChange")]
    public function get FirstRespondedDateIsValid():Boolean
    {
        if (!model_internal::_FirstRespondedDateIsValidCacheInitialized)
        {
            model_internal::calculateFirstRespondedDateIsValid();
        ...
        return model_internal::_FirstRespondedDateIsValid;
    }

    model_internal function calculateFirstRespondedDateIsValid():void
    {
        var valRes:ValidationResultEvent = model_internal::_FirstRespondedDateValidator.validate(model_internal::_instance.FirstRespondedDate)
        model_internal::_FirstRespondedDateIsValid_der = (valRes.results == null);
        model_internal::_FirstRespondedDateIsValidCacheInitialized = true;
        if (valRes.results == null)
             model_internal::FirstRespondedDateValidationFailureMessages_der = emptyArray;
        else
        {
            var _valFailures:Array = new Array();
            for (var a:int = 0 ; a<valRes.results.length ; a++)
            ...
            model_internal::FirstRespondedDateValidationFailureMessages_der = _valFailures;
        }
    }

    [Bindable(event="propertyChange")]
    public function get FirstRespondedDateValidationFailureMessages():Array
    {
        if (model_internal::_FirstRespondedDateValidationFailureMessages == null)
            model_internal::calculateFirstRespondedDateIsValid();

        return _FirstRespondedDateValidationFailureMessages;
    }

    model_internal function set FirstRespondedDateValidationFailureMessages_der(value:Array) : void
    {
        var oldValue:Array = model_internal::_FirstRespondedDateValidationFailureMessages;
        ...
        if (needUpdate)
        {
            model_internal::_FirstRespondedDateValidationFailureMessages = value;   
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "FirstRespondedDateValidationFailureMessages", oldValue, value));
            // Only execute calculateIsValid if it has been called before, to update the validationFailureMessages for
            // the entire entity.
            if (model_internal::_instance.model_internal::_cacheInitialized_isValid)
            {
    ...
    [Bindable(event="propertyChange")]   
    public function get HasRespondedStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }
     ...
     */  
     override public function getPropertyValidationFailureMessages(propertyName:String):Array
     {
         switch(propertyName)
         {
            ...
            {
                return FirstRespondedDateValidationFailureMessages;
            }
