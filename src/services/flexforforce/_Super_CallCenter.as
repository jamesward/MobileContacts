 ...
 * of this value object you may modify the generated sub-class of this class - CallCenter.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_CallCenter extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.CallCenter") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.CallCenter", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _CallCenterEntityMetadata;
    ...
    private var _internal_InternalName : String;
    ...
    private var _internal_Version : Number;
    ...
    public function _Super_CallCenter()
    {
        _model = new _CallCenterEntityMetadata(this);
        ...
        model_internal::_changeWatcherArray.push(mx.binding.utils.ChangeWatcher.watch(this, "InternalName", model_internal::setterListenerInternalName));
    ...
    {
        var oldValue:String = _internal_InternalName;
        if (oldValue !== value)
        {
            _internal_InternalName = value;
        }
    }
    ...
    {
        var oldValue:Number = _internal_Version;
        if (isNaN(_internal_Version) == true || Math.abs(oldValue - value) > epsilon)
        {
    ...
    model_internal function setterListenerInternalName(value:flash.events.Event):void
    {
        _model.invalidateDependentOnInternalName();
    }
    ...
    model_internal function calculateIsValid():Boolean
    {
        ...
        if (!_model.InternalNameIsValid)
        {
            propertyValidity = false;
            com.adobe.fiber.util.FiberUtils.arrayAdd(validationFailureMessages, _model.model_internal::_InternalNameValidationFailureMessages);
        }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _CallCenterEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _CallCenterEntityMetadata) : void
    {
        var oldValue : _CallCenterEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
    ...
    model_internal var _doValidationCacheOfInternalName : Array = null;
    model_internal var _doValidationLastValOfInternalName : String;

    model_internal function _doValidationForInternalName(valueIn:Object):Array
    {
        var value : String = valueIn as String;

        if (model_internal::_doValidationCacheOfInternalName != null && model_internal::_doValidationLastValOfInternalName == value)
           return model_internal::_doValidationCacheOfInternalName ;

        _model.model_internal::_InternalNameIsValidCacheInitialized = true;
        var validationFailures:Array = new Array();
        var errorMessage:String;
        var failure:Boolean;

        var valRes:ValidationResult;
        if (_model.isInternalNameAvailable && _internal_InternalName == null)
        {
            validationFailures.push(new ValidationResult(true, "", "", "InternalName is required"));
        }

        model_internal::_doValidationCacheOfInternalName = validationFailures;
        model_internal::_doValidationLastValOfInternalName = value;
