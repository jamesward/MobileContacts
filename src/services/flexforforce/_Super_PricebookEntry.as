 ...
 * of this value object you may modify the generated sub-class of this class - PricebookEntry.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_PricebookEntry extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.PricebookEntry") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.PricebookEntry", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _PricebookEntryEntityMetadata;
    ...
    private var _internal_UseStandardPrice : Boolean;
    ...
    public function _Super_PricebookEntry()
    {
        _model = new _PricebookEntryEntityMetadata(this);
    ...
    [Bindable(event="propertyChange")]
    public function get UseStandardPrice() : Boolean
    {
        return _internal_UseStandardPrice;
    }
    ...
    public function set UseStandardPrice(value:Boolean) : void
    {
        var oldValue:Boolean = _internal_UseStandardPrice;
        if (oldValue !== value)
        {
            _internal_UseStandardPrice = value;
        }
    }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _PricebookEntryEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _PricebookEntryEntityMetadata) : void
    {
        var oldValue : _PricebookEntryEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
