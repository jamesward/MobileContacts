 ...
 * of this value object you may modify the generated sub-class of this class - OrgWideEmailAddress.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_OrgWideEmailAddress extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.OrgWideEmailAddress") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.OrgWideEmailAddress", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _OrgWideEmailAddressEntityMetadata;
    ...
    private var _internal_IsAllowAllProfiles : Boolean;
    ...
    public function _Super_OrgWideEmailAddress()
    {
        _model = new _OrgWideEmailAddressEntityMetadata(this);
    ...
    [Bindable(event="propertyChange")]
    public function get IsAllowAllProfiles() : Boolean
    {
        return _internal_IsAllowAllProfiles;
    }
    ...
    public function set IsAllowAllProfiles(value:Boolean) : void
    {
        var oldValue:Boolean = _internal_IsAllowAllProfiles;
        if (oldValue !== value)
        {
            _internal_IsAllowAllProfiles = value;
        }
    }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _OrgWideEmailAddressEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _OrgWideEmailAddressEntityMetadata) : void
    {
        var oldValue : _OrgWideEmailAddressEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
