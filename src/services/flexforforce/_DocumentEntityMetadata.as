...
internal class _DocumentEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    ...
    model_internal static var allProperties:Array = new Array("Id", "AuthorId", "Body", "BodyLength", "ContentType", "CreatedById", "CreatedDate", "Description", "DeveloperName", "FolderId", "IsBodySearchable", "IsDeleted", "IsInternalUseOnly", "IsPublic", "Keywords", "LastModifiedById", "LastModifiedDate", "Name", "NamespacePrefix", "SystemModstamp", "Type", "Url");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("Id", "AuthorId", "Body", "BodyLength", "ContentType", "CreatedById", "CreatedDate", "Description", "DeveloperName", "FolderId", "IsBodySearchable", "IsDeleted", "IsInternalUseOnly", "IsPublic", "Keywords", "LastModifiedById", "LastModifiedDate", "Name", "NamespacePrefix", "SystemModstamp", "Type", "Url");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("Id", "AuthorId", "Body", "BodyLength", "ContentType", "CreatedById", "CreatedDate", "Description", "DeveloperName", "FolderId", "IsBodySearchable", "IsDeleted", "IsInternalUseOnly", "IsPublic", "Keywords", "LastModifiedById", "LastModifiedDate", "Name", "NamespacePrefix", "SystemModstamp", "Type", "Url");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("Id", "AuthorId", "Body", "BodyLength", "ContentType", "CreatedById", "CreatedDate", "Description", "DeveloperName", "FolderId", "IsBodySearchable", "IsDeleted", "IsInternalUseOnly", "IsPublic", "Keywords", "LastModifiedById", "LastModifiedDate", "Name", "NamespacePrefix", "SystemModstamp", "Type", "Url");
    ...
    model_internal var _AuthorIdIsValid:Boolean;
    model_internal var _AuthorIdValidator:com.adobe.fiber.styles.StyleValidator;
    model_internal var _AuthorIdIsValidCacheInitialized:Boolean = false;
    model_internal var _AuthorIdValidationFailureMessages:Array;
    ...
    model_internal var _KeywordsIsValid:Boolean;
    model_internal var _KeywordsValidator:com.adobe.fiber.styles.StyleValidator;
    model_internal var _KeywordsIsValidCacheInitialized:Boolean = false;
    model_internal var _KeywordsValidationFailureMessages:Array;
    ...
    public function _DocumentEntityMetadata(value : _Super_Document)
    {
        ...
        if (model_internal::dependentsOnMap == null)
        {
            ...
            model_internal::dependentsOnMap["IsBodySearchable"] = new Array();
            model_internal::dependentsOnMap["IsDeleted"] = new Array();
            model_internal::dependentsOnMap["IsInternalUseOnly"] = new Array();
        ...
        model_internal::_AuthorIdValidator = new StyleValidator(model_internal::_instance.model_internal::_doValidationForAuthorId);
        model_internal::_AuthorIdValidator.required = true;
        model_internal::_AuthorIdValidator.requiredFieldError = "AuthorId is required";
        //model_internal::_AuthorIdValidator.source = model_internal::_instance;
        //model_internal::_AuthorIdValidator.property = "AuthorId";
        ...
        model_internal::_KeywordsValidator = new StyleValidator(model_internal::_instance.model_internal::_doValidationForKeywords);
        model_internal::_KeywordsValidator.required = true;
        model_internal::_KeywordsValidator.requiredFieldError = "Keywords is required";
        //model_internal::_KeywordsValidator.source = model_internal::_instance;
        //model_internal::_KeywordsValidator.property = "Keywords";
    ...
    [Bindable(event="propertyChange")]
    public function get isIsBodySearchableAvailable():Boolean
    {
        return true;
    }
    ...
    [Bindable(event="propertyChange")]
    public function get isIsInternalUseOnlyAvailable():Boolean
    {
        return true;
    }
     ...
     */
    public function invalidateDependentOnAuthorId():void
    {
        if (model_internal::_AuthorIdIsValidCacheInitialized )
        {
            model_internal::_instance.model_internal::_doValidationCacheOfAuthorId = null;
            model_internal::calculateAuthorIdIsValid();
        }
    }
    ...
    public function invalidateDependentOnKeywords():void
    {
        if (model_internal::_KeywordsIsValidCacheInitialized )
        {
            model_internal::_instance.model_internal::_doValidationCacheOfKeywords = null;
            model_internal::calculateKeywordsIsValid();
        }
    }
    ...
    public function get AuthorIdValidator() : StyleValidator
    {
        return model_internal::_AuthorIdValidator;
    }

    model_internal function set _AuthorIdIsValid_der(value:Boolean):void 
    {
        var oldValue:Boolean = model_internal::_AuthorIdIsValid;         
        if (oldValue !== value)
        {
            model_internal::_AuthorIdIsValid = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "AuthorIdIsValid", oldValue, value));
        }                             
    }

    [Bindable(event="propertyChange")]
    public function get AuthorIdIsValid():Boolean
    {
        if (!model_internal::_AuthorIdIsValidCacheInitialized)
        {
            model_internal::calculateAuthorIdIsValid();
        ...
        return model_internal::_AuthorIdIsValid;
    }

    model_internal function calculateAuthorIdIsValid():void
    {
        var valRes:ValidationResultEvent = model_internal::_AuthorIdValidator.validate(model_internal::_instance.AuthorId)
        model_internal::_AuthorIdIsValid_der = (valRes.results == null);
        model_internal::_AuthorIdIsValidCacheInitialized = true;
        if (valRes.results == null)
             model_internal::AuthorIdValidationFailureMessages_der = emptyArray;
        else
        {
            ...
            model_internal::AuthorIdValidationFailureMessages_der = _valFailures;
        }
    }

    [Bindable(event="propertyChange")]
    public function get AuthorIdValidationFailureMessages():Array
    {
        if (model_internal::_AuthorIdValidationFailureMessages == null)
            model_internal::calculateAuthorIdIsValid();

        return _AuthorIdValidationFailureMessages;
    }

    model_internal function set AuthorIdValidationFailureMessages_der(value:Array) : void
    {
        var oldValue:Array = model_internal::_AuthorIdValidationFailureMessages;
        ...
        if (needUpdate)
        {
            model_internal::_AuthorIdValidationFailureMessages = value;   
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "AuthorIdValidationFailureMessages", oldValue, value));
    ...
    [Bindable(event="propertyChange")]   
    public function get IsBodySearchableStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }
    ...
    [Bindable(event="propertyChange")]   
    public function get IsInternalUseOnlyStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }
    ...
    public function get KeywordsValidator() : StyleValidator
    {
        return model_internal::_KeywordsValidator;
    }

    model_internal function set _KeywordsIsValid_der(value:Boolean):void 
    {
        var oldValue:Boolean = model_internal::_KeywordsIsValid;         
        if (oldValue !== value)
        {
            model_internal::_KeywordsIsValid = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "KeywordsIsValid", oldValue, value));
        }                             
    }

    [Bindable(event="propertyChange")]
    public function get KeywordsIsValid():Boolean
    {
        if (!model_internal::_KeywordsIsValidCacheInitialized)
        {
            model_internal::calculateKeywordsIsValid();
        ...
        return model_internal::_KeywordsIsValid;
    }

    model_internal function calculateKeywordsIsValid():void
    {
        var valRes:ValidationResultEvent = model_internal::_KeywordsValidator.validate(model_internal::_instance.Keywords)
        model_internal::_KeywordsIsValid_der = (valRes.results == null);
        model_internal::_KeywordsIsValidCacheInitialized = true;
        if (valRes.results == null)
             model_internal::KeywordsValidationFailureMessages_der = emptyArray;
        else
        {
            var _valFailures:Array = new Array();
            for (var a:int = 0 ; a<valRes.results.length ; a++)
            ...
            model_internal::KeywordsValidationFailureMessages_der = _valFailures;
        }
    }

    [Bindable(event="propertyChange")]
    public function get KeywordsValidationFailureMessages():Array
    {
        if (model_internal::_KeywordsValidationFailureMessages == null)
            model_internal::calculateKeywordsIsValid();

        return _KeywordsValidationFailureMessages;
    }

    model_internal function set KeywordsValidationFailureMessages_der(value:Array) : void
    {
        var oldValue:Array = model_internal::_KeywordsValidationFailureMessages;
        ...
        if (needUpdate)
        {
            model_internal::_KeywordsValidationFailureMessages = value;   
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "KeywordsValidationFailureMessages", oldValue, value));
            // Only execute calculateIsValid if it has been called before, to update the validationFailureMessages for
            // the entire entity.
            if (model_internal::_instance.model_internal::_cacheInitialized_isValid)
            {
     ...
     */  
     override public function getPropertyValidationFailureMessages(propertyName:String):Array
     {
         switch(propertyName)
         {
            case("AuthorId"):
            {
                return AuthorIdValidationFailureMessages;
            }
            case("ContentType"):
            {
            ...
            case("Keywords"):
            {
                return KeywordsValidationFailureMessages;
            }
