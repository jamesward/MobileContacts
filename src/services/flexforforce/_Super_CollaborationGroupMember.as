 ...
 * of this value object you may modify the generated sub-class of this class - CollaborationGroupMember.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_CollaborationGroupMember extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.CollaborationGroupMember") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.CollaborationGroupMember", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _CollaborationGroupMemberEntityMetadata;

    /**
     * properties
     */
    private var _internal_Id : String;
    private var _internal_CollaborationGroupId : String;
    ...
    public function _Super_CollaborationGroupMember()
    {
        _model = new _CollaborationGroupMemberEntityMetadata(this);

        // Bind to own data properties for cache invalidation triggering
        model_internal::_changeWatcherArray.push(mx.binding.utils.ChangeWatcher.watch(this, "CollaborationGroupId", model_internal::setterListenerCollaborationGroupId));
    ...
    [Bindable(event="propertyChange")]
    public function get CollaborationGroupId() : String
    {
        return _internal_CollaborationGroupId;
    }
    ...
    public function set CollaborationGroupId(value:String) : void
    {
        var oldValue:String = _internal_CollaborationGroupId;
        if (oldValue !== value)
        {
            _internal_CollaborationGroupId = value;
        }
    }
    ...
    model_internal function setterListenerCollaborationGroupId(value:flash.events.Event):void
    {
        _model.invalidateDependentOnCollaborationGroupId();
    }
    ...
    model_internal function calculateIsValid():Boolean
    {
        ...
        if (!_model.CollaborationGroupIdIsValid)
        {
            propertyValidity = false;
            com.adobe.fiber.util.FiberUtils.arrayAdd(validationFailureMessages, _model.model_internal::_CollaborationGroupIdValidationFailureMessages);
        }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _CollaborationGroupMemberEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _CollaborationGroupMemberEntityMetadata) : void
    {
        var oldValue : _CollaborationGroupMemberEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
    ...
    model_internal var _doValidationCacheOfCollaborationGroupId : Array = null;
    model_internal var _doValidationLastValOfCollaborationGroupId : String;

    model_internal function _doValidationForCollaborationGroupId(valueIn:Object):Array
    {
        var value : String = valueIn as String;

        if (model_internal::_doValidationCacheOfCollaborationGroupId != null && model_internal::_doValidationLastValOfCollaborationGroupId == value)
           return model_internal::_doValidationCacheOfCollaborationGroupId ;

        _model.model_internal::_CollaborationGroupIdIsValidCacheInitialized = true;
        var validationFailures:Array = new Array();
        var errorMessage:String;
        var failure:Boolean;

        var valRes:ValidationResult;
        if (_model.isCollaborationGroupIdAvailable && _internal_CollaborationGroupId == null)
        {
            validationFailures.push(new ValidationResult(true, "", "", "CollaborationGroupId is required"));
        }

        model_internal::_doValidationCacheOfCollaborationGroupId = validationFailures;
        model_internal::_doValidationLastValOfCollaborationGroupId = value;
