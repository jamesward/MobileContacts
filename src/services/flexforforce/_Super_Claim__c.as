 ...
 * of this value object you may modify the generated sub-class of this class - Claim__c.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_Claim__c extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.Claim__c") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.Claim__c", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _Claim__cEntityMetadata;

    /**
     * properties
     */
    private var _internal_Id : String;
    private var _internal_Address__c : String;
    ...
    private var _internal_Date__c : Date;
    private var _internal_Estimate__c : Number;
    ...
    public function _Super_Claim__c()
    {
        _model = new _Claim__cEntityMetadata(this);

        // Bind to own data properties for cache invalidation triggering
        model_internal::_changeWatcherArray.push(mx.binding.utils.ChangeWatcher.watch(this, "Address__c", model_internal::setterListenerAddress__c));
        ...
        model_internal::_changeWatcherArray.push(mx.binding.utils.ChangeWatcher.watch(this, "Date__c", model_internal::setterListenerDate__c));
    ...
    [Bindable(event="propertyChange")]
    public function get Address__c() : String
    {
        return _internal_Address__c;
    }
    ...
    [Bindable(event="propertyChange")]
    public function get Date__c() : Date
    {
        return _internal_Date__c;
    }

    [Bindable(event="propertyChange")]
    public function get Estimate__c() : Number
    {
        return _internal_Estimate__c;
    }
    ...
    public function set Address__c(value:String) : void
    {
        var oldValue:String = _internal_Address__c;
        if (oldValue !== value)
        {
            _internal_Address__c = value;
        }
    }
    ...
    public function set Date__c(value:Date) : void
    {
        var oldValue:Date = _internal_Date__c;
        if (oldValue !== value)
        {
            _internal_Date__c = value;
        }
    }

    public function set Estimate__c(value:Number) : void
    {
        var oldValue:Number = _internal_Estimate__c;
        if (isNaN(_internal_Estimate__c) == true || Math.abs(oldValue - value) > epsilon)
        {
            _internal_Estimate__c = value;
        }
    }
    ...
    model_internal function setterListenerAddress__c(value:flash.events.Event):void
    {
        _model.invalidateDependentOnAddress__c();
    }
    ...
    model_internal function setterListenerDate__c(value:flash.events.Event):void
    {
        _model.invalidateDependentOnDate__c();
    }
    ...
    model_internal function calculateIsValid():Boolean
    {
        ...
        if (!_model.Address__cIsValid)
        {
            propertyValidity = false;
            com.adobe.fiber.util.FiberUtils.arrayAdd(validationFailureMessages, _model.model_internal::_Address__cValidationFailureMessages);
        }
        ...
        if (!_model.Date__cIsValid)
        {
            propertyValidity = false;
            com.adobe.fiber.util.FiberUtils.arrayAdd(validationFailureMessages, _model.model_internal::_Date__cValidationFailureMessages);
        }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _Claim__cEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _Claim__cEntityMetadata) : void
    {
        var oldValue : _Claim__cEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
    ...
    model_internal var _doValidationCacheOfAddress__c : Array = null;
    model_internal var _doValidationLastValOfAddress__c : String;

    model_internal function _doValidationForAddress__c(valueIn:Object):Array
    {
        var value : String = valueIn as String;

        if (model_internal::_doValidationCacheOfAddress__c != null && model_internal::_doValidationLastValOfAddress__c == value)
           return model_internal::_doValidationCacheOfAddress__c ;

        _model.model_internal::_Address__cIsValidCacheInitialized = true;
        var validationFailures:Array = new Array();
        var errorMessage:String;
        var failure:Boolean;

        var valRes:ValidationResult;
        if (_model.isAddress__cAvailable && _internal_Address__c == null)
        {
            validationFailures.push(new ValidationResult(true, "", "", "Address__c is required"));
        }

        model_internal::_doValidationCacheOfAddress__c = validationFailures;
        model_internal::_doValidationLastValOfAddress__c = value;
    ...
    model_internal var _doValidationCacheOfDate__c : Array = null;
    model_internal var _doValidationLastValOfDate__c : Date;

    model_internal function _doValidationForDate__c(valueIn:Object):Array
    {
        var value : Date = valueIn as Date;

        if (model_internal::_doValidationCacheOfDate__c != null && model_internal::_doValidationLastValOfDate__c == value)
           return model_internal::_doValidationCacheOfDate__c ;

        _model.model_internal::_Date__cIsValidCacheInitialized = true;
        var validationFailures:Array = new Array();
        var errorMessage:String;
        var failure:Boolean;

        var valRes:ValidationResult;
        if (_model.isDate__cAvailable && _internal_Date__c == null)
        {
            validationFailures.push(new ValidationResult(true, "", "", "Date__c is required"));
        }

        model_internal::_doValidationCacheOfDate__c = validationFailures;
        model_internal::_doValidationLastValOfDate__c = value;
