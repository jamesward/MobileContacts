...
[ExcludeClass]
internal class _FooFoo__cEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    private static var emptyArray:Array = new Array();

    model_internal static var allProperties:Array = new Array("Id", "ConnectionReceivedId", "ConnectionSentId", "CreatedById", "CreatedDate", "IsDeleted", "LastModifiedById", "LastModifiedDate", "Name", "OwnerId", "SystemModstamp", "asdf__c");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("Id", "ConnectionReceivedId", "ConnectionSentId", "CreatedById", "CreatedDate", "IsDeleted", "LastModifiedById", "LastModifiedDate", "Name", "OwnerId", "SystemModstamp", "asdf__c");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("Id", "ConnectionReceivedId", "ConnectionSentId", "CreatedById", "CreatedDate", "IsDeleted", "LastModifiedById", "LastModifiedDate", "Name", "OwnerId", "SystemModstamp", "asdf__c");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("Id", "ConnectionReceivedId", "ConnectionSentId", "CreatedById", "CreatedDate", "IsDeleted", "LastModifiedById", "LastModifiedDate", "Name", "OwnerId", "SystemModstamp", "asdf__c");
    model_internal static var derivedProperties:Array = new Array();
    model_internal static var collectionProperties:Array = new Array();
    model_internal static var collectionBaseMap:Object;
    model_internal static var entityName:String = "FooFoo__c";
    ...
    model_internal var _asdf__cIsValid:Boolean;
    model_internal var _asdf__cValidator:com.adobe.fiber.styles.StyleValidator;
    model_internal var _asdf__cIsValidCacheInitialized:Boolean = false;
    model_internal var _asdf__cValidationFailureMessages:Array;

    model_internal var _instance:_Super_FooFoo__c;
    model_internal static var _nullStyle:com.adobe.fiber.styles.Style = new com.adobe.fiber.styles.Style();

    public function _FooFoo__cEntityMetadata(value : _Super_FooFoo__c)
    {
        ...
        if (model_internal::dependentsOnMap == null)
        {
            ...
            model_internal::dependentsOnMap["asdf__c"] = new Array();
        ...
        model_internal::_asdf__cValidator = new StyleValidator(model_internal::_instance.model_internal::_doValidationForAsdf__c);
        model_internal::_asdf__cValidator.required = true;
        model_internal::_asdf__cValidator.requiredFieldError = "asdf__c is required";
        //model_internal::_asdf__cValidator.source = model_internal::_instance;
        //model_internal::_asdf__cValidator.property = "asdf__c";
    }
    ...
    override public function getDependants(propertyName:String):Array
    {
       if (model_internal::dataProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a data property of entity FooFoo__c");  
    ...
    override public function getCollectionBase(propertyName:String):String
    {
        if (model_internal::collectionProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a collection property of entity FooFoo__c");  
    ...
    override public function getValue(propertyName:String):*
    {
        ...
        {
            throw new Error(propertyName + " does not exist for entity FooFoo__c");
        }
    ...
    [Bindable(event="propertyChange")]
    public function get isAsdf__cAvailable():Boolean
    {
        return true;
    }
    ...
    public function invalidateDependentOnAsdf__c():void
    {
        if (model_internal::_asdf__cIsValidCacheInitialized )
        {
            model_internal::_instance.model_internal::_doValidationCacheOfAsdf__c = null;
            model_internal::calculateAsdf__cIsValid();
        }
    }
    ...
    [Bindable(event="propertyChange")]   
    public function get asdf__cStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }

    public function get asdf__cValidator() : StyleValidator
    {
        return model_internal::_asdf__cValidator;
    }

    model_internal function set _asdf__cIsValid_der(value:Boolean):void 
    {
        var oldValue:Boolean = model_internal::_asdf__cIsValid;         
        if (oldValue !== value)
        {
            model_internal::_asdf__cIsValid = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "asdf__cIsValid", oldValue, value));
        }                             
    }

    [Bindable(event="propertyChange")]
    public function get asdf__cIsValid():Boolean
    {
        if (!model_internal::_asdf__cIsValidCacheInitialized)
        {
            model_internal::calculateAsdf__cIsValid();
        ...
        return model_internal::_asdf__cIsValid;
    }

    model_internal function calculateAsdf__cIsValid():void
    {
        var valRes:ValidationResultEvent = model_internal::_asdf__cValidator.validate(model_internal::_instance.asdf__c)
        model_internal::_asdf__cIsValid_der = (valRes.results == null);
        model_internal::_asdf__cIsValidCacheInitialized = true;
        if (valRes.results == null)
             model_internal::asdf__cValidationFailureMessages_der = emptyArray;
        else
        {
            var _valFailures:Array = new Array();
            for (var a:int = 0 ; a<valRes.results.length ; a++)
            ...
            model_internal::asdf__cValidationFailureMessages_der = _valFailures;
        }
    }

    [Bindable(event="propertyChange")]
    public function get asdf__cValidationFailureMessages():Array
    {
        if (model_internal::_asdf__cValidationFailureMessages == null)
            model_internal::calculateAsdf__cIsValid();

        return _asdf__cValidationFailureMessages;
    }

    model_internal function set asdf__cValidationFailureMessages_der(value:Array) : void
    {
        var oldValue:Array = model_internal::_asdf__cValidationFailureMessages;
        ...
        if (needUpdate)
        {
            model_internal::_asdf__cValidationFailureMessages = value;   
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "asdf__cValidationFailureMessages", oldValue, value));
            // Only execute calculateIsValid if it has been called before, to update the validationFailureMessages for
            // the entire entity.
            if (model_internal::_instance.model_internal::_cacheInitialized_isValid)
            {
     ...
     */  
     override public function getPropertyValidationFailureMessages(propertyName:String):Array
     {
         switch(propertyName)
         {
            ...
            case("asdf__c"):
            {
                return asdf__cValidationFailureMessages;
            }
            default:
            {
                return emptyArray;
