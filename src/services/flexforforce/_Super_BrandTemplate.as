 ...
 * of this value object you may modify the generated sub-class of this class - BrandTemplate.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_BrandTemplate extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.BrandTemplate") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.BrandTemplate", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _BrandTemplateEntityMetadata;
    ...
    public function _Super_BrandTemplate()
    {
        _model = new _BrandTemplateEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _BrandTemplateEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _BrandTemplateEntityMetadata) : void
    {
        var oldValue : _BrandTemplateEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
