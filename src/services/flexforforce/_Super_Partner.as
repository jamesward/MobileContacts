 ...
 * of this value object you may modify the generated sub-class of this class - Partner.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_Partner extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.Partner") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.Partner", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _PartnerEntityMetadata;
    ...
    public function _Super_Partner()
    {
        _model = new _PartnerEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _PartnerEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _PartnerEntityMetadata) : void
    {
        var oldValue : _PartnerEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
