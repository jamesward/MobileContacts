 ...
 * of this value object you may modify the generated sub-class of this class - Community.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_Community extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.Community") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.Community", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _CommunityEntityMetadata;
    ...
    public function _Super_Community()
    {
        _model = new _CommunityEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _CommunityEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _CommunityEntityMetadata) : void
    {
        var oldValue : _CommunityEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
