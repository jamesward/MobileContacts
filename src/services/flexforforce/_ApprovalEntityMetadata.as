...
[ExcludeClass]
internal class _ApprovalEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    private static var emptyArray:Array = new Array();

    model_internal static var allProperties:Array = new Array("Id", "ApproveComment", "CreatedById", "CreatedDate", "IsDeleted", "LastModifiedById", "LastModifiedDate", "OwnerId", "ParentId", "RequestComment", "Status", "SystemModstamp");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("Id", "ApproveComment", "CreatedById", "CreatedDate", "IsDeleted", "LastModifiedById", "LastModifiedDate", "OwnerId", "ParentId", "RequestComment", "Status", "SystemModstamp");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("Id", "ApproveComment", "CreatedById", "CreatedDate", "IsDeleted", "LastModifiedById", "LastModifiedDate", "OwnerId", "ParentId", "RequestComment", "Status", "SystemModstamp");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("Id", "ApproveComment", "CreatedById", "CreatedDate", "IsDeleted", "LastModifiedById", "LastModifiedDate", "OwnerId", "ParentId", "RequestComment", "Status", "SystemModstamp");
    model_internal static var derivedProperties:Array = new Array();
    model_internal static var collectionProperties:Array = new Array();
    model_internal static var collectionBaseMap:Object;
    model_internal static var entityName:String = "Approval";
    model_internal static var dependentsOnMap:Object;
    model_internal static var dependedOnServices:Array = new Array();

    
    model_internal var _ApproveCommentIsValid:Boolean;
    model_internal var _ApproveCommentValidator:com.adobe.fiber.styles.StyleValidator;
    model_internal var _ApproveCommentIsValidCacheInitialized:Boolean = false;
    model_internal var _ApproveCommentValidationFailureMessages:Array;
    ...
    model_internal var _RequestCommentIsValid:Boolean;
    model_internal var _RequestCommentValidator:com.adobe.fiber.styles.StyleValidator;
    model_internal var _RequestCommentIsValidCacheInitialized:Boolean = false;
    model_internal var _RequestCommentValidationFailureMessages:Array;
    ...
    model_internal var _instance:_Super_Approval;
    model_internal static var _nullStyle:com.adobe.fiber.styles.Style = new com.adobe.fiber.styles.Style();

    public function _ApprovalEntityMetadata(value : _Super_Approval)
    {
        ...
        if (model_internal::dependentsOnMap == null)
        {
            ...
            model_internal::dependentsOnMap["ApproveComment"] = new Array();
            ...
            model_internal::dependentsOnMap["RequestComment"] = new Array();
        ...
        model_internal::_ApproveCommentValidator = new StyleValidator(model_internal::_instance.model_internal::_doValidationForApproveComment);
        model_internal::_ApproveCommentValidator.required = true;
        model_internal::_ApproveCommentValidator.requiredFieldError = "ApproveComment is required";
        //model_internal::_ApproveCommentValidator.source = model_internal::_instance;
        //model_internal::_ApproveCommentValidator.property = "ApproveComment";
        ...
        model_internal::_RequestCommentValidator = new StyleValidator(model_internal::_instance.model_internal::_doValidationForRequestComment);
        model_internal::_RequestCommentValidator.required = true;
        model_internal::_RequestCommentValidator.requiredFieldError = "RequestComment is required";
        //model_internal::_RequestCommentValidator.source = model_internal::_instance;
        //model_internal::_RequestCommentValidator.property = "RequestComment";
    ...
    override public function getDependants(propertyName:String):Array
    {
       if (model_internal::dataProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a data property of entity Approval");  
    ...
    override public function getCollectionBase(propertyName:String):String
    {
        if (model_internal::collectionProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a collection property of entity Approval");  
    ...
    override public function getValue(propertyName:String):*
    {
        ...
        {
            throw new Error(propertyName + " does not exist for entity Approval");
        }
    ...
    [Bindable(event="propertyChange")]
    public function get isApproveCommentAvailable():Boolean
    {
        return true;
    }
    ...
    [Bindable(event="propertyChange")]
    public function get isRequestCommentAvailable():Boolean
    {
        return true;
    }
     ...
     */
    public function invalidateDependentOnApproveComment():void
    {
        if (model_internal::_ApproveCommentIsValidCacheInitialized )
        {
            model_internal::_instance.model_internal::_doValidationCacheOfApproveComment = null;
            model_internal::calculateApproveCommentIsValid();
        }
    }
    ...
    public function invalidateDependentOnRequestComment():void
    {
        if (model_internal::_RequestCommentIsValidCacheInitialized )
        {
            model_internal::_instance.model_internal::_doValidationCacheOfRequestComment = null;
            model_internal::calculateRequestCommentIsValid();
        }
    }
    ...
    [Bindable(event="propertyChange")]   
    public function get ApproveCommentStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }

    public function get ApproveCommentValidator() : StyleValidator
    {
        return model_internal::_ApproveCommentValidator;
    }

    model_internal function set _ApproveCommentIsValid_der(value:Boolean):void 
    {
        var oldValue:Boolean = model_internal::_ApproveCommentIsValid;         
        if (oldValue !== value)
        {
            model_internal::_ApproveCommentIsValid = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "ApproveCommentIsValid", oldValue, value));
        }                             
    }

    [Bindable(event="propertyChange")]
    public function get ApproveCommentIsValid():Boolean
    {
        if (!model_internal::_ApproveCommentIsValidCacheInitialized)
        {
            model_internal::calculateApproveCommentIsValid();
        ...
        return model_internal::_ApproveCommentIsValid;
    }

    model_internal function calculateApproveCommentIsValid():void
    {
        var valRes:ValidationResultEvent = model_internal::_ApproveCommentValidator.validate(model_internal::_instance.ApproveComment)
        model_internal::_ApproveCommentIsValid_der = (valRes.results == null);
        model_internal::_ApproveCommentIsValidCacheInitialized = true;
        if (valRes.results == null)
             model_internal::ApproveCommentValidationFailureMessages_der = emptyArray;
        else
        {
            ...
            model_internal::ApproveCommentValidationFailureMessages_der = _valFailures;
        }
    }

    [Bindable(event="propertyChange")]
    public function get ApproveCommentValidationFailureMessages():Array
    {
        if (model_internal::_ApproveCommentValidationFailureMessages == null)
            model_internal::calculateApproveCommentIsValid();

        return _ApproveCommentValidationFailureMessages;
    }

    model_internal function set ApproveCommentValidationFailureMessages_der(value:Array) : void
    {
        var oldValue:Array = model_internal::_ApproveCommentValidationFailureMessages;
        ...
        if (needUpdate)
        {
            model_internal::_ApproveCommentValidationFailureMessages = value;   
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "ApproveCommentValidationFailureMessages", oldValue, value));
    ...
    [Bindable(event="propertyChange")]   
    public function get RequestCommentStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }

    public function get RequestCommentValidator() : StyleValidator
    {
        return model_internal::_RequestCommentValidator;
    }

    model_internal function set _RequestCommentIsValid_der(value:Boolean):void 
    {
        var oldValue:Boolean = model_internal::_RequestCommentIsValid;         
        if (oldValue !== value)
        {
            model_internal::_RequestCommentIsValid = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "RequestCommentIsValid", oldValue, value));
        }                             
    }

    [Bindable(event="propertyChange")]
    public function get RequestCommentIsValid():Boolean
    {
        if (!model_internal::_RequestCommentIsValidCacheInitialized)
        {
            model_internal::calculateRequestCommentIsValid();
        ...
        return model_internal::_RequestCommentIsValid;
    }

    model_internal function calculateRequestCommentIsValid():void
    {
        var valRes:ValidationResultEvent = model_internal::_RequestCommentValidator.validate(model_internal::_instance.RequestComment)
        model_internal::_RequestCommentIsValid_der = (valRes.results == null);
        model_internal::_RequestCommentIsValidCacheInitialized = true;
        if (valRes.results == null)
             model_internal::RequestCommentValidationFailureMessages_der = emptyArray;
        else
        {
            var _valFailures:Array = new Array();
            for (var a:int = 0 ; a<valRes.results.length ; a++)
            ...
            model_internal::RequestCommentValidationFailureMessages_der = _valFailures;
        }
    }

    [Bindable(event="propertyChange")]
    public function get RequestCommentValidationFailureMessages():Array
    {
        if (model_internal::_RequestCommentValidationFailureMessages == null)
            model_internal::calculateRequestCommentIsValid();

        return _RequestCommentValidationFailureMessages;
    }

    model_internal function set RequestCommentValidationFailureMessages_der(value:Array) : void
    {
        var oldValue:Array = model_internal::_RequestCommentValidationFailureMessages;
        ...
        if (needUpdate)
        {
            model_internal::_RequestCommentValidationFailureMessages = value;   
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "RequestCommentValidationFailureMessages", oldValue, value));
            // Only execute calculateIsValid if it has been called before, to update the validationFailureMessages for
            // the entire entity.
            if (model_internal::_instance.model_internal::_cacheInitialized_isValid)
            {
     ...
     */  
     override public function getPropertyValidationFailureMessages(propertyName:String):Array
     {
         switch(propertyName)
         {
            case("ApproveComment"):
            {
                return ApproveCommentValidationFailureMessages;
            }
            case("CreatedById"):
            {
            ...
            case("RequestComment"):
            {
                return RequestCommentValidationFailureMessages;
            }
            case("Status"):
            {
