 ...
 * of this value object you may modify the generated sub-class of this class - CaseSolution.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_CaseSolution extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.CaseSolution") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.CaseSolution", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _CaseSolutionEntityMetadata;
    ...
    private var _internal_SolutionId : String;
    ...
    public function _Super_CaseSolution()
    {
        _model = new _CaseSolutionEntityMetadata(this);
        ...
        model_internal::_changeWatcherArray.push(mx.binding.utils.ChangeWatcher.watch(this, "SolutionId", model_internal::setterListenerSolutionId));
    ...
    {
        var oldValue:String = _internal_SolutionId;
        if (oldValue !== value)
        {
            _internal_SolutionId = value;
        }
    }
    ...
    model_internal function setterListenerSolutionId(value:flash.events.Event):void
    {
        _model.invalidateDependentOnSolutionId();
    }
    ...
    model_internal function calculateIsValid():Boolean
    {
        ...
        if (!_model.SolutionIdIsValid)
        {
            propertyValidity = false;
            com.adobe.fiber.util.FiberUtils.arrayAdd(validationFailureMessages, _model.model_internal::_SolutionIdValidationFailureMessages);
        }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _CaseSolutionEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _CaseSolutionEntityMetadata) : void
    {
        var oldValue : _CaseSolutionEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
    ...
    model_internal var _doValidationCacheOfSolutionId : Array = null;
    model_internal var _doValidationLastValOfSolutionId : String;

    model_internal function _doValidationForSolutionId(valueIn:Object):Array
    {
        var value : String = valueIn as String;

        if (model_internal::_doValidationCacheOfSolutionId != null && model_internal::_doValidationLastValOfSolutionId == value)
           return model_internal::_doValidationCacheOfSolutionId ;

        _model.model_internal::_SolutionIdIsValidCacheInitialized = true;
        var validationFailures:Array = new Array();
        var errorMessage:String;
        var failure:Boolean;

        var valRes:ValidationResult;
        if (_model.isSolutionIdAvailable && _internal_SolutionId == null)
        {
            validationFailures.push(new ValidationResult(true, "", "", "SolutionId is required"));
        }

        model_internal::_doValidationCacheOfSolutionId = validationFailures;
        model_internal::_doValidationLastValOfSolutionId = value;
