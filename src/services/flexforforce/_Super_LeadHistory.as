 ...
 * of this value object you may modify the generated sub-class of this class - LeadHistory.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_LeadHistory extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.LeadHistory") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.LeadHistory", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _LeadHistoryEntityMetadata;
    ...
    public function _Super_LeadHistory()
    {
        _model = new _LeadHistoryEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _LeadHistoryEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _LeadHistoryEntityMetadata) : void
    {
        var oldValue : _LeadHistoryEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
