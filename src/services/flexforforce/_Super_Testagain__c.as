 ...
 * of this value object you may modify the generated sub-class of this class - Testagain__c.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_Testagain__c extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.Testagain__c") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.Testagain__c", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _Testagain__cEntityMetadata;
    ...
    public function _Super_Testagain__c()
    {
        _model = new _Testagain__cEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _Testagain__cEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _Testagain__cEntityMetadata) : void
    {
        var oldValue : _Testagain__cEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
