...
[ExcludeClass]
internal class _OpportunityStageEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    private static var emptyArray:Array = new Array();

    model_internal static var allProperties:Array = new Array("Id", "CreatedById", "CreatedDate", "DefaultProbability", "Description", "ForecastCategory", "ForecastCategoryName", "IsActive", "IsClosed", "IsWon", "LastModifiedById", "LastModifiedDate", "MasterLabel", "SortOrder", "SystemModstamp");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("Id", "CreatedById", "CreatedDate", "DefaultProbability", "Description", "ForecastCategory", "ForecastCategoryName", "IsActive", "IsClosed", "IsWon", "LastModifiedById", "LastModifiedDate", "MasterLabel", "SortOrder", "SystemModstamp");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("Id", "CreatedById", "CreatedDate", "DefaultProbability", "Description", "ForecastCategory", "ForecastCategoryName", "IsActive", "IsClosed", "IsWon", "LastModifiedById", "LastModifiedDate", "MasterLabel", "SortOrder", "SystemModstamp");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("Id", "CreatedById", "CreatedDate", "DefaultProbability", "Description", "ForecastCategory", "ForecastCategoryName", "IsActive", "IsClosed", "IsWon", "LastModifiedById", "LastModifiedDate", "MasterLabel", "SortOrder", "SystemModstamp");
    model_internal static var derivedProperties:Array = new Array();
    model_internal static var collectionProperties:Array = new Array();
    model_internal static var collectionBaseMap:Object;
    model_internal static var entityName:String = "OpportunityStage";
    ...
    model_internal var _instance:_Super_OpportunityStage;
    model_internal static var _nullStyle:com.adobe.fiber.styles.Style = new com.adobe.fiber.styles.Style();

    public function _OpportunityStageEntityMetadata(value : _Super_OpportunityStage)
    {
        ...
        if (model_internal::dependentsOnMap == null)
        {
            ...
            model_internal::dependentsOnMap["DefaultProbability"] = new Array();
    ...
    override public function getDependants(propertyName:String):Array
    {
       if (model_internal::dataProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a data property of entity OpportunityStage");  
    ...
    override public function getCollectionBase(propertyName:String):String
    {
        if (model_internal::collectionProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a collection property of entity OpportunityStage");  
    ...
    override public function getValue(propertyName:String):*
    {
        ...
        {
            throw new Error(propertyName + " does not exist for entity OpportunityStage");
        }
    ...
    [Bindable(event="propertyChange")]
    public function get isDefaultProbabilityAvailable():Boolean
    {
        return true;
    }
    ...
    [Bindable(event="propertyChange")]   
    public function get DefaultProbabilityStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }
