 ...
 * of this value object you may modify the generated sub-class of this class - Adamtest__c.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_Adamtest__c extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.Adamtest__c") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.Adamtest__c", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _Adamtest__cEntityMetadata;
    ...
    private var _internal_Service__c : String;
    ...
    public function _Super_Adamtest__c()
    {
        _model = new _Adamtest__cEntityMetadata(this);
        ...
        model_internal::_changeWatcherArray.push(mx.binding.utils.ChangeWatcher.watch(this, "Service__c", model_internal::setterListenerService__c));
    ...
    [Bindable(event="propertyChange")]
    public function get Service__c() : String
    {
        return _internal_Service__c;
    }
    ...
    public function set Service__c(value:String) : void
    {
        var oldValue:String = _internal_Service__c;
        if (oldValue !== value)
        {
            _internal_Service__c = value;
        }
    }
    ...
    model_internal function setterListenerService__c(value:flash.events.Event):void
    {
        _model.invalidateDependentOnService__c();
    }
    ...
    model_internal function calculateIsValid():Boolean
    {
        ...
        if (!_model.Service__cIsValid)
        {
            propertyValidity = false;
            com.adobe.fiber.util.FiberUtils.arrayAdd(validationFailureMessages, _model.model_internal::_Service__cValidationFailureMessages);
        }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _Adamtest__cEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _Adamtest__cEntityMetadata) : void
    {
        var oldValue : _Adamtest__cEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
    ...
    model_internal var _doValidationCacheOfService__c : Array = null;
    model_internal var _doValidationLastValOfService__c : String;

    model_internal function _doValidationForService__c(valueIn:Object):Array
    {
        var value : String = valueIn as String;

        if (model_internal::_doValidationCacheOfService__c != null && model_internal::_doValidationLastValOfService__c == value)
           return model_internal::_doValidationCacheOfService__c ;

        _model.model_internal::_Service__cIsValidCacheInitialized = true;
        var validationFailures:Array = new Array();
        var errorMessage:String;
        var failure:Boolean;

        var valRes:ValidationResult;
        if (_model.isService__cAvailable && _internal_Service__c == null)
        {
            validationFailures.push(new ValidationResult(true, "", "", "Service__c is required"));
        }

        model_internal::_doValidationCacheOfService__c = validationFailures;
        model_internal::_doValidationLastValOfService__c = value;
