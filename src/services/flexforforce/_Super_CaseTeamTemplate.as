 ...
 * of this value object you may modify the generated sub-class of this class - CaseTeamTemplate.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_CaseTeamTemplate extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.CaseTeamTemplate") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.CaseTeamTemplate", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _CaseTeamTemplateEntityMetadata;
    ...
    public function _Super_CaseTeamTemplate()
    {
        _model = new _CaseTeamTemplateEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _CaseTeamTemplateEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _CaseTeamTemplateEntityMetadata) : void
    {
        var oldValue : _CaseTeamTemplateEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
