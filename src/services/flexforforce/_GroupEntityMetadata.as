...
internal class _GroupEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    ...
    model_internal static var allProperties:Array = new Array("Id", "CreatedById", "CreatedDate", "DoesIncludeBosses", "DoesSendEmailToMembers", "Email", "LastModifiedById", "LastModifiedDate", "Name", "OwnerId", "RelatedId", "SystemModstamp", "Type");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("Id", "CreatedById", "CreatedDate", "DoesIncludeBosses", "DoesSendEmailToMembers", "Email", "LastModifiedById", "LastModifiedDate", "Name", "OwnerId", "RelatedId", "SystemModstamp", "Type");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("Id", "CreatedById", "CreatedDate", "DoesIncludeBosses", "DoesSendEmailToMembers", "Email", "LastModifiedById", "LastModifiedDate", "Name", "OwnerId", "RelatedId", "SystemModstamp", "Type");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("Id", "CreatedById", "CreatedDate", "DoesIncludeBosses", "DoesSendEmailToMembers", "Email", "LastModifiedById", "LastModifiedDate", "Name", "OwnerId", "RelatedId", "SystemModstamp", "Type");
    ...
    model_internal var _RelatedIdIsValid:Boolean;
    model_internal var _RelatedIdValidator:com.adobe.fiber.styles.StyleValidator;
    model_internal var _RelatedIdIsValidCacheInitialized:Boolean = false;
    model_internal var _RelatedIdValidationFailureMessages:Array;
    ...
    public function _GroupEntityMetadata(value : _Super_Group)
    {
        ...
        if (model_internal::dependentsOnMap == null)
        {
            ...
            model_internal::dependentsOnMap["DoesIncludeBosses"] = new Array();
            model_internal::dependentsOnMap["DoesSendEmailToMembers"] = new Array();
            ...
            model_internal::dependentsOnMap["RelatedId"] = new Array();
        ...
        model_internal::_RelatedIdValidator = new StyleValidator(model_internal::_instance.model_internal::_doValidationForRelatedId);
        model_internal::_RelatedIdValidator.required = true;
        model_internal::_RelatedIdValidator.requiredFieldError = "RelatedId is required";
        //model_internal::_RelatedIdValidator.source = model_internal::_instance;
        //model_internal::_RelatedIdValidator.property = "RelatedId";
    ...
    [Bindable(event="propertyChange")]
    public function get isDoesIncludeBossesAvailable():Boolean
    {
        return true;
    }

    [Bindable(event="propertyChange")]
    public function get isDoesSendEmailToMembersAvailable():Boolean
    {
        return true;
    }
    ...
    [Bindable(event="propertyChange")]
    public function get isRelatedIdAvailable():Boolean
    {
        return true;
    }
    ...
    public function invalidateDependentOnRelatedId():void
    {
        if (model_internal::_RelatedIdIsValidCacheInitialized )
        {
            model_internal::_instance.model_internal::_doValidationCacheOfRelatedId = null;
            model_internal::calculateRelatedIdIsValid();
        }
    }
    ...
    [Bindable(event="propertyChange")]   
    public function get DoesIncludeBossesStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }

    [Bindable(event="propertyChange")]   
    public function get DoesSendEmailToMembersStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }
    ...
    [Bindable(event="propertyChange")]   
    public function get RelatedIdStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }

    public function get RelatedIdValidator() : StyleValidator
    {
        return model_internal::_RelatedIdValidator;
    }

    model_internal function set _RelatedIdIsValid_der(value:Boolean):void 
    {
        var oldValue:Boolean = model_internal::_RelatedIdIsValid;         
        if (oldValue !== value)
        {
            model_internal::_RelatedIdIsValid = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "RelatedIdIsValid", oldValue, value));
        }                             
    }

    [Bindable(event="propertyChange")]
    public function get RelatedIdIsValid():Boolean
    {
        if (!model_internal::_RelatedIdIsValidCacheInitialized)
        {
            model_internal::calculateRelatedIdIsValid();
        ...
        return model_internal::_RelatedIdIsValid;
    }

    model_internal function calculateRelatedIdIsValid():void
    {
        var valRes:ValidationResultEvent = model_internal::_RelatedIdValidator.validate(model_internal::_instance.RelatedId)
        model_internal::_RelatedIdIsValid_der = (valRes.results == null);
        model_internal::_RelatedIdIsValidCacheInitialized = true;
        if (valRes.results == null)
             model_internal::RelatedIdValidationFailureMessages_der = emptyArray;
        else
        {
            var _valFailures:Array = new Array();
            for (var a:int = 0 ; a<valRes.results.length ; a++)
            ...
            model_internal::RelatedIdValidationFailureMessages_der = _valFailures;
        }
    }

    [Bindable(event="propertyChange")]
    public function get RelatedIdValidationFailureMessages():Array
    {
        if (model_internal::_RelatedIdValidationFailureMessages == null)
            model_internal::calculateRelatedIdIsValid();

        return _RelatedIdValidationFailureMessages;
    }

    model_internal function set RelatedIdValidationFailureMessages_der(value:Array) : void
    {
        var oldValue:Array = model_internal::_RelatedIdValidationFailureMessages;
        ...
        if (needUpdate)
        {
            model_internal::_RelatedIdValidationFailureMessages = value;   
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "RelatedIdValidationFailureMessages", oldValue, value));
            // Only execute calculateIsValid if it has been called before, to update the validationFailureMessages for
            // the entire entity.
            if (model_internal::_instance.model_internal::_cacheInitialized_isValid)
            {
     ...
     */  
     override public function getPropertyValidationFailureMessages(propertyName:String):Array
     {
         switch(propertyName)
         {
            ...
            case("RelatedId"):
            {
                return RelatedIdValidationFailureMessages;
            }
            case("SystemModstamp"):
            {
