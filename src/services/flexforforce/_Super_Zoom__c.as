 ...
 * of this value object you may modify the generated sub-class of this class - Zoom__c.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_Zoom__c extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.Zoom__c") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.Zoom__c", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _Zoom__cEntityMetadata;

    /**
     * properties
     */
    private var _internal_Id : String;
    private var _internal_Amount__c : Number;
    ...
    private var _internal_Hire_date__c : Date;
    ...
    private var _internal_zoom_str__c : String;
    ...
    public function _Super_Zoom__c()
    {
        _model = new _Zoom__cEntityMetadata(this);
        ...
        model_internal::_changeWatcherArray.push(mx.binding.utils.ChangeWatcher.watch(this, "zoom_str__c", model_internal::setterListenerZoom_str__c));
    ...
    [Bindable(event="propertyChange")]
    public function get Amount__c() : Number
    {
    ...
    [Bindable(event="propertyChange")]
    public function get Hire_date__c() : Date
    {
    ...
    [Bindable(event="propertyChange")]
    public function get zoom_str__c() : String
    {
        return _internal_zoom_str__c;
    }
    ...
    public function set Amount__c(value:Number) : void
    {
        var oldValue:Number = _internal_Amount__c;
        if (isNaN(_internal_Amount__c) == true || Math.abs(oldValue - value) > epsilon)
        {
    ...
    public function set Hire_date__c(value:Date) : void
    {
        var oldValue:Date = _internal_Hire_date__c;
        if (oldValue !== value)
        {
    ...
    public function set zoom_str__c(value:String) : void
    {
        var oldValue:String = _internal_zoom_str__c;
        if (oldValue !== value)
        {
            _internal_zoom_str__c = value;
        }
    }
    ...
    model_internal function setterListenerZoom_str__c(value:flash.events.Event):void
    {
        _model.invalidateDependentOnZoom_str__c();
    }
    ...
    model_internal function calculateIsValid():Boolean
    {
        ...
        if (!_model.zoom_str__cIsValid)
        {
            propertyValidity = false;
            com.adobe.fiber.util.FiberUtils.arrayAdd(validationFailureMessages, _model.model_internal::_zoom_str__cValidationFailureMessages);
        }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _Zoom__cEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _Zoom__cEntityMetadata) : void
    {
        var oldValue : _Zoom__cEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
    ...
    model_internal var _doValidationLastValOfHire_date__c : Date;
    ...
    model_internal var _doValidationCacheOfZoom_str__c : Array = null;
    model_internal var _doValidationLastValOfZoom_str__c : String;

    model_internal function _doValidationForZoom_str__c(valueIn:Object):Array
    {
        var value : String = valueIn as String;

        if (model_internal::_doValidationCacheOfZoom_str__c != null && model_internal::_doValidationLastValOfZoom_str__c == value)
           return model_internal::_doValidationCacheOfZoom_str__c ;

        _model.model_internal::_zoom_str__cIsValidCacheInitialized = true;
        var validationFailures:Array = new Array();
        var errorMessage:String;
        var failure:Boolean;

        var valRes:ValidationResult;
        if (_model.isZoom_str__cAvailable && _internal_zoom_str__c == null)
        {
            validationFailures.push(new ValidationResult(true, "", "", "zoom_str__c is required"));
        }

        model_internal::_doValidationCacheOfZoom_str__c = validationFailures;
        model_internal::_doValidationLastValOfZoom_str__c = value;
