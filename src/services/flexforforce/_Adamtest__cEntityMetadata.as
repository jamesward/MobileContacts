...
[ExcludeClass]
internal class _Adamtest__cEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    private static var emptyArray:Array = new Array();

    model_internal static var allProperties:Array = new Array("Id", "ConnectionReceivedId", "ConnectionSentId", "CreatedById", "CreatedDate", "IsDeleted", "LastActivityDate", "LastModifiedById", "LastModifiedDate", "Name", "OwnerId", "Service__c", "SystemModstamp");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("Id", "ConnectionReceivedId", "ConnectionSentId", "CreatedById", "CreatedDate", "IsDeleted", "LastActivityDate", "LastModifiedById", "LastModifiedDate", "Name", "OwnerId", "Service__c", "SystemModstamp");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("Id", "ConnectionReceivedId", "ConnectionSentId", "CreatedById", "CreatedDate", "IsDeleted", "LastActivityDate", "LastModifiedById", "LastModifiedDate", "Name", "OwnerId", "Service__c", "SystemModstamp");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("Id", "ConnectionReceivedId", "ConnectionSentId", "CreatedById", "CreatedDate", "IsDeleted", "LastActivityDate", "LastModifiedById", "LastModifiedDate", "Name", "OwnerId", "Service__c", "SystemModstamp");
    model_internal static var derivedProperties:Array = new Array();
    model_internal static var collectionProperties:Array = new Array();
    model_internal static var collectionBaseMap:Object;
    model_internal static var entityName:String = "Adamtest__c";
    ...
    model_internal var _Service__cIsValid:Boolean;
    model_internal var _Service__cValidator:com.adobe.fiber.styles.StyleValidator;
    model_internal var _Service__cIsValidCacheInitialized:Boolean = false;
    model_internal var _Service__cValidationFailureMessages:Array;
    ...
    model_internal var _instance:_Super_Adamtest__c;
    model_internal static var _nullStyle:com.adobe.fiber.styles.Style = new com.adobe.fiber.styles.Style();

    public function _Adamtest__cEntityMetadata(value : _Super_Adamtest__c)
    {
        ...
        if (model_internal::dependentsOnMap == null)
        {
            ...
            model_internal::dependentsOnMap["Service__c"] = new Array();
        ...
        model_internal::_Service__cValidator = new StyleValidator(model_internal::_instance.model_internal::_doValidationForService__c);
        model_internal::_Service__cValidator.required = true;
        model_internal::_Service__cValidator.requiredFieldError = "Service__c is required";
        //model_internal::_Service__cValidator.source = model_internal::_instance;
        //model_internal::_Service__cValidator.property = "Service__c";
    ...
    override public function getDependants(propertyName:String):Array
    {
       if (model_internal::dataProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a data property of entity Adamtest__c");  
    ...
    override public function getCollectionBase(propertyName:String):String
    {
        if (model_internal::collectionProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a collection property of entity Adamtest__c");  
    ...
    override public function getValue(propertyName:String):*
    {
        ...
        {
            throw new Error(propertyName + " does not exist for entity Adamtest__c");
        }
    ...
    [Bindable(event="propertyChange")]
    public function get isService__cAvailable():Boolean
    {
        return true;
    }
    ...
    public function invalidateDependentOnService__c():void
    {
        if (model_internal::_Service__cIsValidCacheInitialized )
        {
            model_internal::_instance.model_internal::_doValidationCacheOfService__c = null;
            model_internal::calculateService__cIsValid();
        }
    }
    ...
    [Bindable(event="propertyChange")]   
    public function get Service__cStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }

    public function get Service__cValidator() : StyleValidator
    {
        return model_internal::_Service__cValidator;
    }

    model_internal function set _Service__cIsValid_der(value:Boolean):void 
    {
        var oldValue:Boolean = model_internal::_Service__cIsValid;         
        if (oldValue !== value)
        {
            model_internal::_Service__cIsValid = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "Service__cIsValid", oldValue, value));
        }                             
    }

    [Bindable(event="propertyChange")]
    public function get Service__cIsValid():Boolean
    {
        if (!model_internal::_Service__cIsValidCacheInitialized)
        {
            model_internal::calculateService__cIsValid();
        ...
        return model_internal::_Service__cIsValid;
    }

    model_internal function calculateService__cIsValid():void
    {
        var valRes:ValidationResultEvent = model_internal::_Service__cValidator.validate(model_internal::_instance.Service__c)
        model_internal::_Service__cIsValid_der = (valRes.results == null);
        model_internal::_Service__cIsValidCacheInitialized = true;
        if (valRes.results == null)
             model_internal::Service__cValidationFailureMessages_der = emptyArray;
        else
        {
            var _valFailures:Array = new Array();
            for (var a:int = 0 ; a<valRes.results.length ; a++)
            ...
            model_internal::Service__cValidationFailureMessages_der = _valFailures;
        }
    }

    [Bindable(event="propertyChange")]
    public function get Service__cValidationFailureMessages():Array
    {
        if (model_internal::_Service__cValidationFailureMessages == null)
            model_internal::calculateService__cIsValid();

        return _Service__cValidationFailureMessages;
    }

    model_internal function set Service__cValidationFailureMessages_der(value:Array) : void
    {
        var oldValue:Array = model_internal::_Service__cValidationFailureMessages;
        ...
        if (needUpdate)
        {
            model_internal::_Service__cValidationFailureMessages = value;   
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "Service__cValidationFailureMessages", oldValue, value));
            // Only execute calculateIsValid if it has been called before, to update the validationFailureMessages for
            // the entire entity.
            if (model_internal::_instance.model_internal::_cacheInitialized_isValid)
            {
     ...
     */  
     override public function getPropertyValidationFailureMessages(propertyName:String):Array
     {
         switch(propertyName)
         {
            ...
            case("Service__c"):
            {
                return Service__cValidationFailureMessages;
            }
            case("SystemModstamp"):
            {
