 ...
 * of this value object you may modify the generated sub-class of this class - OpportunityFieldHistory.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_OpportunityFieldHistory extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.OpportunityFieldHistory") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.OpportunityFieldHistory", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _OpportunityFieldHistoryEntityMetadata;
    ...
    public function _Super_OpportunityFieldHistory()
    {
        _model = new _OpportunityFieldHistoryEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _OpportunityFieldHistoryEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _OpportunityFieldHistoryEntityMetadata) : void
    {
        var oldValue : _OpportunityFieldHistoryEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
