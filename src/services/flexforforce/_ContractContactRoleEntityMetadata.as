...
[ExcludeClass]
internal class _ContractContactRoleEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    private static var emptyArray:Array = new Array();

    model_internal static var allProperties:Array = new Array("Id", "ContactId", "ContractId", "CreatedById", "CreatedDate", "IsDeleted", "IsPrimary", "LastModifiedById", "LastModifiedDate", "Role", "SystemModstamp");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("Id", "ContactId", "ContractId", "CreatedById", "CreatedDate", "IsDeleted", "IsPrimary", "LastModifiedById", "LastModifiedDate", "Role", "SystemModstamp");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("Id", "ContactId", "ContractId", "CreatedById", "CreatedDate", "IsDeleted", "IsPrimary", "LastModifiedById", "LastModifiedDate", "Role", "SystemModstamp");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("Id", "ContactId", "ContractId", "CreatedById", "CreatedDate", "IsDeleted", "IsPrimary", "LastModifiedById", "LastModifiedDate", "Role", "SystemModstamp");
    model_internal static var derivedProperties:Array = new Array();
    model_internal static var collectionProperties:Array = new Array();
    model_internal static var collectionBaseMap:Object;
    model_internal static var entityName:String = "ContractContactRole";
    ...
    model_internal var _ContractIdIsValid:Boolean;
    model_internal var _ContractIdValidator:com.adobe.fiber.styles.StyleValidator;
    model_internal var _ContractIdIsValidCacheInitialized:Boolean = false;
    model_internal var _ContractIdValidationFailureMessages:Array;
    ...
    model_internal var _instance:_Super_ContractContactRole;
    model_internal static var _nullStyle:com.adobe.fiber.styles.Style = new com.adobe.fiber.styles.Style();

    public function _ContractContactRoleEntityMetadata(value : _Super_ContractContactRole)
    {
        ...
        if (model_internal::dependentsOnMap == null)
        {
            ...
            model_internal::dependentsOnMap["ContractId"] = new Array();
        ...
        model_internal::_ContractIdValidator = new StyleValidator(model_internal::_instance.model_internal::_doValidationForContractId);
        model_internal::_ContractIdValidator.required = true;
        model_internal::_ContractIdValidator.requiredFieldError = "ContractId is required";
        //model_internal::_ContractIdValidator.source = model_internal::_instance;
        //model_internal::_ContractIdValidator.property = "ContractId";
    ...
    override public function getDependants(propertyName:String):Array
    {
       if (model_internal::dataProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a data property of entity ContractContactRole");  
    ...
    override public function getCollectionBase(propertyName:String):String
    {
        if (model_internal::collectionProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a collection property of entity ContractContactRole");  
    ...
    override public function getValue(propertyName:String):*
    {
        ...
        {
            throw new Error(propertyName + " does not exist for entity ContractContactRole");
        }
    ...
    [Bindable(event="propertyChange")]
    public function get isContractIdAvailable():Boolean
    {
        return true;
    }
    ...
    public function invalidateDependentOnContractId():void
    {
        if (model_internal::_ContractIdIsValidCacheInitialized )
        {
            model_internal::_instance.model_internal::_doValidationCacheOfContractId = null;
            model_internal::calculateContractIdIsValid();
        }
    }
    ...
    [Bindable(event="propertyChange")]   
    public function get ContractIdStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }

    public function get ContractIdValidator() : StyleValidator
    {
        return model_internal::_ContractIdValidator;
    }

    model_internal function set _ContractIdIsValid_der(value:Boolean):void 
    {
        var oldValue:Boolean = model_internal::_ContractIdIsValid;         
        if (oldValue !== value)
        {
            model_internal::_ContractIdIsValid = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "ContractIdIsValid", oldValue, value));
        }                             
    }

    [Bindable(event="propertyChange")]
    public function get ContractIdIsValid():Boolean
    {
        if (!model_internal::_ContractIdIsValidCacheInitialized)
        {
            model_internal::calculateContractIdIsValid();
        ...
        return model_internal::_ContractIdIsValid;
    }

    model_internal function calculateContractIdIsValid():void
    {
        var valRes:ValidationResultEvent = model_internal::_ContractIdValidator.validate(model_internal::_instance.ContractId)
        model_internal::_ContractIdIsValid_der = (valRes.results == null);
        model_internal::_ContractIdIsValidCacheInitialized = true;
        if (valRes.results == null)
             model_internal::ContractIdValidationFailureMessages_der = emptyArray;
        else
        {
            var _valFailures:Array = new Array();
            for (var a:int = 0 ; a<valRes.results.length ; a++)
            ...
            model_internal::ContractIdValidationFailureMessages_der = _valFailures;
        }
    }

    [Bindable(event="propertyChange")]
    public function get ContractIdValidationFailureMessages():Array
    {
        if (model_internal::_ContractIdValidationFailureMessages == null)
            model_internal::calculateContractIdIsValid();

        return _ContractIdValidationFailureMessages;
    }

    model_internal function set ContractIdValidationFailureMessages_der(value:Array) : void
    {
        var oldValue:Array = model_internal::_ContractIdValidationFailureMessages;
        ...
        if (needUpdate)
        {
            model_internal::_ContractIdValidationFailureMessages = value;   
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "ContractIdValidationFailureMessages", oldValue, value));
            // Only execute calculateIsValid if it has been called before, to update the validationFailureMessages for
            // the entire entity.
            if (model_internal::_instance.model_internal::_cacheInitialized_isValid)
            {
     ...
     */  
     override public function getPropertyValidationFailureMessages(propertyName:String):Array
     {
         switch(propertyName)
         {
            ...
            case("ContractId"):
            {
                return ContractIdValidationFailureMessages;
            }
            case("CreatedById"):
            {
