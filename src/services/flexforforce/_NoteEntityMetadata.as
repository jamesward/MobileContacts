...
[ExcludeClass]
internal class _NoteEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    private static var emptyArray:Array = new Array();

    model_internal static var allProperties:Array = new Array("Id", "Body", "CreatedById", "CreatedDate", "IsDeleted", "IsPrivate", "LastModifiedById", "LastModifiedDate", "OwnerId", "ParentId", "SystemModstamp", "Title");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("Id", "Body", "CreatedById", "CreatedDate", "IsDeleted", "IsPrivate", "LastModifiedById", "LastModifiedDate", "OwnerId", "ParentId", "SystemModstamp", "Title");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("Id", "Body", "CreatedById", "CreatedDate", "IsDeleted", "IsPrivate", "LastModifiedById", "LastModifiedDate", "OwnerId", "ParentId", "SystemModstamp", "Title");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("Id", "Body", "CreatedById", "CreatedDate", "IsDeleted", "IsPrivate", "LastModifiedById", "LastModifiedDate", "OwnerId", "ParentId", "SystemModstamp", "Title");
    model_internal static var derivedProperties:Array = new Array();
    model_internal static var collectionProperties:Array = new Array();
    model_internal static var collectionBaseMap:Object;
    model_internal static var entityName:String = "Note";
    ...
    model_internal var _instance:_Super_Note;
    model_internal static var _nullStyle:com.adobe.fiber.styles.Style = new com.adobe.fiber.styles.Style();

    public function _NoteEntityMetadata(value : _Super_Note)
    {
    ...
    override public function getDependants(propertyName:String):Array
    {
       if (model_internal::dataProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a data property of entity Note");  
    ...
    override public function getCollectionBase(propertyName:String):String
    {
        if (model_internal::collectionProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a collection property of entity Note");  
    ...
    override public function getValue(propertyName:String):*
    {
        ...
        {
            throw new Error(propertyName + " does not exist for entity Note");
        }
