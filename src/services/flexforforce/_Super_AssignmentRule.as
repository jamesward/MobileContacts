 ...
 * of this value object you may modify the generated sub-class of this class - AssignmentRule.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_AssignmentRule extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.AssignmentRule") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.AssignmentRule", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _AssignmentRuleEntityMetadata;
    ...
    public function _Super_AssignmentRule()
    {
        _model = new _AssignmentRuleEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _AssignmentRuleEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _AssignmentRuleEntityMetadata) : void
    {
        var oldValue : _AssignmentRuleEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
