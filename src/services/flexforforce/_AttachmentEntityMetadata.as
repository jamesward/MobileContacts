...
[ExcludeClass]
internal class _AttachmentEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    private static var emptyArray:Array = new Array();

    model_internal static var allProperties:Array = new Array("Id", "Body", "BodyLength", "ConnectionReceivedId", "ConnectionSentId", "ContentType", "CreatedById", "CreatedDate", "Description", "IsDeleted", "IsPartnerShared", "IsPrivate", "LastModifiedById", "LastModifiedDate", "Name", "OwnerId", "ParentId", "SystemModstamp");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("Id", "Body", "BodyLength", "ConnectionReceivedId", "ConnectionSentId", "ContentType", "CreatedById", "CreatedDate", "Description", "IsDeleted", "IsPartnerShared", "IsPrivate", "LastModifiedById", "LastModifiedDate", "Name", "OwnerId", "ParentId", "SystemModstamp");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("Id", "Body", "BodyLength", "ConnectionReceivedId", "ConnectionSentId", "ContentType", "CreatedById", "CreatedDate", "Description", "IsDeleted", "IsPartnerShared", "IsPrivate", "LastModifiedById", "LastModifiedDate", "Name", "OwnerId", "ParentId", "SystemModstamp");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("Id", "Body", "BodyLength", "ConnectionReceivedId", "ConnectionSentId", "ContentType", "CreatedById", "CreatedDate", "Description", "IsDeleted", "IsPartnerShared", "IsPrivate", "LastModifiedById", "LastModifiedDate", "Name", "OwnerId", "ParentId", "SystemModstamp");
    model_internal static var derivedProperties:Array = new Array();
    model_internal static var collectionProperties:Array = new Array();
    model_internal static var collectionBaseMap:Object;
    model_internal static var entityName:String = "Attachment";
    ...
    model_internal var _instance:_Super_Attachment;
    model_internal static var _nullStyle:com.adobe.fiber.styles.Style = new com.adobe.fiber.styles.Style();

    public function _AttachmentEntityMetadata(value : _Super_Attachment)
    {
        ...
        if (model_internal::dependentsOnMap == null)
        {
            ...
            model_internal::dependentsOnMap["IsPartnerShared"] = new Array();
    ...
    override public function getDependants(propertyName:String):Array
    {
       if (model_internal::dataProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a data property of entity Attachment");  
    ...
    override public function getCollectionBase(propertyName:String):String
    {
        if (model_internal::collectionProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a collection property of entity Attachment");  
    ...
    override public function getValue(propertyName:String):*
    {
        ...
        {
            throw new Error(propertyName + " does not exist for entity Attachment");
        }
    ...
    [Bindable(event="propertyChange")]
    public function get isIsPartnerSharedAvailable():Boolean
    {
        return true;
    }
    ...
    [Bindable(event="propertyChange")]   
    public function get IsPartnerSharedStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }
