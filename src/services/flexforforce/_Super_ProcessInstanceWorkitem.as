 ...
 * of this value object you may modify the generated sub-class of this class - ProcessInstanceWorkitem.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_ProcessInstanceWorkitem extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.ProcessInstanceWorkitem") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.ProcessInstanceWorkitem", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _ProcessInstanceWorkitemEntityMetadata;
    ...
    public function _Super_ProcessInstanceWorkitem()
    {
        _model = new _ProcessInstanceWorkitemEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _ProcessInstanceWorkitemEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _ProcessInstanceWorkitemEntityMetadata) : void
    {
        var oldValue : _ProcessInstanceWorkitemEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
