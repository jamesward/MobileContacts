...
[ExcludeClass]
internal class _Reservations__cEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    private static var emptyArray:Array = new Array();

    model_internal static var allProperties:Array = new Array("Id", "ConnectionReceivedId", "ConnectionSentId", "CreatedById", "CreatedDate", "IsDeleted", "LastActivityDate", "LastModifiedById", "LastModifiedDate", "Name", "OwnerId", "SystemModstamp", "event_date__c");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("Id", "ConnectionReceivedId", "ConnectionSentId", "CreatedById", "CreatedDate", "IsDeleted", "LastActivityDate", "LastModifiedById", "LastModifiedDate", "Name", "OwnerId", "SystemModstamp", "event_date__c");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("Id", "ConnectionReceivedId", "ConnectionSentId", "CreatedById", "CreatedDate", "IsDeleted", "LastActivityDate", "LastModifiedById", "LastModifiedDate", "Name", "OwnerId", "SystemModstamp", "event_date__c");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("Id", "ConnectionReceivedId", "ConnectionSentId", "CreatedById", "CreatedDate", "IsDeleted", "LastActivityDate", "LastModifiedById", "LastModifiedDate", "Name", "OwnerId", "SystemModstamp", "event_date__c");
    model_internal static var derivedProperties:Array = new Array();
    model_internal static var collectionProperties:Array = new Array();
    model_internal static var collectionBaseMap:Object;
    model_internal static var entityName:String = "Reservations__c";
    ...
    model_internal var _event_date__cIsValid:Boolean;
    model_internal var _event_date__cValidator:com.adobe.fiber.styles.StyleValidator;
    model_internal var _event_date__cIsValidCacheInitialized:Boolean = false;
    model_internal var _event_date__cValidationFailureMessages:Array;

    model_internal var _instance:_Super_Reservations__c;
    model_internal static var _nullStyle:com.adobe.fiber.styles.Style = new com.adobe.fiber.styles.Style();

    public function _Reservations__cEntityMetadata(value : _Super_Reservations__c)
    {
        ...
        if (model_internal::dependentsOnMap == null)
        {
            ...
            model_internal::dependentsOnMap["event_date__c"] = new Array();
        ...
        model_internal::_event_date__cValidator = new StyleValidator(model_internal::_instance.model_internal::_doValidationForEvent_date__c);
        model_internal::_event_date__cValidator.required = true;
        model_internal::_event_date__cValidator.requiredFieldError = "event_date__c is required";
        //model_internal::_event_date__cValidator.source = model_internal::_instance;
        //model_internal::_event_date__cValidator.property = "event_date__c";
    }
    ...
    override public function getDependants(propertyName:String):Array
    {
       if (model_internal::dataProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a data property of entity Reservations__c");  
    ...
    override public function getCollectionBase(propertyName:String):String
    {
        if (model_internal::collectionProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a collection property of entity Reservations__c");  
    ...
    override public function getValue(propertyName:String):*
    {
        ...
        {
            throw new Error(propertyName + " does not exist for entity Reservations__c");
        }
    ...
    [Bindable(event="propertyChange")]
    public function get isEvent_date__cAvailable():Boolean
    {
        return true;
    }
    ...
    public function invalidateDependentOnEvent_date__c():void
    {
        if (model_internal::_event_date__cIsValidCacheInitialized )
        {
            model_internal::_instance.model_internal::_doValidationCacheOfEvent_date__c = null;
            model_internal::calculateEvent_date__cIsValid();
        }
    }
    ...
    [Bindable(event="propertyChange")]   
    public function get event_date__cStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }

    public function get event_date__cValidator() : StyleValidator
    {
        return model_internal::_event_date__cValidator;
    }

    model_internal function set _event_date__cIsValid_der(value:Boolean):void 
    {
        var oldValue:Boolean = model_internal::_event_date__cIsValid;         
        if (oldValue !== value)
        {
            model_internal::_event_date__cIsValid = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "event_date__cIsValid", oldValue, value));
        }                             
    }

    [Bindable(event="propertyChange")]
    public function get event_date__cIsValid():Boolean
    {
        if (!model_internal::_event_date__cIsValidCacheInitialized)
        {
            model_internal::calculateEvent_date__cIsValid();
        ...
        return model_internal::_event_date__cIsValid;
    }

    model_internal function calculateEvent_date__cIsValid():void
    {
        var valRes:ValidationResultEvent = model_internal::_event_date__cValidator.validate(model_internal::_instance.event_date__c)
        model_internal::_event_date__cIsValid_der = (valRes.results == null);
        model_internal::_event_date__cIsValidCacheInitialized = true;
        if (valRes.results == null)
             model_internal::event_date__cValidationFailureMessages_der = emptyArray;
        else
        {
            var _valFailures:Array = new Array();
            for (var a:int = 0 ; a<valRes.results.length ; a++)
            ...
            model_internal::event_date__cValidationFailureMessages_der = _valFailures;
        }
    }

    [Bindable(event="propertyChange")]
    public function get event_date__cValidationFailureMessages():Array
    {
        if (model_internal::_event_date__cValidationFailureMessages == null)
            model_internal::calculateEvent_date__cIsValid();

        return _event_date__cValidationFailureMessages;
    }

    model_internal function set event_date__cValidationFailureMessages_der(value:Array) : void
    {
        var oldValue:Array = model_internal::_event_date__cValidationFailureMessages;
        ...
        if (needUpdate)
        {
            model_internal::_event_date__cValidationFailureMessages = value;   
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "event_date__cValidationFailureMessages", oldValue, value));
            // Only execute calculateIsValid if it has been called before, to update the validationFailureMessages for
            // the entire entity.
            if (model_internal::_instance.model_internal::_cacheInitialized_isValid)
            {
     ...
     */  
     override public function getPropertyValidationFailureMessages(propertyName:String):Array
     {
         switch(propertyName)
         {
            ...
            case("event_date__c"):
            {
                return event_date__cValidationFailureMessages;
            }
            default:
            {
                return emptyArray;
