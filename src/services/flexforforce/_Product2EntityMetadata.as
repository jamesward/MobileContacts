...
[ExcludeClass]
internal class _Product2EntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    private static var emptyArray:Array = new Array();

    model_internal static var allProperties:Array = new Array("Id", "ConnectionReceivedId", "ConnectionSentId", "CreatedById", "CreatedDate", "Description", "Family", "IsActive", "IsDeleted", "LastModifiedById", "LastModifiedDate", "Name", "ProductCode", "SystemModstamp");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("Id", "ConnectionReceivedId", "ConnectionSentId", "CreatedById", "CreatedDate", "Description", "Family", "IsActive", "IsDeleted", "LastModifiedById", "LastModifiedDate", "Name", "ProductCode", "SystemModstamp");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("Id", "ConnectionReceivedId", "ConnectionSentId", "CreatedById", "CreatedDate", "Description", "Family", "IsActive", "IsDeleted", "LastModifiedById", "LastModifiedDate", "Name", "ProductCode", "SystemModstamp");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("Id", "ConnectionReceivedId", "ConnectionSentId", "CreatedById", "CreatedDate", "Description", "Family", "IsActive", "IsDeleted", "LastModifiedById", "LastModifiedDate", "Name", "ProductCode", "SystemModstamp");
    model_internal static var derivedProperties:Array = new Array();
    model_internal static var collectionProperties:Array = new Array();
    model_internal static var collectionBaseMap:Object;
    model_internal static var entityName:String = "Product2";
    ...
    model_internal var _FamilyIsValid:Boolean;
    model_internal var _FamilyValidator:com.adobe.fiber.styles.StyleValidator;
    model_internal var _FamilyIsValidCacheInitialized:Boolean = false;
    model_internal var _FamilyValidationFailureMessages:Array;
    ...
    model_internal var _ProductCodeIsValid:Boolean;
    model_internal var _ProductCodeValidator:com.adobe.fiber.styles.StyleValidator;
    model_internal var _ProductCodeIsValidCacheInitialized:Boolean = false;
    model_internal var _ProductCodeValidationFailureMessages:Array;
    ...
    model_internal var _instance:_Super_Product2;
    model_internal static var _nullStyle:com.adobe.fiber.styles.Style = new com.adobe.fiber.styles.Style();

    public function _Product2EntityMetadata(value : _Super_Product2)
    {
        ...
        if (model_internal::dependentsOnMap == null)
        {
            ...
            model_internal::dependentsOnMap["Family"] = new Array();
            ...
            model_internal::dependentsOnMap["ProductCode"] = new Array();
        ...
        model_internal::_FamilyValidator = new StyleValidator(model_internal::_instance.model_internal::_doValidationForFamily);
        model_internal::_FamilyValidator.required = true;
        model_internal::_FamilyValidator.requiredFieldError = "Family is required";
        //model_internal::_FamilyValidator.source = model_internal::_instance;
        //model_internal::_FamilyValidator.property = "Family";
        ...
        model_internal::_ProductCodeValidator = new StyleValidator(model_internal::_instance.model_internal::_doValidationForProductCode);
        model_internal::_ProductCodeValidator.required = true;
        model_internal::_ProductCodeValidator.requiredFieldError = "ProductCode is required";
        //model_internal::_ProductCodeValidator.source = model_internal::_instance;
        //model_internal::_ProductCodeValidator.property = "ProductCode";
    ...
    override public function getDependants(propertyName:String):Array
    {
       if (model_internal::dataProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a data property of entity Product2");  
    ...
    override public function getCollectionBase(propertyName:String):String
    {
        if (model_internal::collectionProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a collection property of entity Product2");  
    ...
    override public function getValue(propertyName:String):*
    {
        ...
        {
            throw new Error(propertyName + " does not exist for entity Product2");
        }
    ...
    [Bindable(event="propertyChange")]
    public function get isFamilyAvailable():Boolean
    {
        return true;
    }
    ...
    [Bindable(event="propertyChange")]
    public function get isProductCodeAvailable():Boolean
    {
        return true;
    }
    ...
    public function invalidateDependentOnFamily():void
    {
        if (model_internal::_FamilyIsValidCacheInitialized )
        {
            model_internal::_instance.model_internal::_doValidationCacheOfFamily = null;
            model_internal::calculateFamilyIsValid();
        }
    }
    ...
    public function invalidateDependentOnProductCode():void
    {
        if (model_internal::_ProductCodeIsValidCacheInitialized )
        {
            model_internal::_instance.model_internal::_doValidationCacheOfProductCode = null;
            model_internal::calculateProductCodeIsValid();
        }
    }
    ...
    [Bindable(event="propertyChange")]   
    public function get FamilyStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }

    public function get FamilyValidator() : StyleValidator
    {
        return model_internal::_FamilyValidator;
    }

    model_internal function set _FamilyIsValid_der(value:Boolean):void 
    {
        var oldValue:Boolean = model_internal::_FamilyIsValid;         
        if (oldValue !== value)
        {
            model_internal::_FamilyIsValid = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "FamilyIsValid", oldValue, value));
        }                             
    }

    [Bindable(event="propertyChange")]
    public function get FamilyIsValid():Boolean
    {
        if (!model_internal::_FamilyIsValidCacheInitialized)
        {
            model_internal::calculateFamilyIsValid();
        ...
        return model_internal::_FamilyIsValid;
    }

    model_internal function calculateFamilyIsValid():void
    {
        var valRes:ValidationResultEvent = model_internal::_FamilyValidator.validate(model_internal::_instance.Family)
        model_internal::_FamilyIsValid_der = (valRes.results == null);
        model_internal::_FamilyIsValidCacheInitialized = true;
        if (valRes.results == null)
             model_internal::FamilyValidationFailureMessages_der = emptyArray;
        else
        {
            var _valFailures:Array = new Array();
            for (var a:int = 0 ; a<valRes.results.length ; a++)
            ...
            model_internal::FamilyValidationFailureMessages_der = _valFailures;
        }
    }

    [Bindable(event="propertyChange")]
    public function get FamilyValidationFailureMessages():Array
    {
        if (model_internal::_FamilyValidationFailureMessages == null)
            model_internal::calculateFamilyIsValid();

        return _FamilyValidationFailureMessages;
    }

    model_internal function set FamilyValidationFailureMessages_der(value:Array) : void
    {
        var oldValue:Array = model_internal::_FamilyValidationFailureMessages;
        ...
        if (needUpdate)
        {
            model_internal::_FamilyValidationFailureMessages = value;   
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "FamilyValidationFailureMessages", oldValue, value));
            // Only execute calculateIsValid if it has been called before, to update the validationFailureMessages for
            // the entire entity.
            if (model_internal::_instance.model_internal::_cacheInitialized_isValid)
            {
    ...
    [Bindable(event="propertyChange")]   
    public function get ProductCodeStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }

    public function get ProductCodeValidator() : StyleValidator
    {
        return model_internal::_ProductCodeValidator;
    }

    model_internal function set _ProductCodeIsValid_der(value:Boolean):void 
    {
        var oldValue:Boolean = model_internal::_ProductCodeIsValid;         
        if (oldValue !== value)
        {
            model_internal::_ProductCodeIsValid = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "ProductCodeIsValid", oldValue, value));
        }                             
    }

    [Bindable(event="propertyChange")]
    public function get ProductCodeIsValid():Boolean
    {
        if (!model_internal::_ProductCodeIsValidCacheInitialized)
        {
            model_internal::calculateProductCodeIsValid();
        ...
        return model_internal::_ProductCodeIsValid;
    }

    model_internal function calculateProductCodeIsValid():void
    {
        var valRes:ValidationResultEvent = model_internal::_ProductCodeValidator.validate(model_internal::_instance.ProductCode)
        model_internal::_ProductCodeIsValid_der = (valRes.results == null);
        model_internal::_ProductCodeIsValidCacheInitialized = true;
        if (valRes.results == null)
             model_internal::ProductCodeValidationFailureMessages_der = emptyArray;
        else
        {
            var _valFailures:Array = new Array();
            for (var a:int = 0 ; a<valRes.results.length ; a++)
            ...
            model_internal::ProductCodeValidationFailureMessages_der = _valFailures;
        }
    }

    [Bindable(event="propertyChange")]
    public function get ProductCodeValidationFailureMessages():Array
    {
        if (model_internal::_ProductCodeValidationFailureMessages == null)
            model_internal::calculateProductCodeIsValid();

        return _ProductCodeValidationFailureMessages;
    }

    model_internal function set ProductCodeValidationFailureMessages_der(value:Array) : void
    {
        var oldValue:Array = model_internal::_ProductCodeValidationFailureMessages;
        ...
        if (needUpdate)
        {
            model_internal::_ProductCodeValidationFailureMessages = value;   
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "ProductCodeValidationFailureMessages", oldValue, value));
            // Only execute calculateIsValid if it has been called before, to update the validationFailureMessages for
            // the entire entity.
            if (model_internal::_instance.model_internal::_cacheInitialized_isValid)
            {
     ...
     */  
     override public function getPropertyValidationFailureMessages(propertyName:String):Array
     {
         switch(propertyName)
         {
            ...
            case("Family"):
            {
                return FamilyValidationFailureMessages;
            }
            ...
            case("ProductCode"):
            {
                return ProductCodeValidationFailureMessages;
            }
            case("SystemModstamp"):
            {
