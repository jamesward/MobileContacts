 ...
 * of this value object you may modify the generated sub-class of this class - Gack__c.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_Gack__c extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.Gack__c") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.Gack__c", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _Gack__cEntityMetadata;
    ...
    public function _Super_Gack__c()
    {
        _model = new _Gack__cEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _Gack__cEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _Gack__cEntityMetadata) : void
    {
        var oldValue : _Gack__cEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
