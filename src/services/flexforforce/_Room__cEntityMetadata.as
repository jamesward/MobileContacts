...
[ExcludeClass]
internal class _Room__cEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    private static var emptyArray:Array = new Array();

    model_internal static var allProperties:Array = new Array("Id", "Capacity__c", "Conference__c", "ConnectionReceivedId", "ConnectionSentId", "CreatedById", "CreatedDate", "IsDeleted", "LastModifiedById", "LastModifiedDate", "Location__c", "Name", "Room_Type__c", "SystemModstamp");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("Id", "Capacity__c", "Conference__c", "ConnectionReceivedId", "ConnectionSentId", "CreatedById", "CreatedDate", "IsDeleted", "LastModifiedById", "LastModifiedDate", "Location__c", "Name", "Room_Type__c", "SystemModstamp");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("Id", "Capacity__c", "Conference__c", "ConnectionReceivedId", "ConnectionSentId", "CreatedById", "CreatedDate", "IsDeleted", "LastModifiedById", "LastModifiedDate", "Location__c", "Name", "Room_Type__c", "SystemModstamp");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("Id", "Capacity__c", "Conference__c", "ConnectionReceivedId", "ConnectionSentId", "CreatedById", "CreatedDate", "IsDeleted", "LastModifiedById", "LastModifiedDate", "Location__c", "Name", "Room_Type__c", "SystemModstamp");
    model_internal static var derivedProperties:Array = new Array();
    model_internal static var collectionProperties:Array = new Array();
    model_internal static var collectionBaseMap:Object;
    model_internal static var entityName:String = "Room__c";
    ...
    model_internal var _Location__cIsValid:Boolean;
    model_internal var _Location__cValidator:com.adobe.fiber.styles.StyleValidator;
    model_internal var _Location__cIsValidCacheInitialized:Boolean = false;
    model_internal var _Location__cValidationFailureMessages:Array;
    ...
    model_internal var _Room_Type__cIsValid:Boolean;
    model_internal var _Room_Type__cValidator:com.adobe.fiber.styles.StyleValidator;
    model_internal var _Room_Type__cIsValidCacheInitialized:Boolean = false;
    model_internal var _Room_Type__cValidationFailureMessages:Array;
    ...
    model_internal var _instance:_Super_Room__c;
    model_internal static var _nullStyle:com.adobe.fiber.styles.Style = new com.adobe.fiber.styles.Style();

    public function _Room__cEntityMetadata(value : _Super_Room__c)
    {
        ...
        if (model_internal::dependentsOnMap == null)
        {
            ...
            model_internal::dependentsOnMap["Capacity__c"] = new Array();
            ...
            model_internal::dependentsOnMap["Location__c"] = new Array();
            model_internal::dependentsOnMap["Name"] = new Array();
            model_internal::dependentsOnMap["Room_Type__c"] = new Array();
        ...
        model_internal::_Location__cValidator = new StyleValidator(model_internal::_instance.model_internal::_doValidationForLocation__c);
        model_internal::_Location__cValidator.required = true;
        model_internal::_Location__cValidator.requiredFieldError = "Location__c is required";
        //model_internal::_Location__cValidator.source = model_internal::_instance;
        //model_internal::_Location__cValidator.property = "Location__c";
        model_internal::_NameValidator = new StyleValidator(model_internal::_instance.model_internal::_doValidationForName);
        model_internal::_NameValidator.required = true;
        model_internal::_NameValidator.requiredFieldError = "Name is required";
        //model_internal::_NameValidator.source = model_internal::_instance;
        //model_internal::_NameValidator.property = "Name";
        model_internal::_Room_Type__cValidator = new StyleValidator(model_internal::_instance.model_internal::_doValidationForRoom_Type__c);
        model_internal::_Room_Type__cValidator.required = true;
        model_internal::_Room_Type__cValidator.requiredFieldError = "Room_Type__c is required";
        //model_internal::_Room_Type__cValidator.source = model_internal::_instance;
        //model_internal::_Room_Type__cValidator.property = "Room_Type__c";
    ...
    override public function getDependants(propertyName:String):Array
    {
       if (model_internal::dataProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a data property of entity Room__c");  
    ...
    override public function getCollectionBase(propertyName:String):String
    {
        if (model_internal::collectionProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a collection property of entity Room__c");  
    ...
    override public function getValue(propertyName:String):*
    {
        ...
        {
            throw new Error(propertyName + " does not exist for entity Room__c");
        }
    ...
    [Bindable(event="propertyChange")]
    public function get isCapacity__cAvailable():Boolean
    {
        return true;
    }
    ...
    [Bindable(event="propertyChange")]
    public function get isLocation__cAvailable():Boolean
    {
        return true;
    }
    ...
    [Bindable(event="propertyChange")]
    public function get isRoom_Type__cAvailable():Boolean
    {
        return true;
    }
    ...
    public function invalidateDependentOnLocation__c():void
    {
        if (model_internal::_Location__cIsValidCacheInitialized )
        {
            model_internal::_instance.model_internal::_doValidationCacheOfLocation__c = null;
            model_internal::calculateLocation__cIsValid();
        }
    }
    ...
    public function invalidateDependentOnRoom_Type__c():void
    {
        if (model_internal::_Room_Type__cIsValidCacheInitialized )
        {
            model_internal::_instance.model_internal::_doValidationCacheOfRoom_Type__c = null;
            model_internal::calculateRoom_Type__cIsValid();
        }
    }
    ...
    [Bindable(event="propertyChange")]   
    public function get Capacity__cStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }
    ...
    [Bindable(event="propertyChange")]   
    public function get Location__cStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }

    public function get Location__cValidator() : StyleValidator
    {
        return model_internal::_Location__cValidator;
    }

    model_internal function set _Location__cIsValid_der(value:Boolean):void 
    {
        var oldValue:Boolean = model_internal::_Location__cIsValid;         
        if (oldValue !== value)
        {
            model_internal::_Location__cIsValid = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "Location__cIsValid", oldValue, value));
        }                             
    }

    [Bindable(event="propertyChange")]
    public function get Location__cIsValid():Boolean
    {
        if (!model_internal::_Location__cIsValidCacheInitialized)
        {
            model_internal::calculateLocation__cIsValid();
        ...
        return model_internal::_Location__cIsValid;
    }

    model_internal function calculateLocation__cIsValid():void
    {
        var valRes:ValidationResultEvent = model_internal::_Location__cValidator.validate(model_internal::_instance.Location__c)
        model_internal::_Location__cIsValid_der = (valRes.results == null);
        model_internal::_Location__cIsValidCacheInitialized = true;
        if (valRes.results == null)
             model_internal::Location__cValidationFailureMessages_der = emptyArray;
        else
        {
            var _valFailures:Array = new Array();
            for (var a:int = 0 ; a<valRes.results.length ; a++)
            ...
            model_internal::Location__cValidationFailureMessages_der = _valFailures;
        }
    }

    [Bindable(event="propertyChange")]
    public function get Location__cValidationFailureMessages():Array
    {
        if (model_internal::_Location__cValidationFailureMessages == null)
            model_internal::calculateLocation__cIsValid();

        return _Location__cValidationFailureMessages;
    }

    model_internal function set Location__cValidationFailureMessages_der(value:Array) : void
    {
        var oldValue:Array = model_internal::_Location__cValidationFailureMessages;
        ...
        if (needUpdate)
        {
            model_internal::_Location__cValidationFailureMessages = value;   
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "Location__cValidationFailureMessages", oldValue, value));
            // Only execute calculateIsValid if it has been called before, to update the validationFailureMessages for
            // the entire entity.
            if (model_internal::_instance.model_internal::_cacheInitialized_isValid)
            {
    ...
    [Bindable(event="propertyChange")]   
    public function get Room_Type__cStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }

    public function get Room_Type__cValidator() : StyleValidator
    {
        return model_internal::_Room_Type__cValidator;
    }

    model_internal function set _Room_Type__cIsValid_der(value:Boolean):void 
    {
        var oldValue:Boolean = model_internal::_Room_Type__cIsValid;         
        if (oldValue !== value)
        {
            model_internal::_Room_Type__cIsValid = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "Room_Type__cIsValid", oldValue, value));
        }                             
    }

    [Bindable(event="propertyChange")]
    public function get Room_Type__cIsValid():Boolean
    {
        if (!model_internal::_Room_Type__cIsValidCacheInitialized)
        {
            model_internal::calculateRoom_Type__cIsValid();
        ...
        return model_internal::_Room_Type__cIsValid;
    }

    model_internal function calculateRoom_Type__cIsValid():void
    {
        var valRes:ValidationResultEvent = model_internal::_Room_Type__cValidator.validate(model_internal::_instance.Room_Type__c)
        model_internal::_Room_Type__cIsValid_der = (valRes.results == null);
        model_internal::_Room_Type__cIsValidCacheInitialized = true;
        if (valRes.results == null)
             model_internal::Room_Type__cValidationFailureMessages_der = emptyArray;
        else
        {
            var _valFailures:Array = new Array();
            for (var a:int = 0 ; a<valRes.results.length ; a++)
            ...
            model_internal::Room_Type__cValidationFailureMessages_der = _valFailures;
        }
    }

    [Bindable(event="propertyChange")]
    public function get Room_Type__cValidationFailureMessages():Array
    {
        if (model_internal::_Room_Type__cValidationFailureMessages == null)
            model_internal::calculateRoom_Type__cIsValid();

        return _Room_Type__cValidationFailureMessages;
    }

    model_internal function set Room_Type__cValidationFailureMessages_der(value:Array) : void
    {
        var oldValue:Array = model_internal::_Room_Type__cValidationFailureMessages;
        ...
        if (needUpdate)
        {
            model_internal::_Room_Type__cValidationFailureMessages = value;   
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "Room_Type__cValidationFailureMessages", oldValue, value));
            // Only execute calculateIsValid if it has been called before, to update the validationFailureMessages for
            // the entire entity.
            if (model_internal::_instance.model_internal::_cacheInitialized_isValid)
            {
     ...
     */  
     override public function getPropertyValidationFailureMessages(propertyName:String):Array
     {
         switch(propertyName)
         {
            ...
            case("Location__c"):
            {
                return Location__cValidationFailureMessages;
            }
            case("Name"):
            {
            ...
            case("Room_Type__c"):
            {
                return Room_Type__cValidationFailureMessages;
            }
            case("SystemModstamp"):
            {
