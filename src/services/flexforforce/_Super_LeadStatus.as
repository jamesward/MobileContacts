 ...
 * of this value object you may modify the generated sub-class of this class - LeadStatus.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_LeadStatus extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.LeadStatus") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.LeadStatus", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _LeadStatusEntityMetadata;
    ...
    public function _Super_LeadStatus()
    {
        _model = new _LeadStatusEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _LeadStatusEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _LeadStatusEntityMetadata) : void
    {
        var oldValue : _LeadStatusEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
