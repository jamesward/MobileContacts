 ...
 * of this value object you may modify the generated sub-class of this class - ContactFeed.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_ContactFeed extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.ContactFeed") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.ContactFeed", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _ContactFeedEntityMetadata;
    ...
    public function _Super_ContactFeed()
    {
        _model = new _ContactFeedEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _ContactFeedEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _ContactFeedEntityMetadata) : void
    {
        var oldValue : _ContactFeedEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
