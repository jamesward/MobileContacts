...
[ExcludeClass]
internal class _CaseContactRoleEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    private static var emptyArray:Array = new Array();

    model_internal static var allProperties:Array = new Array("Id", "CasesId", "ContactId", "CreatedById", "CreatedDate", "IsDeleted", "LastModifiedById", "LastModifiedDate", "Role", "SystemModstamp");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("Id", "CasesId", "ContactId", "CreatedById", "CreatedDate", "IsDeleted", "LastModifiedById", "LastModifiedDate", "Role", "SystemModstamp");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("Id", "CasesId", "ContactId", "CreatedById", "CreatedDate", "IsDeleted", "LastModifiedById", "LastModifiedDate", "Role", "SystemModstamp");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("Id", "CasesId", "ContactId", "CreatedById", "CreatedDate", "IsDeleted", "LastModifiedById", "LastModifiedDate", "Role", "SystemModstamp");
    model_internal static var derivedProperties:Array = new Array();
    model_internal static var collectionProperties:Array = new Array();
    model_internal static var collectionBaseMap:Object;
    model_internal static var entityName:String = "CaseContactRole";
    model_internal static var dependentsOnMap:Object;
    model_internal static var dependedOnServices:Array = new Array();

    
    model_internal var _CasesIdIsValid:Boolean;
    model_internal var _CasesIdValidator:com.adobe.fiber.styles.StyleValidator;
    model_internal var _CasesIdIsValidCacheInitialized:Boolean = false;
    model_internal var _CasesIdValidationFailureMessages:Array;
    ...
    model_internal var _instance:_Super_CaseContactRole;
    model_internal static var _nullStyle:com.adobe.fiber.styles.Style = new com.adobe.fiber.styles.Style();

    public function _CaseContactRoleEntityMetadata(value : _Super_CaseContactRole)
    {
        ...
        if (model_internal::dependentsOnMap == null)
        {
            ...
            model_internal::dependentsOnMap["CasesId"] = new Array();
        ...
        model_internal::_CasesIdValidator = new StyleValidator(model_internal::_instance.model_internal::_doValidationForCasesId);
        model_internal::_CasesIdValidator.required = true;
        model_internal::_CasesIdValidator.requiredFieldError = "CasesId is required";
        //model_internal::_CasesIdValidator.source = model_internal::_instance;
        //model_internal::_CasesIdValidator.property = "CasesId";
    ...
    override public function getDependants(propertyName:String):Array
    {
       if (model_internal::dataProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a data property of entity CaseContactRole");  
    ...
    override public function getCollectionBase(propertyName:String):String
    {
        if (model_internal::collectionProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a collection property of entity CaseContactRole");  
    ...
    override public function getValue(propertyName:String):*
    {
        ...
        {
            throw new Error(propertyName + " does not exist for entity CaseContactRole");
        }
    ...
    [Bindable(event="propertyChange")]
    public function get isCasesIdAvailable():Boolean
    {
        return true;
    }
     ...
     */
    public function invalidateDependentOnCasesId():void
    {
        if (model_internal::_CasesIdIsValidCacheInitialized )
        {
            model_internal::_instance.model_internal::_doValidationCacheOfCasesId = null;
            model_internal::calculateCasesIdIsValid();
        }
    }
    ...
    [Bindable(event="propertyChange")]   
    public function get CasesIdStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }

    public function get CasesIdValidator() : StyleValidator
    {
        return model_internal::_CasesIdValidator;
    }

    model_internal function set _CasesIdIsValid_der(value:Boolean):void 
    {
        var oldValue:Boolean = model_internal::_CasesIdIsValid;         
        if (oldValue !== value)
        {
            model_internal::_CasesIdIsValid = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "CasesIdIsValid", oldValue, value));
        }                             
    }

    [Bindable(event="propertyChange")]
    public function get CasesIdIsValid():Boolean
    {
        if (!model_internal::_CasesIdIsValidCacheInitialized)
        {
            model_internal::calculateCasesIdIsValid();
        ...
        return model_internal::_CasesIdIsValid;
    }

    model_internal function calculateCasesIdIsValid():void
    {
        var valRes:ValidationResultEvent = model_internal::_CasesIdValidator.validate(model_internal::_instance.CasesId)
        model_internal::_CasesIdIsValid_der = (valRes.results == null);
        model_internal::_CasesIdIsValidCacheInitialized = true;
        if (valRes.results == null)
             model_internal::CasesIdValidationFailureMessages_der = emptyArray;
        else
        {
            ...
            model_internal::CasesIdValidationFailureMessages_der = _valFailures;
        }
    }

    [Bindable(event="propertyChange")]
    public function get CasesIdValidationFailureMessages():Array
    {
        if (model_internal::_CasesIdValidationFailureMessages == null)
            model_internal::calculateCasesIdIsValid();

        return _CasesIdValidationFailureMessages;
    }

    model_internal function set CasesIdValidationFailureMessages_der(value:Array) : void
    {
        var oldValue:Array = model_internal::_CasesIdValidationFailureMessages;
        ...
        if (needUpdate)
        {
            model_internal::_CasesIdValidationFailureMessages = value;   
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "CasesIdValidationFailureMessages", oldValue, value));
     ...
     */  
     override public function getPropertyValidationFailureMessages(propertyName:String):Array
     {
         switch(propertyName)
         {
            case("CasesId"):
            {
                return CasesIdValidationFailureMessages;
            }
            case("ContactId"):
            {
