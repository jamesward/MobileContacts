...
[ExcludeClass]
internal class _CategoryNodeEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    private static var emptyArray:Array = new Array();

    model_internal static var allProperties:Array = new Array("Id", "CreatedById", "CreatedDate", "LastModifiedById", "LastModifiedDate", "MasterLabel", "ParentId", "SortOrder", "SortStyle", "SystemModstamp");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("Id", "CreatedById", "CreatedDate", "LastModifiedById", "LastModifiedDate", "MasterLabel", "ParentId", "SortOrder", "SortStyle", "SystemModstamp");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("Id", "CreatedById", "CreatedDate", "LastModifiedById", "LastModifiedDate", "MasterLabel", "ParentId", "SortOrder", "SortStyle", "SystemModstamp");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("Id", "CreatedById", "CreatedDate", "LastModifiedById", "LastModifiedDate", "MasterLabel", "ParentId", "SortOrder", "SortStyle", "SystemModstamp");
    model_internal static var derivedProperties:Array = new Array();
    model_internal static var collectionProperties:Array = new Array();
    model_internal static var collectionBaseMap:Object;
    model_internal static var entityName:String = "CategoryNode";
    ...
    model_internal var _SortStyleIsValid:Boolean;
    model_internal var _SortStyleValidator:com.adobe.fiber.styles.StyleValidator;
    model_internal var _SortStyleIsValidCacheInitialized:Boolean = false;
    model_internal var _SortStyleValidationFailureMessages:Array;
    ...
    model_internal var _instance:_Super_CategoryNode;
    model_internal static var _nullStyle:com.adobe.fiber.styles.Style = new com.adobe.fiber.styles.Style();

    public function _CategoryNodeEntityMetadata(value : _Super_CategoryNode)
    {
        ...
        if (model_internal::dependentsOnMap == null)
        {
            ...
            model_internal::dependentsOnMap["SortStyle"] = new Array();
        ...
        model_internal::_SortStyleValidator = new StyleValidator(model_internal::_instance.model_internal::_doValidationForSortStyle);
        model_internal::_SortStyleValidator.required = true;
        model_internal::_SortStyleValidator.requiredFieldError = "SortStyle is required";
        //model_internal::_SortStyleValidator.source = model_internal::_instance;
        //model_internal::_SortStyleValidator.property = "SortStyle";
    ...
    override public function getDependants(propertyName:String):Array
    {
       if (model_internal::dataProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a data property of entity CategoryNode");  
    ...
    override public function getCollectionBase(propertyName:String):String
    {
        if (model_internal::collectionProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a collection property of entity CategoryNode");  
    ...
    override public function getValue(propertyName:String):*
    {
        ...
        {
            throw new Error(propertyName + " does not exist for entity CategoryNode");
        }
    ...
    [Bindable(event="propertyChange")]
    public function get isSortStyleAvailable():Boolean
    {
        return true;
    }
    ...
    public function invalidateDependentOnSortStyle():void
    {
        if (model_internal::_SortStyleIsValidCacheInitialized )
        {
            model_internal::_instance.model_internal::_doValidationCacheOfSortStyle = null;
            model_internal::calculateSortStyleIsValid();
        }
    }
    ...
    [Bindable(event="propertyChange")]   
    public function get SortStyleStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }

    public function get SortStyleValidator() : StyleValidator
    {
        return model_internal::_SortStyleValidator;
    }

    model_internal function set _SortStyleIsValid_der(value:Boolean):void 
    {
        var oldValue:Boolean = model_internal::_SortStyleIsValid;         
        if (oldValue !== value)
        {
            model_internal::_SortStyleIsValid = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "SortStyleIsValid", oldValue, value));
        }                             
    }

    [Bindable(event="propertyChange")]
    public function get SortStyleIsValid():Boolean
    {
        if (!model_internal::_SortStyleIsValidCacheInitialized)
        {
            model_internal::calculateSortStyleIsValid();
        ...
        return model_internal::_SortStyleIsValid;
    }

    model_internal function calculateSortStyleIsValid():void
    {
        var valRes:ValidationResultEvent = model_internal::_SortStyleValidator.validate(model_internal::_instance.SortStyle)
        model_internal::_SortStyleIsValid_der = (valRes.results == null);
        model_internal::_SortStyleIsValidCacheInitialized = true;
        if (valRes.results == null)
             model_internal::SortStyleValidationFailureMessages_der = emptyArray;
        else
        {
            var _valFailures:Array = new Array();
            for (var a:int = 0 ; a<valRes.results.length ; a++)
            ...
            model_internal::SortStyleValidationFailureMessages_der = _valFailures;
        }
    }

    [Bindable(event="propertyChange")]
    public function get SortStyleValidationFailureMessages():Array
    {
        if (model_internal::_SortStyleValidationFailureMessages == null)
            model_internal::calculateSortStyleIsValid();

        return _SortStyleValidationFailureMessages;
    }

    model_internal function set SortStyleValidationFailureMessages_der(value:Array) : void
    {
        var oldValue:Array = model_internal::_SortStyleValidationFailureMessages;
        ...
        if (needUpdate)
        {
            model_internal::_SortStyleValidationFailureMessages = value;   
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "SortStyleValidationFailureMessages", oldValue, value));
            // Only execute calculateIsValid if it has been called before, to update the validationFailureMessages for
            // the entire entity.
            if (model_internal::_instance.model_internal::_cacheInitialized_isValid)
            {
     ...
     */  
     override public function getPropertyValidationFailureMessages(propertyName:String):Array
     {
         switch(propertyName)
         {
            ...
            case("SortStyle"):
            {
                return SortStyleValidationFailureMessages;
            }
            case("SystemModstamp"):
            {
