...
[ExcludeClass]
internal class _CaseTeamRoleEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    private static var emptyArray:Array = new Array();

    model_internal static var allProperties:Array = new Array("Id", "AccessLevel", "CreatedById", "CreatedDate", "LastModifiedById", "LastModifiedDate", "Name", "PreferencesVisibleInCSP", "SystemModstamp");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("Id", "AccessLevel", "CreatedById", "CreatedDate", "LastModifiedById", "LastModifiedDate", "Name", "PreferencesVisibleInCSP", "SystemModstamp");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("Id", "AccessLevel", "CreatedById", "CreatedDate", "LastModifiedById", "LastModifiedDate", "Name", "PreferencesVisibleInCSP", "SystemModstamp");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("Id", "AccessLevel", "CreatedById", "CreatedDate", "LastModifiedById", "LastModifiedDate", "Name", "PreferencesVisibleInCSP", "SystemModstamp");
    model_internal static var derivedProperties:Array = new Array();
    model_internal static var collectionProperties:Array = new Array();
    model_internal static var collectionBaseMap:Object;
    model_internal static var entityName:String = "CaseTeamRole";
    model_internal static var dependentsOnMap:Object;
    model_internal static var dependedOnServices:Array = new Array();

    
    model_internal var _AccessLevelIsValid:Boolean;
    model_internal var _AccessLevelValidator:com.adobe.fiber.styles.StyleValidator;
    model_internal var _AccessLevelIsValidCacheInitialized:Boolean = false;
    model_internal var _AccessLevelValidationFailureMessages:Array;
    ...
    model_internal var _instance:_Super_CaseTeamRole;
    model_internal static var _nullStyle:com.adobe.fiber.styles.Style = new com.adobe.fiber.styles.Style();

    public function _CaseTeamRoleEntityMetadata(value : _Super_CaseTeamRole)
    {
        ...
        if (model_internal::dependentsOnMap == null)
        {
            ...
            model_internal::dependentsOnMap["AccessLevel"] = new Array();
            ...
            model_internal::dependentsOnMap["PreferencesVisibleInCSP"] = new Array();
        ...
        model_internal::_AccessLevelValidator = new StyleValidator(model_internal::_instance.model_internal::_doValidationForAccessLevel);
        model_internal::_AccessLevelValidator.required = true;
        model_internal::_AccessLevelValidator.requiredFieldError = "AccessLevel is required";
        //model_internal::_AccessLevelValidator.source = model_internal::_instance;
        //model_internal::_AccessLevelValidator.property = "AccessLevel";
    ...
    override public function getDependants(propertyName:String):Array
    {
       if (model_internal::dataProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a data property of entity CaseTeamRole");  
    ...
    override public function getCollectionBase(propertyName:String):String
    {
        if (model_internal::collectionProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a collection property of entity CaseTeamRole");  
    ...
    override public function getValue(propertyName:String):*
    {
        ...
        {
            throw new Error(propertyName + " does not exist for entity CaseTeamRole");
        }
    ...
    [Bindable(event="propertyChange")]
    public function get isAccessLevelAvailable():Boolean
    {
        return true;
    }
    ...
    [Bindable(event="propertyChange")]
    public function get isPreferencesVisibleInCSPAvailable():Boolean
    {
        return true;
    }
     ...
     */
    public function invalidateDependentOnAccessLevel():void
    {
        if (model_internal::_AccessLevelIsValidCacheInitialized )
        {
            model_internal::_instance.model_internal::_doValidationCacheOfAccessLevel = null;
            model_internal::calculateAccessLevelIsValid();
        }
    }
    ...
    [Bindable(event="propertyChange")]   
    public function get AccessLevelStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }

    public function get AccessLevelValidator() : StyleValidator
    {
        return model_internal::_AccessLevelValidator;
    }

    model_internal function set _AccessLevelIsValid_der(value:Boolean):void 
    {
        var oldValue:Boolean = model_internal::_AccessLevelIsValid;         
        if (oldValue !== value)
        {
            model_internal::_AccessLevelIsValid = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "AccessLevelIsValid", oldValue, value));
        }                             
    }

    [Bindable(event="propertyChange")]
    public function get AccessLevelIsValid():Boolean
    {
        if (!model_internal::_AccessLevelIsValidCacheInitialized)
        {
            model_internal::calculateAccessLevelIsValid();
        ...
        return model_internal::_AccessLevelIsValid;
    }

    model_internal function calculateAccessLevelIsValid():void
    {
        var valRes:ValidationResultEvent = model_internal::_AccessLevelValidator.validate(model_internal::_instance.AccessLevel)
        model_internal::_AccessLevelIsValid_der = (valRes.results == null);
        model_internal::_AccessLevelIsValidCacheInitialized = true;
        if (valRes.results == null)
             model_internal::AccessLevelValidationFailureMessages_der = emptyArray;
        else
        {
            ...
            model_internal::AccessLevelValidationFailureMessages_der = _valFailures;
        }
    }

    [Bindable(event="propertyChange")]
    public function get AccessLevelValidationFailureMessages():Array
    {
        if (model_internal::_AccessLevelValidationFailureMessages == null)
            model_internal::calculateAccessLevelIsValid();

        return _AccessLevelValidationFailureMessages;
    }

    model_internal function set AccessLevelValidationFailureMessages_der(value:Array) : void
    {
        var oldValue:Array = model_internal::_AccessLevelValidationFailureMessages;
        ...
        if (needUpdate)
        {
            model_internal::_AccessLevelValidationFailureMessages = value;   
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "AccessLevelValidationFailureMessages", oldValue, value));
    ...
    [Bindable(event="propertyChange")]   
    public function get PreferencesVisibleInCSPStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }
     ...
     */  
     override public function getPropertyValidationFailureMessages(propertyName:String):Array
     {
         switch(propertyName)
         {
            case("AccessLevel"):
            {
                return AccessLevelValidationFailureMessages;
            }
            case("CreatedById"):
            {
