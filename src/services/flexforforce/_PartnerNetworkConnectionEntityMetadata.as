...
[ExcludeClass]
internal class _PartnerNetworkConnectionEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    private static var emptyArray:Array = new Array();

    model_internal static var allProperties:Array = new Array("Id", "AccountId", "ConnectionName", "ConnectionStatus", "ContactId", "CreatedById", "CreatedDate", "LastModifiedById", "LastModifiedDate", "PartnerNetworkTemplateId", "PrimaryContactId", "ResponseDate");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("Id", "AccountId", "ConnectionName", "ConnectionStatus", "ContactId", "CreatedById", "CreatedDate", "LastModifiedById", "LastModifiedDate", "PartnerNetworkTemplateId", "PrimaryContactId", "ResponseDate");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("Id", "AccountId", "ConnectionName", "ConnectionStatus", "ContactId", "CreatedById", "CreatedDate", "LastModifiedById", "LastModifiedDate", "PartnerNetworkTemplateId", "PrimaryContactId", "ResponseDate");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("Id", "AccountId", "ConnectionName", "ConnectionStatus", "ContactId", "CreatedById", "CreatedDate", "LastModifiedById", "LastModifiedDate", "PartnerNetworkTemplateId", "PrimaryContactId", "ResponseDate");
    model_internal static var derivedProperties:Array = new Array();
    model_internal static var collectionProperties:Array = new Array();
    model_internal static var collectionBaseMap:Object;
    model_internal static var entityName:String = "PartnerNetworkConnection";
    ...
    model_internal var _ConnectionNameIsValid:Boolean;
    model_internal var _ConnectionNameValidator:com.adobe.fiber.styles.StyleValidator;
    model_internal var _ConnectionNameIsValidCacheInitialized:Boolean = false;
    model_internal var _ConnectionNameValidationFailureMessages:Array;
    
    model_internal var _ConnectionStatusIsValid:Boolean;
    model_internal var _ConnectionStatusValidator:com.adobe.fiber.styles.StyleValidator;
    model_internal var _ConnectionStatusIsValidCacheInitialized:Boolean = false;
    model_internal var _ConnectionStatusValidationFailureMessages:Array;
    ...
    model_internal var _PartnerNetworkTemplateIdIsValid:Boolean;
    model_internal var _PartnerNetworkTemplateIdValidator:com.adobe.fiber.styles.StyleValidator;
    model_internal var _PartnerNetworkTemplateIdIsValidCacheInitialized:Boolean = false;
    model_internal var _PartnerNetworkTemplateIdValidationFailureMessages:Array;
    
    model_internal var _PrimaryContactIdIsValid:Boolean;
    model_internal var _PrimaryContactIdValidator:com.adobe.fiber.styles.StyleValidator;
    model_internal var _PrimaryContactIdIsValidCacheInitialized:Boolean = false;
    model_internal var _PrimaryContactIdValidationFailureMessages:Array;
    
    model_internal var _ResponseDateIsValid:Boolean;
    model_internal var _ResponseDateValidator:com.adobe.fiber.styles.StyleValidator;
    model_internal var _ResponseDateIsValidCacheInitialized:Boolean = false;
    model_internal var _ResponseDateValidationFailureMessages:Array;

    model_internal var _instance:_Super_PartnerNetworkConnection;
    model_internal static var _nullStyle:com.adobe.fiber.styles.Style = new com.adobe.fiber.styles.Style();

    public function _PartnerNetworkConnectionEntityMetadata(value : _Super_PartnerNetworkConnection)
    {
        ...
        if (model_internal::dependentsOnMap == null)
        {
            ...
            model_internal::dependentsOnMap["ConnectionName"] = new Array();
            model_internal::dependentsOnMap["ConnectionStatus"] = new Array();
            ...
            model_internal::dependentsOnMap["PartnerNetworkTemplateId"] = new Array();
            model_internal::dependentsOnMap["PrimaryContactId"] = new Array();
            model_internal::dependentsOnMap["ResponseDate"] = new Array();
        ...
        model_internal::_ConnectionNameValidator = new StyleValidator(model_internal::_instance.model_internal::_doValidationForConnectionName);
        model_internal::_ConnectionNameValidator.required = true;
        model_internal::_ConnectionNameValidator.requiredFieldError = "ConnectionName is required";
        //model_internal::_ConnectionNameValidator.source = model_internal::_instance;
        //model_internal::_ConnectionNameValidator.property = "ConnectionName";
        model_internal::_ConnectionStatusValidator = new StyleValidator(model_internal::_instance.model_internal::_doValidationForConnectionStatus);
        model_internal::_ConnectionStatusValidator.required = true;
        model_internal::_ConnectionStatusValidator.requiredFieldError = "ConnectionStatus is required";
        //model_internal::_ConnectionStatusValidator.source = model_internal::_instance;
        //model_internal::_ConnectionStatusValidator.property = "ConnectionStatus";
        ...
        model_internal::_PartnerNetworkTemplateIdValidator = new StyleValidator(model_internal::_instance.model_internal::_doValidationForPartnerNetworkTemplateId);
        model_internal::_PartnerNetworkTemplateIdValidator.required = true;
        model_internal::_PartnerNetworkTemplateIdValidator.requiredFieldError = "PartnerNetworkTemplateId is required";
        //model_internal::_PartnerNetworkTemplateIdValidator.source = model_internal::_instance;
        //model_internal::_PartnerNetworkTemplateIdValidator.property = "PartnerNetworkTemplateId";
        model_internal::_PrimaryContactIdValidator = new StyleValidator(model_internal::_instance.model_internal::_doValidationForPrimaryContactId);
        model_internal::_PrimaryContactIdValidator.required = true;
        model_internal::_PrimaryContactIdValidator.requiredFieldError = "PrimaryContactId is required";
        //model_internal::_PrimaryContactIdValidator.source = model_internal::_instance;
        //model_internal::_PrimaryContactIdValidator.property = "PrimaryContactId";
        model_internal::_ResponseDateValidator = new StyleValidator(model_internal::_instance.model_internal::_doValidationForResponseDate);
        model_internal::_ResponseDateValidator.required = true;
        model_internal::_ResponseDateValidator.requiredFieldError = "ResponseDate is required";
        //model_internal::_ResponseDateValidator.source = model_internal::_instance;
        //model_internal::_ResponseDateValidator.property = "ResponseDate";
    }
    ...
    override public function getDependants(propertyName:String):Array
    {
       if (model_internal::dataProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a data property of entity PartnerNetworkConnection");  
    ...
    override public function getCollectionBase(propertyName:String):String
    {
        if (model_internal::collectionProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a collection property of entity PartnerNetworkConnection");  
    ...
    override public function getValue(propertyName:String):*
    {
        ...
        {
            throw new Error(propertyName + " does not exist for entity PartnerNetworkConnection");
        }
    ...
    [Bindable(event="propertyChange")]
    public function get isConnectionNameAvailable():Boolean
    {
        return true;
    }

    [Bindable(event="propertyChange")]
    public function get isConnectionStatusAvailable():Boolean
    {
        return true;
    }
    ...
    [Bindable(event="propertyChange")]
    public function get isPartnerNetworkTemplateIdAvailable():Boolean
    {
        return true;
    }

    [Bindable(event="propertyChange")]
    public function get isPrimaryContactIdAvailable():Boolean
    {
        return true;
    }

    [Bindable(event="propertyChange")]
    public function get isResponseDateAvailable():Boolean
    {
        return true;
    }
    ...
    public function invalidateDependentOnConnectionName():void
    {
        if (model_internal::_ConnectionNameIsValidCacheInitialized )
        {
            model_internal::_instance.model_internal::_doValidationCacheOfConnectionName = null;
            model_internal::calculateConnectionNameIsValid();
        }
    }
    public function invalidateDependentOnConnectionStatus():void
    {
        if (model_internal::_ConnectionStatusIsValidCacheInitialized )
        {
            model_internal::_instance.model_internal::_doValidationCacheOfConnectionStatus = null;
            model_internal::calculateConnectionStatusIsValid();
        }
    }
    ...
    public function invalidateDependentOnPartnerNetworkTemplateId():void
    {
        if (model_internal::_PartnerNetworkTemplateIdIsValidCacheInitialized )
        {
            model_internal::_instance.model_internal::_doValidationCacheOfPartnerNetworkTemplateId = null;
            model_internal::calculatePartnerNetworkTemplateIdIsValid();
        }
    }
    public function invalidateDependentOnPrimaryContactId():void
    {
        if (model_internal::_PrimaryContactIdIsValidCacheInitialized )
        {
            model_internal::_instance.model_internal::_doValidationCacheOfPrimaryContactId = null;
            model_internal::calculatePrimaryContactIdIsValid();
        }
    }
    public function invalidateDependentOnResponseDate():void
    {
        if (model_internal::_ResponseDateIsValidCacheInitialized )
        {
            model_internal::_instance.model_internal::_doValidationCacheOfResponseDate = null;
            model_internal::calculateResponseDateIsValid();
        }
    }
    ...
    [Bindable(event="propertyChange")]   
    public function get ConnectionNameStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }

    public function get ConnectionNameValidator() : StyleValidator
    {
        return model_internal::_ConnectionNameValidator;
    }

    model_internal function set _ConnectionNameIsValid_der(value:Boolean):void 
    {
        var oldValue:Boolean = model_internal::_ConnectionNameIsValid;         
        if (oldValue !== value)
        {
            model_internal::_ConnectionNameIsValid = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "ConnectionNameIsValid", oldValue, value));
        }                             
    }

    [Bindable(event="propertyChange")]
    public function get ConnectionNameIsValid():Boolean
    {
        if (!model_internal::_ConnectionNameIsValidCacheInitialized)
        {
            model_internal::calculateConnectionNameIsValid();
        ...
        return model_internal::_ConnectionNameIsValid;
    }

    model_internal function calculateConnectionNameIsValid():void
    {
        var valRes:ValidationResultEvent = model_internal::_ConnectionNameValidator.validate(model_internal::_instance.ConnectionName)
        model_internal::_ConnectionNameIsValid_der = (valRes.results == null);
        model_internal::_ConnectionNameIsValidCacheInitialized = true;
        if (valRes.results == null)
             model_internal::ConnectionNameValidationFailureMessages_der = emptyArray;
        else
        {
            var _valFailures:Array = new Array();
            for (var a:int = 0 ; a<valRes.results.length ; a++)
            ...
            model_internal::ConnectionNameValidationFailureMessages_der = _valFailures;
        }
    }

    [Bindable(event="propertyChange")]
    public function get ConnectionNameValidationFailureMessages():Array
    {
        if (model_internal::_ConnectionNameValidationFailureMessages == null)
            model_internal::calculateConnectionNameIsValid();

        return _ConnectionNameValidationFailureMessages;
    }

    model_internal function set ConnectionNameValidationFailureMessages_der(value:Array) : void
    {
        var oldValue:Array = model_internal::_ConnectionNameValidationFailureMessages;
        ...
        if (needUpdate)
        {
            model_internal::_ConnectionNameValidationFailureMessages = value;   
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "ConnectionNameValidationFailureMessages", oldValue, value));
            // Only execute calculateIsValid if it has been called before, to update the validationFailureMessages for
            // the entire entity.
            if (model_internal::_instance.model_internal::_cacheInitialized_isValid)
            {
    ...
    [Bindable(event="propertyChange")]   
    public function get ConnectionStatusStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }

    public function get ConnectionStatusValidator() : StyleValidator
    {
        return model_internal::_ConnectionStatusValidator;
    }

    model_internal function set _ConnectionStatusIsValid_der(value:Boolean):void 
    {
        var oldValue:Boolean = model_internal::_ConnectionStatusIsValid;         
        if (oldValue !== value)
        {
            model_internal::_ConnectionStatusIsValid = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "ConnectionStatusIsValid", oldValue, value));
        }                             
    }

    [Bindable(event="propertyChange")]
    public function get ConnectionStatusIsValid():Boolean
    {
        if (!model_internal::_ConnectionStatusIsValidCacheInitialized)
        {
            model_internal::calculateConnectionStatusIsValid();
        ...
        return model_internal::_ConnectionStatusIsValid;
    }

    model_internal function calculateConnectionStatusIsValid():void
    {
        var valRes:ValidationResultEvent = model_internal::_ConnectionStatusValidator.validate(model_internal::_instance.ConnectionStatus)
        model_internal::_ConnectionStatusIsValid_der = (valRes.results == null);
        model_internal::_ConnectionStatusIsValidCacheInitialized = true;
        if (valRes.results == null)
             model_internal::ConnectionStatusValidationFailureMessages_der = emptyArray;
        else
        {
            var _valFailures:Array = new Array();
            for (var a:int = 0 ; a<valRes.results.length ; a++)
            ...
            model_internal::ConnectionStatusValidationFailureMessages_der = _valFailures;
        }
    }

    [Bindable(event="propertyChange")]
    public function get ConnectionStatusValidationFailureMessages():Array
    {
        if (model_internal::_ConnectionStatusValidationFailureMessages == null)
            model_internal::calculateConnectionStatusIsValid();

        return _ConnectionStatusValidationFailureMessages;
    }

    model_internal function set ConnectionStatusValidationFailureMessages_der(value:Array) : void
    {
        var oldValue:Array = model_internal::_ConnectionStatusValidationFailureMessages;
        ...
        if (needUpdate)
        {
            model_internal::_ConnectionStatusValidationFailureMessages = value;   
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "ConnectionStatusValidationFailureMessages", oldValue, value));
            // Only execute calculateIsValid if it has been called before, to update the validationFailureMessages for
            // the entire entity.
            if (model_internal::_instance.model_internal::_cacheInitialized_isValid)
            {
    ...
    [Bindable(event="propertyChange")]   
    public function get PartnerNetworkTemplateIdStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }

    public function get PartnerNetworkTemplateIdValidator() : StyleValidator
    {
        return model_internal::_PartnerNetworkTemplateIdValidator;
    }

    model_internal function set _PartnerNetworkTemplateIdIsValid_der(value:Boolean):void 
    {
        var oldValue:Boolean = model_internal::_PartnerNetworkTemplateIdIsValid;         
        if (oldValue !== value)
        {
            model_internal::_PartnerNetworkTemplateIdIsValid = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "PartnerNetworkTemplateIdIsValid", oldValue, value));
        }                             
    }

    [Bindable(event="propertyChange")]
    public function get PartnerNetworkTemplateIdIsValid():Boolean
    {
        if (!model_internal::_PartnerNetworkTemplateIdIsValidCacheInitialized)
        {
            model_internal::calculatePartnerNetworkTemplateIdIsValid();
        ...
        return model_internal::_PartnerNetworkTemplateIdIsValid;
    }

    model_internal function calculatePartnerNetworkTemplateIdIsValid():void
    {
        var valRes:ValidationResultEvent = model_internal::_PartnerNetworkTemplateIdValidator.validate(model_internal::_instance.PartnerNetworkTemplateId)
        model_internal::_PartnerNetworkTemplateIdIsValid_der = (valRes.results == null);
        model_internal::_PartnerNetworkTemplateIdIsValidCacheInitialized = true;
        if (valRes.results == null)
             model_internal::PartnerNetworkTemplateIdValidationFailureMessages_der = emptyArray;
        else
        {
            var _valFailures:Array = new Array();
            for (var a:int = 0 ; a<valRes.results.length ; a++)
            ...
            model_internal::PartnerNetworkTemplateIdValidationFailureMessages_der = _valFailures;
        }
    }

    [Bindable(event="propertyChange")]
    public function get PartnerNetworkTemplateIdValidationFailureMessages():Array
    {
        if (model_internal::_PartnerNetworkTemplateIdValidationFailureMessages == null)
            model_internal::calculatePartnerNetworkTemplateIdIsValid();

        return _PartnerNetworkTemplateIdValidationFailureMessages;
    }

    model_internal function set PartnerNetworkTemplateIdValidationFailureMessages_der(value:Array) : void
    {
        var oldValue:Array = model_internal::_PartnerNetworkTemplateIdValidationFailureMessages;
        ...
        if (needUpdate)
        {
            model_internal::_PartnerNetworkTemplateIdValidationFailureMessages = value;   
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "PartnerNetworkTemplateIdValidationFailureMessages", oldValue, value));
            // Only execute calculateIsValid if it has been called before, to update the validationFailureMessages for
            // the entire entity.
            if (model_internal::_instance.model_internal::_cacheInitialized_isValid)
            {
    ...
    [Bindable(event="propertyChange")]   
    public function get PrimaryContactIdStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }

    public function get PrimaryContactIdValidator() : StyleValidator
    {
        return model_internal::_PrimaryContactIdValidator;
    }

    model_internal function set _PrimaryContactIdIsValid_der(value:Boolean):void 
    {
        var oldValue:Boolean = model_internal::_PrimaryContactIdIsValid;         
        if (oldValue !== value)
        {
            model_internal::_PrimaryContactIdIsValid = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "PrimaryContactIdIsValid", oldValue, value));
        }                             
    }

    [Bindable(event="propertyChange")]
    public function get PrimaryContactIdIsValid():Boolean
    {
        if (!model_internal::_PrimaryContactIdIsValidCacheInitialized)
        {
            model_internal::calculatePrimaryContactIdIsValid();
        ...
        return model_internal::_PrimaryContactIdIsValid;
    }

    model_internal function calculatePrimaryContactIdIsValid():void
    {
        var valRes:ValidationResultEvent = model_internal::_PrimaryContactIdValidator.validate(model_internal::_instance.PrimaryContactId)
        model_internal::_PrimaryContactIdIsValid_der = (valRes.results == null);
        model_internal::_PrimaryContactIdIsValidCacheInitialized = true;
        if (valRes.results == null)
             model_internal::PrimaryContactIdValidationFailureMessages_der = emptyArray;
        else
        {
            var _valFailures:Array = new Array();
            for (var a:int = 0 ; a<valRes.results.length ; a++)
            ...
            model_internal::PrimaryContactIdValidationFailureMessages_der = _valFailures;
        }
    }

    [Bindable(event="propertyChange")]
    public function get PrimaryContactIdValidationFailureMessages():Array
    {
        if (model_internal::_PrimaryContactIdValidationFailureMessages == null)
            model_internal::calculatePrimaryContactIdIsValid();

        return _PrimaryContactIdValidationFailureMessages;
    }

    model_internal function set PrimaryContactIdValidationFailureMessages_der(value:Array) : void
    {
        var oldValue:Array = model_internal::_PrimaryContactIdValidationFailureMessages;
        ...
        if (needUpdate)
        {
            model_internal::_PrimaryContactIdValidationFailureMessages = value;   
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "PrimaryContactIdValidationFailureMessages", oldValue, value));
            // Only execute calculateIsValid if it has been called before, to update the validationFailureMessages for
            // the entire entity.
            if (model_internal::_instance.model_internal::_cacheInitialized_isValid)
            {
    ...
    [Bindable(event="propertyChange")]   
    public function get ResponseDateStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }

    public function get ResponseDateValidator() : StyleValidator
    {
        return model_internal::_ResponseDateValidator;
    }

    model_internal function set _ResponseDateIsValid_der(value:Boolean):void 
    {
        var oldValue:Boolean = model_internal::_ResponseDateIsValid;         
        if (oldValue !== value)
        {
            model_internal::_ResponseDateIsValid = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "ResponseDateIsValid", oldValue, value));
        }                             
    }

    [Bindable(event="propertyChange")]
    public function get ResponseDateIsValid():Boolean
    {
        if (!model_internal::_ResponseDateIsValidCacheInitialized)
        {
            model_internal::calculateResponseDateIsValid();
        ...
        return model_internal::_ResponseDateIsValid;
    }

    model_internal function calculateResponseDateIsValid():void
    {
        var valRes:ValidationResultEvent = model_internal::_ResponseDateValidator.validate(model_internal::_instance.ResponseDate)
        model_internal::_ResponseDateIsValid_der = (valRes.results == null);
        model_internal::_ResponseDateIsValidCacheInitialized = true;
        if (valRes.results == null)
             model_internal::ResponseDateValidationFailureMessages_der = emptyArray;
        else
        {
            var _valFailures:Array = new Array();
            for (var a:int = 0 ; a<valRes.results.length ; a++)
            ...
            model_internal::ResponseDateValidationFailureMessages_der = _valFailures;
        }
    }

    [Bindable(event="propertyChange")]
    public function get ResponseDateValidationFailureMessages():Array
    {
        if (model_internal::_ResponseDateValidationFailureMessages == null)
            model_internal::calculateResponseDateIsValid();

        return _ResponseDateValidationFailureMessages;
    }

    model_internal function set ResponseDateValidationFailureMessages_der(value:Array) : void
    {
        var oldValue:Array = model_internal::_ResponseDateValidationFailureMessages;
        ...
        if (needUpdate)
        {
            model_internal::_ResponseDateValidationFailureMessages = value;   
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "ResponseDateValidationFailureMessages", oldValue, value));
            // Only execute calculateIsValid if it has been called before, to update the validationFailureMessages for
            // the entire entity.
            if (model_internal::_instance.model_internal::_cacheInitialized_isValid)
            {
     ...
     */  
     override public function getPropertyValidationFailureMessages(propertyName:String):Array
     {
         switch(propertyName)
         {
            ...
            case("ConnectionName"):
            {
                return ConnectionNameValidationFailureMessages;
            }
            case("ConnectionStatus"):
            {
                return ConnectionStatusValidationFailureMessages;
            }
            case("ContactId"):
            {
            ...
            case("PartnerNetworkTemplateId"):
            {
                return PartnerNetworkTemplateIdValidationFailureMessages;
            }
            case("PrimaryContactId"):
            {
                return PrimaryContactIdValidationFailureMessages;
            }
            case("ResponseDate"):
            {
                return ResponseDateValidationFailureMessages;
            }
            default:
            {
                return emptyArray;
