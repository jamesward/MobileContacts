 ...
 * of this value object you may modify the generated sub-class of this class - Holiday.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_Holiday extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.Holiday") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.Holiday", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _HolidayEntityMetadata;
    ...
    private var _internal_EndTimeInMinutes : int;
    private var _internal_IsAllDay : Boolean;
    ...
    private var _internal_RecurrenceStartDate : Date;
    private var _internal_RecurrenceType : String;
    private var _internal_StartTimeInMinutes : int;
    ...
    public function _Super_Holiday()
    {
        _model = new _HolidayEntityMetadata(this);
        ...
        model_internal::_changeWatcherArray.push(mx.binding.utils.ChangeWatcher.watch(this, "RecurrenceStartDate", model_internal::setterListenerRecurrenceStartDate));
    ...
    {
        return _internal_EndTimeInMinutes;
    }

    [Bindable(event="propertyChange")]
    public function get IsAllDay() : Boolean
    {
        return _internal_IsAllDay;
    }
    ...
    [Bindable(event="propertyChange")]
    public function get RecurrenceStartDate() : Date
    {
        return _internal_RecurrenceStartDate;
    }
    ...
    {
        return _internal_StartTimeInMinutes;
    }
    ...
    public function set EndTimeInMinutes(value:int) : void
    {
        var oldValue:int = _internal_EndTimeInMinutes;
        if (oldValue !== value)
        {
            _internal_EndTimeInMinutes = value;
        }
    }

    public function set IsAllDay(value:Boolean) : void
    {
        var oldValue:Boolean = _internal_IsAllDay;
        if (oldValue !== value)
        {
            _internal_IsAllDay = value;
        }
    }
    ...
    public function set RecurrenceStartDate(value:Date) : void
    {
        var oldValue:Date = _internal_RecurrenceStartDate;
        if (oldValue !== value)
        {
            _internal_RecurrenceStartDate = value;
        }
    }
    ...
    public function set StartTimeInMinutes(value:int) : void
    {
        var oldValue:int = _internal_StartTimeInMinutes;
        if (oldValue !== value)
        {
            _internal_StartTimeInMinutes = value;
        }
    }
    ...
    model_internal function setterListenerRecurrenceStartDate(value:flash.events.Event):void
    {
        _model.invalidateDependentOnRecurrenceStartDate();
    }
    ...
    model_internal function calculateIsValid():Boolean
    {
        ...
        if (!_model.RecurrenceStartDateIsValid)
        {
            propertyValidity = false;
            com.adobe.fiber.util.FiberUtils.arrayAdd(validationFailureMessages, _model.model_internal::_RecurrenceStartDateValidationFailureMessages);
        }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _HolidayEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _HolidayEntityMetadata) : void
    {
        var oldValue : _HolidayEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
    ...
    model_internal var _doValidationCacheOfRecurrenceStartDate : Array = null;
    model_internal var _doValidationLastValOfRecurrenceStartDate : Date;

    model_internal function _doValidationForRecurrenceStartDate(valueIn:Object):Array
    {
        var value : Date = valueIn as Date;

        if (model_internal::_doValidationCacheOfRecurrenceStartDate != null && model_internal::_doValidationLastValOfRecurrenceStartDate == value)
           return model_internal::_doValidationCacheOfRecurrenceStartDate ;

        _model.model_internal::_RecurrenceStartDateIsValidCacheInitialized = true;
        var validationFailures:Array = new Array();
        var errorMessage:String;
        var failure:Boolean;

        var valRes:ValidationResult;
        if (_model.isRecurrenceStartDateAvailable && _internal_RecurrenceStartDate == null)
        {
            validationFailures.push(new ValidationResult(true, "", "", "RecurrenceStartDate is required"));
        }

        model_internal::_doValidationCacheOfRecurrenceStartDate = validationFailures;
        model_internal::_doValidationLastValOfRecurrenceStartDate = value;
