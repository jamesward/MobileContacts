 ...
 * of this value object you may modify the generated sub-class of this class - OpportunityContactRole.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_OpportunityContactRole extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.OpportunityContactRole") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.OpportunityContactRole", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _OpportunityContactRoleEntityMetadata;
    ...
    public function _Super_OpportunityContactRole()
    {
        _model = new _OpportunityContactRoleEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _OpportunityContactRoleEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _OpportunityContactRoleEntityMetadata) : void
    {
        var oldValue : _OpportunityContactRoleEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
