 ...
 * of this value object you may modify the generated sub-class of this class - ActivityHistory.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_ActivityHistory extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.ActivityHistory") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.ActivityHistory", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _ActivityHistoryEntityMetadata;
    ...
    public function _Super_ActivityHistory()
    {
        _model = new _ActivityHistoryEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _ActivityHistoryEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _ActivityHistoryEntityMetadata) : void
    {
        var oldValue : _ActivityHistoryEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
