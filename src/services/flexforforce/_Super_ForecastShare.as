 ...
 * of this value object you may modify the generated sub-class of this class - ForecastShare.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_ForecastShare extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.ForecastShare") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.ForecastShare", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _ForecastShareEntityMetadata;
    ...
    private var _internal_CanSubmit : Boolean;
    ...
    public function _Super_ForecastShare()
    {
        _model = new _ForecastShareEntityMetadata(this);
    ...
    [Bindable(event="propertyChange")]
    public function get CanSubmit() : Boolean
    {
        return _internal_CanSubmit;
    }
    ...
    public function set CanSubmit(value:Boolean) : void
    {
        var oldValue:Boolean = _internal_CanSubmit;
        if (oldValue !== value)
        {
            _internal_CanSubmit = value;
        }
    }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _ForecastShareEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _ForecastShareEntityMetadata) : void
    {
        var oldValue : _ForecastShareEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
