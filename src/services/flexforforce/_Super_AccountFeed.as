 ...
 * of this value object you may modify the generated sub-class of this class - AccountFeed.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_AccountFeed extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.AccountFeed") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.AccountFeed", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _AccountFeedEntityMetadata;
    ...
    public function _Super_AccountFeed()
    {
        _model = new _AccountFeedEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _AccountFeedEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _AccountFeedEntityMetadata) : void
    {
        var oldValue : _AccountFeedEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
