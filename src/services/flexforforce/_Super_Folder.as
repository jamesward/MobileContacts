 ...
 * of this value object you may modify the generated sub-class of this class - Folder.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_Folder extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.Folder") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.Folder", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _FolderEntityMetadata;

    /**
     * properties
     */
    private var _internal_Id : String;
    private var _internal_AccessType : String;
    private var _internal_CreatedById : String;
    private var _internal_CreatedDate : Date;
    private var _internal_DeveloperName : String;
    private var _internal_IsReadonly : Boolean;
    ...
    {
        _model = new _FolderEntityMetadata(this);

        // Bind to own data properties for cache invalidation triggering
        model_internal::_changeWatcherArray.push(mx.binding.utils.ChangeWatcher.watch(this, "AccessType", model_internal::setterListenerAccessType));
    ...
    {
        var oldValue:String = _internal_AccessType;
        if (oldValue !== value)
        {
            _internal_AccessType = value;
        }
    }
    ...
    {
        var oldValue:Boolean = _internal_IsReadonly;
        if (oldValue !== value)
        {
            _internal_IsReadonly = value;
        }
    }
    ...
    model_internal function setterListenerAccessType(value:flash.events.Event):void
    {
        _model.invalidateDependentOnAccessType();
    }
    ...
    model_internal function calculateIsValid():Boolean
    {
        ...
        if (!_model.AccessTypeIsValid)
        {
            propertyValidity = false;
            com.adobe.fiber.util.FiberUtils.arrayAdd(validationFailureMessages, _model.model_internal::_AccessTypeValidationFailureMessages);
        }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _FolderEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _FolderEntityMetadata) : void
    {
        var oldValue : _FolderEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
    ...
    model_internal var _doValidationCacheOfAccessType : Array = null;
    model_internal var _doValidationLastValOfAccessType : String;

    model_internal function _doValidationForAccessType(valueIn:Object):Array
    {
        var value : String = valueIn as String;

        if (model_internal::_doValidationCacheOfAccessType != null && model_internal::_doValidationLastValOfAccessType == value)
           return model_internal::_doValidationCacheOfAccessType ;

        _model.model_internal::_AccessTypeIsValidCacheInitialized = true;
        var validationFailures:Array = new Array();
        var errorMessage:String;
        var failure:Boolean;

        var valRes:ValidationResult;
        if (_model.isAccessTypeAvailable && _internal_AccessType == null)
        {
            validationFailures.push(new ValidationResult(true, "", "", "AccessType is required"));
        }

        model_internal::_doValidationCacheOfAccessType = validationFailures;
        model_internal::_doValidationLastValOfAccessType = value;
