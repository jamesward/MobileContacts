...
[ExcludeClass]
internal class _AdditionalNumberEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    private static var emptyArray:Array = new Array();

    model_internal static var allProperties:Array = new Array("Id", "CallCenterId", "CreatedById", "CreatedDate", "Description", "IsDeleted", "LastModifiedById", "LastModifiedDate", "Name", "Phone", "SystemModstamp");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("Id", "CallCenterId", "CreatedById", "CreatedDate", "Description", "IsDeleted", "LastModifiedById", "LastModifiedDate", "Name", "Phone", "SystemModstamp");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("Id", "CallCenterId", "CreatedById", "CreatedDate", "Description", "IsDeleted", "LastModifiedById", "LastModifiedDate", "Name", "Phone", "SystemModstamp");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("Id", "CallCenterId", "CreatedById", "CreatedDate", "Description", "IsDeleted", "LastModifiedById", "LastModifiedDate", "Name", "Phone", "SystemModstamp");
    model_internal static var derivedProperties:Array = new Array();
    model_internal static var collectionProperties:Array = new Array();
    model_internal static var collectionBaseMap:Object;
    model_internal static var entityName:String = "AdditionalNumber";
    ...
    model_internal var _instance:_Super_AdditionalNumber;
    model_internal static var _nullStyle:com.adobe.fiber.styles.Style = new com.adobe.fiber.styles.Style();

    public function _AdditionalNumberEntityMetadata(value : _Super_AdditionalNumber)
    {
    ...
    override public function getDependants(propertyName:String):Array
    {
       if (model_internal::dataProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a data property of entity AdditionalNumber");  
    ...
    override public function getCollectionBase(propertyName:String):String
    {
        if (model_internal::collectionProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a collection property of entity AdditionalNumber");  
    ...
    override public function getValue(propertyName:String):*
    {
        ...
        {
            throw new Error(propertyName + " does not exist for entity AdditionalNumber");
        }
