 ...
 * of this value object you may modify the generated sub-class of this class - Product2.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_Product2 extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.Product2") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.Product2", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _Product2EntityMetadata;
    ...
    private var _internal_Family : String;
    ...
    private var _internal_ProductCode : String;
    ...
    public function _Super_Product2()
    {
        _model = new _Product2EntityMetadata(this);
        ...
        model_internal::_changeWatcherArray.push(mx.binding.utils.ChangeWatcher.watch(this, "Family", model_internal::setterListenerFamily));
        ...
        model_internal::_changeWatcherArray.push(mx.binding.utils.ChangeWatcher.watch(this, "ProductCode", model_internal::setterListenerProductCode));
    ...
    {
        var oldValue:String = _internal_Family;
        if (oldValue !== value)
        {
            _internal_Family = value;
        }
    }
    ...
    {
        var oldValue:String = _internal_ProductCode;
        if (oldValue !== value)
        {
            _internal_ProductCode = value;
        }
    }
    ...
    model_internal function setterListenerFamily(value:flash.events.Event):void
    {
        _model.invalidateDependentOnFamily();
    }
    ...
    model_internal function setterListenerProductCode(value:flash.events.Event):void
    {
        _model.invalidateDependentOnProductCode();
    }
    ...
    model_internal function calculateIsValid():Boolean
    {
        ...
        if (!_model.FamilyIsValid)
        {
            propertyValidity = false;
            com.adobe.fiber.util.FiberUtils.arrayAdd(validationFailureMessages, _model.model_internal::_FamilyValidationFailureMessages);
        }
        ...
        if (!_model.ProductCodeIsValid)
        {
            propertyValidity = false;
            com.adobe.fiber.util.FiberUtils.arrayAdd(validationFailureMessages, _model.model_internal::_ProductCodeValidationFailureMessages);
        }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _Product2EntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _Product2EntityMetadata) : void
    {
        var oldValue : _Product2EntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
    ...
    model_internal var _doValidationCacheOfFamily : Array = null;
    model_internal var _doValidationLastValOfFamily : String;

    model_internal function _doValidationForFamily(valueIn:Object):Array
    {
        var value : String = valueIn as String;

        if (model_internal::_doValidationCacheOfFamily != null && model_internal::_doValidationLastValOfFamily == value)
           return model_internal::_doValidationCacheOfFamily ;

        _model.model_internal::_FamilyIsValidCacheInitialized = true;
        var validationFailures:Array = new Array();
        var errorMessage:String;
        var failure:Boolean;

        var valRes:ValidationResult;
        if (_model.isFamilyAvailable && _internal_Family == null)
        {
            validationFailures.push(new ValidationResult(true, "", "", "Family is required"));
        }

        model_internal::_doValidationCacheOfFamily = validationFailures;
        model_internal::_doValidationLastValOfFamily = value;
    ...
    model_internal var _doValidationCacheOfProductCode : Array = null;
    model_internal var _doValidationLastValOfProductCode : String;

    model_internal function _doValidationForProductCode(valueIn:Object):Array
    {
        var value : String = valueIn as String;

        if (model_internal::_doValidationCacheOfProductCode != null && model_internal::_doValidationLastValOfProductCode == value)
           return model_internal::_doValidationCacheOfProductCode ;

        _model.model_internal::_ProductCodeIsValidCacheInitialized = true;
        var validationFailures:Array = new Array();
        var errorMessage:String;
        var failure:Boolean;

        var valRes:ValidationResult;
        if (_model.isProductCodeAvailable && _internal_ProductCode == null)
        {
            validationFailures.push(new ValidationResult(true, "", "", "ProductCode is required"));
        }

        model_internal::_doValidationCacheOfProductCode = validationFailures;
        model_internal::_doValidationLastValOfProductCode = value;
