...
[ExcludeClass]
internal class _Track__cEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    private static var emptyArray:Array = new Array();

    model_internal static var allProperties:Array = new Array("Id", "Conference__c", "ConnectionReceivedId", "ConnectionSentId", "CreatedById", "CreatedDate", "Description__c", "IsDeleted", "LastModifiedById", "LastModifiedDate", "Name", "OwnerId", "SystemModstamp", "Track_Chairperson__c");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("Id", "Conference__c", "ConnectionReceivedId", "ConnectionSentId", "CreatedById", "CreatedDate", "Description__c", "IsDeleted", "LastModifiedById", "LastModifiedDate", "Name", "OwnerId", "SystemModstamp", "Track_Chairperson__c");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("Id", "Conference__c", "ConnectionReceivedId", "ConnectionSentId", "CreatedById", "CreatedDate", "Description__c", "IsDeleted", "LastModifiedById", "LastModifiedDate", "Name", "OwnerId", "SystemModstamp", "Track_Chairperson__c");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("Id", "Conference__c", "ConnectionReceivedId", "ConnectionSentId", "CreatedById", "CreatedDate", "Description__c", "IsDeleted", "LastModifiedById", "LastModifiedDate", "Name", "OwnerId", "SystemModstamp", "Track_Chairperson__c");
    model_internal static var derivedProperties:Array = new Array();
    model_internal static var collectionProperties:Array = new Array();
    model_internal static var collectionBaseMap:Object;
    model_internal static var entityName:String = "Track__c";
    model_internal static var dependentsOnMap:Object;
    model_internal static var dependedOnServices:Array = new Array();

    
    model_internal var _Conference__cIsValid:Boolean;
    model_internal var _Conference__cValidator:com.adobe.fiber.styles.StyleValidator;
    model_internal var _Conference__cIsValidCacheInitialized:Boolean = false;
    model_internal var _Conference__cValidationFailureMessages:Array;
    ...
    model_internal var _Description__cIsValid:Boolean;
    model_internal var _Description__cValidator:com.adobe.fiber.styles.StyleValidator;
    model_internal var _Description__cIsValidCacheInitialized:Boolean = false;
    model_internal var _Description__cValidationFailureMessages:Array;
    ...
    model_internal var _Track_Chairperson__cIsValid:Boolean;
    model_internal var _Track_Chairperson__cValidator:com.adobe.fiber.styles.StyleValidator;
    model_internal var _Track_Chairperson__cIsValidCacheInitialized:Boolean = false;
    model_internal var _Track_Chairperson__cValidationFailureMessages:Array;

    model_internal var _instance:_Super_Track__c;
    model_internal static var _nullStyle:com.adobe.fiber.styles.Style = new com.adobe.fiber.styles.Style();

    public function _Track__cEntityMetadata(value : _Super_Track__c)
    {
        ...
        if (model_internal::dependentsOnMap == null)
        {
            ...
            model_internal::dependentsOnMap["Conference__c"] = new Array();
            ...
            model_internal::dependentsOnMap["Description__c"] = new Array();
            ...
            model_internal::dependentsOnMap["Track_Chairperson__c"] = new Array();
        ...
        model_internal::_Conference__cValidator = new StyleValidator(model_internal::_instance.model_internal::_doValidationForConference__c);
        model_internal::_Conference__cValidator.required = true;
        model_internal::_Conference__cValidator.requiredFieldError = "Conference__c is required";
        //model_internal::_Conference__cValidator.source = model_internal::_instance;
        //model_internal::_Conference__cValidator.property = "Conference__c";
        ...
        model_internal::_Description__cValidator = new StyleValidator(model_internal::_instance.model_internal::_doValidationForDescription__c);
        model_internal::_Description__cValidator.required = true;
        model_internal::_Description__cValidator.requiredFieldError = "Description__c is required";
        //model_internal::_Description__cValidator.source = model_internal::_instance;
        //model_internal::_Description__cValidator.property = "Description__c";
        ...
        model_internal::_Track_Chairperson__cValidator = new StyleValidator(model_internal::_instance.model_internal::_doValidationForTrack_Chairperson__c);
        model_internal::_Track_Chairperson__cValidator.required = true;
        model_internal::_Track_Chairperson__cValidator.requiredFieldError = "Track_Chairperson__c is required";
        //model_internal::_Track_Chairperson__cValidator.source = model_internal::_instance;
        //model_internal::_Track_Chairperson__cValidator.property = "Track_Chairperson__c";
    }
    ...
    override public function getDependants(propertyName:String):Array
    {
       if (model_internal::dataProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a data property of entity Track__c");  
    ...
    override public function getCollectionBase(propertyName:String):String
    {
        if (model_internal::collectionProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a collection property of entity Track__c");  
    ...
    override public function getValue(propertyName:String):*
    {
        ...
        {
            throw new Error(propertyName + " does not exist for entity Track__c");
        }
    ...
    [Bindable(event="propertyChange")]
    public function get isConference__cAvailable():Boolean
    {
        return true;
    }
    ...
    [Bindable(event="propertyChange")]
    public function get isDescription__cAvailable():Boolean
    {
        return true;
    }
    ...
    [Bindable(event="propertyChange")]
    public function get isTrack_Chairperson__cAvailable():Boolean
    {
        return true;
    }
     ...
     */
    public function invalidateDependentOnConference__c():void
    {
        if (model_internal::_Conference__cIsValidCacheInitialized )
        {
            model_internal::_instance.model_internal::_doValidationCacheOfConference__c = null;
            model_internal::calculateConference__cIsValid();
        }
    }
    ...
    public function invalidateDependentOnDescription__c():void
    {
        if (model_internal::_Description__cIsValidCacheInitialized )
        {
            model_internal::_instance.model_internal::_doValidationCacheOfDescription__c = null;
            model_internal::calculateDescription__cIsValid();
        }
    }
    ...
    public function invalidateDependentOnTrack_Chairperson__c():void
    {
        if (model_internal::_Track_Chairperson__cIsValidCacheInitialized )
        {
            model_internal::_instance.model_internal::_doValidationCacheOfTrack_Chairperson__c = null;
            model_internal::calculateTrack_Chairperson__cIsValid();
        }
    }
    ...
    [Bindable(event="propertyChange")]   
    public function get Conference__cStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }

    public function get Conference__cValidator() : StyleValidator
    {
        return model_internal::_Conference__cValidator;
    }

    model_internal function set _Conference__cIsValid_der(value:Boolean):void 
    {
        var oldValue:Boolean = model_internal::_Conference__cIsValid;         
        if (oldValue !== value)
        {
            model_internal::_Conference__cIsValid = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "Conference__cIsValid", oldValue, value));
        }                             
    }

    [Bindable(event="propertyChange")]
    public function get Conference__cIsValid():Boolean
    {
        if (!model_internal::_Conference__cIsValidCacheInitialized)
        {
            model_internal::calculateConference__cIsValid();
        ...
        return model_internal::_Conference__cIsValid;
    }

    model_internal function calculateConference__cIsValid():void
    {
        var valRes:ValidationResultEvent = model_internal::_Conference__cValidator.validate(model_internal::_instance.Conference__c)
        model_internal::_Conference__cIsValid_der = (valRes.results == null);
        model_internal::_Conference__cIsValidCacheInitialized = true;
        if (valRes.results == null)
             model_internal::Conference__cValidationFailureMessages_der = emptyArray;
        else
        {
            ...
            model_internal::Conference__cValidationFailureMessages_der = _valFailures;
        }
    }

    [Bindable(event="propertyChange")]
    public function get Conference__cValidationFailureMessages():Array
    {
        if (model_internal::_Conference__cValidationFailureMessages == null)
            model_internal::calculateConference__cIsValid();

        return _Conference__cValidationFailureMessages;
    }

    model_internal function set Conference__cValidationFailureMessages_der(value:Array) : void
    {
        var oldValue:Array = model_internal::_Conference__cValidationFailureMessages;
        ...
        if (needUpdate)
        {
            model_internal::_Conference__cValidationFailureMessages = value;   
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "Conference__cValidationFailureMessages", oldValue, value));
    ...
    [Bindable(event="propertyChange")]   
    public function get Description__cStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }

    public function get Description__cValidator() : StyleValidator
    {
        return model_internal::_Description__cValidator;
    }

    model_internal function set _Description__cIsValid_der(value:Boolean):void 
    {
        var oldValue:Boolean = model_internal::_Description__cIsValid;         
        if (oldValue !== value)
        {
            model_internal::_Description__cIsValid = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "Description__cIsValid", oldValue, value));
        }                             
    }

    [Bindable(event="propertyChange")]
    public function get Description__cIsValid():Boolean
    {
        if (!model_internal::_Description__cIsValidCacheInitialized)
        {
            model_internal::calculateDescription__cIsValid();
        ...
        return model_internal::_Description__cIsValid;
    }

    model_internal function calculateDescription__cIsValid():void
    {
        var valRes:ValidationResultEvent = model_internal::_Description__cValidator.validate(model_internal::_instance.Description__c)
        model_internal::_Description__cIsValid_der = (valRes.results == null);
        model_internal::_Description__cIsValidCacheInitialized = true;
        if (valRes.results == null)
             model_internal::Description__cValidationFailureMessages_der = emptyArray;
        else
        {
            var _valFailures:Array = new Array();
            for (var a:int = 0 ; a<valRes.results.length ; a++)
            ...
            model_internal::Description__cValidationFailureMessages_der = _valFailures;
        }
    }

    [Bindable(event="propertyChange")]
    public function get Description__cValidationFailureMessages():Array
    {
        if (model_internal::_Description__cValidationFailureMessages == null)
            model_internal::calculateDescription__cIsValid();

        return _Description__cValidationFailureMessages;
    }

    model_internal function set Description__cValidationFailureMessages_der(value:Array) : void
    {
        var oldValue:Array = model_internal::_Description__cValidationFailureMessages;
        ...
        if (needUpdate)
        {
            model_internal::_Description__cValidationFailureMessages = value;   
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "Description__cValidationFailureMessages", oldValue, value));
            // Only execute calculateIsValid if it has been called before, to update the validationFailureMessages for
            // the entire entity.
            if (model_internal::_instance.model_internal::_cacheInitialized_isValid)
            {
    ...
    [Bindable(event="propertyChange")]   
    public function get Track_Chairperson__cStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }

    public function get Track_Chairperson__cValidator() : StyleValidator
    {
        return model_internal::_Track_Chairperson__cValidator;
    }

    model_internal function set _Track_Chairperson__cIsValid_der(value:Boolean):void 
    {
        var oldValue:Boolean = model_internal::_Track_Chairperson__cIsValid;         
        if (oldValue !== value)
        {
            model_internal::_Track_Chairperson__cIsValid = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "Track_Chairperson__cIsValid", oldValue, value));
        }                             
    }

    [Bindable(event="propertyChange")]
    public function get Track_Chairperson__cIsValid():Boolean
    {
        if (!model_internal::_Track_Chairperson__cIsValidCacheInitialized)
        {
            model_internal::calculateTrack_Chairperson__cIsValid();
        ...
        return model_internal::_Track_Chairperson__cIsValid;
    }

    model_internal function calculateTrack_Chairperson__cIsValid():void
    {
        var valRes:ValidationResultEvent = model_internal::_Track_Chairperson__cValidator.validate(model_internal::_instance.Track_Chairperson__c)
        model_internal::_Track_Chairperson__cIsValid_der = (valRes.results == null);
        model_internal::_Track_Chairperson__cIsValidCacheInitialized = true;
        if (valRes.results == null)
             model_internal::Track_Chairperson__cValidationFailureMessages_der = emptyArray;
        else
        {
            var _valFailures:Array = new Array();
            for (var a:int = 0 ; a<valRes.results.length ; a++)
            ...
            model_internal::Track_Chairperson__cValidationFailureMessages_der = _valFailures;
        }
    }

    [Bindable(event="propertyChange")]
    public function get Track_Chairperson__cValidationFailureMessages():Array
    {
        if (model_internal::_Track_Chairperson__cValidationFailureMessages == null)
            model_internal::calculateTrack_Chairperson__cIsValid();

        return _Track_Chairperson__cValidationFailureMessages;
    }

    model_internal function set Track_Chairperson__cValidationFailureMessages_der(value:Array) : void
    {
        var oldValue:Array = model_internal::_Track_Chairperson__cValidationFailureMessages;
        ...
        if (needUpdate)
        {
            model_internal::_Track_Chairperson__cValidationFailureMessages = value;   
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "Track_Chairperson__cValidationFailureMessages", oldValue, value));
            // Only execute calculateIsValid if it has been called before, to update the validationFailureMessages for
            // the entire entity.
            if (model_internal::_instance.model_internal::_cacheInitialized_isValid)
            {
     ...
     */  
     override public function getPropertyValidationFailureMessages(propertyName:String):Array
     {
         switch(propertyName)
         {
            case("Conference__c"):
            {
                return Conference__cValidationFailureMessages;
            }
            ...
            case("Description__c"):
            {
                return Description__cValidationFailureMessages;
            }
            ...
            case("Track_Chairperson__c"):
            {
                return Track_Chairperson__cValidationFailureMessages;
            }
            default:
            {
                return emptyArray;
