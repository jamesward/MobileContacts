...
[ExcludeClass]
internal class _CaseTeamTemplateMemberEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    private static var emptyArray:Array = new Array();

    model_internal static var allProperties:Array = new Array("Id", "CreatedById", "CreatedDate", "LastModifiedById", "LastModifiedDate", "MemberId", "SystemModstamp", "TeamRoleId", "TeamTemplateId");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("Id", "CreatedById", "CreatedDate", "LastModifiedById", "LastModifiedDate", "MemberId", "SystemModstamp", "TeamRoleId", "TeamTemplateId");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("Id", "CreatedById", "CreatedDate", "LastModifiedById", "LastModifiedDate", "MemberId", "SystemModstamp", "TeamRoleId", "TeamTemplateId");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("Id", "CreatedById", "CreatedDate", "LastModifiedById", "LastModifiedDate", "MemberId", "SystemModstamp", "TeamRoleId", "TeamTemplateId");
    model_internal static var derivedProperties:Array = new Array();
    model_internal static var collectionProperties:Array = new Array();
    model_internal static var collectionBaseMap:Object;
    model_internal static var entityName:String = "CaseTeamTemplateMember";
    ...
    model_internal var _TeamTemplateIdIsValid:Boolean;
    model_internal var _TeamTemplateIdValidator:com.adobe.fiber.styles.StyleValidator;
    model_internal var _TeamTemplateIdIsValidCacheInitialized:Boolean = false;
    model_internal var _TeamTemplateIdValidationFailureMessages:Array;

    model_internal var _instance:_Super_CaseTeamTemplateMember;
    model_internal static var _nullStyle:com.adobe.fiber.styles.Style = new com.adobe.fiber.styles.Style();

    public function _CaseTeamTemplateMemberEntityMetadata(value : _Super_CaseTeamTemplateMember)
    {
        ...
        if (model_internal::dependentsOnMap == null)
        {
            ...
            model_internal::dependentsOnMap["TeamTemplateId"] = new Array();
        ...
        model_internal::_TeamTemplateIdValidator = new StyleValidator(model_internal::_instance.model_internal::_doValidationForTeamTemplateId);
        model_internal::_TeamTemplateIdValidator.required = true;
        model_internal::_TeamTemplateIdValidator.requiredFieldError = "TeamTemplateId is required";
        //model_internal::_TeamTemplateIdValidator.source = model_internal::_instance;
        //model_internal::_TeamTemplateIdValidator.property = "TeamTemplateId";
    }
    ...
    override public function getDependants(propertyName:String):Array
    {
       if (model_internal::dataProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a data property of entity CaseTeamTemplateMember");  
    ...
    override public function getCollectionBase(propertyName:String):String
    {
        if (model_internal::collectionProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a collection property of entity CaseTeamTemplateMember");  
    ...
    override public function getValue(propertyName:String):*
    {
        ...
        {
            throw new Error(propertyName + " does not exist for entity CaseTeamTemplateMember");
        }
    ...
    [Bindable(event="propertyChange")]
    public function get isTeamTemplateIdAvailable():Boolean
    {
        return true;
    }
    ...
    public function invalidateDependentOnTeamTemplateId():void
    {
        if (model_internal::_TeamTemplateIdIsValidCacheInitialized )
        {
            model_internal::_instance.model_internal::_doValidationCacheOfTeamTemplateId = null;
            model_internal::calculateTeamTemplateIdIsValid();
        }
    }
    ...
    [Bindable(event="propertyChange")]   
    public function get TeamTemplateIdStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }

    public function get TeamTemplateIdValidator() : StyleValidator
    {
        return model_internal::_TeamTemplateIdValidator;
    }

    model_internal function set _TeamTemplateIdIsValid_der(value:Boolean):void 
    {
        var oldValue:Boolean = model_internal::_TeamTemplateIdIsValid;         
        if (oldValue !== value)
        {
            model_internal::_TeamTemplateIdIsValid = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "TeamTemplateIdIsValid", oldValue, value));
        }                             
    }

    [Bindable(event="propertyChange")]
    public function get TeamTemplateIdIsValid():Boolean
    {
        if (!model_internal::_TeamTemplateIdIsValidCacheInitialized)
        {
            model_internal::calculateTeamTemplateIdIsValid();
        ...
        return model_internal::_TeamTemplateIdIsValid;
    }

    model_internal function calculateTeamTemplateIdIsValid():void
    {
        var valRes:ValidationResultEvent = model_internal::_TeamTemplateIdValidator.validate(model_internal::_instance.TeamTemplateId)
        model_internal::_TeamTemplateIdIsValid_der = (valRes.results == null);
        model_internal::_TeamTemplateIdIsValidCacheInitialized = true;
        if (valRes.results == null)
             model_internal::TeamTemplateIdValidationFailureMessages_der = emptyArray;
        else
        {
            var _valFailures:Array = new Array();
            for (var a:int = 0 ; a<valRes.results.length ; a++)
            ...
            model_internal::TeamTemplateIdValidationFailureMessages_der = _valFailures;
        }
    }

    [Bindable(event="propertyChange")]
    public function get TeamTemplateIdValidationFailureMessages():Array
    {
        if (model_internal::_TeamTemplateIdValidationFailureMessages == null)
            model_internal::calculateTeamTemplateIdIsValid();

        return _TeamTemplateIdValidationFailureMessages;
    }

    model_internal function set TeamTemplateIdValidationFailureMessages_der(value:Array) : void
    {
        var oldValue:Array = model_internal::_TeamTemplateIdValidationFailureMessages;
        ...
        if (needUpdate)
        {
            model_internal::_TeamTemplateIdValidationFailureMessages = value;   
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "TeamTemplateIdValidationFailureMessages", oldValue, value));
            // Only execute calculateIsValid if it has been called before, to update the validationFailureMessages for
            // the entire entity.
            if (model_internal::_instance.model_internal::_cacheInitialized_isValid)
            {
     ...
     */  
     override public function getPropertyValidationFailureMessages(propertyName:String):Array
     {
         switch(propertyName)
         {
            ...
            case("TeamTemplateId"):
            {
                return TeamTemplateIdValidationFailureMessages;
            }
            default:
            {
                return emptyArray;
