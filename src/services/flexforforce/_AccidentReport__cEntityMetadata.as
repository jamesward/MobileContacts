...
[ExcludeClass]
internal class _AccidentReport__cEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    private static var emptyArray:Array = new Array();

    model_internal static var allProperties:Array = new Array("Id", "Claim__c", "ConnectionReceivedId", "ConnectionSentId", "CreatedById", "CreatedDate", "Date_of_Accident__c", "IncidentX__c", "IncidentY__c", "IsDeleted", "LastActivityDate", "LastModifiedById", "LastModifiedDate", "Name", "OwnerId", "SystemModstamp");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("Id", "Claim__c", "ConnectionReceivedId", "ConnectionSentId", "CreatedById", "CreatedDate", "Date_of_Accident__c", "IncidentX__c", "IncidentY__c", "IsDeleted", "LastActivityDate", "LastModifiedById", "LastModifiedDate", "Name", "OwnerId", "SystemModstamp");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("Id", "Claim__c", "ConnectionReceivedId", "ConnectionSentId", "CreatedById", "CreatedDate", "Date_of_Accident__c", "IncidentX__c", "IncidentY__c", "IsDeleted", "LastActivityDate", "LastModifiedById", "LastModifiedDate", "Name", "OwnerId", "SystemModstamp");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("Id", "Claim__c", "ConnectionReceivedId", "ConnectionSentId", "CreatedById", "CreatedDate", "Date_of_Accident__c", "IncidentX__c", "IncidentY__c", "IsDeleted", "LastActivityDate", "LastModifiedById", "LastModifiedDate", "Name", "OwnerId", "SystemModstamp");
    model_internal static var derivedProperties:Array = new Array();
    model_internal static var collectionProperties:Array = new Array();
    model_internal static var collectionBaseMap:Object;
    model_internal static var entityName:String = "AccidentReport__c";
    model_internal static var dependentsOnMap:Object;
    model_internal static var dependedOnServices:Array = new Array();

    
    model_internal var _Claim__cIsValid:Boolean;
    model_internal var _Claim__cValidator:com.adobe.fiber.styles.StyleValidator;
    model_internal var _Claim__cIsValidCacheInitialized:Boolean = false;
    model_internal var _Claim__cValidationFailureMessages:Array;
    ...
    model_internal var _Date_of_Accident__cIsValid:Boolean;
    model_internal var _Date_of_Accident__cValidator:com.adobe.fiber.styles.StyleValidator;
    model_internal var _Date_of_Accident__cIsValidCacheInitialized:Boolean = false;
    model_internal var _Date_of_Accident__cValidationFailureMessages:Array;
    ...
    model_internal var _instance:_Super_AccidentReport__c;
    model_internal static var _nullStyle:com.adobe.fiber.styles.Style = new com.adobe.fiber.styles.Style();

    public function _AccidentReport__cEntityMetadata(value : _Super_AccidentReport__c)
    {
        ...
        if (model_internal::dependentsOnMap == null)
        {
            ...
            model_internal::dependentsOnMap["Claim__c"] = new Array();
            ...
            model_internal::dependentsOnMap["Date_of_Accident__c"] = new Array();
            model_internal::dependentsOnMap["IncidentX__c"] = new Array();
            model_internal::dependentsOnMap["IncidentY__c"] = new Array();
        ...
        model_internal::_Claim__cValidator = new StyleValidator(model_internal::_instance.model_internal::_doValidationForClaim__c);
        model_internal::_Claim__cValidator.required = true;
        model_internal::_Claim__cValidator.requiredFieldError = "Claim__c is required";
        //model_internal::_Claim__cValidator.source = model_internal::_instance;
        //model_internal::_Claim__cValidator.property = "Claim__c";
        ...
        model_internal::_Date_of_Accident__cValidator = new StyleValidator(model_internal::_instance.model_internal::_doValidationForDate_of_Accident__c);
        model_internal::_Date_of_Accident__cValidator.required = true;
        model_internal::_Date_of_Accident__cValidator.requiredFieldError = "Date_of_Accident__c is required";
        //model_internal::_Date_of_Accident__cValidator.source = model_internal::_instance;
        //model_internal::_Date_of_Accident__cValidator.property = "Date_of_Accident__c";
    ...
    override public function getDependants(propertyName:String):Array
    {
       if (model_internal::dataProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a data property of entity AccidentReport__c");  
    ...
    override public function getCollectionBase(propertyName:String):String
    {
        if (model_internal::collectionProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a collection property of entity AccidentReport__c");  
    ...
    override public function getValue(propertyName:String):*
    {
        ...
        {
            throw new Error(propertyName + " does not exist for entity AccidentReport__c");
        }
    ...
    [Bindable(event="propertyChange")]
    public function get isClaim__cAvailable():Boolean
    {
        return true;
    }
    ...
    [Bindable(event="propertyChange")]
    public function get isDate_of_Accident__cAvailable():Boolean
    {
        return true;
    }

    [Bindable(event="propertyChange")]
    public function get isIncidentX__cAvailable():Boolean
    {
        return true;
    }

    [Bindable(event="propertyChange")]
    public function get isIncidentY__cAvailable():Boolean
    {
        return true;
    }
     ...
     */
    public function invalidateDependentOnClaim__c():void
    {
        if (model_internal::_Claim__cIsValidCacheInitialized )
        {
            model_internal::_instance.model_internal::_doValidationCacheOfClaim__c = null;
            model_internal::calculateClaim__cIsValid();
        }
    }
    ...
    public function invalidateDependentOnDate_of_Accident__c():void
    {
        if (model_internal::_Date_of_Accident__cIsValidCacheInitialized )
        {
            model_internal::_instance.model_internal::_doValidationCacheOfDate_of_Accident__c = null;
            model_internal::calculateDate_of_Accident__cIsValid();
        }
    }
    ...
    [Bindable(event="propertyChange")]   
    public function get Claim__cStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }

    public function get Claim__cValidator() : StyleValidator
    {
        return model_internal::_Claim__cValidator;
    }

    model_internal function set _Claim__cIsValid_der(value:Boolean):void 
    {
        var oldValue:Boolean = model_internal::_Claim__cIsValid;         
        if (oldValue !== value)
        {
            model_internal::_Claim__cIsValid = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "Claim__cIsValid", oldValue, value));
        }                             
    }

    [Bindable(event="propertyChange")]
    public function get Claim__cIsValid():Boolean
    {
        if (!model_internal::_Claim__cIsValidCacheInitialized)
        {
            model_internal::calculateClaim__cIsValid();
        ...
        return model_internal::_Claim__cIsValid;
    }

    model_internal function calculateClaim__cIsValid():void
    {
        var valRes:ValidationResultEvent = model_internal::_Claim__cValidator.validate(model_internal::_instance.Claim__c)
        model_internal::_Claim__cIsValid_der = (valRes.results == null);
        model_internal::_Claim__cIsValidCacheInitialized = true;
        if (valRes.results == null)
             model_internal::Claim__cValidationFailureMessages_der = emptyArray;
        else
        {
            ...
            model_internal::Claim__cValidationFailureMessages_der = _valFailures;
        }
    }

    [Bindable(event="propertyChange")]
    public function get Claim__cValidationFailureMessages():Array
    {
        if (model_internal::_Claim__cValidationFailureMessages == null)
            model_internal::calculateClaim__cIsValid();

        return _Claim__cValidationFailureMessages;
    }

    model_internal function set Claim__cValidationFailureMessages_der(value:Array) : void
    {
        var oldValue:Array = model_internal::_Claim__cValidationFailureMessages;
        ...
        if (needUpdate)
        {
            model_internal::_Claim__cValidationFailureMessages = value;   
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "Claim__cValidationFailureMessages", oldValue, value));
    ...
    [Bindable(event="propertyChange")]   
    public function get Date_of_Accident__cStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }

    public function get Date_of_Accident__cValidator() : StyleValidator
    {
        return model_internal::_Date_of_Accident__cValidator;
    }

    model_internal function set _Date_of_Accident__cIsValid_der(value:Boolean):void 
    {
        var oldValue:Boolean = model_internal::_Date_of_Accident__cIsValid;         
        if (oldValue !== value)
        {
            model_internal::_Date_of_Accident__cIsValid = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "Date_of_Accident__cIsValid", oldValue, value));
        }                             
    }

    [Bindable(event="propertyChange")]
    public function get Date_of_Accident__cIsValid():Boolean
    {
        if (!model_internal::_Date_of_Accident__cIsValidCacheInitialized)
        {
            model_internal::calculateDate_of_Accident__cIsValid();
        ...
        return model_internal::_Date_of_Accident__cIsValid;
    }

    model_internal function calculateDate_of_Accident__cIsValid():void
    {
        var valRes:ValidationResultEvent = model_internal::_Date_of_Accident__cValidator.validate(model_internal::_instance.Date_of_Accident__c)
        model_internal::_Date_of_Accident__cIsValid_der = (valRes.results == null);
        model_internal::_Date_of_Accident__cIsValidCacheInitialized = true;
        if (valRes.results == null)
             model_internal::Date_of_Accident__cValidationFailureMessages_der = emptyArray;
        else
        {
            var _valFailures:Array = new Array();
            for (var a:int = 0 ; a<valRes.results.length ; a++)
            ...
            model_internal::Date_of_Accident__cValidationFailureMessages_der = _valFailures;
        }
    }

    [Bindable(event="propertyChange")]
    public function get Date_of_Accident__cValidationFailureMessages():Array
    {
        if (model_internal::_Date_of_Accident__cValidationFailureMessages == null)
            model_internal::calculateDate_of_Accident__cIsValid();

        return _Date_of_Accident__cValidationFailureMessages;
    }

    model_internal function set Date_of_Accident__cValidationFailureMessages_der(value:Array) : void
    {
        var oldValue:Array = model_internal::_Date_of_Accident__cValidationFailureMessages;
        ...
        if (needUpdate)
        {
            model_internal::_Date_of_Accident__cValidationFailureMessages = value;   
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "Date_of_Accident__cValidationFailureMessages", oldValue, value));
            // Only execute calculateIsValid if it has been called before, to update the validationFailureMessages for
            // the entire entity.
            if (model_internal::_instance.model_internal::_cacheInitialized_isValid)
            {
    ...
    [Bindable(event="propertyChange")]   
    public function get IncidentX__cStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }

    [Bindable(event="propertyChange")]   
    public function get IncidentY__cStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }
     ...
     */  
     override public function getPropertyValidationFailureMessages(propertyName:String):Array
     {
         switch(propertyName)
         {
            case("Claim__c"):
            {
                return Claim__cValidationFailureMessages;
            }
            ...
            case("Date_of_Accident__c"):
            {
                return Date_of_Accident__cValidationFailureMessages;
            }
