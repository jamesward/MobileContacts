...
[ExcludeClass]
internal class _PartnerRoleEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    private static var emptyArray:Array = new Array();

    model_internal static var allProperties:Array = new Array("Id", "CreatedById", "CreatedDate", "LastModifiedById", "LastModifiedDate", "MasterLabel", "ReverseRole", "SortOrder", "SystemModstamp");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("Id", "CreatedById", "CreatedDate", "LastModifiedById", "LastModifiedDate", "MasterLabel", "ReverseRole", "SortOrder", "SystemModstamp");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("Id", "CreatedById", "CreatedDate", "LastModifiedById", "LastModifiedDate", "MasterLabel", "ReverseRole", "SortOrder", "SystemModstamp");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("Id", "CreatedById", "CreatedDate", "LastModifiedById", "LastModifiedDate", "MasterLabel", "ReverseRole", "SortOrder", "SystemModstamp");
    model_internal static var derivedProperties:Array = new Array();
    model_internal static var collectionProperties:Array = new Array();
    model_internal static var collectionBaseMap:Object;
    model_internal static var entityName:String = "PartnerRole";
    ...
    model_internal var _ReverseRoleIsValid:Boolean;
    model_internal var _ReverseRoleValidator:com.adobe.fiber.styles.StyleValidator;
    model_internal var _ReverseRoleIsValidCacheInitialized:Boolean = false;
    model_internal var _ReverseRoleValidationFailureMessages:Array;
    ...
    model_internal var _instance:_Super_PartnerRole;
    model_internal static var _nullStyle:com.adobe.fiber.styles.Style = new com.adobe.fiber.styles.Style();

    public function _PartnerRoleEntityMetadata(value : _Super_PartnerRole)
    {
        ...
        if (model_internal::dependentsOnMap == null)
        {
            ...
            model_internal::dependentsOnMap["ReverseRole"] = new Array();
            model_internal::dependentsOnMap["SortOrder"] = new Array();
        ...
        model_internal::_ReverseRoleValidator = new StyleValidator(model_internal::_instance.model_internal::_doValidationForReverseRole);
        model_internal::_ReverseRoleValidator.required = true;
        model_internal::_ReverseRoleValidator.requiredFieldError = "ReverseRole is required";
        //model_internal::_ReverseRoleValidator.source = model_internal::_instance;
        //model_internal::_ReverseRoleValidator.property = "ReverseRole";
    ...
    override public function getDependants(propertyName:String):Array
    {
       if (model_internal::dataProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a data property of entity PartnerRole");  
    ...
    override public function getCollectionBase(propertyName:String):String
    {
        if (model_internal::collectionProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a collection property of entity PartnerRole");  
    ...
    override public function getValue(propertyName:String):*
    {
        ...
        {
            throw new Error(propertyName + " does not exist for entity PartnerRole");
        }
    ...
    [Bindable(event="propertyChange")]
    public function get isReverseRoleAvailable():Boolean
    {
        return true;
    }

    [Bindable(event="propertyChange")]
    public function get isSortOrderAvailable():Boolean
    {
        return true;
    }
    ...
    public function invalidateDependentOnReverseRole():void
    {
        if (model_internal::_ReverseRoleIsValidCacheInitialized )
        {
            model_internal::_instance.model_internal::_doValidationCacheOfReverseRole = null;
            model_internal::calculateReverseRoleIsValid();
        }
    }
    ...
    [Bindable(event="propertyChange")]   
    public function get ReverseRoleStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }

    public function get ReverseRoleValidator() : StyleValidator
    {
        return model_internal::_ReverseRoleValidator;
    }

    model_internal function set _ReverseRoleIsValid_der(value:Boolean):void 
    {
        var oldValue:Boolean = model_internal::_ReverseRoleIsValid;         
        if (oldValue !== value)
        {
            model_internal::_ReverseRoleIsValid = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "ReverseRoleIsValid", oldValue, value));
        }                             
    }

    [Bindable(event="propertyChange")]
    public function get ReverseRoleIsValid():Boolean
    {
        if (!model_internal::_ReverseRoleIsValidCacheInitialized)
        {
            model_internal::calculateReverseRoleIsValid();
        ...
        return model_internal::_ReverseRoleIsValid;
    }

    model_internal function calculateReverseRoleIsValid():void
    {
        var valRes:ValidationResultEvent = model_internal::_ReverseRoleValidator.validate(model_internal::_instance.ReverseRole)
        model_internal::_ReverseRoleIsValid_der = (valRes.results == null);
        model_internal::_ReverseRoleIsValidCacheInitialized = true;
        if (valRes.results == null)
             model_internal::ReverseRoleValidationFailureMessages_der = emptyArray;
        else
        {
            var _valFailures:Array = new Array();
            for (var a:int = 0 ; a<valRes.results.length ; a++)
            ...
            model_internal::ReverseRoleValidationFailureMessages_der = _valFailures;
        }
    }

    [Bindable(event="propertyChange")]
    public function get ReverseRoleValidationFailureMessages():Array
    {
        if (model_internal::_ReverseRoleValidationFailureMessages == null)
            model_internal::calculateReverseRoleIsValid();

        return _ReverseRoleValidationFailureMessages;
    }

    model_internal function set ReverseRoleValidationFailureMessages_der(value:Array) : void
    {
        var oldValue:Array = model_internal::_ReverseRoleValidationFailureMessages;
        ...
        if (needUpdate)
        {
            model_internal::_ReverseRoleValidationFailureMessages = value;   
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "ReverseRoleValidationFailureMessages", oldValue, value));
            // Only execute calculateIsValid if it has been called before, to update the validationFailureMessages for
            // the entire entity.
            if (model_internal::_instance.model_internal::_cacheInitialized_isValid)
            {
    ...
    [Bindable(event="propertyChange")]   
    public function get SortOrderStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }
     ...
     */  
     override public function getPropertyValidationFailureMessages(propertyName:String):Array
     {
         switch(propertyName)
         {
            ...
            case("ReverseRole"):
            {
                return ReverseRoleValidationFailureMessages;
            }
            case("SystemModstamp"):
            {
