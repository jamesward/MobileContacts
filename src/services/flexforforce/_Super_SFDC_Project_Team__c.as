 ...
 * of this value object you may modify the generated sub-class of this class - SFDC_Project_Team__c.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_SFDC_Project_Team__c extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.SFDC_Project_Team__c") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.SFDC_Project_Team__c", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _SFDC_Project_Team__cEntityMetadata;
    ...
    private var _internal_SFDC_Project_Team_Name__c : String;
    ...
    public function _Super_SFDC_Project_Team__c()
    {
        _model = new _SFDC_Project_Team__cEntityMetadata(this);
        ...
        model_internal::_changeWatcherArray.push(mx.binding.utils.ChangeWatcher.watch(this, "SFDC_Project_Team_Name__c", model_internal::setterListenerSFDC_Project_Team_Name__c));
    ...
    [Bindable(event="propertyChange")]
    public function get SFDC_Project_Team_Name__c() : String
    {
        return _internal_SFDC_Project_Team_Name__c;
    }
    ...
    public function set SFDC_Project_Team_Name__c(value:String) : void
    {
        var oldValue:String = _internal_SFDC_Project_Team_Name__c;
        if (oldValue !== value)
        {
            _internal_SFDC_Project_Team_Name__c = value;
        }
    }
    ...
    model_internal function setterListenerSFDC_Project_Team_Name__c(value:flash.events.Event):void
    {
        _model.invalidateDependentOnSFDC_Project_Team_Name__c();
    }
    ...
    model_internal function calculateIsValid():Boolean
    {
        ...
        if (!_model.SFDC_Project_Team_Name__cIsValid)
        {
            propertyValidity = false;
            com.adobe.fiber.util.FiberUtils.arrayAdd(validationFailureMessages, _model.model_internal::_SFDC_Project_Team_Name__cValidationFailureMessages);
        }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _SFDC_Project_Team__cEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _SFDC_Project_Team__cEntityMetadata) : void
    {
        var oldValue : _SFDC_Project_Team__cEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
    ...
    model_internal var _doValidationCacheOfSFDC_Project_Team_Name__c : Array = null;
    model_internal var _doValidationLastValOfSFDC_Project_Team_Name__c : String;

    model_internal function _doValidationForSFDC_Project_Team_Name__c(valueIn:Object):Array
    {
        var value : String = valueIn as String;

        if (model_internal::_doValidationCacheOfSFDC_Project_Team_Name__c != null && model_internal::_doValidationLastValOfSFDC_Project_Team_Name__c == value)
           return model_internal::_doValidationCacheOfSFDC_Project_Team_Name__c ;

        _model.model_internal::_SFDC_Project_Team_Name__cIsValidCacheInitialized = true;
        var validationFailures:Array = new Array();
        var errorMessage:String;
        var failure:Boolean;

        var valRes:ValidationResult;
        if (_model.isSFDC_Project_Team_Name__cAvailable && _internal_SFDC_Project_Team_Name__c == null)
        {
            validationFailures.push(new ValidationResult(true, "", "", "SFDC_Project_Team_Name__c is required"));
        }

        model_internal::_doValidationCacheOfSFDC_Project_Team_Name__c = validationFailures;
        model_internal::_doValidationLastValOfSFDC_Project_Team_Name__c = value;
