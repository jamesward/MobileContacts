 ...
 * of this value object you may modify the generated sub-class of this class - MailmergeTemplate.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_MailmergeTemplate extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.MailmergeTemplate") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.MailmergeTemplate", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _MailmergeTemplateEntityMetadata;
    ...
    public function _Super_MailmergeTemplate()
    {
        _model = new _MailmergeTemplateEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _MailmergeTemplateEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _MailmergeTemplateEntityMetadata) : void
    {
        var oldValue : _MailmergeTemplateEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
