 ...
 * of this value object you may modify the generated sub-class of this class - Scontrol.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_Scontrol extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.Scontrol") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.Scontrol", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _ScontrolEntityMetadata;

    /**
     * properties
     */
    private var _internal_Id : String;
    private var _internal_Binary : int;
    private var _internal_BodyLength : int;
    private var _internal_ContentSource : String;
    ...
    private var _internal_HtmlWrapper : String;
    ...
    private var _internal_SupportsCaching : Boolean;
    ...
    public function _Super_Scontrol()
    {
        _model = new _ScontrolEntityMetadata(this);

        // Bind to own data properties for cache invalidation triggering
        model_internal::_changeWatcherArray.push(mx.binding.utils.ChangeWatcher.watch(this, "ContentSource", model_internal::setterListenerContentSource));
        ...
        model_internal::_changeWatcherArray.push(mx.binding.utils.ChangeWatcher.watch(this, "HtmlWrapper", model_internal::setterListenerHtmlWrapper));
    ...
    [Bindable(event="propertyChange")]
    public function get Binary() : int
    {
    ...
    {
        return _internal_ContentSource;
    }
    ...
    [Bindable(event="propertyChange")]
    public function get HtmlWrapper() : String
    {
        return _internal_HtmlWrapper;
    }
    ...
    {
        return _internal_SupportsCaching;
    }
    ...
    public function set Binary(value:int) : void
    {
        var oldValue:int = _internal_Binary;
        if (oldValue !== value)
        {
            _internal_Binary = value;
        }
    }
    ...
    {
        var oldValue:String = _internal_ContentSource;
        if (oldValue !== value)
        {
            _internal_ContentSource = value;
        }
    }
    ...
    public function set HtmlWrapper(value:String) : void
    {
        var oldValue:String = _internal_HtmlWrapper;
        if (oldValue !== value)
        {
            _internal_HtmlWrapper = value;
        }
    }
    ...
    public function set SupportsCaching(value:Boolean) : void
    {
        var oldValue:Boolean = _internal_SupportsCaching;
        if (oldValue !== value)
        {
            _internal_SupportsCaching = value;
        }
    }
    ...
    model_internal function setterListenerContentSource(value:flash.events.Event):void
    {
        _model.invalidateDependentOnContentSource();
    }
    ...
    model_internal function setterListenerHtmlWrapper(value:flash.events.Event):void
    {
        _model.invalidateDependentOnHtmlWrapper();
    }
    ...
    model_internal function calculateIsValid():Boolean
    {
        ...
        if (!_model.ContentSourceIsValid)
        {
            propertyValidity = false;
            com.adobe.fiber.util.FiberUtils.arrayAdd(validationFailureMessages, _model.model_internal::_ContentSourceValidationFailureMessages);
        }
        ...
        if (!_model.HtmlWrapperIsValid)
        {
            propertyValidity = false;
            com.adobe.fiber.util.FiberUtils.arrayAdd(validationFailureMessages, _model.model_internal::_HtmlWrapperValidationFailureMessages);
        }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _ScontrolEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _ScontrolEntityMetadata) : void
    {
        var oldValue : _ScontrolEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
    ...
    model_internal var _doValidationCacheOfContentSource : Array = null;
    model_internal var _doValidationLastValOfContentSource : String;

    model_internal function _doValidationForContentSource(valueIn:Object):Array
    {
        var value : String = valueIn as String;

        if (model_internal::_doValidationCacheOfContentSource != null && model_internal::_doValidationLastValOfContentSource == value)
           return model_internal::_doValidationCacheOfContentSource ;

        _model.model_internal::_ContentSourceIsValidCacheInitialized = true;
        var validationFailures:Array = new Array();
        var errorMessage:String;
        var failure:Boolean;

        var valRes:ValidationResult;
        if (_model.isContentSourceAvailable && _internal_ContentSource == null)
        {
            validationFailures.push(new ValidationResult(true, "", "", "ContentSource is required"));
        }

        model_internal::_doValidationCacheOfContentSource = validationFailures;
        model_internal::_doValidationLastValOfContentSource = value;
    ...
    model_internal var _doValidationCacheOfHtmlWrapper : Array = null;
    model_internal var _doValidationLastValOfHtmlWrapper : String;

    model_internal function _doValidationForHtmlWrapper(valueIn:Object):Array
    {
        var value : String = valueIn as String;

        if (model_internal::_doValidationCacheOfHtmlWrapper != null && model_internal::_doValidationLastValOfHtmlWrapper == value)
           return model_internal::_doValidationCacheOfHtmlWrapper ;

        _model.model_internal::_HtmlWrapperIsValidCacheInitialized = true;
        var validationFailures:Array = new Array();
        var errorMessage:String;
        var failure:Boolean;

        var valRes:ValidationResult;
        if (_model.isHtmlWrapperAvailable && _internal_HtmlWrapper == null)
        {
            validationFailures.push(new ValidationResult(true, "", "", "HtmlWrapper is required"));
        }

        model_internal::_doValidationCacheOfHtmlWrapper = validationFailures;
        model_internal::_doValidationLastValOfHtmlWrapper = value;
