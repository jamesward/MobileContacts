 ...
 * of this value object you may modify the generated sub-class of this class - CaseTeamRole.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_CaseTeamRole extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.CaseTeamRole") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.CaseTeamRole", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _CaseTeamRoleEntityMetadata;

    /**
     * properties
     */
    private var _internal_Id : String;
    private var _internal_AccessLevel : String;
    ...
    private var _internal_PreferencesVisibleInCSP : Boolean;
    ...
    public function _Super_CaseTeamRole()
    {
        _model = new _CaseTeamRoleEntityMetadata(this);

        // Bind to own data properties for cache invalidation triggering
        model_internal::_changeWatcherArray.push(mx.binding.utils.ChangeWatcher.watch(this, "AccessLevel", model_internal::setterListenerAccessLevel));
    ...
    [Bindable(event="propertyChange")]
    public function get PreferencesVisibleInCSP() : Boolean
    {
        return _internal_PreferencesVisibleInCSP;
    }
    ...
    {
        var oldValue:String = _internal_AccessLevel;
        if (oldValue !== value)
        {
            _internal_AccessLevel = value;
        }
    }
    ...
    public function set PreferencesVisibleInCSP(value:Boolean) : void
    {
        var oldValue:Boolean = _internal_PreferencesVisibleInCSP;
        if (oldValue !== value)
        {
            _internal_PreferencesVisibleInCSP = value;
        }
    }
    ...
    model_internal function setterListenerAccessLevel(value:flash.events.Event):void
    {
        _model.invalidateDependentOnAccessLevel();
    }
    ...
    model_internal function calculateIsValid():Boolean
    {
        ...
        if (!_model.AccessLevelIsValid)
        {
            propertyValidity = false;
            com.adobe.fiber.util.FiberUtils.arrayAdd(validationFailureMessages, _model.model_internal::_AccessLevelValidationFailureMessages);
        }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _CaseTeamRoleEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _CaseTeamRoleEntityMetadata) : void
    {
        var oldValue : _CaseTeamRoleEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
    ...
    model_internal var _doValidationCacheOfAccessLevel : Array = null;
    model_internal var _doValidationLastValOfAccessLevel : String;

    model_internal function _doValidationForAccessLevel(valueIn:Object):Array
    {
        var value : String = valueIn as String;

        if (model_internal::_doValidationCacheOfAccessLevel != null && model_internal::_doValidationLastValOfAccessLevel == value)
           return model_internal::_doValidationCacheOfAccessLevel ;

        _model.model_internal::_AccessLevelIsValidCacheInitialized = true;
        var validationFailures:Array = new Array();
        var errorMessage:String;
        var failure:Boolean;

        var valRes:ValidationResult;
        if (_model.isAccessLevelAvailable && _internal_AccessLevel == null)
        {
            validationFailures.push(new ValidationResult(true, "", "", "AccessLevel is required"));
        }

        model_internal::_doValidationCacheOfAccessLevel = validationFailures;
        model_internal::_doValidationLastValOfAccessLevel = value;
