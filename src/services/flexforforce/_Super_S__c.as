 ...
 * of this value object you may modify the generated sub-class of this class - S__c.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_S__c extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.S__c") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.S__c", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _S__cEntityMetadata;
    ...
    public function _Super_S__c()
    {
        _model = new _S__cEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _S__cEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _S__cEntityMetadata) : void
    {
        var oldValue : _S__cEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
