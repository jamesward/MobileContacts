...
[ExcludeClass]
internal class _CategoryDataEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    private static var emptyArray:Array = new Array();

    model_internal static var allProperties:Array = new Array("Id", "CategoryNodeId", "CreatedById", "CreatedDate", "IsDeleted", "LastModifiedById", "LastModifiedDate", "RelatedSobjectId", "SystemModstamp");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("Id", "CategoryNodeId", "CreatedById", "CreatedDate", "IsDeleted", "LastModifiedById", "LastModifiedDate", "RelatedSobjectId", "SystemModstamp");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("Id", "CategoryNodeId", "CreatedById", "CreatedDate", "IsDeleted", "LastModifiedById", "LastModifiedDate", "RelatedSobjectId", "SystemModstamp");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("Id", "CategoryNodeId", "CreatedById", "CreatedDate", "IsDeleted", "LastModifiedById", "LastModifiedDate", "RelatedSobjectId", "SystemModstamp");
    model_internal static var derivedProperties:Array = new Array();
    model_internal static var collectionProperties:Array = new Array();
    model_internal static var collectionBaseMap:Object;
    model_internal static var entityName:String = "CategoryData";
    model_internal static var dependentsOnMap:Object;
    model_internal static var dependedOnServices:Array = new Array();

    
    model_internal var _CategoryNodeIdIsValid:Boolean;
    model_internal var _CategoryNodeIdValidator:com.adobe.fiber.styles.StyleValidator;
    model_internal var _CategoryNodeIdIsValidCacheInitialized:Boolean = false;
    model_internal var _CategoryNodeIdValidationFailureMessages:Array;
    ...
    model_internal var _RelatedSobjectIdIsValid:Boolean;
    model_internal var _RelatedSobjectIdValidator:com.adobe.fiber.styles.StyleValidator;
    model_internal var _RelatedSobjectIdIsValidCacheInitialized:Boolean = false;
    model_internal var _RelatedSobjectIdValidationFailureMessages:Array;
    ...
    model_internal var _instance:_Super_CategoryData;
    model_internal static var _nullStyle:com.adobe.fiber.styles.Style = new com.adobe.fiber.styles.Style();

    public function _CategoryDataEntityMetadata(value : _Super_CategoryData)
    {
        ...
        if (model_internal::dependentsOnMap == null)
        {
            ...
            model_internal::dependentsOnMap["CategoryNodeId"] = new Array();
            ...
            model_internal::dependentsOnMap["RelatedSobjectId"] = new Array();
        ...
        model_internal::_CategoryNodeIdValidator = new StyleValidator(model_internal::_instance.model_internal::_doValidationForCategoryNodeId);
        model_internal::_CategoryNodeIdValidator.required = true;
        model_internal::_CategoryNodeIdValidator.requiredFieldError = "CategoryNodeId is required";
        //model_internal::_CategoryNodeIdValidator.source = model_internal::_instance;
        //model_internal::_CategoryNodeIdValidator.property = "CategoryNodeId";
        ...
        model_internal::_RelatedSobjectIdValidator = new StyleValidator(model_internal::_instance.model_internal::_doValidationForRelatedSobjectId);
        model_internal::_RelatedSobjectIdValidator.required = true;
        model_internal::_RelatedSobjectIdValidator.requiredFieldError = "RelatedSobjectId is required";
        //model_internal::_RelatedSobjectIdValidator.source = model_internal::_instance;
        //model_internal::_RelatedSobjectIdValidator.property = "RelatedSobjectId";
    ...
    override public function getDependants(propertyName:String):Array
    {
       if (model_internal::dataProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a data property of entity CategoryData");  
    ...
    override public function getCollectionBase(propertyName:String):String
    {
        if (model_internal::collectionProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a collection property of entity CategoryData");  
    ...
    override public function getValue(propertyName:String):*
    {
        ...
        {
            throw new Error(propertyName + " does not exist for entity CategoryData");
        }
    ...
    [Bindable(event="propertyChange")]
    public function get isCategoryNodeIdAvailable():Boolean
    {
        return true;
    }
    ...
    [Bindable(event="propertyChange")]
    public function get isRelatedSobjectIdAvailable():Boolean
    {
        return true;
    }
     ...
     */
    public function invalidateDependentOnCategoryNodeId():void
    {
        if (model_internal::_CategoryNodeIdIsValidCacheInitialized )
        {
            model_internal::_instance.model_internal::_doValidationCacheOfCategoryNodeId = null;
            model_internal::calculateCategoryNodeIdIsValid();
        }
    }
    ...
    public function invalidateDependentOnRelatedSobjectId():void
    {
        if (model_internal::_RelatedSobjectIdIsValidCacheInitialized )
        {
            model_internal::_instance.model_internal::_doValidationCacheOfRelatedSobjectId = null;
            model_internal::calculateRelatedSobjectIdIsValid();
        }
    }
    ...
    [Bindable(event="propertyChange")]   
    public function get CategoryNodeIdStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }

    public function get CategoryNodeIdValidator() : StyleValidator
    {
        return model_internal::_CategoryNodeIdValidator;
    }

    model_internal function set _CategoryNodeIdIsValid_der(value:Boolean):void 
    {
        var oldValue:Boolean = model_internal::_CategoryNodeIdIsValid;         
        if (oldValue !== value)
        {
            model_internal::_CategoryNodeIdIsValid = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "CategoryNodeIdIsValid", oldValue, value));
        }                             
    }

    [Bindable(event="propertyChange")]
    public function get CategoryNodeIdIsValid():Boolean
    {
        if (!model_internal::_CategoryNodeIdIsValidCacheInitialized)
        {
            model_internal::calculateCategoryNodeIdIsValid();
        ...
        return model_internal::_CategoryNodeIdIsValid;
    }

    model_internal function calculateCategoryNodeIdIsValid():void
    {
        var valRes:ValidationResultEvent = model_internal::_CategoryNodeIdValidator.validate(model_internal::_instance.CategoryNodeId)
        model_internal::_CategoryNodeIdIsValid_der = (valRes.results == null);
        model_internal::_CategoryNodeIdIsValidCacheInitialized = true;
        if (valRes.results == null)
             model_internal::CategoryNodeIdValidationFailureMessages_der = emptyArray;
        else
        {
            ...
            model_internal::CategoryNodeIdValidationFailureMessages_der = _valFailures;
        }
    }

    [Bindable(event="propertyChange")]
    public function get CategoryNodeIdValidationFailureMessages():Array
    {
        if (model_internal::_CategoryNodeIdValidationFailureMessages == null)
            model_internal::calculateCategoryNodeIdIsValid();

        return _CategoryNodeIdValidationFailureMessages;
    }

    model_internal function set CategoryNodeIdValidationFailureMessages_der(value:Array) : void
    {
        var oldValue:Array = model_internal::_CategoryNodeIdValidationFailureMessages;
        ...
        if (needUpdate)
        {
            model_internal::_CategoryNodeIdValidationFailureMessages = value;   
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "CategoryNodeIdValidationFailureMessages", oldValue, value));
    ...
    [Bindable(event="propertyChange")]   
    public function get RelatedSobjectIdStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }

    public function get RelatedSobjectIdValidator() : StyleValidator
    {
        return model_internal::_RelatedSobjectIdValidator;
    }

    model_internal function set _RelatedSobjectIdIsValid_der(value:Boolean):void 
    {
        var oldValue:Boolean = model_internal::_RelatedSobjectIdIsValid;         
        if (oldValue !== value)
        {
            model_internal::_RelatedSobjectIdIsValid = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "RelatedSobjectIdIsValid", oldValue, value));
        }                             
    }

    [Bindable(event="propertyChange")]
    public function get RelatedSobjectIdIsValid():Boolean
    {
        if (!model_internal::_RelatedSobjectIdIsValidCacheInitialized)
        {
            model_internal::calculateRelatedSobjectIdIsValid();
        ...
        return model_internal::_RelatedSobjectIdIsValid;
    }

    model_internal function calculateRelatedSobjectIdIsValid():void
    {
        var valRes:ValidationResultEvent = model_internal::_RelatedSobjectIdValidator.validate(model_internal::_instance.RelatedSobjectId)
        model_internal::_RelatedSobjectIdIsValid_der = (valRes.results == null);
        model_internal::_RelatedSobjectIdIsValidCacheInitialized = true;
        if (valRes.results == null)
             model_internal::RelatedSobjectIdValidationFailureMessages_der = emptyArray;
        else
        {
            var _valFailures:Array = new Array();
            for (var a:int = 0 ; a<valRes.results.length ; a++)
            ...
            model_internal::RelatedSobjectIdValidationFailureMessages_der = _valFailures;
        }
    }

    [Bindable(event="propertyChange")]
    public function get RelatedSobjectIdValidationFailureMessages():Array
    {
        if (model_internal::_RelatedSobjectIdValidationFailureMessages == null)
            model_internal::calculateRelatedSobjectIdIsValid();

        return _RelatedSobjectIdValidationFailureMessages;
    }

    model_internal function set RelatedSobjectIdValidationFailureMessages_der(value:Array) : void
    {
        var oldValue:Array = model_internal::_RelatedSobjectIdValidationFailureMessages;
        ...
        if (needUpdate)
        {
            model_internal::_RelatedSobjectIdValidationFailureMessages = value;   
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "RelatedSobjectIdValidationFailureMessages", oldValue, value));
            // Only execute calculateIsValid if it has been called before, to update the validationFailureMessages for
            // the entire entity.
            if (model_internal::_instance.model_internal::_cacheInitialized_isValid)
            {
     ...
     */  
     override public function getPropertyValidationFailureMessages(propertyName:String):Array
     {
         switch(propertyName)
         {
            case("CategoryNodeId"):
            {
                return CategoryNodeIdValidationFailureMessages;
            }
            case("CreatedById"):
            {
            ...
            case("RelatedSobjectId"):
            {
                return RelatedSobjectIdValidationFailureMessages;
            }
            case("SystemModstamp"):
            {
