...
[ExcludeClass]
internal class _CollaborationGroupEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    private static var emptyArray:Array = new Array();

    model_internal static var allProperties:Array = new Array("Id", "CollaborationType", "CreatedById", "CreatedDate", "Description", "LastModifiedById", "LastModifiedDate", "Name", "OwnerId", "SystemModstamp");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("Id", "CollaborationType", "CreatedById", "CreatedDate", "Description", "LastModifiedById", "LastModifiedDate", "Name", "OwnerId", "SystemModstamp");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("Id", "CollaborationType", "CreatedById", "CreatedDate", "Description", "LastModifiedById", "LastModifiedDate", "Name", "OwnerId", "SystemModstamp");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("Id", "CollaborationType", "CreatedById", "CreatedDate", "Description", "LastModifiedById", "LastModifiedDate", "Name", "OwnerId", "SystemModstamp");
    model_internal static var derivedProperties:Array = new Array();
    model_internal static var collectionProperties:Array = new Array();
    model_internal static var collectionBaseMap:Object;
    model_internal static var entityName:String = "CollaborationGroup";
    model_internal static var dependentsOnMap:Object;
    model_internal static var dependedOnServices:Array = new Array();

    
    model_internal var _CollaborationTypeIsValid:Boolean;
    model_internal var _CollaborationTypeValidator:com.adobe.fiber.styles.StyleValidator;
    model_internal var _CollaborationTypeIsValidCacheInitialized:Boolean = false;
    model_internal var _CollaborationTypeValidationFailureMessages:Array;
    ...
    model_internal var _instance:_Super_CollaborationGroup;
    model_internal static var _nullStyle:com.adobe.fiber.styles.Style = new com.adobe.fiber.styles.Style();

    public function _CollaborationGroupEntityMetadata(value : _Super_CollaborationGroup)
    {
        ...
        if (model_internal::dependentsOnMap == null)
        {
            ...
            model_internal::dependentsOnMap["CollaborationType"] = new Array();
        ...
        model_internal::_CollaborationTypeValidator = new StyleValidator(model_internal::_instance.model_internal::_doValidationForCollaborationType);
        model_internal::_CollaborationTypeValidator.required = true;
        model_internal::_CollaborationTypeValidator.requiredFieldError = "CollaborationType is required";
        //model_internal::_CollaborationTypeValidator.source = model_internal::_instance;
        //model_internal::_CollaborationTypeValidator.property = "CollaborationType";
    ...
    override public function getDependants(propertyName:String):Array
    {
       if (model_internal::dataProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a data property of entity CollaborationGroup");  
    ...
    override public function getCollectionBase(propertyName:String):String
    {
        if (model_internal::collectionProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a collection property of entity CollaborationGroup");  
    ...
    override public function getValue(propertyName:String):*
    {
        ...
        {
            throw new Error(propertyName + " does not exist for entity CollaborationGroup");
        }
    ...
    [Bindable(event="propertyChange")]
    public function get isCollaborationTypeAvailable():Boolean
    {
        return true;
    }
     ...
     */
    public function invalidateDependentOnCollaborationType():void
    {
        if (model_internal::_CollaborationTypeIsValidCacheInitialized )
        {
            model_internal::_instance.model_internal::_doValidationCacheOfCollaborationType = null;
            model_internal::calculateCollaborationTypeIsValid();
        }
    }
    ...
    [Bindable(event="propertyChange")]   
    public function get CollaborationTypeStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }

    public function get CollaborationTypeValidator() : StyleValidator
    {
        return model_internal::_CollaborationTypeValidator;
    }

    model_internal function set _CollaborationTypeIsValid_der(value:Boolean):void 
    {
        var oldValue:Boolean = model_internal::_CollaborationTypeIsValid;         
        if (oldValue !== value)
        {
            model_internal::_CollaborationTypeIsValid = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "CollaborationTypeIsValid", oldValue, value));
        }                             
    }

    [Bindable(event="propertyChange")]
    public function get CollaborationTypeIsValid():Boolean
    {
        if (!model_internal::_CollaborationTypeIsValidCacheInitialized)
        {
            model_internal::calculateCollaborationTypeIsValid();
        ...
        return model_internal::_CollaborationTypeIsValid;
    }

    model_internal function calculateCollaborationTypeIsValid():void
    {
        var valRes:ValidationResultEvent = model_internal::_CollaborationTypeValidator.validate(model_internal::_instance.CollaborationType)
        model_internal::_CollaborationTypeIsValid_der = (valRes.results == null);
        model_internal::_CollaborationTypeIsValidCacheInitialized = true;
        if (valRes.results == null)
             model_internal::CollaborationTypeValidationFailureMessages_der = emptyArray;
        else
        {
            ...
            model_internal::CollaborationTypeValidationFailureMessages_der = _valFailures;
        }
    }

    [Bindable(event="propertyChange")]
    public function get CollaborationTypeValidationFailureMessages():Array
    {
        if (model_internal::_CollaborationTypeValidationFailureMessages == null)
            model_internal::calculateCollaborationTypeIsValid();

        return _CollaborationTypeValidationFailureMessages;
    }

    model_internal function set CollaborationTypeValidationFailureMessages_der(value:Array) : void
    {
        var oldValue:Array = model_internal::_CollaborationTypeValidationFailureMessages;
        ...
        if (needUpdate)
        {
            model_internal::_CollaborationTypeValidationFailureMessages = value;   
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "CollaborationTypeValidationFailureMessages", oldValue, value));
     ...
     */  
     override public function getPropertyValidationFailureMessages(propertyName:String):Array
     {
         switch(propertyName)
         {
            ...
            {
                return CollaborationTypeValidationFailureMessages;
            }
            case("CreatedById"):
            {
