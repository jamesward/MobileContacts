 ...
 * of this value object you may modify the generated sub-class of this class - TaskStatus.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_TaskStatus extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.TaskStatus") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.TaskStatus", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _TaskStatusEntityMetadata;
    ...
    public function _Super_TaskStatus()
    {
        _model = new _TaskStatusEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _TaskStatusEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _TaskStatusEntityMetadata) : void
    {
        var oldValue : _TaskStatusEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
