...
[ExcludeClass]
internal class _OpportunityLineItemEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    private static var emptyArray:Array = new Array();

    model_internal static var allProperties:Array = new Array("Id", "ConnectionReceivedId", "ConnectionSentId", "CreatedById", "CreatedDate", "Description", "IsDeleted", "LastModifiedById", "LastModifiedDate", "ListPrice", "OpportunityId", "PricebookEntryId", "Quantity", "ServiceDate", "SortOrder", "SystemModstamp", "TotalPrice", "UnitPrice");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("Id", "ConnectionReceivedId", "ConnectionSentId", "CreatedById", "CreatedDate", "Description", "IsDeleted", "LastModifiedById", "LastModifiedDate", "ListPrice", "OpportunityId", "PricebookEntryId", "Quantity", "ServiceDate", "SortOrder", "SystemModstamp", "TotalPrice", "UnitPrice");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("Id", "ConnectionReceivedId", "ConnectionSentId", "CreatedById", "CreatedDate", "Description", "IsDeleted", "LastModifiedById", "LastModifiedDate", "ListPrice", "OpportunityId", "PricebookEntryId", "Quantity", "ServiceDate", "SortOrder", "SystemModstamp", "TotalPrice", "UnitPrice");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("Id", "ConnectionReceivedId", "ConnectionSentId", "CreatedById", "CreatedDate", "Description", "IsDeleted", "LastModifiedById", "LastModifiedDate", "ListPrice", "OpportunityId", "PricebookEntryId", "Quantity", "ServiceDate", "SortOrder", "SystemModstamp", "TotalPrice", "UnitPrice");
    model_internal static var derivedProperties:Array = new Array();
    model_internal static var collectionProperties:Array = new Array();
    model_internal static var collectionBaseMap:Object;
    model_internal static var entityName:String = "OpportunityLineItem";
    ...
    model_internal var _PricebookEntryIdIsValid:Boolean;
    model_internal var _PricebookEntryIdValidator:com.adobe.fiber.styles.StyleValidator;
    model_internal var _PricebookEntryIdIsValidCacheInitialized:Boolean = false;
    model_internal var _PricebookEntryIdValidationFailureMessages:Array;
    
    model_internal var _ServiceDateIsValid:Boolean;
    model_internal var _ServiceDateValidator:com.adobe.fiber.styles.StyleValidator;
    model_internal var _ServiceDateIsValidCacheInitialized:Boolean = false;
    model_internal var _ServiceDateValidationFailureMessages:Array;
    ...
    model_internal var _instance:_Super_OpportunityLineItem;
    model_internal static var _nullStyle:com.adobe.fiber.styles.Style = new com.adobe.fiber.styles.Style();

    public function _OpportunityLineItemEntityMetadata(value : _Super_OpportunityLineItem)
    {
        ...
        if (model_internal::dependentsOnMap == null)
        {
            ...
            model_internal::dependentsOnMap["ListPrice"] = new Array();
            model_internal::dependentsOnMap["OpportunityId"] = new Array();
            model_internal::dependentsOnMap["PricebookEntryId"] = new Array();
            model_internal::dependentsOnMap["Quantity"] = new Array();
            model_internal::dependentsOnMap["ServiceDate"] = new Array();
            model_internal::dependentsOnMap["SortOrder"] = new Array();
            model_internal::dependentsOnMap["SystemModstamp"] = new Array();
            model_internal::dependentsOnMap["TotalPrice"] = new Array();
        ...
        model_internal::_PricebookEntryIdValidator = new StyleValidator(model_internal::_instance.model_internal::_doValidationForPricebookEntryId);
        model_internal::_PricebookEntryIdValidator.required = true;
        model_internal::_PricebookEntryIdValidator.requiredFieldError = "PricebookEntryId is required";
        //model_internal::_PricebookEntryIdValidator.source = model_internal::_instance;
        //model_internal::_PricebookEntryIdValidator.property = "PricebookEntryId";
        model_internal::_ServiceDateValidator = new StyleValidator(model_internal::_instance.model_internal::_doValidationForServiceDate);
        model_internal::_ServiceDateValidator.required = true;
        model_internal::_ServiceDateValidator.requiredFieldError = "ServiceDate is required";
        //model_internal::_ServiceDateValidator.source = model_internal::_instance;
        //model_internal::_ServiceDateValidator.property = "ServiceDate";
    ...
    override public function getDependants(propertyName:String):Array
    {
       if (model_internal::dataProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a data property of entity OpportunityLineItem");  
    ...
    override public function getCollectionBase(propertyName:String):String
    {
        if (model_internal::collectionProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a collection property of entity OpportunityLineItem");  
    ...
    override public function getValue(propertyName:String):*
    {
        ...
        {
            throw new Error(propertyName + " does not exist for entity OpportunityLineItem");
        }
    ...
    [Bindable(event="propertyChange")]
    public function get isListPriceAvailable():Boolean
    {
        return true;
    }
    ...
    [Bindable(event="propertyChange")]
    public function get isPricebookEntryIdAvailable():Boolean
    {
        return true;
    }
    ...
    [Bindable(event="propertyChange")]
    public function get isServiceDateAvailable():Boolean
    {
        return true;
    }
    ...
    [Bindable(event="propertyChange")]
    public function get isTotalPriceAvailable():Boolean
    {
        return true;
    }
    ...
    public function invalidateDependentOnPricebookEntryId():void
    {
        if (model_internal::_PricebookEntryIdIsValidCacheInitialized )
        {
            model_internal::_instance.model_internal::_doValidationCacheOfPricebookEntryId = null;
            model_internal::calculatePricebookEntryIdIsValid();
        }
    }
    public function invalidateDependentOnServiceDate():void
    {
        if (model_internal::_ServiceDateIsValidCacheInitialized )
        {
            model_internal::_instance.model_internal::_doValidationCacheOfServiceDate = null;
            model_internal::calculateServiceDateIsValid();
        }
    }
    ...
    [Bindable(event="propertyChange")]   
    public function get ListPriceStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }
    ...
    [Bindable(event="propertyChange")]   
    public function get PricebookEntryIdStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }

    public function get PricebookEntryIdValidator() : StyleValidator
    {
        return model_internal::_PricebookEntryIdValidator;
    }

    model_internal function set _PricebookEntryIdIsValid_der(value:Boolean):void 
    {
        var oldValue:Boolean = model_internal::_PricebookEntryIdIsValid;         
        if (oldValue !== value)
        {
            model_internal::_PricebookEntryIdIsValid = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "PricebookEntryIdIsValid", oldValue, value));
        }                             
    }

    [Bindable(event="propertyChange")]
    public function get PricebookEntryIdIsValid():Boolean
    {
        if (!model_internal::_PricebookEntryIdIsValidCacheInitialized)
        {
            model_internal::calculatePricebookEntryIdIsValid();
        ...
        return model_internal::_PricebookEntryIdIsValid;
    }

    model_internal function calculatePricebookEntryIdIsValid():void
    {
        var valRes:ValidationResultEvent = model_internal::_PricebookEntryIdValidator.validate(model_internal::_instance.PricebookEntryId)
        model_internal::_PricebookEntryIdIsValid_der = (valRes.results == null);
        model_internal::_PricebookEntryIdIsValidCacheInitialized = true;
        if (valRes.results == null)
             model_internal::PricebookEntryIdValidationFailureMessages_der = emptyArray;
        else
        {
            var _valFailures:Array = new Array();
            for (var a:int = 0 ; a<valRes.results.length ; a++)
            ...
            model_internal::PricebookEntryIdValidationFailureMessages_der = _valFailures;
        }
    }

    [Bindable(event="propertyChange")]
    public function get PricebookEntryIdValidationFailureMessages():Array
    {
        if (model_internal::_PricebookEntryIdValidationFailureMessages == null)
            model_internal::calculatePricebookEntryIdIsValid();

        return _PricebookEntryIdValidationFailureMessages;
    }

    model_internal function set PricebookEntryIdValidationFailureMessages_der(value:Array) : void
    {
        var oldValue:Array = model_internal::_PricebookEntryIdValidationFailureMessages;
        ...
        if (needUpdate)
        {
            model_internal::_PricebookEntryIdValidationFailureMessages = value;   
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "PricebookEntryIdValidationFailureMessages", oldValue, value));
            // Only execute calculateIsValid if it has been called before, to update the validationFailureMessages for
            // the entire entity.
            if (model_internal::_instance.model_internal::_cacheInitialized_isValid)
            {
    ...
    [Bindable(event="propertyChange")]   
    public function get ServiceDateStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }

    public function get ServiceDateValidator() : StyleValidator
    {
        return model_internal::_ServiceDateValidator;
    }

    model_internal function set _ServiceDateIsValid_der(value:Boolean):void 
    {
        var oldValue:Boolean = model_internal::_ServiceDateIsValid;         
        if (oldValue !== value)
        {
            model_internal::_ServiceDateIsValid = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "ServiceDateIsValid", oldValue, value));
        }                             
    }

    [Bindable(event="propertyChange")]
    public function get ServiceDateIsValid():Boolean
    {
        if (!model_internal::_ServiceDateIsValidCacheInitialized)
        {
            model_internal::calculateServiceDateIsValid();
        ...
        return model_internal::_ServiceDateIsValid;
    }

    model_internal function calculateServiceDateIsValid():void
    {
        var valRes:ValidationResultEvent = model_internal::_ServiceDateValidator.validate(model_internal::_instance.ServiceDate)
        model_internal::_ServiceDateIsValid_der = (valRes.results == null);
        model_internal::_ServiceDateIsValidCacheInitialized = true;
        if (valRes.results == null)
             model_internal::ServiceDateValidationFailureMessages_der = emptyArray;
        else
        {
            var _valFailures:Array = new Array();
            for (var a:int = 0 ; a<valRes.results.length ; a++)
            ...
            model_internal::ServiceDateValidationFailureMessages_der = _valFailures;
        }
    }

    [Bindable(event="propertyChange")]
    public function get ServiceDateValidationFailureMessages():Array
    {
        if (model_internal::_ServiceDateValidationFailureMessages == null)
            model_internal::calculateServiceDateIsValid();

        return _ServiceDateValidationFailureMessages;
    }

    model_internal function set ServiceDateValidationFailureMessages_der(value:Array) : void
    {
        var oldValue:Array = model_internal::_ServiceDateValidationFailureMessages;
        ...
        if (needUpdate)
        {
            model_internal::_ServiceDateValidationFailureMessages = value;   
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "ServiceDateValidationFailureMessages", oldValue, value));
            // Only execute calculateIsValid if it has been called before, to update the validationFailureMessages for
            // the entire entity.
            if (model_internal::_instance.model_internal::_cacheInitialized_isValid)
            {
    ...
    [Bindable(event="propertyChange")]   
    public function get TotalPriceStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }
     ...
     */  
     override public function getPropertyValidationFailureMessages(propertyName:String):Array
     {
         switch(propertyName)
         {
            ...
            case("PricebookEntryId"):
            {
                return PricebookEntryIdValidationFailureMessages;
            }
            case("ServiceDate"):
            {
                return ServiceDateValidationFailureMessages;
            }
            case("SystemModstamp"):
            {
