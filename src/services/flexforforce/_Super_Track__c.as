 ...
 * of this value object you may modify the generated sub-class of this class - Track__c.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_Track__c extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.Track__c") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.Track__c", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _Track__cEntityMetadata;
    ...
    private var _internal_Description__c : String;
    ...
    private var _internal_Track_Chairperson__c : String;
    ...
    public function _Super_Track__c()
    {
        _model = new _Track__cEntityMetadata(this);
        ...
        model_internal::_changeWatcherArray.push(mx.binding.utils.ChangeWatcher.watch(this, "Description__c", model_internal::setterListenerDescription__c));
        ...
        model_internal::_changeWatcherArray.push(mx.binding.utils.ChangeWatcher.watch(this, "Track_Chairperson__c", model_internal::setterListenerTrack_Chairperson__c));
    ...
    [Bindable(event="propertyChange")]
    public function get Description__c() : String
    {
        return _internal_Description__c;
    }
    ...
    [Bindable(event="propertyChange")]
    public function get Track_Chairperson__c() : String
    {
        return _internal_Track_Chairperson__c;
    }
    ...
    public function set Description__c(value:String) : void
    {
        var oldValue:String = _internal_Description__c;
        if (oldValue !== value)
        {
            _internal_Description__c = value;
        }
    }
    ...
    public function set Track_Chairperson__c(value:String) : void
    {
        var oldValue:String = _internal_Track_Chairperson__c;
        if (oldValue !== value)
        {
            _internal_Track_Chairperson__c = value;
        }
    }
    ...
    model_internal function setterListenerDescription__c(value:flash.events.Event):void
    {
        _model.invalidateDependentOnDescription__c();
    }
    ...
    model_internal function setterListenerTrack_Chairperson__c(value:flash.events.Event):void
    {
        _model.invalidateDependentOnTrack_Chairperson__c();
    }
    ...
    model_internal function calculateIsValid():Boolean
    {
        ...
        if (!_model.Description__cIsValid)
        {
            propertyValidity = false;
            com.adobe.fiber.util.FiberUtils.arrayAdd(validationFailureMessages, _model.model_internal::_Description__cValidationFailureMessages);
        }
        ...
        if (!_model.Track_Chairperson__cIsValid)
        {
            propertyValidity = false;
            com.adobe.fiber.util.FiberUtils.arrayAdd(validationFailureMessages, _model.model_internal::_Track_Chairperson__cValidationFailureMessages);
        }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _Track__cEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _Track__cEntityMetadata) : void
    {
        var oldValue : _Track__cEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
    ...
    model_internal var _doValidationCacheOfDescription__c : Array = null;
    model_internal var _doValidationLastValOfDescription__c : String;

    model_internal function _doValidationForDescription__c(valueIn:Object):Array
    {
        var value : String = valueIn as String;

        if (model_internal::_doValidationCacheOfDescription__c != null && model_internal::_doValidationLastValOfDescription__c == value)
           return model_internal::_doValidationCacheOfDescription__c ;

        _model.model_internal::_Description__cIsValidCacheInitialized = true;
        var validationFailures:Array = new Array();
        var errorMessage:String;
        var failure:Boolean;

        var valRes:ValidationResult;
        if (_model.isDescription__cAvailable && _internal_Description__c == null)
        {
            validationFailures.push(new ValidationResult(true, "", "", "Description__c is required"));
        }

        model_internal::_doValidationCacheOfDescription__c = validationFailures;
        model_internal::_doValidationLastValOfDescription__c = value;
    ...
    model_internal var _doValidationCacheOfTrack_Chairperson__c : Array = null;
    model_internal var _doValidationLastValOfTrack_Chairperson__c : String;

    model_internal function _doValidationForTrack_Chairperson__c(valueIn:Object):Array
    {
        var value : String = valueIn as String;

        if (model_internal::_doValidationCacheOfTrack_Chairperson__c != null && model_internal::_doValidationLastValOfTrack_Chairperson__c == value)
           return model_internal::_doValidationCacheOfTrack_Chairperson__c ;

        _model.model_internal::_Track_Chairperson__cIsValidCacheInitialized = true;
        var validationFailures:Array = new Array();
        var errorMessage:String;
        var failure:Boolean;

        var valRes:ValidationResult;
        if (_model.isTrack_Chairperson__cAvailable && _internal_Track_Chairperson__c == null)
        {
            validationFailures.push(new ValidationResult(true, "", "", "Track_Chairperson__c is required"));
        }

        model_internal::_doValidationCacheOfTrack_Chairperson__c = validationFailures;
        model_internal::_doValidationLastValOfTrack_Chairperson__c = value;
