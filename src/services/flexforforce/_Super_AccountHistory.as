 ...
 * of this value object you may modify the generated sub-class of this class - AccountHistory.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_AccountHistory extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.AccountHistory") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.AccountHistory", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _AccountHistoryEntityMetadata;
    ...
    public function _Super_AccountHistory()
    {
        _model = new _AccountHistoryEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _AccountHistoryEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _AccountHistoryEntityMetadata) : void
    {
        var oldValue : _AccountHistoryEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
