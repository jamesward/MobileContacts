...
[ExcludeClass]
internal class _CaseSolutionEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    private static var emptyArray:Array = new Array();

    model_internal static var allProperties:Array = new Array("Id", "CaseId", "CreatedById", "CreatedDate", "IsDeleted", "SolutionId", "SystemModstamp");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("Id", "CaseId", "CreatedById", "CreatedDate", "IsDeleted", "SolutionId", "SystemModstamp");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("Id", "CaseId", "CreatedById", "CreatedDate", "IsDeleted", "SolutionId", "SystemModstamp");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("Id", "CaseId", "CreatedById", "CreatedDate", "IsDeleted", "SolutionId", "SystemModstamp");
    model_internal static var derivedProperties:Array = new Array();
    model_internal static var collectionProperties:Array = new Array();
    model_internal static var collectionBaseMap:Object;
    model_internal static var entityName:String = "CaseSolution";
    model_internal static var dependentsOnMap:Object;
    model_internal static var dependedOnServices:Array = new Array();

    
    model_internal var _CaseIdIsValid:Boolean;
    model_internal var _CaseIdValidator:com.adobe.fiber.styles.StyleValidator;
    model_internal var _CaseIdIsValidCacheInitialized:Boolean = false;
    model_internal var _CaseIdValidationFailureMessages:Array;
    ...
    model_internal var _SolutionIdIsValid:Boolean;
    model_internal var _SolutionIdValidator:com.adobe.fiber.styles.StyleValidator;
    model_internal var _SolutionIdIsValidCacheInitialized:Boolean = false;
    model_internal var _SolutionIdValidationFailureMessages:Array;
    ...
    model_internal var _instance:_Super_CaseSolution;
    model_internal static var _nullStyle:com.adobe.fiber.styles.Style = new com.adobe.fiber.styles.Style();

    public function _CaseSolutionEntityMetadata(value : _Super_CaseSolution)
    {
        ...
        if (model_internal::dependentsOnMap == null)
        {
            ...
            model_internal::dependentsOnMap["CaseId"] = new Array();
            ...
            model_internal::dependentsOnMap["SolutionId"] = new Array();
        ...
        model_internal::_CaseIdValidator = new StyleValidator(model_internal::_instance.model_internal::_doValidationForCaseId);
        model_internal::_CaseIdValidator.required = true;
        model_internal::_CaseIdValidator.requiredFieldError = "CaseId is required";
        //model_internal::_CaseIdValidator.source = model_internal::_instance;
        //model_internal::_CaseIdValidator.property = "CaseId";
        ...
        model_internal::_SolutionIdValidator = new StyleValidator(model_internal::_instance.model_internal::_doValidationForSolutionId);
        model_internal::_SolutionIdValidator.required = true;
        model_internal::_SolutionIdValidator.requiredFieldError = "SolutionId is required";
        //model_internal::_SolutionIdValidator.source = model_internal::_instance;
        //model_internal::_SolutionIdValidator.property = "SolutionId";
    ...
    override public function getDependants(propertyName:String):Array
    {
       if (model_internal::dataProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a data property of entity CaseSolution");  
    ...
    override public function getCollectionBase(propertyName:String):String
    {
        if (model_internal::collectionProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a collection property of entity CaseSolution");  
    ...
    override public function getValue(propertyName:String):*
    {
        ...
        {
            throw new Error(propertyName + " does not exist for entity CaseSolution");
        }
    ...
    [Bindable(event="propertyChange")]
    public function get isCaseIdAvailable():Boolean
    {
        return true;
    }
    ...
    [Bindable(event="propertyChange")]
    public function get isSolutionIdAvailable():Boolean
    {
        return true;
    }
     ...
     */
    public function invalidateDependentOnCaseId():void
    {
        if (model_internal::_CaseIdIsValidCacheInitialized )
        {
            model_internal::_instance.model_internal::_doValidationCacheOfCaseId = null;
            model_internal::calculateCaseIdIsValid();
        }
    }
    ...
    public function invalidateDependentOnSolutionId():void
    {
        if (model_internal::_SolutionIdIsValidCacheInitialized )
        {
            model_internal::_instance.model_internal::_doValidationCacheOfSolutionId = null;
            model_internal::calculateSolutionIdIsValid();
        }
    }
    ...
    [Bindable(event="propertyChange")]   
    public function get CaseIdStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }

    public function get CaseIdValidator() : StyleValidator
    {
        return model_internal::_CaseIdValidator;
    }

    model_internal function set _CaseIdIsValid_der(value:Boolean):void 
    {
        var oldValue:Boolean = model_internal::_CaseIdIsValid;         
        if (oldValue !== value)
        {
            model_internal::_CaseIdIsValid = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "CaseIdIsValid", oldValue, value));
        }                             
    }

    [Bindable(event="propertyChange")]
    public function get CaseIdIsValid():Boolean
    {
        if (!model_internal::_CaseIdIsValidCacheInitialized)
        {
            model_internal::calculateCaseIdIsValid();
        ...
        return model_internal::_CaseIdIsValid;
    }

    model_internal function calculateCaseIdIsValid():void
    {
        var valRes:ValidationResultEvent = model_internal::_CaseIdValidator.validate(model_internal::_instance.CaseId)
        model_internal::_CaseIdIsValid_der = (valRes.results == null);
        model_internal::_CaseIdIsValidCacheInitialized = true;
        if (valRes.results == null)
             model_internal::CaseIdValidationFailureMessages_der = emptyArray;
        else
        {
            ...
            model_internal::CaseIdValidationFailureMessages_der = _valFailures;
        }
    }

    [Bindable(event="propertyChange")]
    public function get CaseIdValidationFailureMessages():Array
    {
        if (model_internal::_CaseIdValidationFailureMessages == null)
            model_internal::calculateCaseIdIsValid();

        return _CaseIdValidationFailureMessages;
    }

    model_internal function set CaseIdValidationFailureMessages_der(value:Array) : void
    {
        var oldValue:Array = model_internal::_CaseIdValidationFailureMessages;
        ...
        if (needUpdate)
        {
            model_internal::_CaseIdValidationFailureMessages = value;   
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "CaseIdValidationFailureMessages", oldValue, value));
    ...
    [Bindable(event="propertyChange")]   
    public function get SolutionIdStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }

    public function get SolutionIdValidator() : StyleValidator
    {
        return model_internal::_SolutionIdValidator;
    }

    model_internal function set _SolutionIdIsValid_der(value:Boolean):void 
    {
        var oldValue:Boolean = model_internal::_SolutionIdIsValid;         
        if (oldValue !== value)
        {
            model_internal::_SolutionIdIsValid = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "SolutionIdIsValid", oldValue, value));
        }                             
    }

    [Bindable(event="propertyChange")]
    public function get SolutionIdIsValid():Boolean
    {
        if (!model_internal::_SolutionIdIsValidCacheInitialized)
        {
            model_internal::calculateSolutionIdIsValid();
        ...
        return model_internal::_SolutionIdIsValid;
    }

    model_internal function calculateSolutionIdIsValid():void
    {
        var valRes:ValidationResultEvent = model_internal::_SolutionIdValidator.validate(model_internal::_instance.SolutionId)
        model_internal::_SolutionIdIsValid_der = (valRes.results == null);
        model_internal::_SolutionIdIsValidCacheInitialized = true;
        if (valRes.results == null)
             model_internal::SolutionIdValidationFailureMessages_der = emptyArray;
        else
        {
            var _valFailures:Array = new Array();
            for (var a:int = 0 ; a<valRes.results.length ; a++)
            ...
            model_internal::SolutionIdValidationFailureMessages_der = _valFailures;
        }
    }

    [Bindable(event="propertyChange")]
    public function get SolutionIdValidationFailureMessages():Array
    {
        if (model_internal::_SolutionIdValidationFailureMessages == null)
            model_internal::calculateSolutionIdIsValid();

        return _SolutionIdValidationFailureMessages;
    }

    model_internal function set SolutionIdValidationFailureMessages_der(value:Array) : void
    {
        var oldValue:Array = model_internal::_SolutionIdValidationFailureMessages;
        ...
        if (needUpdate)
        {
            model_internal::_SolutionIdValidationFailureMessages = value;   
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "SolutionIdValidationFailureMessages", oldValue, value));
            // Only execute calculateIsValid if it has been called before, to update the validationFailureMessages for
            // the entire entity.
            if (model_internal::_instance.model_internal::_cacheInitialized_isValid)
            {
     ...
     */  
     override public function getPropertyValidationFailureMessages(propertyName:String):Array
     {
         switch(propertyName)
         {
            case("CaseId"):
            {
                return CaseIdValidationFailureMessages;
            }
            case("CreatedById"):
            {
            ...
            case("SolutionId"):
            {
                return SolutionIdValidationFailureMessages;
            }
            case("SystemModstamp"):
            {
