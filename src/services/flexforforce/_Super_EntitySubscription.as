 ...
 * of this value object you may modify the generated sub-class of this class - EntitySubscription.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_EntitySubscription extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.EntitySubscription") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.EntitySubscription", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _EntitySubscriptionEntityMetadata;
    ...
    private var _internal_SubscriberId : String;
    ...
    public function _Super_EntitySubscription()
    {
        _model = new _EntitySubscriptionEntityMetadata(this);
        ...
        model_internal::_changeWatcherArray.push(mx.binding.utils.ChangeWatcher.watch(this, "SubscriberId", model_internal::setterListenerSubscriberId));
    ...
    {
        var oldValue:String = _internal_SubscriberId;
        if (oldValue !== value)
        {
            _internal_SubscriberId = value;
        }
    }
    ...
    model_internal function setterListenerSubscriberId(value:flash.events.Event):void
    {
        _model.invalidateDependentOnSubscriberId();
    }
    ...
    model_internal function calculateIsValid():Boolean
    {
        ...
        if (!_model.SubscriberIdIsValid)
        {
            propertyValidity = false;
            com.adobe.fiber.util.FiberUtils.arrayAdd(validationFailureMessages, _model.model_internal::_SubscriberIdValidationFailureMessages);
        }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _EntitySubscriptionEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _EntitySubscriptionEntityMetadata) : void
    {
        var oldValue : _EntitySubscriptionEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
    ...
    model_internal var _doValidationCacheOfSubscriberId : Array = null;
    model_internal var _doValidationLastValOfSubscriberId : String;

    model_internal function _doValidationForSubscriberId(valueIn:Object):Array
    {
        var value : String = valueIn as String;

        if (model_internal::_doValidationCacheOfSubscriberId != null && model_internal::_doValidationLastValOfSubscriberId == value)
           return model_internal::_doValidationCacheOfSubscriberId ;

        _model.model_internal::_SubscriberIdIsValidCacheInitialized = true;
        var validationFailures:Array = new Array();
        var errorMessage:String;
        var failure:Boolean;

        var valRes:ValidationResult;
        if (_model.isSubscriberIdAvailable && _internal_SubscriberId == null)
        {
            validationFailures.push(new ValidationResult(true, "", "", "SubscriberId is required"));
        }

        model_internal::_doValidationCacheOfSubscriberId = validationFailures;
        model_internal::_doValidationLastValOfSubscriberId = value;
