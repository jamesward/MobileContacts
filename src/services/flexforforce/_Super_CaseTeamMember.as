 ...
 * of this value object you may modify the generated sub-class of this class - CaseTeamMember.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_CaseTeamMember extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.CaseTeamMember") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.CaseTeamMember", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _CaseTeamMemberEntityMetadata;
    ...
    private var _internal_TeamTemplateMemberId : String;
    ...
    public function _Super_CaseTeamMember()
    {
        _model = new _CaseTeamMemberEntityMetadata(this);
        ...
        model_internal::_changeWatcherArray.push(mx.binding.utils.ChangeWatcher.watch(this, "TeamTemplateMemberId", model_internal::setterListenerTeamTemplateMemberId));
    ...
    [Bindable(event="propertyChange")]
    public function get TeamTemplateMemberId() : String
    {
        return _internal_TeamTemplateMemberId;
    }
    ...
    public function set TeamTemplateMemberId(value:String) : void
    {
        var oldValue:String = _internal_TeamTemplateMemberId;
        if (oldValue !== value)
        {
            _internal_TeamTemplateMemberId = value;
        }
    }
    ...
    model_internal function setterListenerTeamTemplateMemberId(value:flash.events.Event):void
    {
        _model.invalidateDependentOnTeamTemplateMemberId();
    }
    ...
    model_internal function calculateIsValid():Boolean
    {
        ...
        if (!_model.TeamTemplateMemberIdIsValid)
        {
            propertyValidity = false;
            com.adobe.fiber.util.FiberUtils.arrayAdd(validationFailureMessages, _model.model_internal::_TeamTemplateMemberIdValidationFailureMessages);
        }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _CaseTeamMemberEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _CaseTeamMemberEntityMetadata) : void
    {
        var oldValue : _CaseTeamMemberEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
    ...
    model_internal var _doValidationCacheOfTeamTemplateMemberId : Array = null;
    model_internal var _doValidationLastValOfTeamTemplateMemberId : String;

    model_internal function _doValidationForTeamTemplateMemberId(valueIn:Object):Array
    {
        var value : String = valueIn as String;

        if (model_internal::_doValidationCacheOfTeamTemplateMemberId != null && model_internal::_doValidationLastValOfTeamTemplateMemberId == value)
           return model_internal::_doValidationCacheOfTeamTemplateMemberId ;

        _model.model_internal::_TeamTemplateMemberIdIsValidCacheInitialized = true;
        var validationFailures:Array = new Array();
        var errorMessage:String;
        var failure:Boolean;

        var valRes:ValidationResult;
        if (_model.isTeamTemplateMemberIdAvailable && _internal_TeamTemplateMemberId == null)
        {
            validationFailures.push(new ValidationResult(true, "", "", "TeamTemplateMemberId is required"));
        }

        model_internal::_doValidationCacheOfTeamTemplateMemberId = validationFailures;
        model_internal::_doValidationLastValOfTeamTemplateMemberId = value;
