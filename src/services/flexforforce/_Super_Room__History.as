 ...
 * of this value object you may modify the generated sub-class of this class - Room__History.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_Room__History extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.Room__History") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.Room__History", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _Room__HistoryEntityMetadata;
    ...
    public function _Super_Room__History()
    {
        _model = new _Room__HistoryEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _Room__HistoryEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _Room__HistoryEntityMetadata) : void
    {
        var oldValue : _Room__HistoryEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
