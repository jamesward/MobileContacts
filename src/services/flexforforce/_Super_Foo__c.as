 ...
 * of this value object you may modify the generated sub-class of this class - Foo__c.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_Foo__c extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.Foo__c") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.Foo__c", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _Foo__cEntityMetadata;
    ...
    public function _Super_Foo__c()
    {
        _model = new _Foo__cEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _Foo__cEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _Foo__cEntityMetadata) : void
    {
        var oldValue : _Foo__cEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
