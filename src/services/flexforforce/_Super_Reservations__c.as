 ...
 * of this value object you may modify the generated sub-class of this class - Reservations__c.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_Reservations__c extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.Reservations__c") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.Reservations__c", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _Reservations__cEntityMetadata;
    ...
    private var _internal_event_date__c : Date;
    ...
    public function _Super_Reservations__c()
    {
        _model = new _Reservations__cEntityMetadata(this);
        ...
        model_internal::_changeWatcherArray.push(mx.binding.utils.ChangeWatcher.watch(this, "event_date__c", model_internal::setterListenerEvent_date__c));
    ...
    [Bindable(event="propertyChange")]
    public function get event_date__c() : Date
    {
        return _internal_event_date__c;
    }
    ...
    public function set event_date__c(value:Date) : void
    {
        var oldValue:Date = _internal_event_date__c;
        if (oldValue !== value)
        {
            _internal_event_date__c = value;
        }
    }
    ...
    model_internal function setterListenerEvent_date__c(value:flash.events.Event):void
    {
        _model.invalidateDependentOnEvent_date__c();
    }
    ...
    model_internal function calculateIsValid():Boolean
    {
        ...
        if (!_model.event_date__cIsValid)
        {
            propertyValidity = false;
            com.adobe.fiber.util.FiberUtils.arrayAdd(validationFailureMessages, _model.model_internal::_event_date__cValidationFailureMessages);
        }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _Reservations__cEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _Reservations__cEntityMetadata) : void
    {
        var oldValue : _Reservations__cEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
    ...
    model_internal var _doValidationCacheOfEvent_date__c : Array = null;
    model_internal var _doValidationLastValOfEvent_date__c : Date;

    model_internal function _doValidationForEvent_date__c(valueIn:Object):Array
    {
        var value : Date = valueIn as Date;

        if (model_internal::_doValidationCacheOfEvent_date__c != null && model_internal::_doValidationLastValOfEvent_date__c == value)
           return model_internal::_doValidationCacheOfEvent_date__c ;

        _model.model_internal::_event_date__cIsValidCacheInitialized = true;
        var validationFailures:Array = new Array();
        var errorMessage:String;
        var failure:Boolean;

        var valRes:ValidationResult;
        if (_model.isEvent_date__cAvailable && _internal_event_date__c == null)
        {
            validationFailures.push(new ValidationResult(true, "", "", "event_date__c is required"));
        }

        model_internal::_doValidationCacheOfEvent_date__c = validationFailures;
        model_internal::_doValidationLastValOfEvent_date__c = value;
