...
[ExcludeClass]
internal class _IncidentCar__cEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    private static var emptyArray:Array = new Array();

    model_internal static var allProperties:Array = new Array("Id", "AccidentReport__c", "ConnectionReceivedId", "ConnectionSentId", "CreatedById", "CreatedDate", "EndX__c", "EndY__c", "IsDeleted", "LastActivityDate", "LastModifiedById", "LastModifiedDate", "Name", "StartX__c", "StartY__c", "SystemModstamp");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("Id", "AccidentReport__c", "ConnectionReceivedId", "ConnectionSentId", "CreatedById", "CreatedDate", "EndX__c", "EndY__c", "IsDeleted", "LastActivityDate", "LastModifiedById", "LastModifiedDate", "Name", "StartX__c", "StartY__c", "SystemModstamp");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("Id", "AccidentReport__c", "ConnectionReceivedId", "ConnectionSentId", "CreatedById", "CreatedDate", "EndX__c", "EndY__c", "IsDeleted", "LastActivityDate", "LastModifiedById", "LastModifiedDate", "Name", "StartX__c", "StartY__c", "SystemModstamp");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("Id", "AccidentReport__c", "ConnectionReceivedId", "ConnectionSentId", "CreatedById", "CreatedDate", "EndX__c", "EndY__c", "IsDeleted", "LastActivityDate", "LastModifiedById", "LastModifiedDate", "Name", "StartX__c", "StartY__c", "SystemModstamp");
    model_internal static var derivedProperties:Array = new Array();
    model_internal static var collectionProperties:Array = new Array();
    model_internal static var collectionBaseMap:Object;
    model_internal static var entityName:String = "IncidentCar__c";
    model_internal static var dependentsOnMap:Object;
    model_internal static var dependedOnServices:Array = new Array();

    
    model_internal var _AccidentReport__cIsValid:Boolean;
    model_internal var _AccidentReport__cValidator:com.adobe.fiber.styles.StyleValidator;
    model_internal var _AccidentReport__cIsValidCacheInitialized:Boolean = false;
    model_internal var _AccidentReport__cValidationFailureMessages:Array;
    ...
    model_internal var _instance:_Super_IncidentCar__c;
    model_internal static var _nullStyle:com.adobe.fiber.styles.Style = new com.adobe.fiber.styles.Style();

    public function _IncidentCar__cEntityMetadata(value : _Super_IncidentCar__c)
    {
        ...
        if (model_internal::dependentsOnMap == null)
        {
            ...
            model_internal::dependentsOnMap["AccidentReport__c"] = new Array();
            ...
            model_internal::dependentsOnMap["EndX__c"] = new Array();
            model_internal::dependentsOnMap["EndY__c"] = new Array();
            ...
            model_internal::dependentsOnMap["StartX__c"] = new Array();
            model_internal::dependentsOnMap["StartY__c"] = new Array();
        ...
        model_internal::_AccidentReport__cValidator = new StyleValidator(model_internal::_instance.model_internal::_doValidationForAccidentReport__c);
        model_internal::_AccidentReport__cValidator.required = true;
        model_internal::_AccidentReport__cValidator.requiredFieldError = "AccidentReport__c is required";
        //model_internal::_AccidentReport__cValidator.source = model_internal::_instance;
        //model_internal::_AccidentReport__cValidator.property = "AccidentReport__c";
    ...
    override public function getDependants(propertyName:String):Array
    {
       if (model_internal::dataProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a data property of entity IncidentCar__c");  
    ...
    override public function getCollectionBase(propertyName:String):String
    {
        if (model_internal::collectionProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a collection property of entity IncidentCar__c");  
    ...
    override public function getValue(propertyName:String):*
    {
        ...
        {
            throw new Error(propertyName + " does not exist for entity IncidentCar__c");
        }
    ...
    [Bindable(event="propertyChange")]
    public function get isAccidentReport__cAvailable():Boolean
    {
        return true;
    }
    ...
    [Bindable(event="propertyChange")]
    public function get isEndX__cAvailable():Boolean
    {
        return true;
    }

    [Bindable(event="propertyChange")]
    public function get isEndY__cAvailable():Boolean
    {
        return true;
    }
    ...
    [Bindable(event="propertyChange")]
    public function get isStartX__cAvailable():Boolean
    {
        return true;
    }

    [Bindable(event="propertyChange")]
    public function get isStartY__cAvailable():Boolean
    {
        return true;
    }
     ...
     */
    public function invalidateDependentOnAccidentReport__c():void
    {
        if (model_internal::_AccidentReport__cIsValidCacheInitialized )
        {
            model_internal::_instance.model_internal::_doValidationCacheOfAccidentReport__c = null;
            model_internal::calculateAccidentReport__cIsValid();
        }
    }
    ...
    [Bindable(event="propertyChange")]   
    public function get AccidentReport__cStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }

    public function get AccidentReport__cValidator() : StyleValidator
    {
        return model_internal::_AccidentReport__cValidator;
    }

    model_internal function set _AccidentReport__cIsValid_der(value:Boolean):void 
    {
        var oldValue:Boolean = model_internal::_AccidentReport__cIsValid;         
        if (oldValue !== value)
        {
            model_internal::_AccidentReport__cIsValid = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "AccidentReport__cIsValid", oldValue, value));
        }                             
    }

    [Bindable(event="propertyChange")]
    public function get AccidentReport__cIsValid():Boolean
    {
        if (!model_internal::_AccidentReport__cIsValidCacheInitialized)
        {
            model_internal::calculateAccidentReport__cIsValid();
        ...
        return model_internal::_AccidentReport__cIsValid;
    }

    model_internal function calculateAccidentReport__cIsValid():void
    {
        var valRes:ValidationResultEvent = model_internal::_AccidentReport__cValidator.validate(model_internal::_instance.AccidentReport__c)
        model_internal::_AccidentReport__cIsValid_der = (valRes.results == null);
        model_internal::_AccidentReport__cIsValidCacheInitialized = true;
        if (valRes.results == null)
             model_internal::AccidentReport__cValidationFailureMessages_der = emptyArray;
        else
        {
            ...
            model_internal::AccidentReport__cValidationFailureMessages_der = _valFailures;
        }
    }

    [Bindable(event="propertyChange")]
    public function get AccidentReport__cValidationFailureMessages():Array
    {
        if (model_internal::_AccidentReport__cValidationFailureMessages == null)
            model_internal::calculateAccidentReport__cIsValid();

        return _AccidentReport__cValidationFailureMessages;
    }

    model_internal function set AccidentReport__cValidationFailureMessages_der(value:Array) : void
    {
        var oldValue:Array = model_internal::_AccidentReport__cValidationFailureMessages;
        ...
        if (needUpdate)
        {
            model_internal::_AccidentReport__cValidationFailureMessages = value;   
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "AccidentReport__cValidationFailureMessages", oldValue, value));
    ...
    [Bindable(event="propertyChange")]   
    public function get EndX__cStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }

    [Bindable(event="propertyChange")]   
    public function get EndY__cStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }
    ...
    [Bindable(event="propertyChange")]   
    public function get StartX__cStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }

    [Bindable(event="propertyChange")]   
    public function get StartY__cStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }
     ...
     */  
     override public function getPropertyValidationFailureMessages(propertyName:String):Array
     {
         switch(propertyName)
         {
            case("AccidentReport__c"):
            {
                return AccidentReport__cValidationFailureMessages;
            }
