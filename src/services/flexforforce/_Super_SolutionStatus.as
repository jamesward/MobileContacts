 ...
 * of this value object you may modify the generated sub-class of this class - SolutionStatus.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_SolutionStatus extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.SolutionStatus") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.SolutionStatus", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _SolutionStatusEntityMetadata;
    ...
    private var _internal_IsReviewed : Boolean;
    ...
    public function _Super_SolutionStatus()
    {
        _model = new _SolutionStatusEntityMetadata(this);
    ...
    [Bindable(event="propertyChange")]
    public function get IsReviewed() : Boolean
    {
        return _internal_IsReviewed;
    }
    ...
    public function set IsReviewed(value:Boolean) : void
    {
        var oldValue:Boolean = _internal_IsReviewed;
        if (oldValue !== value)
        {
            _internal_IsReviewed = value;
        }
    }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _SolutionStatusEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _SolutionStatusEntityMetadata) : void
    {
        var oldValue : _SolutionStatusEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
