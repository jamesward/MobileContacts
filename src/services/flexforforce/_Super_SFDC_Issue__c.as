 ...
 * of this value object you may modify the generated sub-class of this class - SFDC_Issue__c.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_SFDC_Issue__c extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.SFDC_Issue__c") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.SFDC_Issue__c", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _SFDC_Issue__cEntityMetadata;
    ...
    private var _internal_SFDC_Issue_Description__c : String;
    private var _internal_SFDC_Issue_Name__c : String;
    private var _internal_SFDC_Issue_Priority__c : String;
    private var _internal_SFDC_Issue_Status__c : String;
    private var _internal_SFDC_Project__c : String;
    private var _internal_SystemModstamp : Date;
    private var _internal_User__c : String;
    ...
    public function _Super_SFDC_Issue__c()
    {
        _model = new _SFDC_Issue__cEntityMetadata(this);
        ...
        model_internal::_changeWatcherArray.push(mx.binding.utils.ChangeWatcher.watch(this, "SFDC_Issue_Description__c", model_internal::setterListenerSFDC_Issue_Description__c));
        model_internal::_changeWatcherArray.push(mx.binding.utils.ChangeWatcher.watch(this, "SFDC_Issue_Name__c", model_internal::setterListenerSFDC_Issue_Name__c));
        model_internal::_changeWatcherArray.push(mx.binding.utils.ChangeWatcher.watch(this, "SFDC_Issue_Priority__c", model_internal::setterListenerSFDC_Issue_Priority__c));
        model_internal::_changeWatcherArray.push(mx.binding.utils.ChangeWatcher.watch(this, "SFDC_Issue_Status__c", model_internal::setterListenerSFDC_Issue_Status__c));
        model_internal::_changeWatcherArray.push(mx.binding.utils.ChangeWatcher.watch(this, "SFDC_Project__c", model_internal::setterListenerSFDC_Project__c));
        ...
        model_internal::_changeWatcherArray.push(mx.binding.utils.ChangeWatcher.watch(this, "User__c", model_internal::setterListenerUser__c));
    ...
    [Bindable(event="propertyChange")]
    public function get SFDC_Issue_Description__c() : String
    {
        return _internal_SFDC_Issue_Description__c;
    }

    [Bindable(event="propertyChange")]
    public function get SFDC_Issue_Name__c() : String
    {
        return _internal_SFDC_Issue_Name__c;
    }

    [Bindable(event="propertyChange")]
    public function get SFDC_Issue_Priority__c() : String
    {
        return _internal_SFDC_Issue_Priority__c;
    }

    [Bindable(event="propertyChange")]
    public function get SFDC_Issue_Status__c() : String
    {
        return _internal_SFDC_Issue_Status__c;
    }

    [Bindable(event="propertyChange")]
    public function get SFDC_Project__c() : String
    {
        return _internal_SFDC_Project__c;
    }
    ...
    [Bindable(event="propertyChange")]
    public function get User__c() : String
    {
        return _internal_User__c;
    }
    ...
    public function set SFDC_Issue_Description__c(value:String) : void
    {
        var oldValue:String = _internal_SFDC_Issue_Description__c;
        if (oldValue !== value)
        {
            _internal_SFDC_Issue_Description__c = value;
        }
    }

    public function set SFDC_Issue_Name__c(value:String) : void
    {
        var oldValue:String = _internal_SFDC_Issue_Name__c;
        if (oldValue !== value)
        {
            _internal_SFDC_Issue_Name__c = value;
        }
    }

    public function set SFDC_Issue_Priority__c(value:String) : void
    {
        var oldValue:String = _internal_SFDC_Issue_Priority__c;
        if (oldValue !== value)
        {
            _internal_SFDC_Issue_Priority__c = value;
        }
    }

    public function set SFDC_Issue_Status__c(value:String) : void
    {
        var oldValue:String = _internal_SFDC_Issue_Status__c;
        if (oldValue !== value)
        {
            _internal_SFDC_Issue_Status__c = value;
        }
    }

    public function set SFDC_Project__c(value:String) : void
    {
        var oldValue:String = _internal_SFDC_Project__c;
        if (oldValue !== value)
        {
            _internal_SFDC_Project__c = value;
        }
    }
    ...
    public function set User__c(value:String) : void
    {
        var oldValue:String = _internal_User__c;
        if (oldValue !== value)
        {
            _internal_User__c = value;
        }
    }
    ...
    model_internal function setterListenerSFDC_Issue_Description__c(value:flash.events.Event):void
    {
        _model.invalidateDependentOnSFDC_Issue_Description__c();
    }

    model_internal function setterListenerSFDC_Issue_Name__c(value:flash.events.Event):void
    {
        _model.invalidateDependentOnSFDC_Issue_Name__c();
    }

    model_internal function setterListenerSFDC_Issue_Priority__c(value:flash.events.Event):void
    {
        _model.invalidateDependentOnSFDC_Issue_Priority__c();
    }

    model_internal function setterListenerSFDC_Issue_Status__c(value:flash.events.Event):void
    {
        _model.invalidateDependentOnSFDC_Issue_Status__c();
    }

    model_internal function setterListenerSFDC_Project__c(value:flash.events.Event):void
    {
        _model.invalidateDependentOnSFDC_Project__c();
    }
    ...
    model_internal function setterListenerUser__c(value:flash.events.Event):void
    {
        _model.invalidateDependentOnUser__c();
    }
    ...
    model_internal function calculateIsValid():Boolean
    {
        ...
        if (!_model.SFDC_Issue_Description__cIsValid)
        {
            propertyValidity = false;
            com.adobe.fiber.util.FiberUtils.arrayAdd(validationFailureMessages, _model.model_internal::_SFDC_Issue_Description__cValidationFailureMessages);
        }
        if (!_model.SFDC_Issue_Name__cIsValid)
        {
            propertyValidity = false;
            com.adobe.fiber.util.FiberUtils.arrayAdd(validationFailureMessages, _model.model_internal::_SFDC_Issue_Name__cValidationFailureMessages);
        }
        if (!_model.SFDC_Issue_Priority__cIsValid)
        {
            propertyValidity = false;
            com.adobe.fiber.util.FiberUtils.arrayAdd(validationFailureMessages, _model.model_internal::_SFDC_Issue_Priority__cValidationFailureMessages);
        }
        if (!_model.SFDC_Issue_Status__cIsValid)
        {
            propertyValidity = false;
            com.adobe.fiber.util.FiberUtils.arrayAdd(validationFailureMessages, _model.model_internal::_SFDC_Issue_Status__cValidationFailureMessages);
        }
        if (!_model.SFDC_Project__cIsValid)
        {
            propertyValidity = false;
            com.adobe.fiber.util.FiberUtils.arrayAdd(validationFailureMessages, _model.model_internal::_SFDC_Project__cValidationFailureMessages);
        }
        ...
        if (!_model.User__cIsValid)
        {
            propertyValidity = false;
            com.adobe.fiber.util.FiberUtils.arrayAdd(validationFailureMessages, _model.model_internal::_User__cValidationFailureMessages);
        }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _SFDC_Issue__cEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _SFDC_Issue__cEntityMetadata) : void
    {
        var oldValue : _SFDC_Issue__cEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
    ...
    model_internal var _doValidationCacheOfSFDC_Issue_Description__c : Array = null;
    model_internal var _doValidationLastValOfSFDC_Issue_Description__c : String;

    model_internal function _doValidationForSFDC_Issue_Description__c(valueIn:Object):Array
    {
        var value : String = valueIn as String;

        if (model_internal::_doValidationCacheOfSFDC_Issue_Description__c != null && model_internal::_doValidationLastValOfSFDC_Issue_Description__c == value)
           return model_internal::_doValidationCacheOfSFDC_Issue_Description__c ;

        _model.model_internal::_SFDC_Issue_Description__cIsValidCacheInitialized = true;
        var validationFailures:Array = new Array();
        var errorMessage:String;
        var failure:Boolean;

        var valRes:ValidationResult;
        if (_model.isSFDC_Issue_Description__cAvailable && _internal_SFDC_Issue_Description__c == null)
        {
            validationFailures.push(new ValidationResult(true, "", "", "SFDC_Issue_Description__c is required"));
        }

        model_internal::_doValidationCacheOfSFDC_Issue_Description__c = validationFailures;
        model_internal::_doValidationLastValOfSFDC_Issue_Description__c = value;

        return validationFailures;
    }
    
    model_internal var _doValidationCacheOfSFDC_Issue_Name__c : Array = null;
    model_internal var _doValidationLastValOfSFDC_Issue_Name__c : String;

    model_internal function _doValidationForSFDC_Issue_Name__c(valueIn:Object):Array
    {
        var value : String = valueIn as String;

        if (model_internal::_doValidationCacheOfSFDC_Issue_Name__c != null && model_internal::_doValidationLastValOfSFDC_Issue_Name__c == value)
           return model_internal::_doValidationCacheOfSFDC_Issue_Name__c ;

        _model.model_internal::_SFDC_Issue_Name__cIsValidCacheInitialized = true;
        var validationFailures:Array = new Array();
        var errorMessage:String;
        var failure:Boolean;

        var valRes:ValidationResult;
        if (_model.isSFDC_Issue_Name__cAvailable && _internal_SFDC_Issue_Name__c == null)
        {
            validationFailures.push(new ValidationResult(true, "", "", "SFDC_Issue_Name__c is required"));
        }

        model_internal::_doValidationCacheOfSFDC_Issue_Name__c = validationFailures;
        model_internal::_doValidationLastValOfSFDC_Issue_Name__c = value;

        return validationFailures;
    }
    
    model_internal var _doValidationCacheOfSFDC_Issue_Priority__c : Array = null;
    model_internal var _doValidationLastValOfSFDC_Issue_Priority__c : String;

    model_internal function _doValidationForSFDC_Issue_Priority__c(valueIn:Object):Array
    {
        var value : String = valueIn as String;

        if (model_internal::_doValidationCacheOfSFDC_Issue_Priority__c != null && model_internal::_doValidationLastValOfSFDC_Issue_Priority__c == value)
           return model_internal::_doValidationCacheOfSFDC_Issue_Priority__c ;

        _model.model_internal::_SFDC_Issue_Priority__cIsValidCacheInitialized = true;
        var validationFailures:Array = new Array();
        var errorMessage:String;
        var failure:Boolean;

        var valRes:ValidationResult;
        if (_model.isSFDC_Issue_Priority__cAvailable && _internal_SFDC_Issue_Priority__c == null)
        {
            validationFailures.push(new ValidationResult(true, "", "", "SFDC_Issue_Priority__c is required"));
        }

        model_internal::_doValidationCacheOfSFDC_Issue_Priority__c = validationFailures;
        model_internal::_doValidationLastValOfSFDC_Issue_Priority__c = value;

        return validationFailures;
    }
    
    model_internal var _doValidationCacheOfSFDC_Issue_Status__c : Array = null;
    model_internal var _doValidationLastValOfSFDC_Issue_Status__c : String;

    model_internal function _doValidationForSFDC_Issue_Status__c(valueIn:Object):Array
    {
        var value : String = valueIn as String;

        if (model_internal::_doValidationCacheOfSFDC_Issue_Status__c != null && model_internal::_doValidationLastValOfSFDC_Issue_Status__c == value)
           return model_internal::_doValidationCacheOfSFDC_Issue_Status__c ;

        _model.model_internal::_SFDC_Issue_Status__cIsValidCacheInitialized = true;
        var validationFailures:Array = new Array();
        var errorMessage:String;
        var failure:Boolean;

        var valRes:ValidationResult;
        if (_model.isSFDC_Issue_Status__cAvailable && _internal_SFDC_Issue_Status__c == null)
        {
            validationFailures.push(new ValidationResult(true, "", "", "SFDC_Issue_Status__c is required"));
        }

        model_internal::_doValidationCacheOfSFDC_Issue_Status__c = validationFailures;
        model_internal::_doValidationLastValOfSFDC_Issue_Status__c = value;

        return validationFailures;
    }
    
    model_internal var _doValidationCacheOfSFDC_Project__c : Array = null;
    model_internal var _doValidationLastValOfSFDC_Project__c : String;

    model_internal function _doValidationForSFDC_Project__c(valueIn:Object):Array
    {
        var value : String = valueIn as String;

        if (model_internal::_doValidationCacheOfSFDC_Project__c != null && model_internal::_doValidationLastValOfSFDC_Project__c == value)
           return model_internal::_doValidationCacheOfSFDC_Project__c ;

        _model.model_internal::_SFDC_Project__cIsValidCacheInitialized = true;
        var validationFailures:Array = new Array();
        var errorMessage:String;
        var failure:Boolean;

        var valRes:ValidationResult;
        if (_model.isSFDC_Project__cAvailable && _internal_SFDC_Project__c == null)
        {
            validationFailures.push(new ValidationResult(true, "", "", "SFDC_Project__c is required"));
        }

        model_internal::_doValidationCacheOfSFDC_Project__c = validationFailures;
        model_internal::_doValidationLastValOfSFDC_Project__c = value;
    ...
    model_internal var _doValidationCacheOfUser__c : Array = null;
    model_internal var _doValidationLastValOfUser__c : String;

    model_internal function _doValidationForUser__c(valueIn:Object):Array
    {
        var value : String = valueIn as String;

        if (model_internal::_doValidationCacheOfUser__c != null && model_internal::_doValidationLastValOfUser__c == value)
           return model_internal::_doValidationCacheOfUser__c ;

        _model.model_internal::_User__cIsValidCacheInitialized = true;
        var validationFailures:Array = new Array();
        var errorMessage:String;
        var failure:Boolean;

        var valRes:ValidationResult;
        if (_model.isUser__cAvailable && _internal_User__c == null)
        {
            validationFailures.push(new ValidationResult(true, "", "", "User__c is required"));
        }

        model_internal::_doValidationCacheOfUser__c = validationFailures;
        model_internal::_doValidationLastValOfUser__c = value;
