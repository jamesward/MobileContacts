 ...
 * of this value object you may modify the generated sub-class of this class - ApexPage.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_ApexPage extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.ApexPage") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.ApexPage", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _ApexPageEntityMetadata;
    ...
    public function _Super_ApexPage()
    {
        _model = new _ApexPageEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _ApexPageEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _ApexPageEntityMetadata) : void
    {
        var oldValue : _ApexPageEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
