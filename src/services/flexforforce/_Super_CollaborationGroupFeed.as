 ...
 * of this value object you may modify the generated sub-class of this class - CollaborationGroupFeed.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_CollaborationGroupFeed extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.CollaborationGroupFeed") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.CollaborationGroupFeed", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _CollaborationGroupFeedEntityMetadata;
    ...
    private var _internal_FeedPostId : String;
    ...
    public function _Super_CollaborationGroupFeed()
    {
        _model = new _CollaborationGroupFeedEntityMetadata(this);
        ...
        model_internal::_changeWatcherArray.push(mx.binding.utils.ChangeWatcher.watch(this, "FeedPostId", model_internal::setterListenerFeedPostId));
    ...
    [Bindable(event="propertyChange")]
    public function get FeedPostId() : String
    {
        return _internal_FeedPostId;
    }
    ...
    public function set FeedPostId(value:String) : void
    {
        var oldValue:String = _internal_FeedPostId;
        if (oldValue !== value)
        {
            _internal_FeedPostId = value;
        }
    }
    ...
    model_internal function setterListenerFeedPostId(value:flash.events.Event):void
    {
        _model.invalidateDependentOnFeedPostId();
    }
    ...
    model_internal function calculateIsValid():Boolean
    {
        ...
        if (!_model.FeedPostIdIsValid)
        {
            propertyValidity = false;
            com.adobe.fiber.util.FiberUtils.arrayAdd(validationFailureMessages, _model.model_internal::_FeedPostIdValidationFailureMessages);
        }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _CollaborationGroupFeedEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _CollaborationGroupFeedEntityMetadata) : void
    {
        var oldValue : _CollaborationGroupFeedEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
    ...
    model_internal var _doValidationCacheOfFeedPostId : Array = null;
    model_internal var _doValidationLastValOfFeedPostId : String;

    model_internal function _doValidationForFeedPostId(valueIn:Object):Array
    {
        var value : String = valueIn as String;

        if (model_internal::_doValidationCacheOfFeedPostId != null && model_internal::_doValidationLastValOfFeedPostId == value)
           return model_internal::_doValidationCacheOfFeedPostId ;

        _model.model_internal::_FeedPostIdIsValidCacheInitialized = true;
        var validationFailures:Array = new Array();
        var errorMessage:String;
        var failure:Boolean;

        var valRes:ValidationResult;
        if (_model.isFeedPostIdAvailable && _internal_FeedPostId == null)
        {
            validationFailures.push(new ValidationResult(true, "", "", "FeedPostId is required"));
        }

        model_internal::_doValidationCacheOfFeedPostId = validationFailures;
        model_internal::_doValidationLastValOfFeedPostId = value;
