...
[ExcludeClass]
internal class _SolutionEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    private static var emptyArray:Array = new Array();

    model_internal static var allProperties:Array = new Array("Id", "CreatedById", "CreatedDate", "IsDeleted", "IsHtml", "IsPublished", "IsPublishedInPublicKb", "IsReviewed", "LastModifiedById", "LastModifiedDate", "OwnerId", "SolutionName", "SolutionNote", "SolutionNumber", "Status", "SystemModstamp", "TimesUsed");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("Id", "CreatedById", "CreatedDate", "IsDeleted", "IsHtml", "IsPublished", "IsPublishedInPublicKb", "IsReviewed", "LastModifiedById", "LastModifiedDate", "OwnerId", "SolutionName", "SolutionNote", "SolutionNumber", "Status", "SystemModstamp", "TimesUsed");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("Id", "CreatedById", "CreatedDate", "IsDeleted", "IsHtml", "IsPublished", "IsPublishedInPublicKb", "IsReviewed", "LastModifiedById", "LastModifiedDate", "OwnerId", "SolutionName", "SolutionNote", "SolutionNumber", "Status", "SystemModstamp", "TimesUsed");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("Id", "CreatedById", "CreatedDate", "IsDeleted", "IsHtml", "IsPublished", "IsPublishedInPublicKb", "IsReviewed", "LastModifiedById", "LastModifiedDate", "OwnerId", "SolutionName", "SolutionNote", "SolutionNumber", "Status", "SystemModstamp", "TimesUsed");
    model_internal static var derivedProperties:Array = new Array();
    model_internal static var collectionProperties:Array = new Array();
    model_internal static var collectionBaseMap:Object;
    model_internal static var entityName:String = "Solution";
    ...
    model_internal var _SolutionNameIsValid:Boolean;
    model_internal var _SolutionNameValidator:com.adobe.fiber.styles.StyleValidator;
    model_internal var _SolutionNameIsValidCacheInitialized:Boolean = false;
    model_internal var _SolutionNameValidationFailureMessages:Array;
    
    model_internal var _SolutionNoteIsValid:Boolean;
    model_internal var _SolutionNoteValidator:com.adobe.fiber.styles.StyleValidator;
    model_internal var _SolutionNoteIsValidCacheInitialized:Boolean = false;
    model_internal var _SolutionNoteValidationFailureMessages:Array;
    
    model_internal var _SolutionNumberIsValid:Boolean;
    model_internal var _SolutionNumberValidator:com.adobe.fiber.styles.StyleValidator;
    model_internal var _SolutionNumberIsValidCacheInitialized:Boolean = false;
    model_internal var _SolutionNumberValidationFailureMessages:Array;
    ...
    model_internal var _instance:_Super_Solution;
    model_internal static var _nullStyle:com.adobe.fiber.styles.Style = new com.adobe.fiber.styles.Style();

    public function _SolutionEntityMetadata(value : _Super_Solution)
    {
        ...
        if (model_internal::dependentsOnMap == null)
        {
            ...
            model_internal::dependentsOnMap["IsPublished"] = new Array();
            model_internal::dependentsOnMap["IsPublishedInPublicKb"] = new Array();
            ...
            model_internal::dependentsOnMap["SolutionName"] = new Array();
            model_internal::dependentsOnMap["SolutionNote"] = new Array();
            model_internal::dependentsOnMap["SolutionNumber"] = new Array();
        ...
        model_internal::_SolutionNameValidator = new StyleValidator(model_internal::_instance.model_internal::_doValidationForSolutionName);
        model_internal::_SolutionNameValidator.required = true;
        model_internal::_SolutionNameValidator.requiredFieldError = "SolutionName is required";
        //model_internal::_SolutionNameValidator.source = model_internal::_instance;
        //model_internal::_SolutionNameValidator.property = "SolutionName";
        model_internal::_SolutionNoteValidator = new StyleValidator(model_internal::_instance.model_internal::_doValidationForSolutionNote);
        model_internal::_SolutionNoteValidator.required = true;
        model_internal::_SolutionNoteValidator.requiredFieldError = "SolutionNote is required";
        //model_internal::_SolutionNoteValidator.source = model_internal::_instance;
        //model_internal::_SolutionNoteValidator.property = "SolutionNote";
        model_internal::_SolutionNumberValidator = new StyleValidator(model_internal::_instance.model_internal::_doValidationForSolutionNumber);
        model_internal::_SolutionNumberValidator.required = true;
        model_internal::_SolutionNumberValidator.requiredFieldError = "SolutionNumber is required";
        //model_internal::_SolutionNumberValidator.source = model_internal::_instance;
        //model_internal::_SolutionNumberValidator.property = "SolutionNumber";
    ...
    override public function getDependants(propertyName:String):Array
    {
       if (model_internal::dataProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a data property of entity Solution");  
    ...
    override public function getCollectionBase(propertyName:String):String
    {
        if (model_internal::collectionProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a collection property of entity Solution");  
    ...
    override public function getValue(propertyName:String):*
    {
        ...
        {
            throw new Error(propertyName + " does not exist for entity Solution");
        }
    ...
    [Bindable(event="propertyChange")]
    public function get isIsPublishedAvailable():Boolean
    {
        return true;
    }

    [Bindable(event="propertyChange")]
    public function get isIsPublishedInPublicKbAvailable():Boolean
    {
        return true;
    }
    ...
    [Bindable(event="propertyChange")]
    public function get isSolutionNameAvailable():Boolean
    {
        return true;
    }

    [Bindable(event="propertyChange")]
    public function get isSolutionNoteAvailable():Boolean
    {
        return true;
    }

    [Bindable(event="propertyChange")]
    public function get isSolutionNumberAvailable():Boolean
    {
        return true;
    }
    ...
    public function invalidateDependentOnSolutionName():void
    {
        if (model_internal::_SolutionNameIsValidCacheInitialized )
        {
            model_internal::_instance.model_internal::_doValidationCacheOfSolutionName = null;
            model_internal::calculateSolutionNameIsValid();
        }
    }
    public function invalidateDependentOnSolutionNote():void
    {
        if (model_internal::_SolutionNoteIsValidCacheInitialized )
        {
            model_internal::_instance.model_internal::_doValidationCacheOfSolutionNote = null;
            model_internal::calculateSolutionNoteIsValid();
        }
    }
    public function invalidateDependentOnSolutionNumber():void
    {
        if (model_internal::_SolutionNumberIsValidCacheInitialized )
        {
            model_internal::_instance.model_internal::_doValidationCacheOfSolutionNumber = null;
            model_internal::calculateSolutionNumberIsValid();
        }
    }
    ...
    [Bindable(event="propertyChange")]   
    public function get IsPublishedStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }

    [Bindable(event="propertyChange")]   
    public function get IsPublishedInPublicKbStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }
    ...
    [Bindable(event="propertyChange")]   
    public function get SolutionNameStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }

    public function get SolutionNameValidator() : StyleValidator
    {
        return model_internal::_SolutionNameValidator;
    }

    model_internal function set _SolutionNameIsValid_der(value:Boolean):void 
    {
        var oldValue:Boolean = model_internal::_SolutionNameIsValid;         
        if (oldValue !== value)
        {
            model_internal::_SolutionNameIsValid = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "SolutionNameIsValid", oldValue, value));
        }                             
    }

    [Bindable(event="propertyChange")]
    public function get SolutionNameIsValid():Boolean
    {
        if (!model_internal::_SolutionNameIsValidCacheInitialized)
        {
            model_internal::calculateSolutionNameIsValid();
        ...
        return model_internal::_SolutionNameIsValid;
    }

    model_internal function calculateSolutionNameIsValid():void
    {
        var valRes:ValidationResultEvent = model_internal::_SolutionNameValidator.validate(model_internal::_instance.SolutionName)
        model_internal::_SolutionNameIsValid_der = (valRes.results == null);
        model_internal::_SolutionNameIsValidCacheInitialized = true;
        if (valRes.results == null)
             model_internal::SolutionNameValidationFailureMessages_der = emptyArray;
        else
        {
            var _valFailures:Array = new Array();
            for (var a:int = 0 ; a<valRes.results.length ; a++)
            ...
            model_internal::SolutionNameValidationFailureMessages_der = _valFailures;
        }
    }

    [Bindable(event="propertyChange")]
    public function get SolutionNameValidationFailureMessages():Array
    {
        if (model_internal::_SolutionNameValidationFailureMessages == null)
            model_internal::calculateSolutionNameIsValid();

        return _SolutionNameValidationFailureMessages;
    }

    model_internal function set SolutionNameValidationFailureMessages_der(value:Array) : void
    {
        var oldValue:Array = model_internal::_SolutionNameValidationFailureMessages;
        ...
        if (needUpdate)
        {
            model_internal::_SolutionNameValidationFailureMessages = value;   
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "SolutionNameValidationFailureMessages", oldValue, value));
            // Only execute calculateIsValid if it has been called before, to update the validationFailureMessages for
            // the entire entity.
            if (model_internal::_instance.model_internal::_cacheInitialized_isValid)
            {
    ...
    [Bindable(event="propertyChange")]   
    public function get SolutionNoteStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }

    public function get SolutionNoteValidator() : StyleValidator
    {
        return model_internal::_SolutionNoteValidator;
    }

    model_internal function set _SolutionNoteIsValid_der(value:Boolean):void 
    {
        var oldValue:Boolean = model_internal::_SolutionNoteIsValid;         
        if (oldValue !== value)
        {
            model_internal::_SolutionNoteIsValid = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "SolutionNoteIsValid", oldValue, value));
        }                             
    }

    [Bindable(event="propertyChange")]
    public function get SolutionNoteIsValid():Boolean
    {
        if (!model_internal::_SolutionNoteIsValidCacheInitialized)
        {
            model_internal::calculateSolutionNoteIsValid();
        ...
        return model_internal::_SolutionNoteIsValid;
    }

    model_internal function calculateSolutionNoteIsValid():void
    {
        var valRes:ValidationResultEvent = model_internal::_SolutionNoteValidator.validate(model_internal::_instance.SolutionNote)
        model_internal::_SolutionNoteIsValid_der = (valRes.results == null);
        model_internal::_SolutionNoteIsValidCacheInitialized = true;
        if (valRes.results == null)
             model_internal::SolutionNoteValidationFailureMessages_der = emptyArray;
        else
        {
            var _valFailures:Array = new Array();
            for (var a:int = 0 ; a<valRes.results.length ; a++)
            ...
            model_internal::SolutionNoteValidationFailureMessages_der = _valFailures;
        }
    }

    [Bindable(event="propertyChange")]
    public function get SolutionNoteValidationFailureMessages():Array
    {
        if (model_internal::_SolutionNoteValidationFailureMessages == null)
            model_internal::calculateSolutionNoteIsValid();

        return _SolutionNoteValidationFailureMessages;
    }

    model_internal function set SolutionNoteValidationFailureMessages_der(value:Array) : void
    {
        var oldValue:Array = model_internal::_SolutionNoteValidationFailureMessages;
        ...
        if (needUpdate)
        {
            model_internal::_SolutionNoteValidationFailureMessages = value;   
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "SolutionNoteValidationFailureMessages", oldValue, value));
            // Only execute calculateIsValid if it has been called before, to update the validationFailureMessages for
            // the entire entity.
            if (model_internal::_instance.model_internal::_cacheInitialized_isValid)
            {
    ...
    [Bindable(event="propertyChange")]   
    public function get SolutionNumberStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }

    public function get SolutionNumberValidator() : StyleValidator
    {
        return model_internal::_SolutionNumberValidator;
    }

    model_internal function set _SolutionNumberIsValid_der(value:Boolean):void 
    {
        var oldValue:Boolean = model_internal::_SolutionNumberIsValid;         
        if (oldValue !== value)
        {
            model_internal::_SolutionNumberIsValid = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "SolutionNumberIsValid", oldValue, value));
        }                             
    }

    [Bindable(event="propertyChange")]
    public function get SolutionNumberIsValid():Boolean
    {
        if (!model_internal::_SolutionNumberIsValidCacheInitialized)
        {
            model_internal::calculateSolutionNumberIsValid();
        ...
        return model_internal::_SolutionNumberIsValid;
    }

    model_internal function calculateSolutionNumberIsValid():void
    {
        var valRes:ValidationResultEvent = model_internal::_SolutionNumberValidator.validate(model_internal::_instance.SolutionNumber)
        model_internal::_SolutionNumberIsValid_der = (valRes.results == null);
        model_internal::_SolutionNumberIsValidCacheInitialized = true;
        if (valRes.results == null)
             model_internal::SolutionNumberValidationFailureMessages_der = emptyArray;
        else
        {
            var _valFailures:Array = new Array();
            for (var a:int = 0 ; a<valRes.results.length ; a++)
            ...
            model_internal::SolutionNumberValidationFailureMessages_der = _valFailures;
        }
    }

    [Bindable(event="propertyChange")]
    public function get SolutionNumberValidationFailureMessages():Array
    {
        if (model_internal::_SolutionNumberValidationFailureMessages == null)
            model_internal::calculateSolutionNumberIsValid();

        return _SolutionNumberValidationFailureMessages;
    }

    model_internal function set SolutionNumberValidationFailureMessages_der(value:Array) : void
    {
        var oldValue:Array = model_internal::_SolutionNumberValidationFailureMessages;
        ...
        if (needUpdate)
        {
            model_internal::_SolutionNumberValidationFailureMessages = value;   
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "SolutionNumberValidationFailureMessages", oldValue, value));
            // Only execute calculateIsValid if it has been called before, to update the validationFailureMessages for
            // the entire entity.
            if (model_internal::_instance.model_internal::_cacheInitialized_isValid)
            {
     ...
     */  
     override public function getPropertyValidationFailureMessages(propertyName:String):Array
     {
         switch(propertyName)
         {
            ...
            case("SolutionName"):
            {
                return SolutionNameValidationFailureMessages;
            }
            case("SolutionNote"):
            {
                return SolutionNoteValidationFailureMessages;
            }
            case("SolutionNumber"):
            {
                return SolutionNumberValidationFailureMessages;
            }
            case("Status"):
            {
