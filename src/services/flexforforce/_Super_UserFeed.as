 ...
 * of this value object you may modify the generated sub-class of this class - UserFeed.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_UserFeed extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.UserFeed") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.UserFeed", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _UserFeedEntityMetadata;
    ...
    public function _Super_UserFeed()
    {
        _model = new _UserFeedEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _UserFeedEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _UserFeedEntityMetadata) : void
    {
        var oldValue : _UserFeedEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
