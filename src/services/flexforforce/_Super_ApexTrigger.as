 ...
 * of this value object you may modify the generated sub-class of this class - ApexTrigger.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_ApexTrigger extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.ApexTrigger") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.ApexTrigger", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _ApexTriggerEntityMetadata;
    ...
    private var _internal_BodyCrc : Number;
    private var _internal_CreatedById : String;
    private var _internal_CreatedDate : Date;
    private var _internal_IsValid : Boolean;
    private var _internal_LastModifiedById : String;
    private var _internal_LastModifiedDate : Date;
    private var _internal_LengthWithoutComments : int;
    private var _internal_Name : String;
    private var _internal_NamespacePrefix : String;
    private var _internal_Status : String;
    private var _internal_SystemModstamp : Date;
    private var _internal_TableEnumOrId : String;
    private var _internal_UsageAfterDelete : Boolean;
    private var _internal_UsageAfterInsert : Boolean;
    private var _internal_UsageAfterUndelete : Boolean;
    private var _internal_UsageAfterUpdate : Boolean;
    private var _internal_UsageBeforeDelete : Boolean;
    private var _internal_UsageBeforeInsert : Boolean;
    private var _internal_UsageBeforeUpdate : Boolean;
    private var _internal_UsageIsBulk : Boolean;
    ...
    public function _Super_ApexTrigger()
    {
        _model = new _ApexTriggerEntityMetadata(this);
        ...
        model_internal::_changeWatcherArray.push(mx.binding.utils.ChangeWatcher.watch(this, "TableEnumOrId", model_internal::setterListenerTableEnumOrId));
    ...
    [Bindable(event="propertyChange")]
    public function get BodyCrc() : Number
    {
        return _internal_BodyCrc;
    }
    ...
    [Bindable(event="propertyChange")]
    public function get LengthWithoutComments() : int
    {
        return _internal_LengthWithoutComments;
    }
    ...
    [Bindable(event="propertyChange")]
    public function get TableEnumOrId() : String
    {
        return _internal_TableEnumOrId;
    }

    [Bindable(event="propertyChange")]
    public function get UsageAfterDelete() : Boolean
    {
        return _internal_UsageAfterDelete;
    }

    [Bindable(event="propertyChange")]
    public function get UsageAfterInsert() : Boolean
    {
        return _internal_UsageAfterInsert;
    }

    [Bindable(event="propertyChange")]
    public function get UsageAfterUndelete() : Boolean
    {
        return _internal_UsageAfterUndelete;
    }

    [Bindable(event="propertyChange")]
    public function get UsageAfterUpdate() : Boolean
    {
        return _internal_UsageAfterUpdate;
    }

    [Bindable(event="propertyChange")]
    public function get UsageBeforeDelete() : Boolean
    {
        return _internal_UsageBeforeDelete;
    }

    [Bindable(event="propertyChange")]
    public function get UsageBeforeInsert() : Boolean
    {
        return _internal_UsageBeforeInsert;
    }

    [Bindable(event="propertyChange")]
    public function get UsageBeforeUpdate() : Boolean
    {
        return _internal_UsageBeforeUpdate;
    }

    [Bindable(event="propertyChange")]
    public function get UsageIsBulk() : Boolean
    {
        return _internal_UsageIsBulk;
    }
    ...
    public function set BodyCrc(value:Number) : void
    {
        var oldValue:Number = _internal_BodyCrc;
        if (isNaN(_internal_BodyCrc) == true || Math.abs(oldValue - value) > epsilon)
        {
            _internal_BodyCrc = value;
        }
    }
    ...
    {
        var oldValue:Boolean = _internal_IsValid;
        if (oldValue !== value)
        {
            _internal_IsValid = value;
        }
    }
    ...
    public function set LengthWithoutComments(value:int) : void
    {
        var oldValue:int = _internal_LengthWithoutComments;
        if (oldValue !== value)
        {
            _internal_LengthWithoutComments = value;
        }
    }
    ...
    public function set TableEnumOrId(value:String) : void
    {
        var oldValue:String = _internal_TableEnumOrId;
        if (oldValue !== value)
        {
            _internal_TableEnumOrId = value;
        }
    }

    public function set UsageAfterDelete(value:Boolean) : void
    {
        var oldValue:Boolean = _internal_UsageAfterDelete;
        if (oldValue !== value)
        {
            _internal_UsageAfterDelete = value;
        }
    }

    public function set UsageAfterInsert(value:Boolean) : void
    {
        var oldValue:Boolean = _internal_UsageAfterInsert;
        if (oldValue !== value)
        {
            _internal_UsageAfterInsert = value;
        }
    }

    public function set UsageAfterUndelete(value:Boolean) : void
    {
        var oldValue:Boolean = _internal_UsageAfterUndelete;
        if (oldValue !== value)
        {
            _internal_UsageAfterUndelete = value;
        }
    }

    public function set UsageAfterUpdate(value:Boolean) : void
    {
        var oldValue:Boolean = _internal_UsageAfterUpdate;
        if (oldValue !== value)
        {
            _internal_UsageAfterUpdate = value;
        }
    }

    public function set UsageBeforeDelete(value:Boolean) : void
    {
        var oldValue:Boolean = _internal_UsageBeforeDelete;
        if (oldValue !== value)
        {
            _internal_UsageBeforeDelete = value;
        }
    }

    public function set UsageBeforeInsert(value:Boolean) : void
    {
        var oldValue:Boolean = _internal_UsageBeforeInsert;
        if (oldValue !== value)
        {
            _internal_UsageBeforeInsert = value;
        }
    }

    public function set UsageBeforeUpdate(value:Boolean) : void
    {
        var oldValue:Boolean = _internal_UsageBeforeUpdate;
        if (oldValue !== value)
        {
            _internal_UsageBeforeUpdate = value;
        }
    }

    public function set UsageIsBulk(value:Boolean) : void
    {
        var oldValue:Boolean = _internal_UsageIsBulk;
        if (oldValue !== value)
        {
            _internal_UsageIsBulk = value;
        }
    }
    ...
    model_internal function setterListenerTableEnumOrId(value:flash.events.Event):void
    {
        _model.invalidateDependentOnTableEnumOrId();
    }
    ...
    model_internal function calculateIsValid():Boolean
    {
        ...
        if (!_model.TableEnumOrIdIsValid)
        {
            propertyValidity = false;
            com.adobe.fiber.util.FiberUtils.arrayAdd(validationFailureMessages, _model.model_internal::_TableEnumOrIdValidationFailureMessages);
        }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _ApexTriggerEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _ApexTriggerEntityMetadata) : void
    {
        var oldValue : _ApexTriggerEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
    ...
    model_internal var _doValidationCacheOfTableEnumOrId : Array = null;
    model_internal var _doValidationLastValOfTableEnumOrId : String;

    model_internal function _doValidationForTableEnumOrId(valueIn:Object):Array
    {
        var value : String = valueIn as String;

        if (model_internal::_doValidationCacheOfTableEnumOrId != null && model_internal::_doValidationLastValOfTableEnumOrId == value)
           return model_internal::_doValidationCacheOfTableEnumOrId ;

        _model.model_internal::_TableEnumOrIdIsValidCacheInitialized = true;
        var validationFailures:Array = new Array();
        var errorMessage:String;
        var failure:Boolean;

        var valRes:ValidationResult;
        if (_model.isTableEnumOrIdAvailable && _internal_TableEnumOrId == null)
        {
            validationFailures.push(new ValidationResult(true, "", "", "TableEnumOrId is required"));
        }

        model_internal::_doValidationCacheOfTableEnumOrId = validationFailures;
        model_internal::_doValidationLastValOfTableEnumOrId = value;
