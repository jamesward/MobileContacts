 ...
 * of this value object you may modify the generated sub-class of this class - StaticResource.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_StaticResource extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.StaticResource") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.StaticResource", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _StaticResourceEntityMetadata;
    ...
    public function _Super_StaticResource()
    {
        _model = new _StaticResourceEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _StaticResourceEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _StaticResourceEntityMetadata) : void
    {
        var oldValue : _StaticResourceEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
