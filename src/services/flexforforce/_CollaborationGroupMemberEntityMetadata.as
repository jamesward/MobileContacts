...
[ExcludeClass]
internal class _CollaborationGroupMemberEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    private static var emptyArray:Array = new Array();

    model_internal static var allProperties:Array = new Array("Id", "CollaborationGroupId", "CreatedById", "CreatedDate", "LastModifiedById", "LastModifiedDate", "MemberId", "SystemModstamp");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("Id", "CollaborationGroupId", "CreatedById", "CreatedDate", "LastModifiedById", "LastModifiedDate", "MemberId", "SystemModstamp");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("Id", "CollaborationGroupId", "CreatedById", "CreatedDate", "LastModifiedById", "LastModifiedDate", "MemberId", "SystemModstamp");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("Id", "CollaborationGroupId", "CreatedById", "CreatedDate", "LastModifiedById", "LastModifiedDate", "MemberId", "SystemModstamp");
    model_internal static var derivedProperties:Array = new Array();
    model_internal static var collectionProperties:Array = new Array();
    model_internal static var collectionBaseMap:Object;
    model_internal static var entityName:String = "CollaborationGroupMember";
    model_internal static var dependentsOnMap:Object;
    model_internal static var dependedOnServices:Array = new Array();

    
    model_internal var _CollaborationGroupIdIsValid:Boolean;
    model_internal var _CollaborationGroupIdValidator:com.adobe.fiber.styles.StyleValidator;
    model_internal var _CollaborationGroupIdIsValidCacheInitialized:Boolean = false;
    model_internal var _CollaborationGroupIdValidationFailureMessages:Array;
    ...
    model_internal var _instance:_Super_CollaborationGroupMember;
    model_internal static var _nullStyle:com.adobe.fiber.styles.Style = new com.adobe.fiber.styles.Style();

    public function _CollaborationGroupMemberEntityMetadata(value : _Super_CollaborationGroupMember)
    {
        ...
        if (model_internal::dependentsOnMap == null)
        {
            ...
            model_internal::dependentsOnMap["CollaborationGroupId"] = new Array();
        ...
        model_internal::_CollaborationGroupIdValidator = new StyleValidator(model_internal::_instance.model_internal::_doValidationForCollaborationGroupId);
        model_internal::_CollaborationGroupIdValidator.required = true;
        model_internal::_CollaborationGroupIdValidator.requiredFieldError = "CollaborationGroupId is required";
        //model_internal::_CollaborationGroupIdValidator.source = model_internal::_instance;
        //model_internal::_CollaborationGroupIdValidator.property = "CollaborationGroupId";
    ...
    override public function getDependants(propertyName:String):Array
    {
       if (model_internal::dataProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a data property of entity CollaborationGroupMember");  
    ...
    override public function getCollectionBase(propertyName:String):String
    {
        if (model_internal::collectionProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a collection property of entity CollaborationGroupMember");  
    ...
    override public function getValue(propertyName:String):*
    {
        ...
        {
            throw new Error(propertyName + " does not exist for entity CollaborationGroupMember");
        }
    ...
    [Bindable(event="propertyChange")]
    public function get isCollaborationGroupIdAvailable():Boolean
    {
        return true;
    }
     ...
     */
    public function invalidateDependentOnCollaborationGroupId():void
    {
        if (model_internal::_CollaborationGroupIdIsValidCacheInitialized )
        {
            model_internal::_instance.model_internal::_doValidationCacheOfCollaborationGroupId = null;
            model_internal::calculateCollaborationGroupIdIsValid();
        }
    }
    ...
    [Bindable(event="propertyChange")]   
    public function get CollaborationGroupIdStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }

    public function get CollaborationGroupIdValidator() : StyleValidator
    {
        return model_internal::_CollaborationGroupIdValidator;
    }

    model_internal function set _CollaborationGroupIdIsValid_der(value:Boolean):void 
    {
        var oldValue:Boolean = model_internal::_CollaborationGroupIdIsValid;         
        if (oldValue !== value)
        {
            model_internal::_CollaborationGroupIdIsValid = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "CollaborationGroupIdIsValid", oldValue, value));
        }                             
    }

    [Bindable(event="propertyChange")]
    public function get CollaborationGroupIdIsValid():Boolean
    {
        if (!model_internal::_CollaborationGroupIdIsValidCacheInitialized)
        {
            model_internal::calculateCollaborationGroupIdIsValid();
        ...
        return model_internal::_CollaborationGroupIdIsValid;
    }

    model_internal function calculateCollaborationGroupIdIsValid():void
    {
        var valRes:ValidationResultEvent = model_internal::_CollaborationGroupIdValidator.validate(model_internal::_instance.CollaborationGroupId)
        model_internal::_CollaborationGroupIdIsValid_der = (valRes.results == null);
        model_internal::_CollaborationGroupIdIsValidCacheInitialized = true;
        if (valRes.results == null)
             model_internal::CollaborationGroupIdValidationFailureMessages_der = emptyArray;
        else
        {
            ...
            model_internal::CollaborationGroupIdValidationFailureMessages_der = _valFailures;
        }
    }

    [Bindable(event="propertyChange")]
    public function get CollaborationGroupIdValidationFailureMessages():Array
    {
        if (model_internal::_CollaborationGroupIdValidationFailureMessages == null)
            model_internal::calculateCollaborationGroupIdIsValid();

        return _CollaborationGroupIdValidationFailureMessages;
    }

    model_internal function set CollaborationGroupIdValidationFailureMessages_der(value:Array) : void
    {
        var oldValue:Array = model_internal::_CollaborationGroupIdValidationFailureMessages;
        ...
        if (needUpdate)
        {
            model_internal::_CollaborationGroupIdValidationFailureMessages = value;   
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "CollaborationGroupIdValidationFailureMessages", oldValue, value));
     ...
     */  
     override public function getPropertyValidationFailureMessages(propertyName:String):Array
     {
         switch(propertyName)
         {
            ...
            {
                return CollaborationGroupIdValidationFailureMessages;
            }
            case("CreatedById"):
            {
