 ...
 * of this value object you may modify the generated sub-class of this class - Sdfsdf__c.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_Sdfsdf__c extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.Sdfsdf__c") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.Sdfsdf__c", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _Sdfsdf__cEntityMetadata;
    ...
    public function _Super_Sdfsdf__c()
    {
        _model = new _Sdfsdf__cEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _Sdfsdf__cEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _Sdfsdf__cEntityMetadata) : void
    {
        var oldValue : _Sdfsdf__cEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
