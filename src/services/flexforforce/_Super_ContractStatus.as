 ...
 * of this value object you may modify the generated sub-class of this class - ContractStatus.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_ContractStatus extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.ContractStatus") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.ContractStatus", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _ContractStatusEntityMetadata;
    ...
    public function _Super_ContractStatus()
    {
        _model = new _ContractStatusEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _ContractStatusEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _ContractStatusEntityMetadata) : void
    {
        var oldValue : _ContractStatusEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
