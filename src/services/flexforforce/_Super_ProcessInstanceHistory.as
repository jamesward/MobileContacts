 ...
 * of this value object you may modify the generated sub-class of this class - ProcessInstanceHistory.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_ProcessInstanceHistory extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.ProcessInstanceHistory") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.ProcessInstanceHistory", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _ProcessInstanceHistoryEntityMetadata;
    ...
    public function _Super_ProcessInstanceHistory()
    {
        _model = new _ProcessInstanceHistoryEntityMetadata(this);
    ...
    [Bindable(event="propertyChange")]
    public function get RemindersSent() : int
    {
        return _internal_RemindersSent;
    }
    ...
    {
        var oldValue:Boolean = _internal_IsPending;
        if (oldValue !== value)
        {
            _internal_IsPending = value;
        }
    }
    ...
    public function set RemindersSent(value:int) : void
    {
        var oldValue:int = _internal_RemindersSent;
        if (oldValue !== value)
        {
            _internal_RemindersSent = value;
        }
    }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _ProcessInstanceHistoryEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _ProcessInstanceHistoryEntityMetadata) : void
    {
        var oldValue : _ProcessInstanceHistoryEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
