 ...
 * of this value object you may modify the generated sub-class of this class - CaseFeed.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_CaseFeed extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.CaseFeed") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.CaseFeed", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _CaseFeedEntityMetadata;
    ...
    public function _Super_CaseFeed()
    {
        _model = new _CaseFeedEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _CaseFeedEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _CaseFeedEntityMetadata) : void
    {
        var oldValue : _CaseFeedEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
