 ...
 * of this value object you may modify the generated sub-class of this class - NoteAndAttachment.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_NoteAndAttachment extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.NoteAndAttachment") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.NoteAndAttachment", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _NoteAndAttachmentEntityMetadata;
    ...
    private var _internal_IsNote : Boolean;
    ...
    public function _Super_NoteAndAttachment()
    {
        _model = new _NoteAndAttachmentEntityMetadata(this);
    ...
    [Bindable(event="propertyChange")]
    public function get IsNote() : Boolean
    {
        return _internal_IsNote;
    }
    ...
    public function set IsNote(value:Boolean) : void
    {
        var oldValue:Boolean = _internal_IsNote;
        if (oldValue !== value)
        {
            _internal_IsNote = value;
        }
    }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _NoteAndAttachmentEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _NoteAndAttachmentEntityMetadata) : void
    {
        var oldValue : _NoteAndAttachmentEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
