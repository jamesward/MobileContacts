 ...
 * of this value object you may modify the generated sub-class of this class - CaseTeamTemplateRecord.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_CaseTeamTemplateRecord extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.CaseTeamTemplateRecord") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.CaseTeamTemplateRecord", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _CaseTeamTemplateRecordEntityMetadata;
    ...
    public function _Super_CaseTeamTemplateRecord()
    {
        _model = new _CaseTeamTemplateRecordEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _CaseTeamTemplateRecordEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _CaseTeamTemplateRecordEntityMetadata) : void
    {
        var oldValue : _CaseTeamTemplateRecordEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
