 ...
 * of this value object you may modify the generated sub-class of this class - TaskPriority.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_TaskPriority extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.TaskPriority") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.TaskPriority", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _TaskPriorityEntityMetadata;
    ...
    private var _internal_IsHighPriority : Boolean;
    ...
    public function _Super_TaskPriority()
    {
        _model = new _TaskPriorityEntityMetadata(this);
    ...
    [Bindable(event="propertyChange")]
    public function get IsHighPriority() : Boolean
    {
        return _internal_IsHighPriority;
    }
    ...
    public function set IsHighPriority(value:Boolean) : void
    {
        var oldValue:Boolean = _internal_IsHighPriority;
        if (oldValue !== value)
        {
            _internal_IsHighPriority = value;
        }
    }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _TaskPriorityEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _TaskPriorityEntityMetadata) : void
    {
        var oldValue : _TaskPriorityEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
