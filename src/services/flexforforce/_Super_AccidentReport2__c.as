 ...
 * of this value object you may modify the generated sub-class of this class - AccidentReport2__c.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_AccidentReport2__c extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.AccidentReport2__c") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.AccidentReport2__c", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _AccidentReport2__cEntityMetadata;
    ...
    public function _Super_AccidentReport2__c()
    {
        _model = new _AccidentReport2__cEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _AccidentReport2__cEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _AccidentReport2__cEntityMetadata) : void
    {
        var oldValue : _AccidentReport2__cEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
