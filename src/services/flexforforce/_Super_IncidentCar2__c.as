 ...
 * of this value object you may modify the generated sub-class of this class - IncidentCar2__c.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_IncidentCar2__c extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.IncidentCar2__c") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.IncidentCar2__c", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _IncidentCar2__cEntityMetadata;
    ...
    public function _Super_IncidentCar2__c()
    {
        _model = new _IncidentCar2__cEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _IncidentCar2__cEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _IncidentCar2__cEntityMetadata) : void
    {
        var oldValue : _IncidentCar2__cEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
