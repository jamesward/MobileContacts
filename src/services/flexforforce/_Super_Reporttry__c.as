 ...
 * of this value object you may modify the generated sub-class of this class - Reporttry__c.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_Reporttry__c extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.Reporttry__c") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.Reporttry__c", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _Reporttry__cEntityMetadata;
    ...
    private var _internal_Last_Activity__c : String;
    ...
    public function _Super_Reporttry__c()
    {
        _model = new _Reporttry__cEntityMetadata(this);
    ...
    [Bindable(event="propertyChange")]
    public function get Last_Activity__c() : String
    {
    ...
    public function set Last_Activity__c(value:String) : void
    {
        var oldValue:String = _internal_Last_Activity__c;
        if (oldValue !== value)
        {
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _Reporttry__cEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _Reporttry__cEntityMetadata) : void
    {
        var oldValue : _Reporttry__cEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
    ...
    model_internal var _doValidationLastValOfLast_Activity__c : String;
