 ...
 * of this value object you may modify the generated sub-class of this class - Who__c.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_Who__c extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.Who__c") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.Who__c", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _Who__cEntityMetadata;
    ...
    public function _Super_Who__c()
    {
        _model = new _Who__cEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _Who__cEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _Who__cEntityMetadata) : void
    {
        var oldValue : _Who__cEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
