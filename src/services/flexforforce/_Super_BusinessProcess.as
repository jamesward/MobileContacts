 ...
 * of this value object you may modify the generated sub-class of this class - BusinessProcess.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_BusinessProcess extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.BusinessProcess") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.BusinessProcess", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _BusinessProcessEntityMetadata;
    ...
    public function _Super_BusinessProcess()
    {
        _model = new _BusinessProcessEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _BusinessProcessEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _BusinessProcessEntityMetadata) : void
    {
        var oldValue : _BusinessProcessEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
