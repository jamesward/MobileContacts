 ...
 * of this value object you may modify the generated sub-class of this class - AccidentReport__c.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_AccidentReport__c extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.AccidentReport__c") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.AccidentReport__c", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _AccidentReport__cEntityMetadata;

    /**
     * properties
     */
    private var _internal_Id : String;
    private var _internal_Claim__c : String;
    ...
    private var _internal_Date_of_Accident__c : Date;
    private var _internal_IncidentX__c : Number;
    private var _internal_IncidentY__c : Number;
    ...
    public function _Super_AccidentReport__c()
    {
        _model = new _AccidentReport__cEntityMetadata(this);

        // Bind to own data properties for cache invalidation triggering
        model_internal::_changeWatcherArray.push(mx.binding.utils.ChangeWatcher.watch(this, "Claim__c", model_internal::setterListenerClaim__c));
        ...
        model_internal::_changeWatcherArray.push(mx.binding.utils.ChangeWatcher.watch(this, "Date_of_Accident__c", model_internal::setterListenerDate_of_Accident__c));
    ...
    [Bindable(event="propertyChange")]
    public function get Claim__c() : String
    {
        return _internal_Claim__c;
    }
    ...
    [Bindable(event="propertyChange")]
    public function get Date_of_Accident__c() : Date
    {
        return _internal_Date_of_Accident__c;
    }

    [Bindable(event="propertyChange")]
    public function get IncidentX__c() : Number
    {
        return _internal_IncidentX__c;
    }

    [Bindable(event="propertyChange")]
    public function get IncidentY__c() : Number
    {
        return _internal_IncidentY__c;
    }
    ...
    public function set Claim__c(value:String) : void
    {
        var oldValue:String = _internal_Claim__c;
        if (oldValue !== value)
        {
            _internal_Claim__c = value;
        }
    }
    ...
    public function set Date_of_Accident__c(value:Date) : void
    {
        var oldValue:Date = _internal_Date_of_Accident__c;
        if (oldValue !== value)
        {
            _internal_Date_of_Accident__c = value;
        }
    }

    public function set IncidentX__c(value:Number) : void
    {
        var oldValue:Number = _internal_IncidentX__c;
        if (isNaN(_internal_IncidentX__c) == true || Math.abs(oldValue - value) > epsilon)
        {
            _internal_IncidentX__c = value;
        }
    }

    public function set IncidentY__c(value:Number) : void
    {
        var oldValue:Number = _internal_IncidentY__c;
        if (isNaN(_internal_IncidentY__c) == true || Math.abs(oldValue - value) > epsilon)
        {
            _internal_IncidentY__c = value;
        }
    }
    ...
    model_internal function setterListenerClaim__c(value:flash.events.Event):void
    {
        _model.invalidateDependentOnClaim__c();
    }
    ...
    model_internal function setterListenerDate_of_Accident__c(value:flash.events.Event):void
    {
        _model.invalidateDependentOnDate_of_Accident__c();
    }
    ...
    model_internal function calculateIsValid():Boolean
    {
        ...
        if (!_model.Claim__cIsValid)
        {
            propertyValidity = false;
            com.adobe.fiber.util.FiberUtils.arrayAdd(validationFailureMessages, _model.model_internal::_Claim__cValidationFailureMessages);
        }
        ...
        if (!_model.Date_of_Accident__cIsValid)
        {
            propertyValidity = false;
            com.adobe.fiber.util.FiberUtils.arrayAdd(validationFailureMessages, _model.model_internal::_Date_of_Accident__cValidationFailureMessages);
        }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _AccidentReport__cEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _AccidentReport__cEntityMetadata) : void
    {
        var oldValue : _AccidentReport__cEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
    ...
    model_internal var _doValidationCacheOfClaim__c : Array = null;
    model_internal var _doValidationLastValOfClaim__c : String;

    model_internal function _doValidationForClaim__c(valueIn:Object):Array
    {
        var value : String = valueIn as String;

        if (model_internal::_doValidationCacheOfClaim__c != null && model_internal::_doValidationLastValOfClaim__c == value)
           return model_internal::_doValidationCacheOfClaim__c ;

        _model.model_internal::_Claim__cIsValidCacheInitialized = true;
        var validationFailures:Array = new Array();
        var errorMessage:String;
        var failure:Boolean;

        var valRes:ValidationResult;
        if (_model.isClaim__cAvailable && _internal_Claim__c == null)
        {
            validationFailures.push(new ValidationResult(true, "", "", "Claim__c is required"));
        }

        model_internal::_doValidationCacheOfClaim__c = validationFailures;
        model_internal::_doValidationLastValOfClaim__c = value;
    ...
    model_internal var _doValidationCacheOfDate_of_Accident__c : Array = null;
    model_internal var _doValidationLastValOfDate_of_Accident__c : Date;

    model_internal function _doValidationForDate_of_Accident__c(valueIn:Object):Array
    {
        var value : Date = valueIn as Date;

        if (model_internal::_doValidationCacheOfDate_of_Accident__c != null && model_internal::_doValidationLastValOfDate_of_Accident__c == value)
           return model_internal::_doValidationCacheOfDate_of_Accident__c ;

        _model.model_internal::_Date_of_Accident__cIsValidCacheInitialized = true;
        var validationFailures:Array = new Array();
        var errorMessage:String;
        var failure:Boolean;

        var valRes:ValidationResult;
        if (_model.isDate_of_Accident__cAvailable && _internal_Date_of_Accident__c == null)
        {
            validationFailures.push(new ValidationResult(true, "", "", "Date_of_Accident__c is required"));
        }

        model_internal::_doValidationCacheOfDate_of_Accident__c = validationFailures;
        model_internal::_doValidationLastValOfDate_of_Accident__c = value;
