...
[ExcludeClass]
internal class _FolderEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    private static var emptyArray:Array = new Array();

    model_internal static var allProperties:Array = new Array("Id", "AccessType", "CreatedById", "CreatedDate", "DeveloperName", "IsReadonly", "LastModifiedById", "LastModifiedDate", "Name", "NamespacePrefix", "SystemModstamp", "Type");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("Id", "AccessType", "CreatedById", "CreatedDate", "DeveloperName", "IsReadonly", "LastModifiedById", "LastModifiedDate", "Name", "NamespacePrefix", "SystemModstamp", "Type");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("Id", "AccessType", "CreatedById", "CreatedDate", "DeveloperName", "IsReadonly", "LastModifiedById", "LastModifiedDate", "Name", "NamespacePrefix", "SystemModstamp", "Type");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("Id", "AccessType", "CreatedById", "CreatedDate", "DeveloperName", "IsReadonly", "LastModifiedById", "LastModifiedDate", "Name", "NamespacePrefix", "SystemModstamp", "Type");
    model_internal static var derivedProperties:Array = new Array();
    model_internal static var collectionProperties:Array = new Array();
    model_internal static var collectionBaseMap:Object;
    model_internal static var entityName:String = "Folder";
    model_internal static var dependentsOnMap:Object;
    model_internal static var dependedOnServices:Array = new Array();

    
    model_internal var _AccessTypeIsValid:Boolean;
    model_internal var _AccessTypeValidator:com.adobe.fiber.styles.StyleValidator;
    model_internal var _AccessTypeIsValidCacheInitialized:Boolean = false;
    model_internal var _AccessTypeValidationFailureMessages:Array;
    ...
    model_internal var _instance:_Super_Folder;
    model_internal static var _nullStyle:com.adobe.fiber.styles.Style = new com.adobe.fiber.styles.Style();

    public function _FolderEntityMetadata(value : _Super_Folder)
    {
        ...
        if (model_internal::dependentsOnMap == null)
        {
            ...
            model_internal::dependentsOnMap["AccessType"] = new Array();
            ...
            model_internal::dependentsOnMap["IsReadonly"] = new Array();
        ...
        model_internal::_AccessTypeValidator = new StyleValidator(model_internal::_instance.model_internal::_doValidationForAccessType);
        model_internal::_AccessTypeValidator.required = true;
        model_internal::_AccessTypeValidator.requiredFieldError = "AccessType is required";
        //model_internal::_AccessTypeValidator.source = model_internal::_instance;
        //model_internal::_AccessTypeValidator.property = "AccessType";
    ...
    override public function getDependants(propertyName:String):Array
    {
       if (model_internal::dataProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a data property of entity Folder");  
    ...
    override public function getCollectionBase(propertyName:String):String
    {
        if (model_internal::collectionProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a collection property of entity Folder");  
    ...
    override public function getValue(propertyName:String):*
    {
        ...
        {
            throw new Error(propertyName + " does not exist for entity Folder");
        }
    ...
    [Bindable(event="propertyChange")]
    public function get isAccessTypeAvailable():Boolean
    {
        return true;
    }
    ...
    [Bindable(event="propertyChange")]
    public function get isIsReadonlyAvailable():Boolean
    {
        return true;
    }
     ...
     */
    public function invalidateDependentOnAccessType():void
    {
        if (model_internal::_AccessTypeIsValidCacheInitialized )
        {
            model_internal::_instance.model_internal::_doValidationCacheOfAccessType = null;
            model_internal::calculateAccessTypeIsValid();
        }
    }
    ...
    [Bindable(event="propertyChange")]   
    public function get AccessTypeStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }

    public function get AccessTypeValidator() : StyleValidator
    {
        return model_internal::_AccessTypeValidator;
    }

    model_internal function set _AccessTypeIsValid_der(value:Boolean):void 
    {
        var oldValue:Boolean = model_internal::_AccessTypeIsValid;         
        if (oldValue !== value)
        {
            model_internal::_AccessTypeIsValid = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "AccessTypeIsValid", oldValue, value));
        }                             
    }

    [Bindable(event="propertyChange")]
    public function get AccessTypeIsValid():Boolean
    {
        if (!model_internal::_AccessTypeIsValidCacheInitialized)
        {
            model_internal::calculateAccessTypeIsValid();
        ...
        return model_internal::_AccessTypeIsValid;
    }

    model_internal function calculateAccessTypeIsValid():void
    {
        var valRes:ValidationResultEvent = model_internal::_AccessTypeValidator.validate(model_internal::_instance.AccessType)
        model_internal::_AccessTypeIsValid_der = (valRes.results == null);
        model_internal::_AccessTypeIsValidCacheInitialized = true;
        if (valRes.results == null)
             model_internal::AccessTypeValidationFailureMessages_der = emptyArray;
        else
        {
            ...
            model_internal::AccessTypeValidationFailureMessages_der = _valFailures;
        }
    }

    [Bindable(event="propertyChange")]
    public function get AccessTypeValidationFailureMessages():Array
    {
        if (model_internal::_AccessTypeValidationFailureMessages == null)
            model_internal::calculateAccessTypeIsValid();

        return _AccessTypeValidationFailureMessages;
    }

    model_internal function set AccessTypeValidationFailureMessages_der(value:Array) : void
    {
        var oldValue:Array = model_internal::_AccessTypeValidationFailureMessages;
        ...
        if (needUpdate)
        {
            model_internal::_AccessTypeValidationFailureMessages = value;   
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "AccessTypeValidationFailureMessages", oldValue, value));
    ...
    [Bindable(event="propertyChange")]   
    public function get IsReadonlyStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }
     ...
     */  
     override public function getPropertyValidationFailureMessages(propertyName:String):Array
     {
         switch(propertyName)
         {
            case("AccessType"):
            {
                return AccessTypeValidationFailureMessages;
            }
            case("CreatedById"):
            {
