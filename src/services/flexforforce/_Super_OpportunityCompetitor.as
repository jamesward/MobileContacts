 ...
 * of this value object you may modify the generated sub-class of this class - OpportunityCompetitor.as.
 */
...
[Managed]
[ExcludeClass]
public class _Super_OpportunityCompetitor extends mx.data.DynamicManagedItem implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("services.flexforforce.OpportunityCompetitor") == null)
            {
                flash.net.registerClassAlias("services.flexforforce.OpportunityCompetitor", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _OpportunityCompetitorEntityMetadata;

    /**
     * properties
     */
    private var _internal_Id : String;
    private var _internal_CompetitorName : String;
    ...
    private var _internal_Strengths : String;
    private var _internal_SystemModstamp : Date;
    private var _internal_Weaknesses : String;
    ...
    public function _Super_OpportunityCompetitor()
    {
        _model = new _OpportunityCompetitorEntityMetadata(this);

        // Bind to own data properties for cache invalidation triggering
        model_internal::_changeWatcherArray.push(mx.binding.utils.ChangeWatcher.watch(this, "CompetitorName", model_internal::setterListenerCompetitorName));
        ...
        model_internal::_changeWatcherArray.push(mx.binding.utils.ChangeWatcher.watch(this, "Strengths", model_internal::setterListenerStrengths));
        ...
        model_internal::_changeWatcherArray.push(mx.binding.utils.ChangeWatcher.watch(this, "Weaknesses", model_internal::setterListenerWeaknesses));
    ...
    [Bindable(event="propertyChange")]
    public function get Strengths() : String
    {
        return _internal_Strengths;
    }
    ...
    [Bindable(event="propertyChange")]
    public function get Weaknesses() : String
    {
        return _internal_Weaknesses;
    }
    ...
    {
        var oldValue:String = _internal_CompetitorName;
        if (oldValue !== value)
        {
            _internal_CompetitorName = value;
        }
    }
    ...
    public function set Strengths(value:String) : void
    {
        var oldValue:String = _internal_Strengths;
        if (oldValue !== value)
        {
            _internal_Strengths = value;
        }
    }
    ...
    public function set Weaknesses(value:String) : void
    {
        var oldValue:String = _internal_Weaknesses;
        if (oldValue !== value)
        {
            _internal_Weaknesses = value;
        }
    }
    ...
    model_internal function setterListenerCompetitorName(value:flash.events.Event):void
    {
        _model.invalidateDependentOnCompetitorName();
    }
    ...
    model_internal function setterListenerStrengths(value:flash.events.Event):void
    {
        _model.invalidateDependentOnStrengths();
    }
    ...
    model_internal function setterListenerWeaknesses(value:flash.events.Event):void
    {
        _model.invalidateDependentOnWeaknesses();
    }
    ...
    model_internal function calculateIsValid():Boolean
    {
        ...
        if (!_model.CompetitorNameIsValid)
        {
            propertyValidity = false;
            com.adobe.fiber.util.FiberUtils.arrayAdd(validationFailureMessages, _model.model_internal::_CompetitorNameValidationFailureMessages);
        }
        ...
        if (!_model.StrengthsIsValid)
        {
            propertyValidity = false;
            com.adobe.fiber.util.FiberUtils.arrayAdd(validationFailureMessages, _model.model_internal::_StrengthsValidationFailureMessages);
        }
        ...
        if (!_model.WeaknessesIsValid)
        {
            propertyValidity = false;
            com.adobe.fiber.util.FiberUtils.arrayAdd(validationFailureMessages, _model.model_internal::_WeaknessesValidationFailureMessages);
        }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _OpportunityCompetitorEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _OpportunityCompetitorEntityMetadata) : void
    {
        var oldValue : _OpportunityCompetitorEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
    ...
    model_internal var _doValidationCacheOfCompetitorName : Array = null;
    model_internal var _doValidationLastValOfCompetitorName : String;

    model_internal function _doValidationForCompetitorName(valueIn:Object):Array
    {
        var value : String = valueIn as String;

        if (model_internal::_doValidationCacheOfCompetitorName != null && model_internal::_doValidationLastValOfCompetitorName == value)
           return model_internal::_doValidationCacheOfCompetitorName ;

        _model.model_internal::_CompetitorNameIsValidCacheInitialized = true;
        var validationFailures:Array = new Array();
        var errorMessage:String;
        var failure:Boolean;

        var valRes:ValidationResult;
        if (_model.isCompetitorNameAvailable && _internal_CompetitorName == null)
        {
            validationFailures.push(new ValidationResult(true, "", "", "CompetitorName is required"));
        }

        model_internal::_doValidationCacheOfCompetitorName = validationFailures;
        model_internal::_doValidationLastValOfCompetitorName = value;
    ...
    model_internal var _doValidationCacheOfStrengths : Array = null;
    model_internal var _doValidationLastValOfStrengths : String;

    model_internal function _doValidationForStrengths(valueIn:Object):Array
    {
        var value : String = valueIn as String;

        if (model_internal::_doValidationCacheOfStrengths != null && model_internal::_doValidationLastValOfStrengths == value)
           return model_internal::_doValidationCacheOfStrengths ;

        _model.model_internal::_StrengthsIsValidCacheInitialized = true;
        var validationFailures:Array = new Array();
        var errorMessage:String;
        var failure:Boolean;

        var valRes:ValidationResult;
        if (_model.isStrengthsAvailable && _internal_Strengths == null)
        {
            validationFailures.push(new ValidationResult(true, "", "", "Strengths is required"));
        }

        model_internal::_doValidationCacheOfStrengths = validationFailures;
        model_internal::_doValidationLastValOfStrengths = value;
    ...
    model_internal var _doValidationCacheOfWeaknesses : Array = null;
    model_internal var _doValidationLastValOfWeaknesses : String;

    model_internal function _doValidationForWeaknesses(valueIn:Object):Array
    {
        var value : String = valueIn as String;

        if (model_internal::_doValidationCacheOfWeaknesses != null && model_internal::_doValidationLastValOfWeaknesses == value)
           return model_internal::_doValidationCacheOfWeaknesses ;

        _model.model_internal::_WeaknessesIsValidCacheInitialized = true;
        var validationFailures:Array = new Array();
        var errorMessage:String;
        var failure:Boolean;

        var valRes:ValidationResult;
        if (_model.isWeaknessesAvailable && _internal_Weaknesses == null)
        {
            validationFailures.push(new ValidationResult(true, "", "", "Weaknesses is required"));
        }

        model_internal::_doValidationCacheOfWeaknesses = validationFailures;
        model_internal::_doValidationLastValOfWeaknesses = value;
